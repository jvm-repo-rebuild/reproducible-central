...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20231129032326 --> [whitespace-maven-plugin](../content/com/github/hazendaz/maven/whitespace-maven-plugin/README.md) | [1.3.0](../content/com/github/hazendaz/maven/whitespace-maven-plugin/whitespace-maven-plugin-1.3.0.buildspec) :warning: | [1.3.1](../content/com/github/hazendaz/maven/whitespace-maven-plugin/whitespace-maven-plugin-1.3.1.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/maven/whitespace-maven-plugin/whitespace-maven-plugin-1.3.0.buildspec 1.3.1` |
