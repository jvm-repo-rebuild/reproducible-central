...
| <!-- 20240605164952 --> [:mailbox:](https://lists.apache.org/list?dev@pulsar.apache.org:lte=1M:VOTE) | [pulsar](../content/org/apache/pulsar/README.md) | [3.2.0](../content/org/apache/pulsar/pulsar-3.2.0.buildspec) :warning: | [3.3.1](../content/org/apache/pulsar/pulsar-3.3.1.buildspec)  | `bin/add-new-release.sh content/org/apache/pulsar/pulsar-3.2.0.buildspec 3.3.1 staging` |
...
| <!-- 20230924095100 --> [:mailbox:](https://lists.apache.org/list?dev@avro.apache.org:lte=1M:VOTE) | [avro-toplevel](../content/org/apache/avro/README.md) | [1.11.3](../content/org/apache/avro/avro-1.11.3.buildspec) :warning: | [1.12.0](../content/org/apache/avro/avro-1.12.0.buildspec)  | `bin/add-new-release.sh content/org/apache/avro/avro-1.11.3.buildspec 1.12.0 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20240729155944 --> [artemis-pom](../content/org/apache/activemq/artemis/README.md) | [2.34.0](../content/org/apache/activemq/artemis/artemis-2.34.0.buildspec) :warning: | [2.36.0](../content/org/apache/activemq/artemis/artemis-2.36.0.buildspec) | `bin/add-new-release.sh content/org/apache/activemq/artemis/artemis-2.34.0.buildspec 2.36.0` |
| <!-- 20240729140221 --> [jooby](../content/io/jooby/README.md) | [3.0.5](../content/io/jooby/jooby-3.0.5.buildspec) :warning: | [3.2.7](../content/io/jooby/jooby-3.2.7.buildspec) | `bin/add-new-release.sh content/io/jooby/jooby-3.0.5.buildspec 3.2.7` |
| <!-- 20240729102011 --> [jandex-parent](../content/io/smallrye/jandex/README.md) | [3.2.0](../content/io/smallrye/jandex/jandex-3.2.0.buildspec) :warning: | [3.2.1](../content/io/smallrye/jandex/jandex-3.2.1.buildspec) | `bin/add-new-release.sh content/io/smallrye/jandex/jandex-3.2.0.buildspec 3.2.1` |
...
| <!-- 20240714134539 --> [spring-bridge-maven](../content/com/homeofthewizard/spring-bridge-maven-plugin/README.md) | [](../content/com/homeofthewizard/spring-bridge-maven-plugin/) :x: | [1.0.1-alpha](../content/com/homeofthewizard/spring-bridge-maven-plugin/-1.0.1-alpha.buildspec) | `bin/add-new-release.sh content/com/homeofthewizard/spring-bridge-maven-plugin/ 1.0.1-alpha` |
...
| artifactId | newest |
| ---------- | ------ |
| <!-- 20240728014748 --> [spoon-core](../content/fr/inria/gforge/spoon/spoon-core/README.md) | 11.0.1-beta-16 :x: |
