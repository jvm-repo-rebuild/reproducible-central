...
| ---------- | ---- | -- | ------- |
| <!-- 20241011155404 --> [taglist-maven-plugin](../content/org/codehaus/mojo/taglist-maven-plugin/README.md) | [3.1.0](../content/org/codehaus/mojo/taglist-maven-plugin/taglist-maven-plugin-3.1.0.buildspec) :white_check_mark: | [3.2.0](../content/org/codehaus/mojo/taglist-maven-plugin/taglist-maven-plugin-3.2.0.buildspec) | `bin/add-new-release.sh content/org/codehaus/mojo/taglist-maven-plugin/taglist-maven-plugin-3.1.0.buildspec 3.2.0` |
| <!-- 20241010205834 --> [trino-root](../content/io/trino/README.md) | [460](../content/io/trino/trino-460.buildspec) :white_check_mark: | [461](../content/io/trino/trino-461.buildspec) | `bin/add-new-release.sh content/io/trino/trino-460.buildspec 461` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20241011170121 --> [opentelemetry-sdk](../content/io/opentelemetry/java/README.md) | [1.42.1](../content/io/opentelemetry/java/opentelemetry-sdk-1.42.1.buildspec) :warning: | [1.43.0](../content/io/opentelemetry/java/opentelemetry-sdk-1.43.0.buildspec) | `bin/add-new-release.sh content/io/opentelemetry/java/opentelemetry-sdk-1.42.1.buildspec 1.43.0` |
