...
| ---------- | ---- | -- | ------- |
| <!-- 20230811190622 --> [liquibase-percona](../content/org/liquibase/ext/liquibase-percona/README.md) | 4.23.0 :heavy_check_mark: | [4.23.1](../content/org/liquibase/ext/liquibase-percona/liquibase-percona-4.23.1.buildspec) | `bin/add-new-release.sh content/org/liquibase/ext/liquibase-percona/liquibase-percona-4.23.0.buildspec 4.23.1` |
| <!-- 20230811151930 --> [tomcat-authnz-spnego-ad](../content/net/sf/michael-o/tomcat/tomcat-authnz-spnego-ad/README.md) | 4.0.0 :heavy_check_mark: | [4.0.1](../content/net/sf/michael-o/tomcat/tomcat-authnz-spnego-ad/tomcat-authnz-spnego-ad-4.0.1.buildspec) | `bin/add-new-release.sh content/net/sf/michael-o/tomcat/tomcat-authnz-spnego-ad/tomcat-authnz-spnego-ad-4.0.0.buildspec 4.0.1` |
| <!-- 20230811080837 --> [tag-expressions](../content/io/cucumber/tag-expressions/README.md) | 5.0.4 :heavy_check_mark: | [5.0.5](../content/io/cucumber/tag-expressions/tag-expressions-5.0.5.buildspec) | `bin/add-new-release.sh content/io/cucumber/tag-expressions/tag-expressions-5.0.4.buildspec 5.0.5` |
| <!-- 20230811071817 --> [eforms-core-java](../content/eu/europa/ted/eforms/eforms-core-java/README.md) | 1.0.5 :heavy_check_mark: | [1.1.0](../content/eu/europa/ted/eforms/eforms-core-java/eforms-core-java-1.1.0.buildspec) | `bin/add-new-release.sh content/eu/europa/ted/eforms/eforms-core-java/eforms-core-java-1.0.5.buildspec 1.1.0` |
| <!-- 20230809193656 --> [logback-parent](../content/ch/qos/logback/README.md) | 1.4.9 :heavy_check_mark: | [1.4.11](../content/ch/qos/logback/logback-1.4.11.buildspec) | `bin/add-new-release.sh content/ch/qos/logback/logback-1.4.9.buildspec 1.4.11` |
...
| <!-- 20230811110947 --> [jspwiki-builder](../content/org/apache/jspwiki/README.md) | 2.11.3 :warning: | [2.12.1](../content/org/apache/jspwiki/jspwiki-2.12.1.buildspec) | `bin/add-new-release.sh content/org/apache/jspwiki/jspwiki-2.11.3.buildspec 2.12.1` |
| <!-- 20230811075625 --> [jackrabbit-parent](../content/org/apache/jackrabbit/jackrabbit/README.md) | 2.21.17 :warning: [:memo:](https://github.com/apache/jackrabbit/pull/139) | [2.21.19](../content/org/apache/jackrabbit/jackrabbit/jackrabbit-2.21.19.buildspec) | `bin/add-new-release.sh content/org/apache/jackrabbit/jackrabbit/jackrabbit-2.21.17.buildspec 2.21.19` |
