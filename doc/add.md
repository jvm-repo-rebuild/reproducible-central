...
| ---------- | ---- | -- | ------- |
| <!-- 20250912172522 --> [gherkin-utils](../content/io/cucumber/gherkin-utils/README.md) | [9.2.0](../content/io/cucumber/gherkin-utils/gherkin-utils-9.2.0.buildspec) :white_check_mark: | [10.0.0](../content/io/cucumber/gherkin-utils/gherkin-utils-10.0.0.buildspec) | `bin/add-new-release.sh content/io/cucumber/gherkin-utils/gherkin-utils-9.2.0.buildspec 10.0.0` |
| <!-- 20250912131724 --> [cui-parent-pom](../content/de/cuioss/cui-parent-pom/README.md) | [1.2.1](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.2.1.buildspec) :white_check_mark: | [1.2.2](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.2.2.buildspec) | `bin/add-new-release.sh content/de/cuioss/cui-parent-pom/cui-parent-pom-1.2.1.buildspec 1.2.2` |
| <!-- 20250912080620 --> [pmd](../content/net/sourceforge/pmd/README.md) | [7.16.0](../content/net/sourceforge/pmd/pmd-7.16.0.buildspec) :white_check_mark: | [7.17.0](../content/net/sourceforge/pmd/pmd-7.17.0.buildspec) | `bin/add-new-release.sh content/net/sourceforge/pmd/pmd-7.16.0.buildspec 7.17.0` |
| <!-- 20250911224041 --> [formatter-maven-plugin](../content/net/revelc/code/formatter/formatter-maven-plugin/README.md) | [2.28.0](../content/net/revelc/code/formatter/formatter-maven-plugin/formatter-maven-plugin-2.28.0.buildspec) :white_check_mark: | [2.29.0](../content/net/revelc/code/formatter/formatter-maven-plugin/formatter-maven-plugin-2.29.0.buildspec) | `bin/add-new-release.sh content/net/revelc/code/formatter/formatter-maven-plugin/formatter-maven-plugin-2.28.0.buildspec 2.29.0` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20250825084948 --> [:mailbox:](https://lists.apache.org/list?dev@qpid.apache.org:lte=1M:VOTE) | [qpid-jms-parent](../content/org/apache/qpid/jms/README.md) | [2.8.0](../content/org/apache/qpid/jms/qpid-jms-2.8.0.buildspec) :white_check_mark: | [2.9.0](../content/org/apache/qpid/jms/qpid-jms-2.9.0.buildspec)  | `bin/add-new-release.sh content/org/apache/qpid/jms/qpid-jms-2.8.0.buildspec 2.9.0 staging` |
...
| <!-- 20250502051147 --> [:mailbox:](https://lists.apache.org/list?dev@ratis.apache.org:lte=1M:VOTE) | [ratis-thirdparty](../content/org/apache/ratis/ratis-thirdparty/README.md) | [1.0.9](../content/org/apache/ratis/ratis-thirdparty/ratis-thirdparty-1.0.9.buildspec) :warning: | [1.0.10](../content/org/apache/ratis/ratis-thirdparty/ratis-thirdparty-1.0.10.buildspec)  | `bin/add-new-release.sh content/org/apache/ratis/ratis-thirdparty/ratis-thirdparty-1.0.9.buildspec 1.0.10 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250912135640 --> [jandex-parent](../content/io/smallrye/jandex/README.md) | [3.4.0](../content/io/smallrye/jandex/jandex-3.4.0.buildspec) :warning: | [3.5.0](../content/io/smallrye/jandex/jandex-3.5.0.buildspec) | `bin/add-new-release.sh content/io/smallrye/jandex/jandex-3.4.0.buildspec 3.5.0` |
| <!-- 20250912122536 --> [sdk-parent](../content/com/sap/ai/sdk/README.md) | [1.10.0](../content/com/sap/ai/sdk/sdk-1.10.0.buildspec) :warning: | [1.11.0](../content/com/sap/ai/sdk/sdk-1.11.0.buildspec) | `bin/add-new-release.sh content/com/sap/ai/sdk/sdk-1.10.0.buildspec 1.11.0` |
| <!-- 20250912055743 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.100.0](../content/org/finos/legend/engine/legend-engine-4.100.0.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.100.0` |
