...
| ---------- | ---- | -- | ------- |
| <!-- 20251127192119 --> [pmd-designer](../content/net/sourceforge/pmd/pmd-designer/README.md) | [7.10.0](../content/net/sourceforge/pmd/pmd-designer/pmd-designer-7.10.0.buildspec) :white_check_mark: | [7.19.1](../content/net/sourceforge/pmd/pmd-designer/pmd-designer-7.19.1.buildspec) | `bin/add-new-release.sh content/net/sourceforge/pmd/pmd-designer/pmd-designer-7.10.0.buildspec 7.19.1` |
| <!-- 20251127192119 --> [pmd-designer](../content/net/sourceforge/pmd/pmd-designer/README.md) | [7.10.0](../content/net/sourceforge/pmd/pmd-designer/pmd-designer-7.10.0.buildspec) :white_check_mark: | 7.19.0  | `bin/add-new-release.sh content/net/sourceforge/pmd/pmd-designer/pmd-designer-7.10.0.buildspec ...` |
| <!-- 20251127150514 --> [pmd-build-tools-config](../content/net/sourceforge/pmd/pmd-build-tools-config/README.md) | [35](../content/net/sourceforge/pmd/pmd-build-tools-config/pmd-build-tools-config-35.buildspec) :white_check_mark: | [36](../content/net/sourceforge/pmd/pmd-build-tools-config/pmd-build-tools-config-36.buildspec) | `bin/add-new-release.sh content/net/sourceforge/pmd/pmd-build-tools-config/pmd-build-tools-config-35.buildspec 36` |
| <!-- 20251127112137 --> [scg-base](../content/io/telicent/smart-caches/graph/scg-base/README.md) | [0.92.0](../content/io/telicent/smart-caches/graph/scg-base/scg-base-0.92.0.buildspec) :white_check_mark: | [0.92.1](../content/io/telicent/smart-caches/graph/scg-base/scg-base-0.92.1.buildspec) | `bin/add-new-release.sh content/io/telicent/smart-caches/graph/scg-base/scg-base-0.92.0.buildspec 0.92.1` |
| <!-- 20251127103917 --> [airbase](../content/io/airlift/airbase/README.md) | [329](../content/io/airlift/airbase/airbase-329.buildspec) :white_check_mark: | [330](../content/io/airlift/airbase/airbase-330.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-329.buildspec 330` |
| <!-- 20251127093725 --> [hibernate-reactive-core](../content/org/hibernate/reactive/hibernate-reactive/README.md) | [4.1.7.Final](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.1.7.Final.buildspec) :white_check_mark: | [4.2.0.CR1](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.2.0.CR1.buildspec) | `bin/add-new-release.sh content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.1.7.Final.buildspec 4.2.0.CR1` |
| <!-- 20251127093725 --> [hibernate-reactive-core](../content/org/hibernate/reactive/hibernate-reactive/README.md) | [4.1.7.Final](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.1.7.Final.buildspec) :white_check_mark: | 3.2.0.CR1  | `bin/add-new-release.sh content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.1.7.Final.buildspec ...` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20251108194754 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-release-plugin](../content/org/apache/maven/plugins/maven-release-plugin/README.md) | [3.2.0](../content/org/apache/maven/plugins/maven-release-plugin/maven-release-plugin-3.2.0.buildspec) :white_check_mark: | [3.3.0](../content/org/apache/maven/plugins/maven-release-plugin/maven-release-plugin-3.3.0.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-release-plugin/maven-release-plugin-3.2.0.buildspec 3.3.0 staging` |
