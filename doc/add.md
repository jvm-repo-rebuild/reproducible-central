...
| ---------- | ---- | -- | ------- |
| <!-- 20241205072938 --> [airbase](../content/io/airlift/airbase/README.md) | [202](../content/io/airlift/airbase/airbase-202.buildspec) :white_check_mark: | [203](../content/io/airlift/airbase/airbase-203.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-202.buildspec 203` |
| <!-- 20241204212230 --> [sigstore-maven-plugin](../content/dev/sigstore/sigstore-maven-plugin/README.md) | [1.1.0](../content/dev/sigstore/sigstore-maven-plugin/sigstore-maven-plugin-1.1.0.buildspec) :white_check_mark: | [1.2.0](../content/dev/sigstore/sigstore-maven-plugin/sigstore-maven-plugin-1.2.0.buildspec) | `bin/add-new-release.sh content/dev/sigstore/sigstore-maven-plugin/sigstore-maven-plugin-1.1.0.buildspec 1.2.0` |
...
| <!-- 20241205011828 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.56.0](../content/org/finos/legend/engine/legend-engine-4.56.0.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.67.4](../content/org/finos/legend/engine/legend-engine-4.67.4.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.56.0.buildspec 4.67.4` |
