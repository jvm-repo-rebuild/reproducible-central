...
| ---------- | ---- | -- | ------- |
| <!-- 20251124175720 --> [versions-maven-plugin](../content/org/codehaus/mojo/versions-maven-plugin/README.md) | [2.20.0](../content/org/codehaus/mojo/versions-maven-plugin/versions-maven-plugin-2.20.0.buildspec) :white_check_mark: | [2.20.1](../content/org/codehaus/mojo/versions-maven-plugin/versions-maven-plugin-2.20.1.buildspec) | `bin/add-new-release.sh content/org/codehaus/mojo/versions-maven-plugin/versions-maven-plugin-2.20.0.buildspec 2.20.1` |
| <!-- 20251124154130 --> [hibernate-core](../content/org/hibernate/orm/hibernate-core/README.md) | [7.2.0.CR2](../content/org/hibernate/orm/hibernate-core/hibernate-core-7.2.0.CR2.buildspec) :white_check_mark: | 7.1.10.Final  | `bin/add-new-release.sh content/org/hibernate/orm/hibernate-core/hibernate-core-7.2.0.CR2.buildspec ...` |
| <!-- 20251124154116 --> [avaje-jex-parent](../content/io/avaje/jex/README.md) | [3.3](../content/io/avaje/jex/avaje-jex-3.3.buildspec) :white_check_mark: | [3.4-RC1](../content/io/avaje/jex/avaje-jex-3.4-RC1.buildspec) | `bin/add-new-release.sh content/io/avaje/jex/avaje-jex-3.3.buildspec 3.4-RC1` |
| <!-- 20251124124118 --> [github-client](../content/com/spotify/github-client/README.md) | [0.4.14](../content/com/spotify/github-client/github-client-0.4.14.buildspec) :white_check_mark: | [0.5.1](../content/com/spotify/github-client/github-client-0.5.1.buildspec) | `bin/add-new-release.sh content/com/spotify/github-client/github-client-0.4.14.buildspec 0.5.1` |
| <!-- 20251124113717 --> [io.wcm.handler.link](../content/io/wcm/io.wcm.handler/link/README.md) | [2.2.10](../content/io/wcm/io.wcm.handler/link/io.wcm.handler.link-2.2.10.buildspec) :white_check_mark: | [2.3.0](../content/io/wcm/io.wcm.handler/link/io.wcm.handler.link-2.3.0.buildspec) | `bin/add-new-release.sh content/io/wcm/io.wcm.handler/link/io.wcm.handler.link-2.2.10.buildspec 2.3.0` |
| <!-- 20251124113548 --> [io.wcm.handler.media](../content/io/wcm/io.wcm.handler/media/README.md) | [2.5.4](../content/io/wcm/io.wcm.handler/media/wcm-media-2.5.4.buildspec) :white_check_mark: | [2.6.0](../content/io/wcm/io.wcm.handler/media/wcm-media-2.6.0.buildspec) | `bin/add-new-release.sh content/io/wcm/io.wcm.handler/media/wcm-media-2.5.4.buildspec 2.6.0` |
| <!-- 20251124094515 --> [airbase](../content/io/airlift/airbase/README.md) | [328](../content/io/airlift/airbase/airbase-328.buildspec) :white_check_mark: | [329](../content/io/airlift/airbase/airbase-329.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-328.buildspec 329` |
| <!-- 20251124044113 --> [avaje-prisms-parent](../content/io/avaje/prisms/README.md) | [1.44-RC3](../content/io/avaje/prisms/avaje-prisms-1.44-RC3.buildspec) :white_check_mark: | [1.44-RC4](../content/io/avaje/prisms/avaje-prisms-1.44-RC4.buildspec) | `bin/add-new-release.sh content/io/avaje/prisms/avaje-prisms-1.44-RC3.buildspec 1.44-RC4` |
| <!-- 20251124044113 --> [avaje-prisms-parent](../content/io/avaje/prisms/README.md) | [1.44-RC3](../content/io/avaje/prisms/avaje-prisms-1.44-RC3.buildspec) :white_check_mark: | 1.44-RC2  | `bin/add-new-release.sh content/io/avaje/prisms/avaje-prisms-1.44-RC3.buildspec ...` |
| <!-- 20251123011719 --> [hibernate-reactive-core](../content/org/hibernate/reactive/hibernate-reactive/README.md) | [4.1.7.Final](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.1.7.Final.buildspec) :white_check_mark: | 3.1.9.Final 3.0.11.Final  | `bin/add-new-release.sh content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.1.7.Final.buildspec ...` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20251124114357 --> [syncope](../content/org/apache/syncope/README.md) | [4.0.2](../content/org/apache/syncope/syncope-4.0.2.buildspec) :warning: | [4.0.3](../content/org/apache/syncope/syncope-4.0.3.buildspec) | `bin/add-new-release.sh content/org/apache/syncope/syncope-4.0.2.buildspec 4.0.3` |
...
| <!-- 20251123172718 --> [spotbugs-maven-plugin](../content/com/github/spotbugs/spotbugs-maven-plugin/README.md) | [4.9.8.1](../content/com/github/spotbugs/spotbugs-maven-plugin/spotbugs-maven-plugin-4.9.8.1.buildspec) :warning: [:memo:](https://github.com/spotbugs/spotbugs-maven-plugin/issues/1148) | [4.9.8.2](../content/com/github/spotbugs/spotbugs-maven-plugin/spotbugs-maven-plugin-4.9.8.2.buildspec) | `bin/add-new-release.sh content/com/github/spotbugs/spotbugs-maven-plugin/spotbugs-maven-plugin-4.9.8.1.buildspec 4.9.8.2` |
...
| <!-- 20251122061336 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.112.0](../content/org/finos/legend/engine/legend-engine-4.112.0.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.112.0` |
