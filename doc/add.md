...
| <!-- 20241113141951 --> [langchain4j](../content/dev/langchain4j/README.md) | [0.35.0](../content/dev/langchain4j/langchain4j-0.35.0.buildspec) :white_check_mark: | [0.36.0](../content/dev/langchain4j/langchain4j-0.36.0.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-0.35.0.buildspec 0.36.0` |
| <!-- 20241113082850 --> [scg-base](../content/io/telicent/smart-caches/graph/scg-base/README.md) | [0.82.6](../content/io/telicent/smart-caches/graph/scg-base/scg-base-0.82.6.buildspec) :white_check_mark: | [0.82.7](../content/io/telicent/smart-caches/graph/scg-base/scg-base-0.82.7.buildspec) | `bin/add-new-release.sh content/io/telicent/smart-caches/graph/scg-base/scg-base-0.82.6.buildspec 0.82.7` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20241113161518 --> [jooby](../content/io/jooby/README.md) | [3.5.1](../content/io/jooby/jooby-3.5.1.buildspec) :warning: | [3.5.2](../content/io/jooby/jooby-3.5.2.buildspec) | `bin/add-new-release.sh content/io/jooby/jooby-3.5.1.buildspec 3.5.2` |
| <!-- 20241113115412 --> [quarkus-project](../content/io/quarkus/README.md) | [3.16.2](../content/io/quarkus/quarkus-3.16.2.buildspec) :warning: | [3.17.0.CR1](../content/io/quarkus/quarkus-3.17.0.CR1.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.16.2.buildspec 3.17.0.CR1` |
| <!-- 20241113115211 --> [bitcoin-commons](../content/net/osslabz/bitcoin-commons/README.md) | [0.2.0](../content/net/osslabz/bitcoin-commons/bitcoin-commons-0.2.0.buildspec) :warning: | [0.2.1](../content/net/osslabz/bitcoin-commons/bitcoin-commons-0.2.1.buildspec) | `bin/add-new-release.sh content/net/osslabz/bitcoin-commons/bitcoin-commons-0.2.0.buildspec 0.2.1` |
...
| <!-- 20241113051104 --> [opentelemetry-instrumentation-api](../content/io/opentelemetry/instrumentation/README.md) | [2.9.0](../content/io/opentelemetry/instrumentation/opentelemetry-2.9.0.buildspec) :warning: | [2.10.0](../content/io/opentelemetry/instrumentation/opentelemetry-2.10.0.buildspec) | `bin/add-new-release.sh content/io/opentelemetry/instrumentation/opentelemetry-2.9.0.buildspec 2.10.0` |
