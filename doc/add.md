...
| ---------- | ---- | -- | ------- |
| <!-- 20240306144301 --> [jstachio](../content/io/jstach/jstachio/README.md) | [1.3.4](../content/io/jstach/jstachio/jstachio-1.3.4.buildspec) :white_check_mark: | [1.3.5](../content/io/jstach/jstachio/jstachio-1.3.5.buildspec) | `bin/add-new-release.sh content/io/jstach/jstachio/jstachio-1.3.4.buildspec 1.3.5` |
| <!-- 20240305225253 --> [commons-parent](../content/org/apache/commons/parent/README.md) | [66](../content/org/apache/commons/parent/commons-parent-66.buildspec) :white_check_mark: | [67](../content/org/apache/commons/parent/commons-parent-67.buildspec) | `bin/add-new-release.sh content/org/apache/commons/parent/commons-parent-66.buildspec 67` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20240304193330 --> [:mailbox:](https://lists.apache.org/list?dev@zookeeper.apache.org:lte=1M:VOTE) | [parent](../content/org/apache/zookeeper/README.md) | [3.9.1](../content/org/apache/zookeeper/zookeeper-3.9.1.buildspec) :warning: [:memo:](https://github.com/apache/zookeeper/pull/2042) | [3.9.2](../content/org/apache/zookeeper/zookeeper-3.9.2.buildspec)  | `bin/add-new-release.sh content/org/apache/zookeeper/zookeeper-3.9.1.buildspec 3.9.2 staging` |
| <!-- 20240219003801 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-compress](../content/org/apache/commons/compress/README.md) | [1.26.0](../content/org/apache/commons/compress/commons-compress-1.26.0.buildspec) :white_check_mark: | [1.26.1](../content/org/apache/commons/compress/commons-compress-1.26.1.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/compress/commons-compress-1.26.0.buildspec 1.26.1 staging` |
| <!-- 20240205085330 --> [:mailbox:](https://lists.apache.org/list?dev@pulsar.apache.org:lte=1M:VOTE) | [pulsar](../content/org/apache/pulsar/README.md) | [3.2.0](../content/org/apache/pulsar/pulsar-3.2.0.buildspec) :warning: | [3.2.1](../content/org/apache/pulsar/pulsar-3.2.1.buildspec)  | `bin/add-new-release.sh content/org/apache/pulsar/pulsar-3.2.0.buildspec 3.2.1 staging` |
| <!-- 20240115165527 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven](../content/org/apache/maven/maven/README.md) | [4.0.0-alpha-12](../content/org/apache/maven/maven/maven-4.0.0-alpha-12.buildspec) :white_check_mark: | [4.0.0-alpha-13](../content/org/apache/maven/maven/maven-4.0.0-alpha-13.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/maven/maven-4.0.0-alpha-12.buildspec 4.0.0-alpha-13 staging` |
...
| <!-- 20231203130327 --> [:mailbox:](https://lists.apache.org/list?dev@activemq.apache.org:lte=1M:VOTE) | [activemq-parent](../content/org/apache/activemq/README.md) | [6.0.1](../content/org/apache/activemq/activemq-6.0.1.buildspec) :white_check_mark: | [6.1.0](../content/org/apache/activemq/activemq-6.1.0.buildspec)  | `bin/add-new-release.sh content/org/apache/activemq/activemq-6.0.1.buildspec 6.1.0 staging` |
...
| <!-- 20231110095945 --> [:mailbox:](https://lists.apache.org/list?dev@orc.apache.org:lte=1M:VOTE) | [orc](../content/org/apache/orc/README.md) | [1.9.2](../content/org/apache/orc/orc-1.9.2.buildspec) :warning: | [2.0.0](../content/org/apache/orc/orc-2.0.0.buildspec)  | `bin/add-new-release.sh content/org/apache/orc/orc-1.9.2.buildspec 2.0.0 staging` |
...
| <!-- 20230511211425 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-remote-resources-plugin](../content/org/apache/maven/plugins/maven-remote-resources-plugin/README.md) | [3.1.0](../content/org/apache/maven/plugins/maven-remote-resources-plugin/maven-remote-resources-plugin-3.1.0.buildspec) :white_check_mark: | [3.2.0](../content/org/apache/maven/plugins/maven-remote-resources-plugin/maven-remote-resources-plugin-3.2.0.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-remote-resources-plugin/maven-remote-resources-plugin-3.1.0.buildspec 3.2.0 staging` |
| <!-- 20230324072106 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-filtering](../content/org/apache/maven/shared/maven-filtering/README.md) | [3.3.1](../content/org/apache/maven/shared/maven-filtering/maven-filtering-3.3.1.buildspec) :white_check_mark: | [3.3.2](../content/org/apache/maven/shared/maven-filtering/maven-filtering-3.3.2.buildspec) [6 :white_check_mark: ](../content/org/apache/maven/shared/maven-filtering/maven-filtering-3.3.2.buildcompare) | `bin/add-new-release.sh content/org/apache/maven/shared/maven-filtering/maven-filtering-3.3.1.buildspec 3.3.2 staging` |
...
| <!-- 20240306145736 --> [jetty-project](../content/org/eclipse/jetty/jetty-project/README.md) | [12.0.6](../content/org/eclipse/jetty/jetty-project/jetty-project-12.0.6.buildspec) :warning: [:memo:](https://github.com/jetty/jetty.project/pull/11360) | [12.0.7](../content/org/eclipse/jetty/jetty-project/jetty-project-12.0.7.buildspec) | `bin/add-new-release.sh content/org/eclipse/jetty/jetty-project/jetty-project-12.0.6.buildspec 12.0.7` |
...
| <!-- 20240228184654 --> [opentelemetry-instrumentation-api](../content/io/opentelemetry/instrumentation/README.md) | [1.17.0-alpha](../content/io/opentelemetry/instrumentation/opentelemetry-1.17.0-alpha.buildspec) :warning: | [2.1.0](../content/io/opentelemetry/instrumentation/opentelemetry-2.1.0.buildspec) | `bin/add-new-release.sh content/io/opentelemetry/instrumentation/opentelemetry-1.17.0-alpha.buildspec 2.1.0` |
| <!-- 20240227194505 --> [jooby](../content/io/jooby/README.md) | [3.0.5](../content/io/jooby/jooby-3.0.5.buildspec) :warning: | [3.0.8](../content/io/jooby/jooby-3.0.8.buildspec) | `bin/add-new-release.sh content/io/jooby/jooby-3.0.5.buildspec 3.0.8` |
...
| artifactId | newest |
| ---------- | ------ |
| <!-- 20240304201739 --> [git-commit-id-maven-plugin](../content/io/github/git-commit-id/README.md) | 8.0.0 :warning: [:memo:](https://github.com/git-commit-id/git-commit-id-maven-plugin/pull/711) |
| <!-- 20240304193330 --> [parent](../content/org/apache/zookeeper/README.md) | 3.9.1 :warning: [:memo:](https://github.com/apache/zookeeper/pull/2042) |
...
| <!-- 20240226091427 --> [jackrabbit-parent](../content/org/apache/jackrabbit/jackrabbit/README.md) | 2.21.25 :warning: [:memo:](https://lists.apache.org/thread/6qxnclwmxggq6j20l8z78yr375vxo508) |
...
| <!-- 20240218210158 --> [jdbi3-root](../content/org/jdbi/README.md) | 3.45.0 :warning: |
...
| <!-- 20231206184548 --> [jackrabbit-oak](../content/org/apache/jackrabbit/oak/README.md) | 1.60.0 :warning: [:memo:](https://issues.apache.org/jira/browse/OAK-10662) |
...
| <!-- 20231110095945 --> [orc](../content/org/apache/orc/README.md) | 1.9.2 :warning: |
