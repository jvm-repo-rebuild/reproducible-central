...
| ---------- | ---- | -- | ------- |
| <!-- 20250503193802 --> [smartsprites](../content/com/github/hazendaz/smartsprites/README.md) | [0.3.0](../content/com/github/hazendaz/smartsprites/smartsprites-0.3.0.buildspec) :white_check_mark: | [0.4.0](../content/com/github/hazendaz/smartsprites/smartsprites-0.4.0.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/smartsprites/smartsprites-0.3.0.buildspec 0.4.0` |
| <!-- 20250503165839 --> [yauaa](../content/nl/basjes/parse/useragent/yauaa/README.md) | [7.30.0](../content/nl/basjes/parse/useragent/yauaa/yauaa-7.30.0.buildspec) :white_check_mark: | [7.31.0](../content/nl/basjes/parse/useragent/yauaa/yauaa-7.31.0.buildspec) | `bin/add-new-release.sh content/nl/basjes/parse/useragent/yauaa/yauaa-7.30.0.buildspec 7.31.0` |
...
| <!-- 20250502114225 --> [junit-bom](../content/org/junit/junit5/README.md) | [5.13.0-M2](../content/org/junit/junit5/junit5-5.13.0-M2.buildspec) :white_check_mark: | [5.13.0-M3](../content/org/junit/junit5/junit5-5.13.0-M3.buildspec) | `bin/add-new-release.sh content/org/junit/junit5/junit5-5.13.0-M2.buildspec 5.13.0-M3` |
| <!-- 20250502051147 --> [ratis-thirdparty](../content/org/apache/ratis/ratis-thirdparty/README.md) | [1.0.8](../content/org/apache/ratis/ratis-thirdparty/ratis-thirdparty-1.0.8.buildspec) :white_check_mark: | [1.0.9](../content/org/apache/ratis/ratis-thirdparty/ratis-thirdparty-1.0.9.buildspec) | `bin/add-new-release.sh content/org/apache/ratis/ratis-thirdparty/ratis-thirdparty-1.0.8.buildspec 1.0.9` |
| <!-- 20250501212213 --> [spdx-maven-plugin](../content/org/spdx/spdx-maven-plugin/README.md) | [1.0.1](../content/org/spdx/spdx-maven-plugin/spdx-maven-plugin-1.0.1.buildspec) :white_check_mark: | [1.0.2](../content/org/spdx/spdx-maven-plugin/spdx-maven-plugin-1.0.2.buildspec) | `bin/add-new-release.sh content/org/spdx/spdx-maven-plugin/spdx-maven-plugin-1.0.1.buildspec 1.0.2` |
| <!-- 20250429233214 --> [avaje-jex-parent](../content/io/avaje/jex/README.md) | [3.2-RC1](../content/io/avaje/jex/avaje-jex-3.2-RC1.buildspec) :white_check_mark: | [3.2](../content/io/avaje/jex/avaje-jex-3.2.buildspec) | `bin/add-new-release.sh content/io/avaje/jex/avaje-jex-3.2-RC1.buildspec 3.2` |
...
| <!-- 20250430091454 --> [quarkus-project](../content/io/quarkus/README.md) | [3.22.0](../content/io/quarkus/quarkus-3.22.0.buildspec) :warning: [:memo:](https://github.com/quarkusio/quarkus/pull/44671) | [3.22.1](../content/io/quarkus/quarkus-3.22.1.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.22.0.buildspec 3.22.1` |
