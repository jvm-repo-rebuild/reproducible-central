...
| ---------- | ---- | -- | ------- |
| <!-- 20250728185939 --> [flatten-maven-plugin](../content/org/codehaus/mojo/flatten-maven-plugin/README.md) | [1.7.1](../content/org/codehaus/mojo/flatten-maven-plugin/flatten-maven-plugin-1.7.1.buildspec) :white_check_mark: | [1.7.2](../content/org/codehaus/mojo/flatten-maven-plugin/flatten-maven-plugin-1.7.2.buildspec) | `bin/add-new-release.sh content/org/codehaus/mojo/flatten-maven-plugin/flatten-maven-plugin-1.7.1.buildspec 1.7.2` |
| <!-- 20250728101733 --> [io.wcm.handler.link](../content/io/wcm/io.wcm.handler/link/README.md) | [2.2.6](../content/io/wcm/io.wcm.handler/link/io.wcm.handler.link-2.2.6.buildspec) :white_check_mark: | [2.2.8](../content/io/wcm/io.wcm.handler/link/io.wcm.handler.link-2.2.8.buildspec) | `bin/add-new-release.sh content/io/wcm/io.wcm.handler/link/io.wcm.handler.link-2.2.6.buildspec 2.2.8` |
| <!-- 20250728092737 --> [github-client](../content/com/spotify/github-client/README.md) | [0.4.9](../content/com/spotify/github-client/github-client-0.4.9.buildspec) :white_check_mark: | [0.4.11](../content/com/spotify/github-client/github-client-0.4.11.buildspec) | `bin/add-new-release.sh content/com/spotify/github-client/github-client-0.4.9.buildspec 0.4.11` |
| <!-- 20250728071503 --> [airbase](../content/io/airlift/airbase/README.md) | [281](../content/io/airlift/airbase/airbase-281.buildspec) :white_check_mark: | [282](../content/io/airlift/airbase/airbase-282.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-281.buildspec 282` |
| <!-- 20250728050938 --> [avaje-prisms-parent](../content/io/avaje/prisms/README.md) | [1.42](../content/io/avaje/prisms/avaje-prisms-1.42.buildspec) :white_check_mark: | [1.43](../content/io/avaje/prisms/avaje-prisms-1.43.buildspec) | `bin/add-new-release.sh content/io/avaje/prisms/avaje-prisms-1.42.buildspec 1.43` |
| <!-- 20250727232936 --> [github-desktop](../content/com/github/hazendaz/git/github-desktop/README.md) | [3.5.1](../content/com/github/hazendaz/git/github-desktop/github-desktop-3.5.1.buildspec) :white_check_mark: | [3.5.2](../content/com/github/hazendaz/git/github-desktop/github-desktop-3.5.2.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/git/github-desktop/github-desktop-3.5.1.buildspec 3.5.2` |
| <!-- 20250727214930 --> [cucumber-jvm](../content/io/cucumber/cucumber-jvm/README.md) | [7.26.0](../content/io/cucumber/cucumber-jvm/cucumber-jvm-7.26.0.buildspec) :white_check_mark: | [7.27.0](../content/io/cucumber/cucumber-jvm/cucumber-jvm-7.27.0.buildspec) | `bin/add-new-release.sh content/io/cucumber/cucumber-jvm/cucumber-jvm-7.26.0.buildspec 7.27.0` |
| <!-- 20250727010734 --> [hibernate-reactive-core](../content/org/hibernate/reactive/hibernate-reactive/README.md) | [4.0.0.Beta1](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.0.0.Beta1.buildspec) :white_check_mark: | 3.0.6.Final  | `bin/add-new-release.sh content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.0.0.Beta1.buildspec ...` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20250709143919 --> [:mailbox:](https://lists.apache.org/list?dev@orc.apache.org:lte=1M:VOTE) | [orc](../content/org/apache/orc/README.md) | [2.1.3](../content/org/apache/orc/orc-2.1.3.buildspec) :white_check_mark: | [2.2.0](../content/org/apache/orc/orc-2.2.0.buildspec)  | `bin/add-new-release.sh content/org/apache/orc/orc-2.1.3.buildspec 2.2.0 staging` |
...
| <!-- 20250319220703 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-csv](../content/org/apache/commons/csv/README.md) | [1.14.0](../content/org/apache/commons/csv/commons-csv-1.14.0.buildspec) :warning: | [1.14.1](../content/org/apache/commons/csv/commons-csv-1.14.1.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/csv/commons-csv-1.14.0.buildspec 1.14.1 staging` |
...
| <!-- 20240820105849 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-compress](../content/org/apache/commons/compress/README.md) | [1.27.1](../content/org/apache/commons/compress/commons-compress-1.27.1.buildspec) :white_check_mark: | [1.28.0](../content/org/apache/commons/compress/commons-compress-1.28.0.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/compress/commons-compress-1.27.1.buildspec 1.28.0 staging` |
| <!-- 20240617100002 --> [:mailbox:](https://lists.apache.org/list?dev@jspwiki.apache.org:lte=1M:VOTE) | [jspwiki-builder](../content/org/apache/jspwiki/README.md) | [2.12.2](../content/org/apache/jspwiki/jspwiki-2.12.2.buildspec) :warning: [:memo:](https://issues.apache.org/jira/browse/JSPWIKI-1202) | [2.12.3](../content/org/apache/jspwiki/jspwiki-2.12.3.buildspec)  | `bin/add-new-release.sh content/org/apache/jspwiki/jspwiki-2.12.2.buildspec 2.12.3 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250728094935 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [11.6](../content/io/avaje/inject/avaje-inject-11.6.buildspec) :warning: | [12.0-RC1](../content/io/avaje/inject/avaje-inject-12.0-RC1.buildspec) | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-11.6.buildspec 12.0-RC1` |
| <!-- 20250727220136 --> [jooby](../content/io/jooby/README.md) | [4.0.1](../content/io/jooby/jooby-4.0.1.buildspec) :warning: | [4.0.2](../content/io/jooby/jooby-4.0.2.buildspec) | `bin/add-new-release.sh content/io/jooby/jooby-4.0.1.buildspec 4.0.2` |
