...
| ---------- | ---- | -- | ------- |
| <!-- 20240514165858 --> [tomcat-authnz-spnego-ad](../content/net/sf/michael-o/tomcat/tomcat-authnz-spnego-ad/README.md) | [4.0.1](../content/net/sf/michael-o/tomcat/tomcat-authnz-spnego-ad/tomcat-authnz-spnego-ad-4.0.1.buildspec) :white_check_mark: | [4.1.0](../content/net/sf/michael-o/tomcat/tomcat-authnz-spnego-ad/tomcat-authnz-spnego-ad-4.1.0.buildspec) | `bin/add-new-release.sh content/net/sf/michael-o/tomcat/tomcat-authnz-spnego-ad/tomcat-authnz-spnego-ad-4.0.1.buildspec 4.1.0` |
| <!-- 20240514082047 --> [log4j-tools-bom](../content/org/apache/logging/log4j/tools/README.md) | [0.8.0](../content/org/apache/logging/log4j/tools/log4j-tools-0.8.0.buildspec) :white_check_mark: | [0.9.0](../content/org/apache/logging/log4j/tools/log4j-tools-0.9.0.buildspec) | `bin/add-new-release.sh content/org/apache/logging/log4j/tools/log4j-tools-0.8.0.buildspec 0.9.0` |
| <!-- 20240506065040 --> [batchee](../content/org/apache/batchee/README.md) | [1.0.4](../content/org/apache/batchee/batchee-1.0.4.buildspec) :white_check_mark: | [2.0.0](../content/org/apache/batchee/batchee-2.0.0.buildspec) | `bin/add-new-release.sh content/org/apache/batchee/batchee-1.0.4.buildspec 2.0.0` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20240506182017 --> [:mailbox:](https://lists.apache.org/list?dev@nifi.apache.org:lte=1M:VOTE) | [nifi](../content/org/apache/nifi/nifi/README.md) | [1.22.0](../content/org/apache/nifi/nifi/nifi-1.22.0.buildspec) :warning: | [2.0.0-M3](../content/org/apache/nifi/nifi/nifi-2.0.0-M3.buildspec)  | `bin/add-new-release.sh content/org/apache/nifi/nifi/nifi-1.22.0.buildspec 2.0.0-M3 staging` |
| <!-- 20240420074909 --> [:mailbox:](https://lists.apache.org/list?dev@struts.apache.org:lte=1M:VOTE) | [struts2-parent](../content/org/apache/struts/README.md) | [6.4.0](../content/org/apache/struts/struts2-6.4.0.buildspec) :white_check_mark: | [7.0.0-M6](../content/org/apache/struts/struts2-7.0.0-M6.buildspec)  | `bin/add-new-release.sh content/org/apache/struts/struts2-6.4.0.buildspec 7.0.0-M6 staging` |
| <!-- 20240414123028 --> [:mailbox:](https://lists.apache.org/list?dev@orc.apache.org:lte=1M:VOTE) | [orc](../content/org/apache/orc/README.md) | [1.9.2](../content/org/apache/orc/orc-1.9.2.buildspec) :warning: | [2.0.1](../content/org/apache/orc/orc-2.0.1.buildspec)  | `bin/add-new-release.sh content/org/apache/orc/orc-1.9.2.buildspec 2.0.1 staging` |
| <!-- 20240402061308 --> [:mailbox:](https://lists.apache.org/list?dev@pulsar.apache.org:lte=1M:VOTE) | [pulsar](../content/org/apache/pulsar/README.md) | [3.2.0](../content/org/apache/pulsar/pulsar-3.2.0.buildspec) :warning: | [3.2.3](../content/org/apache/pulsar/pulsar-3.2.3.buildspec)  | `bin/add-new-release.sh content/org/apache/pulsar/pulsar-3.2.0.buildspec 3.2.3 staging` |
| <!-- 20240401172046 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-parent](../content/org/apache/commons/parent/README.md) | [69](../content/org/apache/commons/parent/commons-parent-69.buildspec) :white_check_mark: | [70](../content/org/apache/commons/parent/commons-parent-70.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/parent/commons-parent-69.buildspec 70 staging` |
| <!-- 20240310140536 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven](../content/org/apache/maven/maven/README.md) | [4.0.0-alpha-13](../content/org/apache/maven/maven/maven-4.0.0-alpha-13.buildspec) :white_check_mark: | [4.0.0-beta-2](../content/org/apache/maven/maven/maven-4.0.0-beta-2.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/maven/maven-4.0.0-alpha-13.buildspec 4.0.0-beta-2 staging` |
...
| <!-- 20230505163125 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-dependency-analyzer](../content/org/apache/maven/shared/maven-dependency-analyzer/README.md) | [1.13.2](../content/org/apache/maven/shared/maven-dependency-analyzer/maven-dependency-analyzer-1.13.2.buildspec) :white_check_mark: | [1.14.0](../content/org/apache/maven/shared/maven-dependency-analyzer/maven-dependency-analyzer-1.14.0.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/shared/maven-dependency-analyzer/maven-dependency-analyzer-1.13.2.buildspec 1.14.0 staging` |
| <!-- 20230429054803 --> [:mailbox:](https://lists.apache.org/list?dev@drill.apache.org:lte=1M:VOTE) | [drill-root](../content/org/apache/drill/README.md) | [1.21.1](../content/org/apache/drill/drill-1.21.1.buildspec) :warning: [:memo:](https://github.com/apache/drill/pull/2805) | [1.21.2](../content/org/apache/drill/drill-1.21.2.buildspec)  | `bin/add-new-release.sh content/org/apache/drill/drill-1.21.1.buildspec 1.21.2 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20240514182253 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.4.5](../content/org/finos/legend/engine/legend-engine-4.4.5.buildspec) :warning: | [4.45.2](../content/org/finos/legend/engine/legend-engine-4.45.2.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.4.5.buildspec 4.45.2` |
| <!-- 20240514135739 --> [glassfish-parent](../content/org/glassfish/main/README.md) | [8.0.0-M1](../content/org/glassfish/main/glassfish-8.0.0-M1.buildspec) :warning: | [8.0.0-JDK17-M6](../content/org/glassfish/main/glassfish-8.0.0-JDK17-M6.buildspec) | `bin/add-new-release.sh content/org/glassfish/main/glassfish-8.0.0-M1.buildspec 8.0.0-JDK17-M6` |
...
| <!-- 20240513181207 --> [jooby](../content/io/jooby/README.md) | [3.0.5](../content/io/jooby/jooby-3.0.5.buildspec) :warning: | [3.1.0](../content/io/jooby/jooby-3.1.0.buildspec) | `bin/add-new-release.sh content/io/jooby/jooby-3.0.5.buildspec 3.1.0` |
...
| <!-- 20240511193145 --> [com.io7m.idstore](../content/com/io7m/idstore/README.md) | [1.0.0](../content/com/io7m/idstore/com.io7m.idstore-1.0.0.buildspec) :warning: | [2.0.0](../content/com/io7m/idstore/com.io7m.idstore-2.0.0.buildspec) | `bin/add-new-release.sh content/com/io7m/idstore/com.io7m.idstore-1.0.0.buildspec 2.0.0` |
| <!-- 20240510194112 --> [com.io7m.cedarbridge](../content/com/io7m/cedarbridge/README.md) | [1.2.0](../content/com/io7m/cedarbridge/com.io7m.cedarbridge-1.2.0.buildspec) :warning: | [2.0.0](../content/com/io7m/cedarbridge/com.io7m.cedarbridge-2.0.0.buildspec) | `bin/add-new-release.sh content/com/io7m/cedarbridge/com.io7m.cedarbridge-1.2.0.buildspec 2.0.0` |
| <!-- 20240510152803 --> [opentelemetry-sdk](../content/io/opentelemetry/java/README.md) | [1.14.0](../content/io/opentelemetry/java/opentelemetry-sdk-1.14.0.buildspec) :warning: [:memo:](https://github.com/open-telemetry/opentelemetry-java/issues/4488) | [1.38.0](../content/io/opentelemetry/java/opentelemetry-sdk-1.38.0.buildspec) | `bin/add-new-release.sh content/io/opentelemetry/java/opentelemetry-sdk-1.14.0.buildspec 1.38.0` |
| <!-- 20240510060057 --> [camel](../content/org/apache/camel/camel/README.md) | [4.0.0-RC1](../content/org/apache/camel/camel/camel-4.0.0-RC1.buildspec) :warning: | [4.6.0](../content/org/apache/camel/camel/camel-4.6.0.buildspec) | `bin/add-new-release.sh content/org/apache/camel/camel/camel-4.0.0-RC1.buildspec 4.6.0` |
...
| <!-- 20240509124501 --> [paimon-parent](../content/org/apache/paimon/README.md) | [0.6.0-incubating](../content/org/apache/paimon/paimon-parent-0.6.0-incubating.buildspec) :warning: [:memo:](https://github.com/apache/incubator-paimon/pull/2519) | [0.8.0](../content/org/apache/paimon/paimon-parent-0.8.0.buildspec) | `bin/add-new-release.sh content/org/apache/paimon/paimon-parent-0.6.0-incubating.buildspec 0.8.0` |
| <!-- 20240506182017 --> [nifi](../content/org/apache/nifi/nifi/README.md) | [1.22.0](../content/org/apache/nifi/nifi/nifi-1.22.0.buildspec) :warning: | [2.0.0-M2](../content/org/apache/nifi/nifi/nifi-2.0.0-M2.buildspec) | `bin/add-new-release.sh content/org/apache/nifi/nifi/nifi-1.22.0.buildspec 2.0.0-M2` |
| <!-- 20240502135210 --> [guava](../content/com/google/guava/README.md) | [32.0.1-jre](../content/com/google/guava/guava-32.0.1-jre.buildspec) :warning: | [33.2.0-jre](../content/com/google/guava/guava-33.2.0-jre.buildspec) | `bin/add-new-release.sh content/com/google/guava/guava-32.0.1-jre.buildspec 33.2.0-jre` |
| <!-- 20240426065328 --> [pmd](../content/net/sourceforge/pmd/README.md) | [7.0.0](../content/net/sourceforge/pmd/pmd-7.0.0.buildspec) :warning: | [7.1.0](../content/net/sourceforge/pmd/pmd-7.1.0.buildspec) | `bin/add-new-release.sh content/net/sourceforge/pmd/pmd-7.0.0.buildspec 7.1.0` |
| <!-- 20240425183651 --> [swagger-ui](../content/org/webjars/swagger-ui/README.md) | [5.15.2](../content/org/webjars/swagger-ui/swagger-ui-5.15.2.buildspec) :x: | [5.17.2](../content/org/webjars/swagger-ui/swagger-ui-5.17.2.buildspec) | `bin/add-new-release.sh content/org/webjars/swagger-ui/swagger-ui-5.15.2.buildspec 5.17.2` |
| <!-- 20240425154318 --> [io.wcm.handler.media](../content/io/wcm/io.wcm.handler/media/README.md) | [1.15.6](../content/io/wcm/io.wcm.handler/media/wcm-media-1.15.6.buildspec) :warning: | [2.0.6](../content/io/wcm/io.wcm.handler/media/wcm-media-2.0.6.buildspec) | `bin/add-new-release.sh content/io/wcm/io.wcm.handler/media/wcm-media-1.15.6.buildspec 2.0.6` |
...
| <!-- 20240420115944 --> [opentelemetry-instrumentation-api](../content/io/opentelemetry/instrumentation/README.md) | [1.17.0-alpha](../content/io/opentelemetry/instrumentation/opentelemetry-1.17.0-alpha.buildspec) :warning: | [2.3.0](../content/io/opentelemetry/instrumentation/opentelemetry-2.3.0.buildspec) | `bin/add-new-release.sh content/io/opentelemetry/instrumentation/opentelemetry-1.17.0-alpha.buildspec 2.3.0` |
| <!-- 20240418124354 --> [kubernetes-client-project](../content/io/fabric8/kubernetes-client/README.md) | [6.4.0](../content/io/fabric8/kubernetes-client/kubernetes-client-6.4.0.buildspec) :warning: | [6.12.1](../content/io/fabric8/kubernetes-client/kubernetes-client-6.12.1.buildspec) | `bin/add-new-release.sh content/io/fabric8/kubernetes-client/kubernetes-client-6.4.0.buildspec 6.12.1` |
...
| <!-- 20240402061308 --> [pulsar](../content/org/apache/pulsar/README.md) | [3.2.0](../content/org/apache/pulsar/pulsar-3.2.0.buildspec) :warning: | [3.2.2](../content/org/apache/pulsar/pulsar-3.2.2.buildspec) | `bin/add-new-release.sh content/org/apache/pulsar/pulsar-3.2.0.buildspec 3.2.2` |
...
| artifactId | newest |
| ---------- | ------ |
| <!-- 20240513095516 --> [jandex-parent](../content/io/smallrye/jandex/README.md) | 3.1.5 :warning: [:memo:](https://github.com/smallrye/smallrye-parent/pull/420) |
| <!-- 20240513093056 --> [jackrabbit-oak](../content/org/apache/jackrabbit/oak/README.md) | 1.62.0 :warning: [:memo:](https://issues.apache.org/jira/browse/OAK-10662) |
| <!-- 20240512013500 --> [spoon-core](../content/fr/inria/gforge/spoon/spoon-core/README.md) | 11.0.1-beta-6 :x: |
...
| <!-- 20240509091150 --> [jpmml-sklearn](../content/org/jpmml/jpmml-sklearn/README.md) | 1.8.2 :warning: |
...
| <!-- 20240423132951 --> [junit-bom](../content/org/junit/junit5/README.md) | 5.11.0-M1 :warning: |
| <!-- 20240420074415 --> [jpmml-python](../content/org/jpmml/jpmml-python/README.md) | 1.2.2 :warning: |
...
| <!-- 20240327033253 --> [woodstox-core](../content/com/fasterxml/woodstox/README.md) | 6.6.2 :warning: |
| <!-- 20240314170258 --> [jdbi3-root](../content/org/jdbi/README.md) | 3.45.1 :warning: [:memo:](https://github.com/basepom/basepom/pull/73) |
...
| <!-- 20240227122610 --> [jakarta.servlet-api](../content/jakarta/servlet/jakarta.servlet-api/README.md) | 6.1.0-M2 :warning: [:memo:](https://github.com/jakartaee/servlet/issues/578) |
