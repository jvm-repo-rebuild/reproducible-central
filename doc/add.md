...
| ---------- | ---- | -- | ------- |
| <!-- 20251103203539 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [12.0-javax](../content/io/avaje/inject/avaje-inject-12.0-javax.buildspec) :white_check_mark: | [12.1-RC1](../content/io/avaje/inject/avaje-inject-12.1-RC1.buildspec) | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-12.0-javax.buildspec 12.1-RC1` |
| <!-- 20251103203531 --> [avaje-prisms-parent](../content/io/avaje/prisms/README.md) | [1.43](../content/io/avaje/prisms/avaje-prisms-1.43.buildspec) :white_check_mark: | [1.44-RC1](../content/io/avaje/prisms/avaje-prisms-1.44-RC1.buildspec) | `bin/add-new-release.sh content/io/avaje/prisms/avaje-prisms-1.43.buildspec 1.44-RC1` |
| <!-- 20251103164733 --> [protostream-aggregator](../content/org/infinispan/protostream/README.md) | [6.0.0.Dev14](../content/org/infinispan/protostream/protostream-6.0.0.Dev14.buildspec) :white_check_mark: | [6.0.1](../content/org/infinispan/protostream/protostream-6.0.1.buildspec) | `bin/add-new-release.sh content/org/infinispan/protostream/protostream-6.0.0.Dev14.buildspec 6.0.1` |
| <!-- 20251103135157 --> [maven-lockfile](../content/io/github/chains-project/maven-lockfile/README.md) | [5.8.3-beta-2](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.8.3-beta-2.buildspec) :white_check_mark: | [5.9.0](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.9.0.buildspec) | `bin/add-new-release.sh content/io/github/chains-project/maven-lockfile/maven-lockfile-5.8.3-beta-2.buildspec 5.9.0` |
| <!-- 20251103135104 --> [artemis-pom](../content/org/apache/activemq/artemis/README.md) | [2.43.0](../content/org/apache/activemq/artemis/artemis-2.43.0.buildspec) :white_check_mark: | [2.44.0](../content/org/apache/activemq/artemis/artemis-2.44.0.buildspec) | `bin/add-new-release.sh content/org/apache/activemq/artemis/artemis-2.43.0.buildspec 2.44.0` |
| <!-- 20251103115329 --> [jkube](../content/org/eclipse/jkube/README.md) | [1.18.1](../content/org/eclipse/jkube/jkube-1.18.1.buildspec) :white_check_mark: | [1.18.2](../content/org/eclipse/jkube/jkube-1.18.2.buildspec) | `bin/add-new-release.sh content/org/eclipse/jkube/jkube-1.18.1.buildspec 1.18.2` |
...
| <!-- 20251103090645 --> [openapi-diff-parent](../content/org/openapitools/openapidiff/README.md) | [2.1.4](../content/org/openapitools/openapidiff/openapi-diff-2.1.4.buildspec) :white_check_mark: | [2.1.5](../content/org/openapitools/openapidiff/openapi-diff-2.1.5.buildspec) | `bin/add-new-release.sh content/org/openapitools/openapidiff/openapi-diff-2.1.4.buildspec 2.1.5` |
| <!-- 20251103090633 --> [airbase](../content/io/airlift/airbase/README.md) | [323](../content/io/airlift/airbase/airbase-323.buildspec) :white_check_mark: | [324](../content/io/airlift/airbase/airbase-324.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-323.buildspec 324` |
| <!-- 20251102010935 --> [hibernate-reactive-core](../content/org/hibernate/reactive/hibernate-reactive/README.md) | [4.1.4.Final](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.1.4.Final.buildspec) :white_check_mark: | 3.1.7.Final 3.0.9.Final  | `bin/add-new-release.sh content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.1.4.Final.buildspec ...` |
| <!-- 20251102004607 --> [hibernate-core](../content/org/hibernate/orm/hibernate-core/README.md) | [7.2.0.CR1](../content/org/hibernate/orm/hibernate-core/hibernate-core-7.2.0.CR1.buildspec) :white_check_mark: | 7.1.6.Final  | `bin/add-new-release.sh content/org/hibernate/orm/hibernate-core/hibernate-core-7.2.0.CR1.buildspec ...` |
| <!-- 20251101223934 --> [htmlcompressor-maven-plugin](../content/com/github/hazendaz/maven/htmlcompressor-maven-plugin/README.md) | [2.3.0](../content/com/github/hazendaz/maven/htmlcompressor-maven-plugin/htmlcompressor-maven-plugin-2.3.0.buildspec) :white_check_mark: | 1.12.0 1.10.2  | `bin/add-new-release.sh content/com/github/hazendaz/maven/htmlcompressor-maven-plugin/htmlcompressor-maven-plugin-2.3.0.buildspec ...` |
...
| <!-- 20251031175619 --> [junit-bom](../content/org/junit/junit5/README.md) | [6.0.0-RC3](../content/org/junit/junit5/junit5-6.0.0-RC3.buildspec) :white_check_mark: | 6.0.0 5.14.1  | `bin/add-new-release.sh content/org/junit/junit5/junit5-6.0.0-RC3.buildspec ...` |
| <!-- 20251031001135 --> [jackson-datatypes-misc-parent](../content/com/fasterxml/jackson/datatype/jackson-datatypes-misc-parent/README.md) | [2.20.1](../content/com/fasterxml/jackson/datatype/jackson-datatypes-misc-parent/jackson-datatypes-misc-parent-2.20.1.buildspec) :white_check_mark: | 2.19.4 2.19.3  | `bin/add-new-release.sh content/com/fasterxml/jackson/datatype/jackson-datatypes-misc-parent/jackson-datatypes-misc-parent-2.20.1.buildspec ...` |
| <!-- 20251031001135 --> [jackson-datatypes-collections](../content/com/fasterxml/jackson/datatype/jackson-datatypes-collections/README.md) | [2.20.1](../content/com/fasterxml/jackson/datatype/jackson-datatypes-collections/jackson-datatypes-collections-2.20.1.buildspec) :white_check_mark: | 2.19.4 2.19.3  | `bin/add-new-release.sh content/com/fasterxml/jackson/datatype/jackson-datatypes-collections/jackson-datatypes-collections-2.20.1.buildspec ...` |
| <!-- 20251031001135 --> [jackson-datatype-joda](../content/com/fasterxml/jackson/datatype/jackson-datatype-joda/README.md) | [2.20.1](../content/com/fasterxml/jackson/datatype/jackson-datatype-joda/jackson-datatype-joda-2.20.1.buildspec) :white_check_mark: | 2.19.4 2.19.3  | `bin/add-new-release.sh content/com/fasterxml/jackson/datatype/jackson-datatype-joda/jackson-datatype-joda-2.20.1.buildspec ...` |
| <!-- 20251030235934 --> [jackson-dataformats-binary](../content/com/fasterxml/jackson/dataformat/jackson-dataformats-binary/README.md) | [2.20.1](../content/com/fasterxml/jackson/dataformat/jackson-dataformats-binary/jackson-dataformats-binary-2.20.1.buildspec) :white_check_mark: | 2.19.4 2.19.3  | `bin/add-new-release.sh content/com/fasterxml/jackson/dataformat/jackson-dataformats-binary/jackson-dataformats-binary-2.20.1.buildspec ...` |
...
| <!-- 20251030232849 --> [jackson-bom](../content/com/fasterxml/jackson/jackson-bom/README.md) | [2.20.1](../content/com/fasterxml/jackson/jackson-bom/jackson-bom-2.20.1.buildspec) :white_check_mark: | 2.19.4  | `bin/add-new-release.sh content/com/fasterxml/jackson/jackson-bom/jackson-bom-2.20.1.buildspec ...` |
...
| <!-- 20251029112934 --> [parent](../content/ch/qos/logback/access/README.md) | [2.0.6](../content/ch/qos/logback/access/access-2.0.6.buildspec) :white_check_mark: | [2.0.7](../content/ch/qos/logback/access/access-2.0.7.buildspec) | `bin/add-new-release.sh content/ch/qos/logback/access/access-2.0.6.buildspec 2.0.7` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20251103085647 --> [jpmml-sparkml](../content/org/jpmml/jpmml-sparkml/README.md) | [3.2.1](../content/org/jpmml/jpmml-sparkml/jpmml-sparkml-3.2.1.buildspec) :warning: | [3.2.2](../content/org/jpmml/jpmml-sparkml/jpmml-sparkml-3.2.2.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-sparkml/jpmml-sparkml-3.2.1.buildspec 3.2.2` |
