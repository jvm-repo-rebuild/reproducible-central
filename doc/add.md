...
| ---------- | ---- | -- | ------- |
| <!-- 20250726181937 --> [spdx-maven-plugin](../content/org/spdx/spdx-maven-plugin/README.md) | [1.0.2](../content/org/spdx/spdx-maven-plugin/spdx-maven-plugin-1.0.2.buildspec) :white_check_mark: | [1.0.3](../content/org/spdx/spdx-maven-plugin/spdx-maven-plugin-1.0.3.buildspec) | `bin/add-new-release.sh content/org/spdx/spdx-maven-plugin/spdx-maven-plugin-1.0.2.buildspec 1.0.3` |
| <!-- 20250726124850 --> [org.apache.sling.engine](../content/org/apache/sling/org.apache.sling.engine/README.md) | [3.0.0](../content/org/apache/sling/org.apache.sling.engine/org.apache.sling.engine-3.0.0.buildspec) :white_check_mark: | 2.16.6  | `bin/add-new-release.sh content/org/apache/sling/org.apache.sling.engine/org.apache.sling.engine-3.0.0.buildspec ...` |
| <!-- 20250726124009 --> [cui-java-tools](../content/de/cuioss/cui-java-tools/README.md) | [2.5.0](../content/de/cuioss/cui-java-tools/cui-java-tools-2.5.0.buildspec) :white_check_mark: | [2.5.1](../content/de/cuioss/cui-java-tools/cui-java-tools-2.5.1.buildspec) | `bin/add-new-release.sh content/de/cuioss/cui-java-tools/cui-java-tools-2.5.0.buildspec 2.5.1` |
| <!-- 20250725215534 --> [aru-parent](../content/io/github/cbarlin/aru/README.md) | [0.5.0](../content/io/github/cbarlin/aru/aru-0.5.0.buildspec) :white_check_mark: | [0.5.1](../content/io/github/cbarlin/aru/aru-0.5.1.buildspec) | `bin/add-new-release.sh content/io/github/cbarlin/aru/aru-0.5.0.buildspec 0.5.1` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250726115405 --> [commons-release-plugin](../content/org/apache/commons/commons-release-plugin/README.md) | [1.9.0](../content/org/apache/commons/commons-release-plugin/commons-release-plugin-1.9.0.buildspec) :warning: | [1.9.1](../content/org/apache/commons/commons-release-plugin/commons-release-plugin-1.9.1.buildspec) | `bin/add-new-release.sh content/org/apache/commons/commons-release-plugin/commons-release-plugin-1.9.0.buildspec 1.9.1` |
| <!-- 20250725225938 --> [jooby](../content/io/jooby/README.md) | [3.11.0](../content/io/jooby/jooby-3.11.0.buildspec) :warning: | [4.0.1](../content/io/jooby/jooby-4.0.1.buildspec) | `bin/add-new-release.sh content/io/jooby/jooby-3.11.0.buildspec 4.0.1` |
