...
| ---------- | ---- | -- | ------- |
| <!-- 20250130201500 --> [commons-parent](../content/org/apache/commons/parent/README.md) | [80](../content/org/apache/commons/parent/commons-parent-80.buildspec) :white_check_mark: | [81](../content/org/apache/commons/parent/commons-parent-81.buildspec) | `bin/add-new-release.sh content/org/apache/commons/parent/commons-parent-80.buildspec 81` |
| <!-- 20250130191717 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [11.2-RC2](../content/io/avaje/inject/avaje-inject-11.2-RC2.buildspec) :white_check_mark: | [11.2-javax](../content/io/avaje/inject/avaje-inject-11.2-javax.buildspec) | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-11.2-RC2.buildspec 11.2-javax` |
| <!-- 20250130191717 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [11.2-RC2](../content/io/avaje/inject/avaje-inject-11.2-RC2.buildspec) :white_check_mark: | 11.2  | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-11.2-RC2.buildspec ...` |
| <!-- 20250130170913 --> [jline](../content/org/jline/README.md) | [3.28.0](../content/org/jline/jline-3.28.0.buildspec) :white_check_mark: | [3.29.0](../content/org/jline/jline-3.29.0.buildspec) | `bin/add-new-release.sh content/org/jline/jline-3.28.0.buildspec 3.29.0` |
| <!-- 20250130145001 --> [org.apache.sling.resourceresolver](../content/org/apache/sling/org.apache.sling.resourceresolver/README.md) | [1.12.2](../content/org/apache/sling/org.apache.sling.resourceresolver/org.apache.sling.resourceresolver-1.12.2.buildspec) :white_check_mark: | [1.12.4](../content/org/apache/sling/org.apache.sling.resourceresolver/org.apache.sling.resourceresolver-1.12.4.buildspec) | `bin/add-new-release.sh content/org/apache/sling/org.apache.sling.resourceresolver/org.apache.sling.resourceresolver-1.12.2.buildspec 1.12.4` |
| <!-- 20250130125318 --> [dependency-check-parent](../content/org/owasp/dependency-check/README.md) | [12.0.1](../content/org/owasp/dependency-check/dependency-check-12.0.1.buildspec) :white_check_mark: | [12.0.2](../content/org/owasp/dependency-check/dependency-check-12.0.2.buildspec) | `bin/add-new-release.sh content/org/owasp/dependency-check/dependency-check-12.0.1.buildspec 12.0.2` |
...
| <!-- 20250130053948 --> [airbase](../content/io/airlift/airbase/README.md) | [214](../content/io/airlift/airbase/airbase-214.buildspec) :white_check_mark: | [215](../content/io/airlift/airbase/airbase-215.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-214.buildspec 215` |
| <!-- 20250129220901 --> [byte-buddy-parent](../content/net/bytebuddy/README.md) | [1.16.1](../content/net/bytebuddy/byte-buddy-1.16.1.buildspec) :white_check_mark: | [1.17.0](../content/net/bytebuddy/byte-buddy-1.17.0.buildspec) | `bin/add-new-release.sh content/net/bytebuddy/byte-buddy-1.16.1.buildspec 1.17.0` |
...
| <!-- 20250127183643 --> [avaje-jex-parent](../content/io/avaje/jex/README.md) | [3.0-RC15](../content/io/avaje/jex/avaje-jex-3.0-RC15.buildspec) :white_check_mark: | [3.0-RC16](../content/io/avaje/jex/avaje-jex-3.0-RC16.buildspec) | `bin/add-new-release.sh content/io/avaje/jex/avaje-jex-3.0-RC15.buildspec 3.0-RC16` |
...
| <!-- 20241129052209 --> [:mailbox:](https://lists.apache.org/list?dev@helix.apache.org:lte=1M:VOTE) | [helix](../content/org/apache/helix/README.md) | [1.4.2](../content/org/apache/helix/helix-1.4.2.buildspec) :white_check_mark: | [1.4.3](../content/org/apache/helix/helix-1.4.3.buildspec)  | `bin/add-new-release.sh content/org/apache/helix/helix-1.4.2.buildspec 1.4.3 staging` |
| <!-- 20241113221017 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-plugin-testing](../content/org/apache/maven/plugin-testing/maven-plugin-testing/README.md) | [4.0.0-beta-2](../content/org/apache/maven/plugin-testing/maven-plugin-testing/maven-plugin-testing-4.0.0-beta-2.buildspec) :white_check_mark: | [4.0.0-beta-3](../content/org/apache/maven/plugin-testing/maven-plugin-testing/maven-plugin-testing-4.0.0-beta-3.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/plugin-testing/maven-plugin-testing/maven-plugin-testing-4.0.0-beta-2.buildspec 4.0.0-beta-3 staging` |
| <!-- 20241019172008 --> [:mailbox:](https://lists.apache.org/list?dev@tika.apache.org:lte=1M:VOTE) | [tika](../content/org/apache/tika/README.md) | [3.0.0](../content/org/apache/tika/tika-3.0.0.buildspec) :warning: | [3.1.0](../content/org/apache/tika/tika-3.1.0.buildspec)  | `bin/add-new-release.sh content/org/apache/tika/tika-3.0.0.buildspec 3.1.0 staging` |
| <!-- 20241009192643 --> [:mailbox:](https://lists.apache.org/list?dev@camel.apache.org:lte=1M:VOTE) | [camel-k-runtime-project](../content/org/apache/camel/camel-k-runtime/README.md) | [3.15.0](../content/org/apache/camel/camel-k-runtime/camel-k-runtime-3.15.0.buildspec) :warning: | [3.15.2](../content/org/apache/camel/camel-k-runtime/camel-k-runtime-3.15.2.buildspec)  | `bin/add-new-release.sh content/org/apache/camel/camel-k-runtime/camel-k-runtime-3.15.0.buildspec 3.15.2 staging` |
| <!-- 20240814100724 --> [:mailbox:](https://lists.apache.org/list?dev@sling.apache.org:lte=1M:VOTE) | [org.apache.sling.scripting.sightly.testing](../content/org/apache/sling/org.apache.sling.scripting.sightly.testing/README.md) | [1.0.36-1.4.0](../content/org/apache/sling/org.apache.sling.scripting.sightly.testing/org.apache.sling.scripting.sightly.testing-1.0.36-1.4.0.buildspec) :warning: | [1.0.38-1.4.0](../content/org/apache/sling/org.apache.sling.scripting.sightly.testing/org.apache.sling.scripting.sightly.testing-1.0.38-1.4.0.buildspec)  | `bin/add-new-release.sh content/org/apache/sling/org.apache.sling.scripting.sightly.testing/org.apache.sling.scripting.sightly.testing-1.0.36-1.4.0.buildspec 1.0.38-1.4.0 staging` |
...
| <!-- 20220525171200 --> [:mailbox:](https://lists.apache.org/list?dev@ws.apache.org:lte=1M:VOTE) | [axiom](../content/org/apache/ws/commons/axiom/README.md) | [1.4.0](../content/org/apache/ws/commons/axiom/axiom-1.4.0.buildspec) :warning: | [2.0.0](../content/org/apache/ws/commons/axiom/axiom-2.0.0.buildspec)  | `bin/add-new-release.sh content/org/apache/ws/commons/axiom/axiom-1.4.0.buildspec 2.0.0 staging` |
| <!-- 20220313222929 --> [:mailbox:](https://lists.apache.org/list?dev@ftpserver.apache.org:lte=1M:VOTE) | [ftpserver-parent](../content/org/apache/mina/ftpserver/README.md) | [1.2.0](../content/org/apache/mina/ftpserver/mina-ftpserver-1.2.0.buildspec) :warning: [:memo:](https://github.com/apache/mina-ftpserver/pull/13) | [1.2.1](../content/org/apache/mina/ftpserver/mina-ftpserver-1.2.1.buildspec)  | `bin/add-new-release.sh content/org/apache/mina/ftpserver/mina-ftpserver-1.2.0.buildspec 1.2.1 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250130093121 --> [kubernetes-client-project](../content/io/fabric8/kubernetes-client/README.md) | [7.0.1](../content/io/fabric8/kubernetes-client/kubernetes-client-7.0.1.buildspec) :warning: | [7.1.0](../content/io/fabric8/kubernetes-client/kubernetes-client-7.1.0.buildspec) | `bin/add-new-release.sh content/io/fabric8/kubernetes-client/kubernetes-client-7.0.1.buildspec 7.1.0` |
| <!-- 20250129113232 --> [quarkus-project](../content/io/quarkus/README.md) | [3.18.0](../content/io/quarkus/quarkus-3.18.0.buildspec) :warning: [:memo:](https://github.com/quarkusio/quarkus/pull/44671) | [3.18.1](../content/io/quarkus/quarkus-3.18.1.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.18.0.buildspec 3.18.1` |
| <!-- 20250129003229 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.56.0](../content/org/finos/legend/engine/legend-engine-4.56.0.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.69.0](../content/org/finos/legend/engine/legend-engine-4.69.0.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.56.0.buildspec 4.69.0` |
| <!-- 20250127202917 --> [nifi](../content/org/apache/nifi/nifi/README.md) | [2.1.0](../content/org/apache/nifi/nifi/nifi-2.1.0.buildspec) :warning: | [2.2.0](../content/org/apache/nifi/nifi/nifi-2.2.0.buildspec) | `bin/add-new-release.sh content/org/apache/nifi/nifi/nifi-2.1.0.buildspec 2.2.0` |
...
| <!-- 20250122145015 --> [html-formatter](../content/io/cucumber/html-formatter/README.md) | [20.2.0](../content/io/cucumber/html-formatter/html-formatter-20.2.0.buildspec) :warning: [:memo:](https://github.com/cucumber/html-formatter/issues/207) | [21.8.0](../content/io/cucumber/html-formatter/html-formatter-21.8.0.buildspec) | `bin/add-new-release.sh content/io/cucumber/html-formatter/html-formatter-20.2.0.buildspec 21.8.0` |
...
| <!-- 20250124073245 --> [jpmml-evaluator](../content/org/jpmml/jpmml-evaluator/README.md) | 1.7.0 :warning: |
