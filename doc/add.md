...
| ---------- | ---- | -- | ------- |
| <!-- 20250917161137 --> [query](../content/io/cucumber/query/README.md) | [14.1.0](../content/io/cucumber/query/query-14.1.0.buildspec) :white_check_mark: | [14.3.0](../content/io/cucumber/query/query-14.3.0.buildspec) | `bin/add-new-release.sh content/io/cucumber/query/query-14.1.0.buildspec 14.3.0` |
| <!-- 20250917161137 --> [query](../content/io/cucumber/query/README.md) | [14.1.0](../content/io/cucumber/query/query-14.1.0.buildspec) :white_check_mark: | 14.2.3 14.2.2 14.2.1 14.2.0  | `bin/add-new-release.sh content/io/cucumber/query/query-14.1.0.buildspec ...` |
| <!-- 20250917134946 --> [font-awesome](../content/org/webjars/font-awesome/README.md) | [7.0.0](../content/org/webjars/font-awesome/font-awesome-7.0.0.buildspec) :white_check_mark: | [7.0.1](../content/org/webjars/font-awesome/font-awesome-7.0.1.buildspec) | `bin/add-new-release.sh content/org/webjars/font-awesome/font-awesome-7.0.0.buildspec 7.0.1` |
| <!-- 20250917122757 --> [fmt-maven-plugin](../content/com/spotify/fmt-maven-plugin/README.md) | [2.28](../content/com/spotify/fmt-maven-plugin/fmt-maven-plugin-2.28.buildspec) :white_check_mark: | [2.29](../content/com/spotify/fmt-maven-plugin/fmt-maven-plugin-2.29.buildspec) | `bin/add-new-release.sh content/com/spotify/fmt-maven-plugin/fmt-maven-plugin-2.28.buildspec 2.29` |
| <!-- 20250917120934 --> [toolbox](../content/eu/maveniverse/maven/toolbox/README.md) | [0.13.1](../content/eu/maveniverse/maven/toolbox/toolbox-0.13.1.buildspec) :white_check_mark: | [0.13.4](../content/eu/maveniverse/maven/toolbox/toolbox-0.13.4.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/toolbox/toolbox-0.13.1.buildspec 0.13.4` |
| <!-- 20250917120934 --> [toolbox](../content/eu/maveniverse/maven/toolbox/README.md) | [0.13.1](../content/eu/maveniverse/maven/toolbox/toolbox-0.13.1.buildspec) :white_check_mark: | 0.13.3 0.13.2  | `bin/add-new-release.sh content/eu/maveniverse/maven/toolbox/toolbox-0.13.1.buildspec ...` |
...
| <!-- 20250917064735 --> [maven-lockfile](../content/io/github/chains-project/maven-lockfile/README.md) | [5.6.2](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.6.2.buildspec) :white_check_mark: | [5.7.0](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.7.0.buildspec) | `bin/add-new-release.sh content/io/github/chains-project/maven-lockfile/maven-lockfile-5.6.2.buildspec 5.7.0` |
| <!-- 20250917034735 --> [jmeter-java-dsl-parent](../content/us/abstracta/jmeter/jmeter-java-dsl/README.md) | [1.30](../content/us/abstracta/jmeter/jmeter-java-dsl/jmeter-java-dsl-1.30.buildspec) :white_check_mark: | [2.0](../content/us/abstracta/jmeter/jmeter-java-dsl/jmeter-java-dsl-2.0.buildspec) | `bin/add-new-release.sh content/us/abstracta/jmeter/jmeter-java-dsl/jmeter-java-dsl-1.30.buildspec 2.0` |
...
| <!-- 20250917102655 --> [quarkus-project](../content/io/quarkus/README.md) | [3.28.0.CR1](../content/io/quarkus/quarkus-3.28.0.CR1.buildspec) :warning: | [3.28.0](../content/io/quarkus/quarkus-3.28.0.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.28.0.CR1.buildspec 3.28.0` |
...
| <!-- 20250915123130 --> [jpmml-sklearn](../content/org/jpmml/jpmml-sklearn/README.md) | 1.9.16 :warning: |
