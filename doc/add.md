...
| <!-- 20220916064032 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-jar-plugin](../content/org/apache/maven/plugins/maven-jar-plugin/README.md) | [3.3.0](../content/org/apache/maven/plugins/maven-jar-plugin/maven-jar-plugin-3.3.0.buildspec) :white_check_mark: | [3.4.0](../content/org/apache/maven/plugins/maven-jar-plugin/maven-jar-plugin-3.4.0.buildspec) [6 :white_check_mark: ](../content/org/apache/maven/plugins/maven-jar-plugin/maven-jar-plugin-3.4.0.buildcompare) | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-jar-plugin/maven-jar-plugin-3.3.0.buildspec 3.4.0 staging` |
