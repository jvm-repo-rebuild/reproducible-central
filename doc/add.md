...
| ---------- | ---- | -- | ------- |
| <!-- 20250408155456 --> [hibernate-reactive-core](../content/org/hibernate/reactive/hibernate-reactive/README.md) | [3.0.0.Beta2](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-3.0.0.Beta2.buildspec) :white_check_mark: | [3.0.0.Beta3](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-3.0.0.Beta3.buildspec) | `bin/add-new-release.sh content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-3.0.0.Beta2.buildspec 3.0.0.Beta3` |
...
| <!-- 20250408012650 --> [jackson-jr-parent](../content/com/fasterxml/jackson/jr/README.md) | [2.18.3](../content/com/fasterxml/jackson/jr/jackson-jr-2.18.3.buildspec) :white_check_mark: | [2.19.0-rc2](../content/com/fasterxml/jackson/jr/jackson-jr-2.19.0-rc2.buildspec) | `bin/add-new-release.sh content/com/fasterxml/jackson/jr/jackson-jr-2.18.3.buildspec 2.19.0-rc2` |
| <!-- 20250408012511 --> [jackson-databind](../content/com/fasterxml/jackson/databind/README.md) | [2.18.3](../content/com/fasterxml/jackson/databind/jackson-databind-2.18.3.buildspec) :white_check_mark: | [2.19.0-rc2](../content/com/fasterxml/jackson/databind/jackson-databind-2.19.0-rc2.buildspec) | `bin/add-new-release.sh content/com/fasterxml/jackson/databind/jackson-databind-2.18.3.buildspec 2.19.0-rc2` |
| <!-- 20250408011111 --> [jackson-core](../content/com/fasterxml/jackson/core/README.md) | [2.18.3](../content/com/fasterxml/jackson/core/jackson-core-2.18.3.buildspec) :white_check_mark: | [2.19.0-rc2](../content/com/fasterxml/jackson/core/jackson-core-2.19.0-rc2.buildspec) | `bin/add-new-release.sh content/com/fasterxml/jackson/core/jackson-core-2.18.3.buildspec 2.19.0-rc2` |
| <!-- 20250408011111 --> [jackson-core](../content/com/fasterxml/jackson/core/README.md) | [2.18.3](../content/com/fasterxml/jackson/core/jackson-core-2.18.3.buildspec) :white_check_mark: | 2.19.0-rc1  | `bin/add-new-release.sh content/com/fasterxml/jackson/core/jackson-core-2.18.3.buildspec ...` |
...
| <!-- 20250408010228 --> [jackson-bom](../content/com/fasterxml/jackson/jackson-bom/README.md) | [2.18.3](../content/com/fasterxml/jackson/jackson-bom/jackson-bom-2.18.3.buildspec) :white_check_mark: | [2.19.0-rc2](../content/com/fasterxml/jackson/jackson-bom/jackson-bom-2.19.0-rc2.buildspec) | `bin/add-new-release.sh content/com/fasterxml/jackson/jackson-bom/jackson-bom-2.18.3.buildspec 2.19.0-rc2` |
| <!-- 20250408010228 --> [jackson-bom](../content/com/fasterxml/jackson/jackson-bom/README.md) | [2.18.3](../content/com/fasterxml/jackson/jackson-bom/jackson-bom-2.18.3.buildspec) :white_check_mark: | 2.19.0-rc1  | `bin/add-new-release.sh content/com/fasterxml/jackson/jackson-bom/jackson-bom-2.18.3.buildspec ...` |
| <!-- 20250408005758 --> [jackson-parent](../content/com/fasterxml/jackson/jackson-parent/README.md) | [2.18.1](../content/com/fasterxml/jackson/jackson-parent/jackson-parent-2.18.1.buildspec) :white_check_mark: | [2.19-rc2](../content/com/fasterxml/jackson/jackson-parent/jackson-parent-2.19-rc2.buildspec) | `bin/add-new-release.sh content/com/fasterxml/jackson/jackson-parent/jackson-parent-2.18.1.buildspec 2.19-rc2` |
| <!-- 20250408005758 --> [jackson-parent](../content/com/fasterxml/jackson/jackson-parent/README.md) | [2.18.1](../content/com/fasterxml/jackson/jackson-parent/jackson-parent-2.18.1.buildspec) :white_check_mark: | 2.19-rc1  | `bin/add-new-release.sh content/com/fasterxml/jackson/jackson-parent/jackson-parent-2.18.1.buildspec ...` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20250227115749 --> [:mailbox:](https://lists.apache.org/list?dev@pulsar.apache.org:lte=1M:VOTE) | [pulsar](../content/org/apache/pulsar/README.md) | [4.0.3](../content/org/apache/pulsar/pulsar-4.0.3.buildspec) :warning: | [4.0.4](../content/org/apache/pulsar/pulsar-4.0.4.buildspec)  | `bin/add-new-release.sh content/org/apache/pulsar/pulsar-4.0.3.buildspec 4.0.4 staging` |
...
| <!-- 20241113200517 --> [:mailbox:](https://lists.apache.org/list?dev@shiro.apache.org:lte=1M:VOTE) | [shiro-root](../content/org/apache/shiro/README.md) | [2.0.2](../content/org/apache/shiro/shiro-2.0.2.buildspec) :white_check_mark: | [2.0.3](../content/org/apache/shiro/shiro-2.0.3.buildspec)  | `bin/add-new-release.sh content/org/apache/shiro/shiro-2.0.2.buildspec 2.0.3 staging` |
...
| <!-- 20250407130336 --> [jandex-parent](../content/io/smallrye/jandex/README.md) | [3.2.7](../content/io/smallrye/jandex/jandex-3.2.7.buildspec) :warning: | [3.3.0](../content/io/smallrye/jandex/jandex-3.3.0.buildspec) | `bin/add-new-release.sh content/io/smallrye/jandex/jandex-3.2.7.buildspec 3.3.0` |
...
| <!-- 20250407073921 --> [jpmml-sklearn](../content/org/jpmml/jpmml-sklearn/README.md) | [1.9.5](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.5.buildspec) :warning: | [1.9.6](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.6.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.5.buildspec 1.9.6` |
