...
| ---------- | ---- | -- | ------- |
| <!-- 20250410134724 --> [pmd-build-tools-config](../content/net/sourceforge/pmd/pmd-build-tools-config/README.md) | [29](../content/net/sourceforge/pmd/pmd-build-tools-config/pmd-build-tools-config-29.buildspec) :white_check_mark: | [30](../content/net/sourceforge/pmd/pmd-build-tools-config/pmd-build-tools-config-30.buildspec) | `bin/add-new-release.sh content/net/sourceforge/pmd/pmd-build-tools-config/pmd-build-tools-config-29.buildspec 30` |
| <!-- 20250410114105 --> [github-client](../content/com/spotify/github-client/README.md) | [0.4.2](../content/com/spotify/github-client/github-client-0.4.2.buildspec) :white_check_mark: | [0.4.3](../content/com/spotify/github-client/github-client-0.4.3.buildspec) | `bin/add-new-release.sh content/com/spotify/github-client/github-client-0.4.2.buildspec 0.4.3` |
| <!-- 20250410095837 --> [airbase](../content/io/airlift/airbase/README.md) | [249](../content/io/airlift/airbase/airbase-249.buildspec) :white_check_mark: | [250](../content/io/airlift/airbase/airbase-250.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-249.buildspec 250` |
| <!-- 20250410071159 --> [fusion](../content/io/yupiik/fusion/README.md) | [1.0.23](../content/io/yupiik/fusion/fusion-1.0.23.buildspec) :white_check_mark: | [1.0.24](../content/io/yupiik/fusion/fusion-1.0.24.buildspec) | `bin/add-new-release.sh content/io/yupiik/fusion/fusion-1.0.23.buildspec 1.0.24` |
...
| <!-- 20250410085949 --> [fediz](../content/org/apache/cxf/fediz/README.md) | [1.7.0](../content/org/apache/cxf/fediz/fediz-1.7.0.buildspec) :warning: | [1.7.1](../content/org/apache/cxf/fediz/fediz-1.7.1.buildspec) | `bin/add-new-release.sh content/org/apache/cxf/fediz/fediz-1.7.0.buildspec 1.7.1` |
| <!-- 20250410055157 --> [jpmml-xgboost](../content/org/jpmml/jpmml-xgboost/README.md) | [1.9.0](../content/org/jpmml/jpmml-xgboost/jpmml-xgboost-1.9.0.buildspec) :warning: | [1.9.1](../content/org/jpmml/jpmml-xgboost/jpmml-xgboost-1.9.1.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-xgboost/jpmml-xgboost-1.9.0.buildspec 1.9.1` |
