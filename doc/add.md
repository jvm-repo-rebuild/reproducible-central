...
| ---------- | ---- | -- | ------- |
| <!-- 20240618145357 --> [cyclonedx-core-java](../content/org/cyclonedx/cyclonedx-core-java/README.md) | [9.0.2](../content/org/cyclonedx/cyclonedx-core-java/cyclonedx-core-java-9.0.2.buildspec) :white_check_mark: | [9.0.3](../content/org/cyclonedx/cyclonedx-core-java/cyclonedx-core-java-9.0.3.buildspec) | `bin/add-new-release.sh content/org/cyclonedx/cyclonedx-core-java/cyclonedx-core-java-9.0.2.buildspec 9.0.3` |
| <!-- 20240618140515 --> [jpmml-r](../content/org/jpmml/jpmml-r/README.md) | [1.5.4](../content/org/jpmml/jpmml-r/jpmml-r-1.5.4.buildspec) :white_check_mark: | [1.5.5](../content/org/jpmml/jpmml-r/jpmml-r-1.5.5.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-r/jpmml-r-1.5.4.buildspec 1.5.5` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20240611180927 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-dependency-plugin](../content/org/apache/maven/plugins/maven-dependency-plugin/README.md) | [3.7.0](../content/org/apache/maven/plugins/maven-dependency-plugin/maven-dependency-plugin-3.7.0.buildspec) :white_check_mark: | [3.7.1](../content/org/apache/maven/plugins/maven-dependency-plugin/maven-dependency-plugin-3.7.1.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-dependency-plugin/maven-dependency-plugin-3.7.0.buildspec 3.7.1 staging` |
...
| <!-- 20240420070349 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-jar-plugin](../content/org/apache/maven/plugins/maven-jar-plugin/README.md) | [3.4.1](../content/org/apache/maven/plugins/maven-jar-plugin/maven-jar-plugin-3.4.1.buildspec) :white_check_mark: | [3.4.2](../content/org/apache/maven/plugins/maven-jar-plugin/maven-jar-plugin-3.4.2.buildspec) [6 :white_check_mark: ](../content/org/apache/maven/plugins/maven-jar-plugin/maven-jar-plugin-3.4.2.buildcompare) | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-jar-plugin/maven-jar-plugin-3.4.1.buildspec 3.4.2 staging` |
...
| <!-- 20231026195016 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-clean-plugin](../content/org/apache/maven/plugins/maven-clean-plugin/README.md) | [3.3.2](../content/org/apache/maven/plugins/maven-clean-plugin/maven-clean-plugin-3.3.2.buildspec) :white_check_mark: | [3.4.0](../content/org/apache/maven/plugins/maven-clean-plugin/maven-clean-plugin-3.4.0.buildspec) [6 :white_check_mark: ](../content/org/apache/maven/plugins/maven-clean-plugin/maven-clean-plugin-3.4.0.buildcompare) | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-clean-plugin/maven-clean-plugin-3.3.2.buildspec 3.4.0 staging` |
...
| <!-- 20230328171244 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-scm-publish-plugin](../content/org/apache/maven/plugins/maven-scm-publish-plugin/README.md) | [3.2.1](../content/org/apache/maven/plugins/maven-scm-publish-plugin/maven-scm-publish-plugin-3.2.1.buildspec) :white_check_mark: | [3.3.0](../content/org/apache/maven/plugins/maven-scm-publish-plugin/maven-scm-publish-plugin-3.3.0.buildspec) [6 :white_check_mark: ](../content/org/apache/maven/plugins/maven-scm-publish-plugin/maven-scm-publish-plugin-3.3.0.buildcompare) | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-scm-publish-plugin/maven-scm-publish-plugin-3.2.1.buildspec 3.3.0 staging` |
...
| <!-- 20240617171644 --> [opentelemetry-instrumentation-api](../content/io/opentelemetry/instrumentation/README.md) | [2.4.0](../content/io/opentelemetry/instrumentation/opentelemetry-2.4.0.buildspec) :warning: | [2.5.0](../content/io/opentelemetry/instrumentation/opentelemetry-2.5.0.buildspec) | `bin/add-new-release.sh content/io/opentelemetry/instrumentation/opentelemetry-2.4.0.buildspec 2.5.0` |
...
| artifactId | newest |
| ---------- | ------ |
| <!-- 20240610045634 --> [openapi-jaxrs-client](../content/dk/mada/jaxrs/openapi-jaxrs-client/README.md) | 0.11.4 :warning: |
