...
| ---------- | ---- | -- | ------- |
| <!-- 20251024175531 --> [jsign](../content/net/jsign/README.md) | [7.3](../content/net/jsign/jsign-7.3.buildspec) :white_check_mark: | [7.4](../content/net/jsign/jsign-7.4.buildspec) | `bin/add-new-release.sh content/net/jsign/jsign-7.3.buildspec 7.4` |
...
| <!-- 20251024161332 --> [maven-plugin-tools](../content/org/apache/maven/plugin-tools/maven-plugin-tools/README.md) | [4.0.0-beta-1](../content/org/apache/maven/plugin-tools/maven-plugin-tools/maven-plugin-tools-4.0.0-beta-1.buildspec) :white_check_mark: | 3.15.2  | `bin/add-new-release.sh content/org/apache/maven/plugin-tools/maven-plugin-tools/maven-plugin-tools-4.0.0-beta-1.buildspec ...` |
| <!-- 20251024145934 --> [com.io7m.primogenitor](../content/com/io7m/primogenitor/README.md) | [9.0.0](../content/com/io7m/primogenitor/com.io7m.primogenitor-9.0.0.buildspec) :white_check_mark: | [9.1.0](../content/com/io7m/primogenitor/com.io7m.primogenitor-9.1.0.buildspec) | `bin/add-new-release.sh content/com/io7m/primogenitor/com.io7m.primogenitor-9.0.0.buildspec 9.1.0` |
| <!-- 20251024111709 --> [jackrabbit-filevault](../content/org/apache/jackrabbit/filevault/README.md) | [4.0.0](../content/org/apache/jackrabbit/filevault/jackrabbit-filevault-4.0.0.buildspec) :white_check_mark: | [4.1.4](../content/org/apache/jackrabbit/filevault/jackrabbit-filevault-4.1.4.buildspec) | `bin/add-new-release.sh content/org/apache/jackrabbit/filevault/jackrabbit-filevault-4.0.0.buildspec 4.1.4` |
| <!-- 20251024110321 --> [langchain4j](../content/dev/langchain4j/README.md) | [1.7.1](../content/dev/langchain4j/langchain4j-1.7.1.buildspec) :white_check_mark: | [1.8.0](../content/dev/langchain4j/langchain4j-1.8.0.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-1.7.1.buildspec 1.8.0` |
| <!-- 20251024014731 --> [jackson-parent](../content/com/fasterxml/jackson/jackson-parent/README.md) | [2.20](../content/com/fasterxml/jackson/jackson-parent/jackson-parent-2.20.buildspec) :white_check_mark: | 2.18.4  | `bin/add-new-release.sh content/com/fasterxml/jackson/jackson-parent/jackson-parent-2.20.buildspec ...` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20251024123537 --> [sdmx-dl-parent](../content/com/github/nbbrd/sdmx-dl/README.md) | [3.0.0-beta.14](../content/com/github/nbbrd/sdmx-dl/sdmx-dl-3.0.0-beta.14.buildspec) :warning: | [3.0.0-beta.15](../content/com/github/nbbrd/sdmx-dl/sdmx-dl-3.0.0-beta.15.buildspec) | `bin/add-new-release.sh content/com/github/nbbrd/sdmx-dl/sdmx-dl-3.0.0-beta.14.buildspec 3.0.0-beta.15` |
| <!-- 20251024120236 --> [com.io7m.cardant](../content/com/io7m/cardant/README.md) | [1.0.0-beta0001](../content/com/io7m/cardant/com.io7m.cardant-1.0.0-beta0001.buildspec) :warning: | [1.0.0-beta0002](../content/com/io7m/cardant/com.io7m.cardant-1.0.0-beta0002.buildspec) | `bin/add-new-release.sh content/com/io7m/cardant/com.io7m.cardant-1.0.0-beta0001.buildspec 1.0.0-beta0002` |
| <!-- 20251023220437 --> [jpmml-sparkml](../content/org/jpmml/jpmml-sparkml/README.md) | [3.2.0](../content/org/jpmml/jpmml-sparkml/jpmml-sparkml-3.2.0.buildspec) :warning: | [3.2.1](../content/org/jpmml/jpmml-sparkml/jpmml-sparkml-3.2.1.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-sparkml/jpmml-sparkml-3.2.0.buildspec 3.2.1` |
| <!-- 20251023215456 --> [jpmml-sklearn](../content/org/jpmml/jpmml-sklearn/README.md) | [1.9.18](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.18.buildspec) :warning: | [1.9.19](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.19.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.18.buildspec 1.9.19` |
| <!-- 20251023215446 --> [jpmml-r](../content/org/jpmml/jpmml-r/README.md) | [1.7.3](../content/org/jpmml/jpmml-r/jpmml-r-1.7.3.buildspec) :warning: | [1.7.4](../content/org/jpmml/jpmml-r/jpmml-r-1.7.4.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-r/jpmml-r-1.7.3.buildspec 1.7.4` |
...
| <!-- 20251023091806 --> [avaje-config](../content/io/avaje/config/README.md) | 4.2-RC2 :warning: |
