...
| ---------- | ---- | -- | ------- |
| <!-- 20250214204823 --> [jpmml-sparkml](../content/org/jpmml/jpmml-sparkml/README.md) | [2.5.3](../content/org/jpmml/jpmml-sparkml/jpmml-sparkml-2.5.3.buildspec) :white_check_mark: | [3.1.0](../content/org/jpmml/jpmml-sparkml/jpmml-sparkml-3.1.0.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-sparkml/jpmml-sparkml-2.5.3.buildspec 3.1.0` |
| <!-- 20250214204823 --> [jpmml-sparkml](../content/org/jpmml/jpmml-sparkml/README.md) | [2.5.3](../content/org/jpmml/jpmml-sparkml/jpmml-sparkml-2.5.3.buildspec) :white_check_mark: | 3.0.0  | `bin/add-new-release.sh content/org/jpmml/jpmml-sparkml/jpmml-sparkml-2.5.3.buildspec ...` |
| <!-- 20250214113807 --> [wss4j](../content/org/apache/wss4j/README.md) | [3.0.4](../content/org/apache/wss4j/wss4j-3.0.4.buildspec) :white_check_mark: | [4.0.0](../content/org/apache/wss4j/wss4j-4.0.0.buildspec) | `bin/add-new-release.sh content/org/apache/wss4j/wss4j-3.0.4.buildspec 4.0.0` |
| <!-- 20250214110054 --> [jena-kafka](../content/io/telicent/jena/jena-kafka/README.md) | [1.5.2](../content/io/telicent/jena/jena-kafka/jena-kafka-1.5.2.buildspec) :white_check_mark: | [1.5.3](../content/io/telicent/jena/jena-kafka/jena-kafka-1.5.3.buildspec) | `bin/add-new-release.sh content/io/telicent/jena/jena-kafka/jena-kafka-1.5.2.buildspec 1.5.3` |
| <!-- 20250214103644 --> [byte-buddy-parent](../content/net/bytebuddy/README.md) | [1.17.0](../content/net/bytebuddy/byte-buddy-1.17.0.buildspec) :white_check_mark: | [1.17.1](../content/net/bytebuddy/byte-buddy-1.17.1.buildspec) | `bin/add-new-release.sh content/net/bytebuddy/byte-buddy-1.17.0.buildspec 1.17.1` |
...
| <!-- 20250214080207 --> [winrm](../content/org/sentrysoftware/winrm/README.md) | [1.0.01](../content/org/sentrysoftware/winrm/winrm-1.0.01.buildspec) :white_check_mark: | [1.1.00](../content/org/sentrysoftware/winrm/winrm-1.1.00.buildspec) | `bin/add-new-release.sh content/org/sentrysoftware/winrm/winrm-1.0.01.buildspec 1.1.00` |
| <!-- 20250213231159 --> [oss-parent](../content/com/fasterxml/oss-parent/README.md) | [62](../content/com/fasterxml/oss-parent/oss-parent-62.buildspec) :white_check_mark: | [63](../content/com/fasterxml/oss-parent/oss-parent-63.buildspec) | `bin/add-new-release.sh content/com/fasterxml/oss-parent/oss-parent-62.buildspec 63` |
...
| <!-- 20250210041608 --> [paimon-parent](../content/org/apache/paimon/README.md) | [1.0.1](../content/org/apache/paimon/paimon-parent-1.0.1.buildspec) :white_check_mark: | 0.7.0-incubating 0.6.1-incubating  | `bin/add-new-release.sh content/org/apache/paimon/paimon-parent-1.0.1.buildspec ...` |
...
| <!-- 20250128092920 --> [mimir](../content/eu/maveniverse/maven/mimir/README.md) | [0.2.0](../content/eu/maveniverse/maven/mimir/mimir-0.2.0.buildspec) :white_check_mark: | [0.3.4](../content/eu/maveniverse/maven/mimir/mimir-0.3.4.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/mimir/mimir-0.2.0.buildspec 0.3.4` |
| <!-- 20250128092920 --> [mimir](../content/eu/maveniverse/maven/mimir/README.md) | [0.2.0](../content/eu/maveniverse/maven/mimir/mimir-0.2.0.buildspec) :white_check_mark: | 0.3.3 0.3.2 0.3.1 0.3.0 0.2.3 0.2.2 0.2.1  | `bin/add-new-release.sh content/eu/maveniverse/maven/mimir/mimir-0.2.0.buildspec ...` |
...
| <!-- 20241004140525 --> [:mailbox:](https://lists.apache.org/list?dev@qpid.apache.org:lte=1M:VOTE) | [qpid-jms-parent](../content/org/apache/qpid/jms/README.md) | [2.6.1](../content/org/apache/qpid/jms/qpid-jms-2.6.1.buildspec) :white_check_mark: | [2.7.0](../content/org/apache/qpid/jms/qpid-jms-2.7.0.buildspec)  | `bin/add-new-release.sh content/org/apache/qpid/jms/qpid-jms-2.6.1.buildspec 2.7.0 staging` |
