...
| ---------- | ---- | -- | ------- |
| <!-- 20251203181548 --> [maven-release-plugin](../content/org/apache/maven/plugins/maven-release-plugin/README.md) | [3.2.0](../content/org/apache/maven/plugins/maven-release-plugin/maven-release-plugin-3.2.0.buildspec) :white_check_mark: | [3.3.0](../content/org/apache/maven/plugins/maven-release-plugin/maven-release-plugin-3.3.0.buildspec) | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-release-plugin/maven-release-plugin-3.2.0.buildspec 3.3.0` |
| <!-- 20251203110925 --> [github-client](../content/com/spotify/github-client/README.md) | [0.5.2](../content/com/spotify/github-client/github-client-0.5.2.buildspec) :white_check_mark: | [0.5.3](../content/com/spotify/github-client/github-client-0.5.3.buildspec) | `bin/add-new-release.sh content/com/spotify/github-client/github-client-0.5.2.buildspec 0.5.3` |
| <!-- 20251203095328 --> [rdf-abac](../content/io/telicent/jena/rdf-abac/README.md) | [1.1.2](../content/io/telicent/jena/rdf-abac/rdf-abac-1.1.2.buildspec) :white_check_mark: | [1.1.3](../content/io/telicent/jena/rdf-abac/rdf-abac-1.1.3.buildspec) | `bin/add-new-release.sh content/io/telicent/jena/rdf-abac/rdf-abac-1.1.2.buildspec 1.1.3` |
| <!-- 20251202231524 --> [commons-exec](../content/org/apache/commons/commons-exec/README.md) | [1.5.0](../content/org/apache/commons/commons-exec/commons-exec-1.5.0.buildspec) :white_check_mark: | [1.6.0](../content/org/apache/commons/commons-exec/commons-exec-1.6.0.buildspec) | `bin/add-new-release.sh content/org/apache/commons/commons-exec/commons-exec-1.5.0.buildspec 1.6.0` |
| <!-- 20251202222721 --> [plexus-testing](../content/org/codehaus/plexus/plexus-testing/README.md) | [2.0.1](../content/org/codehaus/plexus/plexus-testing/plexus-testing-2.0.1.buildspec) :white_check_mark: | [2.0.2](../content/org/codehaus/plexus/plexus-testing/plexus-testing-2.0.2.buildspec) | `bin/add-new-release.sh content/org/codehaus/plexus/plexus-testing/plexus-testing-2.0.1.buildspec 2.0.2` |
| <!-- 20251202212748 --> [java-spdx-library](../content/org/spdx/java-spdx-library/README.md) | [2.0.1](../content/org/spdx/java-spdx-library/java-spdx-library-2.0.1.buildspec) :white_check_mark: | [2.0.2](../content/org/spdx/java-spdx-library/java-spdx-library-2.0.2.buildspec) | `bin/add-new-release.sh content/org/spdx/java-spdx-library/java-spdx-library-2.0.1.buildspec 2.0.2` |
| <!-- 20251202120240 --> [lz4-java](../content/at/yawk/lz4/lz4-java/README.md) | [1.8.1](../content/at/yawk/lz4/lz4-java/lz4-java-1.8.1.buildspec) :white_check_mark: | [1.10.0](../content/at/yawk/lz4/lz4-java/lz4-java-1.10.0.buildspec) | `bin/add-new-release.sh content/at/yawk/lz4/lz4-java/lz4-java-1.8.1.buildspec 1.10.0` |
| <!-- 20251202120240 --> [lz4-java](../content/at/yawk/lz4/lz4-java/README.md) | [1.8.1](../content/at/yawk/lz4/lz4-java/lz4-java-1.8.1.buildspec) :white_check_mark: | 1.9.0  | `bin/add-new-release.sh content/at/yawk/lz4/lz4-java/lz4-java-1.8.1.buildspec ...` |
| <!-- 20251202052913 --> [avaje-prisms-parent](../content/io/avaje/prisms/README.md) | [2.0-RC2](../content/io/avaje/prisms/avaje-prisms-2.0-RC2.buildspec) :white_check_mark: | 2.0-RC1  | `bin/add-new-release.sh content/io/avaje/prisms/avaje-prisms-2.0-RC2.buildspec ...` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20251203114649 --> [quarkus-project](../content/io/quarkus/README.md) | [3.30.1](../content/io/quarkus/quarkus-3.30.1.buildspec) :warning: | [3.30.2](../content/io/quarkus/quarkus-3.30.2.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.30.1.buildspec 3.30.2` |
