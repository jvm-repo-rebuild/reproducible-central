...
| ---------- | ---- | -- | ------- |
| <!-- 20231118191816 --> [maven-resolver](../content/org/apache/maven/resolver/maven-resolver/README.md) | [2.0.0-alpha-1](../content/org/apache/maven/resolver/maven-resolver/maven-resolver-2.0.0-alpha-1.buildspec) :heavy_check_mark: | [2.0.0-alpha-2](../content/org/apache/maven/resolver/maven-resolver/maven-resolver-2.0.0-alpha-2.buildspec) | `bin/add-new-release.sh content/org/apache/maven/resolver/maven-resolver/maven-resolver-2.0.0-alpha-1.buildspec 2.0.0-alpha-2` |
| <!-- 20231118174554 --> [javabean-tester](../content/com/github/hazendaz/javabean-tester/README.md) | [2.6.0](../content/com/github/hazendaz/javabean-tester/javabean-tester-2.6.0.buildspec) :heavy_check_mark: | [2.6.1](../content/com/github/hazendaz/javabean-tester/javabean-tester-2.6.1.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/javabean-tester/javabean-tester-2.6.0.buildspec 2.6.1` |
| <!-- 20231118030135 --> [mybatis-cdi](../content/org/mybatis/cdi/README.md) | [2.0.0](../content/org/mybatis/cdi/mybatis-cdi-2.0.0.buildspec) :heavy_check_mark: | [2.0.1](../content/org/mybatis/cdi/mybatis-cdi-2.0.1.buildspec) | `bin/add-new-release.sh content/org/mybatis/cdi/mybatis-cdi-2.0.0.buildspec 2.0.1` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20231118025823 --> [ratis](../content/org/apache/ratis/README.md) | [2.5.1](../content/org/apache/ratis/ratis-2.5.1.buildspec) :warning: [:memo:](https://issues.apache.org/jira/browse/RATIS-1840) | [3.0.0](../content/org/apache/ratis/ratis-3.0.0.buildspec) | `bin/add-new-release.sh content/org/apache/ratis/ratis-2.5.1.buildspec 3.0.0` |
...
| <!-- 20231115233347 --> [commons-compress](../content/org/apache/commons/compress/README.md) | [1.24.0](../content/org/apache/commons/compress/commons-compress-1.24.0.buildspec) :warning: | [1.25.0](../content/org/apache/commons/compress/commons-compress-1.25.0.buildspec) | `bin/add-new-release.sh content/org/apache/commons/compress/commons-compress-1.24.0.buildspec 1.25.0` |
