...
| ---------- | ---- | -- | ------- |
| <!-- 20250506125851 --> [rdf-abac](../content/io/telicent/jena/rdf-abac/README.md) | [0.73.4](../content/io/telicent/jena/rdf-abac/rdf-abac-0.73.4.buildspec) :white_check_mark: | [1.0.0](../content/io/telicent/jena/rdf-abac/rdf-abac-1.0.0.buildspec) | `bin/add-new-release.sh content/io/telicent/jena/rdf-abac/rdf-abac-0.73.4.buildspec 1.0.0` |
...
| <!-- 20250506065440 --> [sunspec-device-parent](../content/nl/basjes/sunspec/sunspec-device-parent/README.md) | [0.1.1](../content/nl/basjes/sunspec/sunspec-device-parent/sunspec-device-parent-0.1.1.buildspec) :white_check_mark: | [0.2.0](../content/nl/basjes/sunspec/sunspec-device-parent/sunspec-device-parent-0.2.0.buildspec) | `bin/add-new-release.sh content/nl/basjes/sunspec/sunspec-device-parent/sunspec-device-parent-0.1.1.buildspec 0.2.0` |
| <!-- 20250506065347 --> [modbus-devices-parent](../content/nl/basjes/modbus/devices/modbus-devices-parent/README.md) | [0.1.1](../content/nl/basjes/modbus/devices/modbus-devices-parent/modbus-devices-parent-0.1.1.buildspec) :white_check_mark: | [0.2.0](../content/nl/basjes/modbus/devices/modbus-devices-parent/modbus-devices-parent-0.2.0.buildspec) | `bin/add-new-release.sh content/nl/basjes/modbus/devices/modbus-devices-parent/modbus-devices-parent-0.1.1.buildspec 0.2.0` |
| <!-- 20250506062347 --> [modbus-schema-parent](../content/nl/basjes/modbus/modbus-schema-parent/README.md) | [0.1.1](../content/nl/basjes/modbus/modbus-schema-parent/modbus-schema-parent-0.1.1.buildspec) :white_check_mark: | [0.2.0](../content/nl/basjes/modbus/modbus-schema-parent/modbus-schema-parent-0.2.0.buildspec) | `bin/add-new-release.sh content/nl/basjes/modbus/modbus-schema-parent/modbus-schema-parent-0.1.1.buildspec 0.2.0` |
| <!-- 20250505221059 --> [javabean-tester](../content/com/github/hazendaz/javabean-tester/README.md) | [2.8.5](../content/com/github/hazendaz/javabean-tester/javabean-tester-2.8.5.buildspec) :white_check_mark: | [2.9.0](../content/com/github/hazendaz/javabean-tester/javabean-tester-2.9.0.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/javabean-tester/javabean-tester-2.8.5.buildspec 2.9.0` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250506090820 --> [avaje-jsonb-parent](../content/io/avaje/jsonb/README.md) | [](../content/io/avaje/jsonb/) :x: | [3.5-RC1](../content/io/avaje/jsonb/-3.5-RC1.buildspec) | `bin/add-new-release.sh content/io/avaje/jsonb/ 3.5-RC1` |
