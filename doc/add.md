...
| ---------- | ---- | -- | ------- |
| <!-- 20241129103457 --> [pmd](../content/net/sourceforge/pmd/README.md) | [7.7.0](../content/net/sourceforge/pmd/pmd-7.7.0.buildspec) :white_check_mark: | [7.8.0](../content/net/sourceforge/pmd/pmd-7.8.0.buildspec) | `bin/add-new-release.sh content/net/sourceforge/pmd/pmd-7.7.0.buildspec 7.8.0` |
| <!-- 20241129100608 --> [toolbox](../content/eu/maveniverse/maven/toolbox/README.md) | [0.5.1](../content/eu/maveniverse/maven/toolbox/toolbox-0.5.1.buildspec) :white_check_mark: | [0.5.2](../content/eu/maveniverse/maven/toolbox/toolbox-0.5.2.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/toolbox/toolbox-0.5.1.buildspec 0.5.2` |
...
| <!-- 20241129064441 --> [airbase](../content/io/airlift/airbase/README.md) | [201](../content/io/airlift/airbase/airbase-201.buildspec) :white_check_mark: | [202](../content/io/airlift/airbase/airbase-202.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-201.buildspec 202` |
| <!-- 20241129063107 --> [struts2-parent](../content/org/apache/struts/README.md) | [6.6.1](../content/org/apache/struts/struts2-6.6.1.buildspec) :white_check_mark: | [6.7.0](../content/org/apache/struts/struts2-6.7.0.buildspec) | `bin/add-new-release.sh content/org/apache/struts/struts2-6.6.1.buildspec 6.7.0` |
...
| <!-- 20241128213223 --> [cyclonedx-maven-plugin](../content/org/cyclonedx/cyclonedx-maven-plugin/README.md) | [2.9.0](../content/org/cyclonedx/cyclonedx-maven-plugin/cyclonedx-maven-plugin-2.9.0.buildspec) :white_check_mark: | [2.9.1](../content/org/cyclonedx/cyclonedx-maven-plugin/cyclonedx-maven-plugin-2.9.1.buildspec) | `bin/add-new-release.sh content/org/cyclonedx/cyclonedx-maven-plugin/cyclonedx-maven-plugin-2.9.0.buildspec 2.9.1` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20241128212009 --> [quarkus-project](../content/io/quarkus/README.md) | [3.17.0](../content/io/quarkus/quarkus-3.17.0.buildspec) :warning: [:memo:](https://github.com/quarkusio/quarkus/pull/44671) | [3.17.2](../content/io/quarkus/quarkus-3.17.2.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.17.0.buildspec 3.17.2` |
