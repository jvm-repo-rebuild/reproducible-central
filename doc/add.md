...
| ---------- | ---- | -- | ------- |
| <!-- 20251109203134 --> [yuicompressor-maven-plugin](../content/com/github/hazendaz/maven/yuicompressor-maven-plugin/README.md) | [2.2.0](../content/com/github/hazendaz/maven/yuicompressor-maven-plugin/yuicompressor-maven-plugin-2.2.0.buildspec) :white_check_mark: | [2.3.0](../content/com/github/hazendaz/maven/yuicompressor-maven-plugin/yuicompressor-maven-plugin-2.3.0.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/maven/yuicompressor-maven-plugin/yuicompressor-maven-plugin-2.2.0.buildspec 2.3.0` |
| <!-- 20251109184334 --> [aru-parent](../content/io/github/cbarlin/aru/README.md) | [0.6.8](../content/io/github/cbarlin/aru/aru-0.6.8.buildspec) :white_check_mark: | [0.7.0](../content/io/github/cbarlin/aru/aru-0.7.0.buildspec) | `bin/add-new-release.sh content/io/github/cbarlin/aru/aru-0.6.8.buildspec 0.7.0` |
| <!-- 20251109134333 --> [fusion](../content/io/yupiik/fusion/README.md) | [1.0.31](../content/io/yupiik/fusion/fusion-1.0.31.buildspec) :white_check_mark: | [1.0.32](../content/io/yupiik/fusion/fusion-1.0.32.buildspec) | `bin/add-new-release.sh content/io/yupiik/fusion/fusion-1.0.31.buildspec 1.0.32` |
| <!-- 20251109093334 --> [flowlogix](../content/com/flowlogix/README.md) | [10.0.5](../content/com/flowlogix/flowlogix-10.0.5.buildspec) :white_check_mark: | [10.0.8](../content/com/flowlogix/flowlogix-10.0.8.buildspec) | `bin/add-new-release.sh content/com/flowlogix/flowlogix-10.0.5.buildspec 10.0.8` |
| <!-- 20251109093334 --> [flowlogix](../content/com/flowlogix/README.md) | [10.0.5](../content/com/flowlogix/flowlogix-10.0.5.buildspec) :white_check_mark: | 10.0.7 10.0.6  | `bin/add-new-release.sh content/com/flowlogix/flowlogix-10.0.5.buildspec ...` |
| <!-- 20251109021850 --> [nifi-api](../content/org/apache/nifi/nifi-api/README.md) | [2.4.0](../content/org/apache/nifi/nifi-api/nifi-api-2.4.0.buildspec) :white_check_mark: | [2.5.0](../content/org/apache/nifi/nifi-api/nifi-api-2.5.0.buildspec) | `bin/add-new-release.sh content/org/apache/nifi/nifi-api/nifi-api-2.4.0.buildspec 2.5.0` |
| <!-- 20251109021536 --> [spoon-core](../content/fr/inria/gforge/spoon/spoon-core/README.md) | [11.2.2-beta-11](../content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.2.2-beta-11.buildspec) :white_check_mark: | [11.2.2-beta-12](../content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.2.2-beta-12.buildspec) | `bin/add-new-release.sh content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.2.2-beta-11.buildspec 11.2.2-beta-12` |
| <!-- 20251109010936 --> [hibernate-reactive-core](../content/org/hibernate/reactive/hibernate-reactive/README.md) | [4.1.4.Final](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.1.4.Final.buildspec) :white_check_mark: | [4.1.5.Final](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.1.5.Final.buildspec) | `bin/add-new-release.sh content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.1.4.Final.buildspec 4.1.5.Final` |
| <!-- 20251109010936 --> [hibernate-reactive-core](../content/org/hibernate/reactive/hibernate-reactive/README.md) | [4.1.4.Final](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.1.4.Final.buildspec) :white_check_mark: | 3.1.8.Final 3.0.10.Final  | `bin/add-new-release.sh content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.1.4.Final.buildspec ...` |
| <!-- 20251109010537 --> [maven-lockfile](../content/io/github/chains-project/maven-lockfile/README.md) | [5.10.0](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.10.0.buildspec) :white_check_mark: | [5.10.1-beta-1](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.10.1-beta-1.buildspec) | `bin/add-new-release.sh content/io/github/chains-project/maven-lockfile/maven-lockfile-5.10.0.buildspec 5.10.1-beta-1` |
| <!-- 20251109000335 --> [jmockit-parent](../content/com/github/hazendaz/jmockit/README.md) | [1.56.0](../content/com/github/hazendaz/jmockit/jmockit-1.56.0.buildspec) :white_check_mark: | [2.0.0](../content/com/github/hazendaz/jmockit/jmockit-2.0.0.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/jmockit/jmockit-1.56.0.buildspec 2.0.0` |
...
| <!-- 20251022175810 --> [:mailbox:](https://lists.apache.org/list?dev@activemq.apache.org:lte=1M:VOTE) | [activemq-parent](../content/org/apache/activemq/README.md) | [6.1.8](../content/org/apache/activemq/activemq-6.1.8.buildspec) :white_check_mark: | [6.2.0](../content/org/apache/activemq/activemq-6.2.0.buildspec)  | `bin/add-new-release.sh content/org/apache/activemq/activemq-6.1.8.buildspec 6.2.0 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20251109200344 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.108.0](../content/org/finos/legend/engine/legend-engine-4.108.0.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.108.0` |
| <!-- 20251109191933 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [12.1-RC1](../content/io/avaje/inject/avaje-inject-12.1-RC1.buildspec) :warning: | [12.1-RC2](../content/io/avaje/inject/avaje-inject-12.1-RC2.buildspec) | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-12.1-RC1.buildspec 12.1-RC2` |
...
| <!-- 20250625092738 --> [paapi5-java-sdk](../content/net/osslabz/paapi5-java-sdk/README.md) | [0.0.2](../content/net/osslabz/paapi5-java-sdk/paapi5-java-sdk-0.0.2.buildspec) :warning: | [1.2.2](../content/net/osslabz/paapi5-java-sdk/paapi5-java-sdk-1.2.2.buildspec) | `bin/add-new-release.sh content/net/osslabz/paapi5-java-sdk/paapi5-java-sdk-0.0.2.buildspec 1.2.2` |
...
| <!-- 20250424080642 --> [electrum-client](../content/net/osslabz/electrum-client/README.md) | [0.0.1](../content/net/osslabz/electrum-client/electrum-client-0.0.1.buildspec) :warning: | [0.2.16](../content/net/osslabz/electrum-client/electrum-client-0.2.16.buildspec) | `bin/add-new-release.sh content/net/osslabz/electrum-client/electrum-client-0.0.1.buildspec 0.2.16` |
...
| artifactId | newest |
| ---------- | ------ |
| <!-- 20251109200647 --> [jpmml-sparkml](../content/org/jpmml/jpmml-sparkml/README.md) | 3.2.2 :warning: |
| <!-- 20251108111825 --> [quarkus-project](../content/io/quarkus/README.md) | 3.29.2 :warning: |
