...
| ---------- | ---- | -- | ------- |
| <!-- 20250401145023 --> [micronaut-maven-plugin](../content/io/micronaut/maven/micronaut-maven-plugin/README.md) | [4.7.2](../content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-4.7.2.buildspec) :white_check_mark: | [4.8.0](../content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-4.8.0.buildspec) | `bin/add-new-release.sh content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-4.7.2.buildspec 4.8.0` |
| <!-- 20250401103544 --> [sling-initial-content-transform-maven-plugin](../content/io/wcm/maven/plugins/sling-initial-content-transform-maven-plugin/README.md) | [1.1.6](../content/io/wcm/maven/plugins/sling-initial-content-transform-maven-plugin/sling-initial-content-transform-maven-plugin-1.1.6.buildspec) :white_check_mark: | [1.1.8](../content/io/wcm/maven/plugins/sling-initial-content-transform-maven-plugin/sling-initial-content-transform-maven-plugin-1.1.8.buildspec) | `bin/add-new-release.sh content/io/wcm/maven/plugins/sling-initial-content-transform-maven-plugin/sling-initial-content-transform-maven-plugin-1.1.6.buildspec 1.1.8` |
| <!-- 20250401095339 --> [airbase](../content/io/airlift/airbase/README.md) | [244](../content/io/airlift/airbase/airbase-244.buildspec) :white_check_mark: | [245](../content/io/airlift/airbase/airbase-245.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-244.buildspec 245` |
| <!-- 20250401044211 --> [flexmonster](../content/org/webjars/flexmonster/README.md) | [2.9.99](../content/org/webjars/flexmonster/flexmonster-2.9.99.buildspec) :white_check_mark: | [2.9.100](../content/org/webjars/flexmonster/flexmonster-2.9.100.buildspec) | `bin/add-new-release.sh content/org/webjars/flexmonster/flexmonster-2.9.99.buildspec 2.9.100` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250401054706 --> [camel](../content/org/apache/camel/camel/README.md) | [4.10.0](../content/org/apache/camel/camel/camel-4.10.0.buildspec) :x: | [4.10.3](../content/org/apache/camel/camel/camel-4.10.3.buildspec) | `bin/add-new-release.sh content/org/apache/camel/camel/camel-4.10.0.buildspec 4.10.3` |
...
| <!-- 20250328205257 --> [jpmml-sklearn](../content/org/jpmml/jpmml-sklearn/README.md) | 1.9.4 :warning: |
