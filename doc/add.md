...
| <!-- 20240924184351 --> [wicket-parent](../content/org/apache/wicket/README.md) | [10.1.0](../content/org/apache/wicket/wicket-parent-10.1.0.buildspec) :white_check_mark: | [10.2.0](../content/org/apache/wicket/wicket-parent-10.2.0.buildspec) | `bin/add-new-release.sh content/org/apache/wicket/wicket-parent-10.1.0.buildspec 10.2.0` |
| <!-- 20240924133912 --> [airbase](../content/io/airlift/airbase/README.md) | [176](../content/io/airlift/airbase/airbase-176.buildspec) :white_check_mark: | [178](../content/io/airlift/airbase/airbase-178.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-176.buildspec 178` |
| <!-- 20240924133912 --> [airbase](../content/io/airlift/airbase/README.md) | [176](../content/io/airlift/airbase/airbase-176.buildspec) :white_check_mark: | 177  | `bin/add-new-release.sh content/io/airlift/airbase/airbase-176.buildspec ...` |
| <!-- 20240924123436 --> [junit-bom](../content/org/junit/junit5/README.md) | [5.11.0](../content/org/junit/junit5/junit5-5.11.0.buildspec) :white_check_mark: | 5.10.4  | `bin/add-new-release.sh content/org/junit/junit5/junit5-5.11.0.buildspec ...` |
| <!-- 20240924045546 --> [plexus-utils](../content/org/codehaus/plexus/plexus-utils/README.md) | [4.0.1](../content/org/codehaus/plexus/plexus-utils/plexus-utils-4.0.1.buildspec) :white_check_mark: | [4.0.2](../content/org/codehaus/plexus/plexus-utils/plexus-utils-4.0.2.buildspec) | `bin/add-new-release.sh content/org/codehaus/plexus/plexus-utils/plexus-utils-4.0.1.buildspec 4.0.2` |
...
| <!-- 20240923202223 --> [makeself-maven-plugin](../content/com/github/hazendaz/maven/makeself-maven-plugin/README.md) | [1.8.1](../content/com/github/hazendaz/maven/makeself-maven-plugin/makeself-maven-plugin-1.8.1.buildspec) :white_check_mark: | [1.8.2](../content/com/github/hazendaz/maven/makeself-maven-plugin/makeself-maven-plugin-1.8.2.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/maven/makeself-maven-plugin/makeself-maven-plugin-1.8.1.buildspec 1.8.2` |
...
| <!-- 20240806072000 --> [:mailbox:](https://lists.apache.org/list?dev@jackrabbit.apache.org:lte=1M:VOTE) | [jackrabbit-filevault](../content/org/apache/jackrabbit/filevault/README.md) | [3.8.0](../content/org/apache/jackrabbit/filevault/jackrabbit-filevault-3.8.0.buildspec) :white_check_mark: | [3.8.2](../content/org/apache/jackrabbit/filevault/jackrabbit-filevault-3.8.2.buildspec)  | `bin/add-new-release.sh content/org/apache/jackrabbit/filevault/jackrabbit-filevault-3.8.0.buildspec 3.8.2 staging` |
...
| <!-- 20240528221132 --> [:mailbox:](https://lists.apache.org/list?dev@nifi.apache.org:lte=1M:VOTE) | [nifi-nar-maven-plugin](../content/org/apache/nifi/nifi-nar-maven-plugin/README.md) | [2.0.0](../content/org/apache/nifi/nifi-nar-maven-plugin/nifi-nar-maven-plugin-2.0.0.buildspec) :white_check_mark: | [2.1.0](../content/org/apache/nifi/nifi-nar-maven-plugin/nifi-nar-maven-plugin-2.1.0.buildspec)  | `bin/add-new-release.sh content/org/apache/nifi/nifi-nar-maven-plugin/nifi-nar-maven-plugin-2.0.0.buildspec 2.1.0 staging` |
| <!-- 20240502220117 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-csv](../content/org/apache/commons/csv/README.md) | [1.11.0](../content/org/apache/commons/csv/commons-csv-1.11.0.buildspec) :warning: | [1.12.0](../content/org/apache/commons/csv/commons-csv-1.12.0.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/csv/commons-csv-1.11.0.buildspec 1.12.0 staging` |
| <!-- 20231030115417 --> [:mailbox:](https://lists.apache.org/list?dev@qpid.apache.org:lte=1M:VOTE) | [qpid-jms-parent](../content/org/apache/qpid/jms/README.md) | [2.5.0](../content/org/apache/qpid/jms/qpid-jms-2.5.0.buildspec) :white_check_mark: | [2.6.0](../content/org/apache/qpid/jms/qpid-jms-2.6.0.buildspec)  | `bin/add-new-release.sh content/org/apache/qpid/jms/qpid-jms-2.5.0.buildspec 2.6.0 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20240923205509 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.56.0](../content/org/finos/legend/engine/legend-engine-4.56.0.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.58.0](../content/org/finos/legend/engine/legend-engine-4.58.0.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.56.0.buildspec 4.58.0` |
