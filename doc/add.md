...
| ---------- | ---- | -- | ------- |
| <!-- 20241030100857 --> [dependency-check-parent](../content/org/owasp/dependency-check/README.md) | [11.0.0](../content/org/owasp/dependency-check/dependency-check-11.0.0.buildspec) :white_check_mark: | [11.1.0](../content/org/owasp/dependency-check/dependency-check-11.1.0.buildspec) | `bin/add-new-release.sh content/org/owasp/dependency-check/dependency-check-11.0.0.buildspec 11.1.0` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20241030163826 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.56.0](../content/org/finos/legend/engine/legend-engine-4.56.0.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.64.1](../content/org/finos/legend/engine/legend-engine-4.64.1.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.56.0.buildspec 4.64.1` |
| <!-- 20241030100408 --> [quarkus-project](../content/io/quarkus/README.md) | [3.15.1](../content/io/quarkus/quarkus-3.15.1.buildspec) :warning: | [3.16.1](../content/io/quarkus/quarkus-3.16.1.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.15.1.buildspec 3.16.1` |
| <!-- 20241029214125 --> [acs-aem-commons](../content/com/adobe/acs/aem-commons/README.md) | [6.0.14](../content/com/adobe/acs/aem-commons/acs-aem-commons-6.0.14.buildspec) :warning: | [6.9.0](../content/com/adobe/acs/aem-commons/acs-aem-commons-6.9.0.buildspec) | `bin/add-new-release.sh content/com/adobe/acs/aem-commons/acs-aem-commons-6.0.14.buildspec 6.9.0` |
