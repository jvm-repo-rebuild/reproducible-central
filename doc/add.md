...
| ---------- | ---- | -- | ------- |
| <!-- 20240714201625 --> [maven-release-plugin](../content/org/apache/maven/plugins/maven-release-plugin/README.md) | [3.1.0](../content/org/apache/maven/plugins/maven-release-plugin/maven-release-plugin-3.1.0.buildspec) :white_check_mark: | [3.1.1](../content/org/apache/maven/plugins/maven-release-plugin/maven-release-plugin-3.1.1.buildspec) | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-release-plugin/maven-release-plugin-3.1.0.buildspec 3.1.1` |
