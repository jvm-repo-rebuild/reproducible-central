...
| <!-- 20230603064433 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-release-plugin](../content/org/apache/maven/plugins/maven-release-plugin/README.md) | [3.0.1](../content/org/apache/maven/plugins/maven-release-plugin/maven-release-plugin-3.0.1.buildspec) :white_check_mark: | [3.1.0](../content/org/apache/maven/plugins/maven-release-plugin/maven-release-plugin-3.1.0.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-release-plugin/maven-release-plugin-3.0.1.buildspec 3.1.0 staging` |
