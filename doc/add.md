...
| ---------- | ---- | -- | ------- |
| <!-- 20251219152053 --> [byte-buddy-parent](../content/net/bytebuddy/README.md) | [1.18.2](../content/net/bytebuddy/byte-buddy-1.18.2.buildspec) :white_check_mark: | [1.18.3](../content/net/bytebuddy/byte-buddy-1.18.3.buildspec) | `bin/add-new-release.sh content/net/bytebuddy/byte-buddy-1.18.2.buildspec 1.18.3` |
| <!-- 20251219143634 --> [mimir](../content/eu/maveniverse/maven/mimir/README.md) | [0.10.6](../content/eu/maveniverse/maven/mimir/mimir-0.10.6.buildspec) :white_check_mark: | [0.11.0](../content/eu/maveniverse/maven/mimir/mimir-0.11.0.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/mimir/mimir-0.10.6.buildspec 0.11.0` |
| <!-- 20251219135133 --> [bom-builder](../content/eu/maveniverse/maven/bom-builder/README.md) | [1.3.1](../content/eu/maveniverse/maven/bom-builder/bom-builder-1.3.1.buildspec) :white_check_mark: | [1.3.2](../content/eu/maveniverse/maven/bom-builder/bom-builder-1.3.2.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/bom-builder/bom-builder-1.3.1.buildspec 1.3.2` |
| <!-- 20251219135132 --> [java-desktop-util-parent](../content/com/github/nbbrd/java-desktop-util/README.md) | [2.5.0](../content/com/github/nbbrd/java-desktop-util/java-desktop-util-2.5.0.buildspec) :white_check_mark: | [2.6.0](../content/com/github/nbbrd/java-desktop-util/java-desktop-util-2.6.0.buildspec) | `bin/add-new-release.sh content/com/github/nbbrd/java-desktop-util/java-desktop-util-2.5.0.buildspec 2.6.0` |
| <!-- 20251219134528 --> [nisse](../content/eu/maveniverse/maven/nisse/README.md) | [0.6.3](../content/eu/maveniverse/maven/nisse/nisse-0.6.3.buildspec) :white_check_mark: | [0.7.0](../content/eu/maveniverse/maven/nisse/nisse-0.7.0.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/nisse/nisse-0.6.3.buildspec 0.7.0` |
| <!-- 20251219054918 --> [avaje-validator-parent](../content/io/avaje/validator/README.md) | [2.15](../content/io/avaje/validator/avaje-validator-2.15.buildspec) :white_check_mark: | [2.16-RC1](../content/io/avaje/validator/avaje-validator-2.16-RC1.buildspec) | `bin/add-new-release.sh content/io/avaje/validator/avaje-validator-2.15.buildspec 2.16-RC1` |
| <!-- 20251218221222 --> [shared](../content/eu/maveniverse/maven/shared/shared/README.md) | [0.1.9](../content/eu/maveniverse/maven/shared/shared/shared-0.1.9.buildspec) :white_check_mark: | [0.1.10](../content/eu/maveniverse/maven/shared/shared/shared-0.1.10.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/shared/shared/shared-0.1.9.buildspec 0.1.10` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20251219175807 --> [evm-abi-decoder](../content/net/osslabz/evm-abi-decode/README.md) | [0.1.2](../content/net/osslabz/evm-abi-decode/evm-abi-decoder-0.1.2.buildspec) :warning: | [0.1.3](../content/net/osslabz/evm-abi-decode/evm-abi-decoder-0.1.3.buildspec) | `bin/add-new-release.sh content/net/osslabz/evm-abi-decode/evm-abi-decoder-0.1.2.buildspec 0.1.3` |
...
| <!-- 20251218112519 --> [jdplus-benchmarking](../content/eu/europa/ec/joinup/sat/jdplus-benchmarking/README.md) | [2.0.1](../content/eu/europa/ec/joinup/sat/jdplus-benchmarking/jdplus-benchmarking-2.0.1.buildspec) :warning: | [2.1.0](../content/eu/europa/ec/joinup/sat/jdplus-benchmarking/jdplus-benchmarking-2.1.0.buildspec) | `bin/add-new-release.sh content/eu/europa/ec/joinup/sat/jdplus-benchmarking/jdplus-benchmarking-2.0.1.buildspec 2.1.0` |
| <!-- 20251217220443 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.116.0](../content/org/finos/legend/engine/legend-engine-4.116.0.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.116.0` |
...
| <!-- 20251217144158 --> [quarkus-project](../content/io/quarkus/README.md) | 3.30.4 :warning: |
