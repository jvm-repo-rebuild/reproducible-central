...
| ---------- | ---- | -- | ------- |
| <!-- 20240926163302 --> [nexus-format-archetype](../content/org/sonatype/nexus/archetypes/nexus-format-archetype/README.md) | [1.0.61](../content/org/sonatype/nexus/archetypes/nexus-format-archetype/nexus-format-archetype-1.0.61.buildspec) :white_check_mark: | [1.0.63](../content/org/sonatype/nexus/archetypes/nexus-format-archetype/nexus-format-archetype-1.0.63.buildspec) | `bin/add-new-release.sh content/org/sonatype/nexus/archetypes/nexus-format-archetype/nexus-format-archetype-1.0.61.buildspec 1.0.63` |
| <!-- 20240926163302 --> [nexus-format-archetype](../content/org/sonatype/nexus/archetypes/nexus-format-archetype/README.md) | [1.0.61](../content/org/sonatype/nexus/archetypes/nexus-format-archetype/nexus-format-archetype-1.0.61.buildspec) :white_check_mark: | 1.0.62  | `bin/add-new-release.sh content/org/sonatype/nexus/archetypes/nexus-format-archetype/nexus-format-archetype-1.0.61.buildspec ...` |
| <!-- 20240926144845 --> [pmd-build-tools-config](../content/net/sourceforge/pmd/pmd-build-tools-config/README.md) | [26](../content/net/sourceforge/pmd/pmd-build-tools-config/pmd-build-tools-config-26.buildspec) :white_check_mark: | [27](../content/net/sourceforge/pmd/pmd-build-tools-config/pmd-build-tools-config-27.buildspec) | `bin/add-new-release.sh content/net/sourceforge/pmd/pmd-build-tools-config/pmd-build-tools-config-26.buildspec 27` |
| <!-- 20240926104317 --> [scg-base](../content/io/telicent/smart-caches/graph/scg-base/README.md) | [0.82.1](../content/io/telicent/smart-caches/graph/scg-base/scg-base-0.82.1.buildspec) :white_check_mark: | [0.82.2](../content/io/telicent/smart-caches/graph/scg-base/scg-base-0.82.2.buildspec) | `bin/add-new-release.sh content/io/telicent/smart-caches/graph/scg-base/scg-base-0.82.1.buildspec 0.82.2` |
| <!-- 20240926104317 --> [scg-base](../content/io/telicent/smart-caches/graph/scg-base/README.md) | [0.82.1](../content/io/telicent/smart-caches/graph/scg-base/scg-base-0.82.1.buildspec) :white_check_mark: | 0.81.0  | `bin/add-new-release.sh content/io/telicent/smart-caches/graph/scg-base/scg-base-0.82.1.buildspec ...` |
| <!-- 20240926090610 --> [airbase](../content/io/airlift/airbase/README.md) | [178](../content/io/airlift/airbase/airbase-178.buildspec) :white_check_mark: | [180](../content/io/airlift/airbase/airbase-180.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-178.buildspec 180` |
| <!-- 20240926090610 --> [airbase](../content/io/airlift/airbase/README.md) | [178](../content/io/airlift/airbase/airbase-178.buildspec) :white_check_mark: | 179  | `bin/add-new-release.sh content/io/airlift/airbase/airbase-178.buildspec ...` |
| <!-- 20240926072208 --> [maven-archetype](../content/org/apache/maven/archetype/README.md) | [3.2.1](../content/org/apache/maven/archetype/archetype-3.2.1.buildspec) :white_check_mark: | [3.3.0](../content/org/apache/maven/archetype/archetype-3.3.0.buildspec) | `bin/add-new-release.sh content/org/apache/maven/archetype/archetype-3.2.1.buildspec 3.3.0` |
...
| <!-- 20240925234123 --> [trino-root](../content/io/trino/README.md) | [458](../content/io/trino/trino-458.buildspec) :white_check_mark: | [459](../content/io/trino/trino-459.buildspec) | `bin/add-new-release.sh content/io/trino/trino-458.buildspec 459` |
| <!-- 20240925233957 --> [mybatis-velocity](../content/org/mybatis/scripting/mybatis-velocity/README.md) | [2.1.2](../content/org/mybatis/scripting/mybatis-velocity/mybatis-velocity-2.1.2.buildspec) :white_check_mark: | [2.3.0](../content/org/mybatis/scripting/mybatis-velocity/mybatis-velocity-2.3.0.buildspec) | `bin/add-new-release.sh content/org/mybatis/scripting/mybatis-velocity/mybatis-velocity-2.1.2.buildspec 2.3.0` |
| <!-- 20240925233957 --> [mybatis-velocity](../content/org/mybatis/scripting/mybatis-velocity/README.md) | [2.1.2](../content/org/mybatis/scripting/mybatis-velocity/mybatis-velocity-2.1.2.buildspec) :white_check_mark: | 2.2.0  | `bin/add-new-release.sh content/org/mybatis/scripting/mybatis-velocity/mybatis-velocity-2.1.2.buildspec ...` |
...
| <!-- 20240925074256 --> [byte-buddy-parent](../content/net/bytebuddy/README.md) | [1.15.1](../content/net/bytebuddy/byte-buddy-1.15.1.buildspec) :white_check_mark: | [1.15.2](../content/net/bytebuddy/byte-buddy-1.15.2.buildspec) | `bin/add-new-release.sh content/net/bytebuddy/byte-buddy-1.15.1.buildspec 1.15.2` |
| <!-- 20240925070734 --> [junit-bom](../content/org/junit/junit5/README.md) | [5.11.0](../content/org/junit/junit5/junit5-5.11.0.buildspec) :white_check_mark: | [5.11.1](../content/org/junit/junit5/junit5-5.11.1.buildspec) | `bin/add-new-release.sh content/org/junit/junit5/junit5-5.11.0.buildspec 5.11.1` |
| <!-- 20240925070734 --> [junit-bom](../content/org/junit/junit5/README.md) | [5.11.0](../content/org/junit/junit5/junit5-5.11.0.buildspec) :white_check_mark: | 5.10.4  | `bin/add-new-release.sh content/org/junit/junit5/junit5-5.11.0.buildspec ...` |
...
| <!-- 20240920131111 --> [jline](../content/org/jline/README.md) | [3.26.3](../content/org/jline/jline-3.26.3.buildspec) :white_check_mark: | [3.27.0](../content/org/jline/jline-3.27.0.buildspec) | `bin/add-new-release.sh content/org/jline/jline-3.26.3.buildspec 3.27.0` |
| <!-- 20240917011228 --> [convex](../content/world/convex/README.md) | [0.7.15](../content/world/convex/convex-0.7.15.buildspec) :white_check_mark: | 0.7.10 0.7.9 0.7.7 0.7.6 0.7.1 0.7.0 0.7.0-rc4 0.7.0-rc3  | `bin/add-new-release.sh content/world/convex/convex-0.7.15.buildspec ...` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20240918213454 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-parent](../content/org/apache/commons/parent/README.md) | [75](../content/org/apache/commons/parent/commons-parent-75.buildspec) :white_check_mark: | [76](../content/org/apache/commons/parent/commons-parent-76.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/parent/commons-parent-75.buildspec 76 staging` |
| <!-- 20240914150917 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-gpg-plugin](../content/org/apache/maven/plugins/maven-gpg-plugin/README.md) | [3.2.6](../content/org/apache/maven/plugins/maven-gpg-plugin/maven-gpg-plugin-3.2.6.buildspec) :white_check_mark: | [3.2.7](../content/org/apache/maven/plugins/maven-gpg-plugin/maven-gpg-plugin-3.2.7.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-gpg-plugin/maven-gpg-plugin-3.2.6.buildspec 3.2.7 staging` |
| <!-- 20240827125619 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-javadoc-plugin](../content/org/apache/maven/plugins/maven-javadoc-plugin/README.md) | [3.10.0](../content/org/apache/maven/plugins/maven-javadoc-plugin/maven-javadoc-plugin-3.10.0.buildspec) :white_check_mark: | [3.10.1](../content/org/apache/maven/plugins/maven-javadoc-plugin/maven-javadoc-plugin-3.10.1.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-javadoc-plugin/maven-javadoc-plugin-3.10.0.buildspec 3.10.1 staging` |
| <!-- 20240818155500 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-fluido-skin](../content/org/apache/maven/skins/fluido/README.md) | [2.0.0-M10](../content/org/apache/maven/skins/fluido/maven-fluido-skin-2.0.0-M10.buildspec) :white_check_mark: | [2.0.0-M11](../content/org/apache/maven/skins/fluido/maven-fluido-skin-2.0.0-M11.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/skins/fluido/maven-fluido-skin-2.0.0-M10.buildspec 2.0.0-M11 staging` |
| <!-- 20240814091815 --> [:mailbox:](https://lists.apache.org/list?dev@sling.apache.org:lte=1M:VOTE) | [org.apache.sling.resourceresolver](../content/org/apache/sling/org.apache.sling.resourceresolver/README.md) | [1.12.0](../content/org/apache/sling/org.apache.sling.resourceresolver/org.apache.sling.resourceresolver-1.12.0.buildspec) :white_check_mark: | [1.12.2](../content/org/apache/sling/org.apache.sling.resourceresolver/org.apache.sling.resourceresolver-1.12.2.buildspec)  | `bin/add-new-release.sh content/org/apache/sling/org.apache.sling.resourceresolver/org.apache.sling.resourceresolver-1.12.0.buildspec 1.12.2 staging` |
...
| <!-- 20240731135509 --> [:mailbox:](https://lists.apache.org/list?dev@sshd.apache.org:lte=1M:VOTE) | [sshd](../content/org/apache/sshd/README.md) | [2.13.2](../content/org/apache/sshd/sshd-2.13.2.buildspec) :warning: | [2.14.0](../content/org/apache/sshd/sshd-2.14.0.buildspec)  | `bin/add-new-release.sh content/org/apache/sshd/sshd-2.13.2.buildspec 2.14.0 staging` |
| <!-- 20240509155445 --> [:mailbox:](https://lists.apache.org/list?dev@hive.apache.org:lte=1M:VOTE) | [hive](../content/org/apache/hive/README.md) | [4.0.0](../content/org/apache/hive/hive-4.0.0.buildspec) :warning: [:memo:](https://issues.apache.org/jira/browse/HIVE-28186) | [4.0.1](../content/org/apache/hive/hive-4.0.1.buildspec)  | `bin/add-new-release.sh content/org/apache/hive/hive-4.0.0.buildspec 4.0.1 staging` |
| <!-- 20231116164810 --> [:mailbox:](https://lists.apache.org/list?dev@jackrabbit.apache.org:lte=1M:VOTE) | [filevault-package-maven-plugin](../content/org/apache/jackrabbit/filevault-package-maven-plugin/README.md) | [1.3.6](../content/org/apache/jackrabbit/filevault-package-maven-plugin/filevault-package-maven-plugin-1.3.6.buildspec) :white_check_mark: | [1.4.0](../content/org/apache/jackrabbit/filevault-package-maven-plugin/filevault-package-maven-plugin-1.4.0.buildspec)  | `bin/add-new-release.sh content/org/apache/jackrabbit/filevault-package-maven-plugin/filevault-package-maven-plugin-1.3.6.buildspec 1.4.0 staging` |
| <!-- 20221101205935 --> [:mailbox:](https://lists.apache.org/list?dev@httpcomponents.apache.org:lte=1M:VOTE) | [httpcomponents-parent](../content/org/apache/httpcomponents/parent/README.md) | [13](../content/org/apache/httpcomponents/parent/httpcomponents-parent-13.buildspec) :white_check_mark: | [14](../content/org/apache/httpcomponents/parent/httpcomponents-parent-14.buildspec)  | `bin/add-new-release.sh content/org/apache/httpcomponents/parent/httpcomponents-parent-13.buildspec 14 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20240926030016 --> [ratis](../content/org/apache/ratis/README.md) | [3.1.0](../content/org/apache/ratis/ratis-3.1.0.buildspec) :warning: [:memo:](https://issues.apache.org/jira/browse/RATIS-1840) | [3.1.1](../content/org/apache/ratis/ratis-3.1.1.buildspec) | `bin/add-new-release.sh content/org/apache/ratis/ratis-3.1.0.buildspec 3.1.1` |
| <!-- 20240925221448 --> [quarkus-project](../content/io/quarkus/README.md) | [3.15.0](../content/io/quarkus/quarkus-3.15.0.buildspec) :warning: | [3.15.1](../content/io/quarkus/quarkus-3.15.1.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.15.0.buildspec 3.15.1` |
| <!-- 20240925152232 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.56.0](../content/org/finos/legend/engine/legend-engine-4.56.0.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.59.0](../content/org/finos/legend/engine/legend-engine-4.59.0.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.56.0.buildspec 4.59.0` |
| <!-- 20240925091104 --> [kubernetes-client-project](../content/io/fabric8/kubernetes-client/README.md) | [6.13.3](../content/io/fabric8/kubernetes-client/kubernetes-client-6.13.3.buildspec) :warning: | [6.13.4](../content/io/fabric8/kubernetes-client/kubernetes-client-6.13.4.buildspec) | `bin/add-new-release.sh content/io/fabric8/kubernetes-client/kubernetes-client-6.13.3.buildspec 6.13.4` |
| <!-- 20240925020157 --> [commons-csv](../content/org/apache/commons/csv/README.md) | [1.11.0](../content/org/apache/commons/csv/commons-csv-1.11.0.buildspec) :warning: | [1.12.0](../content/org/apache/commons/csv/commons-csv-1.12.0.buildspec) | `bin/add-new-release.sh content/org/apache/commons/csv/commons-csv-1.11.0.buildspec 1.12.0` |
| <!-- 20240923204413 --> [guava](../content/com/google/guava/README.md) | [32.0.1-jre](../content/com/google/guava/guava-32.0.1-jre.buildspec) :warning: | [33.3.1-jre](../content/com/google/guava/guava-33.3.1-jre.buildspec) | `bin/add-new-release.sh content/com/google/guava/guava-32.0.1-jre.buildspec 33.3.1-jre` |
