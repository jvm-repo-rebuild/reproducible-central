...
| ---------- | ---- | -- | ------- |
| <!-- 20250714141124 --> [spoon-core](../content/fr/inria/gforge/spoon/spoon-core/README.md) | [11.2.2-beta-2](../content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.2.2-beta-2.buildspec) :white_check_mark: | [11.2.2-beta-3](../content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.2.2-beta-3.buildspec) | `bin/add-new-release.sh content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.2.2-beta-2.buildspec 11.2.2-beta-3` |
| <!-- 20250714140201 --> [oras-java-sdk](../content/land/oras/oras-java-sdk/README.md) | [0.2.14](../content/land/oras/oras-java-sdk/oras-java-sdk-0.2.14.buildspec) :white_check_mark: | [0.2.15](../content/land/oras/oras-java-sdk/oras-java-sdk-0.2.15.buildspec) | `bin/add-new-release.sh content/land/oras/oras-java-sdk/oras-java-sdk-0.2.14.buildspec 0.2.15` |
| <!-- 20250714134413 --> [cucumber-jvm](../content/io/cucumber/cucumber-jvm/README.md) | [7.25.0](../content/io/cucumber/cucumber-jvm/cucumber-jvm-7.25.0.buildspec) :white_check_mark: | [7.26.0](../content/io/cucumber/cucumber-jvm/cucumber-jvm-7.26.0.buildspec) | `bin/add-new-release.sh content/io/cucumber/cucumber-jvm/cucumber-jvm-7.25.0.buildspec 7.26.0` |
| <!-- 20250714133010 --> [nifi-api](../content/org/apache/nifi/nifi-api/README.md) | [2.1.0](../content/org/apache/nifi/nifi-api/nifi-api-2.1.0.buildspec) :white_check_mark: | [2.2.0](../content/org/apache/nifi/nifi-api/nifi-api-2.2.0.buildspec) | `bin/add-new-release.sh content/org/apache/nifi/nifi-api/nifi-api-2.1.0.buildspec 2.2.0` |
| <!-- 20250714112452 --> [aru-parent](../content/io/github/cbarlin/aru/README.md) | [0.2.6](../content/io/github/cbarlin/aru/aru-0.2.6.buildspec) :white_check_mark: | [0.3.0](../content/io/github/cbarlin/aru/aru-0.3.0.buildspec) | `bin/add-new-release.sh content/io/github/cbarlin/aru/aru-0.2.6.buildspec 0.3.0` |
| <!-- 20250714063852 --> [airbase](../content/io/airlift/airbase/README.md) | [278](../content/io/airlift/airbase/airbase-278.buildspec) :white_check_mark: | [279](../content/io/airlift/airbase/airbase-279.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-278.buildspec 279` |
| <!-- 20250714052333 --> [jackrabbit-parent](../content/org/apache/jackrabbit/jackrabbit/README.md) | [2.23.1-beta](../content/org/apache/jackrabbit/jackrabbit/jackrabbit-2.23.1-beta.buildspec) :white_check_mark: | [2.23.2-beta](../content/org/apache/jackrabbit/jackrabbit/jackrabbit-2.23.2-beta.buildspec) | `bin/add-new-release.sh content/org/apache/jackrabbit/jackrabbit/jackrabbit-2.23.1-beta.buildspec 2.23.2-beta` |
| <!-- 20250714052333 --> [jackrabbit-parent](../content/org/apache/jackrabbit/jackrabbit/README.md) | [2.23.1-beta](../content/org/apache/jackrabbit/jackrabbit/jackrabbit-2.23.1-beta.buildspec) :white_check_mark: | 2.22.1  | `bin/add-new-release.sh content/org/apache/jackrabbit/jackrabbit/jackrabbit-2.23.1-beta.buildspec ...` |
| <!-- 20250713202123 --> [cui-parent-pom](../content/de/cuioss/cui-parent-pom/README.md) | [1.1.1](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.1.1.buildspec) :white_check_mark: | [1.1.2](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.1.2.buildspec) | `bin/add-new-release.sh content/de/cuioss/cui-parent-pom/cui-parent-pom-1.1.1.buildspec 1.1.2` |
| <!-- 20250713200419 --> [maven-surefire-cached](../content/com/github/seregamorph/maven-surefire-cached/README.md) | [0.21](../content/com/github/seregamorph/maven-surefire-cached/maven-surefire-cached-0.21.buildspec) :white_check_mark: | [0.22](../content/com/github/seregamorph/maven-surefire-cached/maven-surefire-cached-0.22.buildspec) | `bin/add-new-release.sh content/com/github/seregamorph/maven-surefire-cached/maven-surefire-cached-0.21.buildspec 0.22` |
| <!-- 20250710124740 --> [pretty-formatter](../content/io/cucumber/pretty-formatter/README.md) | [0.3.0](../content/io/cucumber/pretty-formatter/pretty-formatter-0.3.0.buildspec) :white_check_mark: | 0.2.0  | `bin/add-new-release.sh content/io/cucumber/pretty-formatter/pretty-formatter-0.3.0.buildspec ...` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20250702073533 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [enforcer](../content/org/apache/maven/enforcer/README.md) | [3.6.0](../content/org/apache/maven/enforcer/maven-enforcer-plugin-3.6.0.buildspec) :white_check_mark: | [3.6.1](../content/org/apache/maven/enforcer/maven-enforcer-plugin-3.6.1.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/enforcer/maven-enforcer-plugin-3.6.0.buildspec 3.6.1 staging` |
...
| <!-- 20250713215219 --> [avaje-http-parent](../content/io/avaje/http/README.md) | [3.4-RC1](../content/io/avaje/http/avaje-http-3.4-RC1.buildspec) :warning: | [3.4-RC2](../content/io/avaje/http/avaje-http-3.4-RC2.buildspec) | `bin/add-new-release.sh content/io/avaje/http/avaje-http-3.4-RC1.buildspec 3.4-RC2` |
