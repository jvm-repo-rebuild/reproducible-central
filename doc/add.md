...
| ---------- | ---- | -- | ------- |
| <!-- 20250919164938 --> [hibernate-validator](../content/org/hibernate/validator/hibernate-validator/README.md) | [9.1.0.Alpha1](../content/org/hibernate/validator/hibernate-validator/hibernate-validator-9.1.0.Alpha1.buildspec) :white_check_mark: | [9.1.0.Alpha2](../content/org/hibernate/validator/hibernate-validator/hibernate-validator-9.1.0.Alpha2.buildspec) | `bin/add-new-release.sh content/org/hibernate/validator/hibernate-validator/hibernate-validator-9.1.0.Alpha1.buildspec 9.1.0.Alpha2` |
| <!-- 20250919143535 --> [javabean-tester](../content/com/github/hazendaz/javabean-tester/README.md) | [2.11.0](../content/com/github/hazendaz/javabean-tester/javabean-tester-2.11.0.buildspec) :white_check_mark: | [2.11.1](../content/com/github/hazendaz/javabean-tester/javabean-tester-2.11.1.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/javabean-tester/javabean-tester-2.11.0.buildspec 2.11.1` |
| <!-- 20250919140604 --> [maven-turbo-builder](../content/com/github/seregamorph/maven-turbo-builder/README.md) | [0.9](../content/com/github/seregamorph/maven-turbo-builder/maven-turbo-builder-0.9.buildspec) :white_check_mark: | [0.11](../content/com/github/seregamorph/maven-turbo-builder/maven-turbo-builder-0.11.buildspec) | `bin/add-new-release.sh content/com/github/seregamorph/maven-turbo-builder/maven-turbo-builder-0.9.buildspec 0.11` |
| <!-- 20250919140604 --> [maven-turbo-builder](../content/com/github/seregamorph/maven-turbo-builder/README.md) | [0.9](../content/com/github/seregamorph/maven-turbo-builder/maven-turbo-builder-0.9.buildspec) :white_check_mark: | 0.10  | `bin/add-new-release.sh content/com/github/seregamorph/maven-turbo-builder/maven-turbo-builder-0.9.buildspec ...` |
| <!-- 20250919080025 --> [io.wcm.tooling.commons.crx-packmgr-helper](../content/io/wcm/tooling/commons/crx-packmgr-helper/README.md) | [2.2.0](../content/io/wcm/tooling/commons/crx-packmgr-helper/wcm-crx-packmgr-helper-2.2.0.buildspec) :white_check_mark: | [2.3.0](../content/io/wcm/tooling/commons/crx-packmgr-helper/wcm-crx-packmgr-helper-2.3.0.buildspec) | `bin/add-new-release.sh content/io/wcm/tooling/commons/crx-packmgr-helper/wcm-crx-packmgr-helper-2.2.0.buildspec 2.3.0` |
| <!-- 20250919073131 --> [avaje-metrics-parent](../content/io/avaje/metrics/README.md) | [9.7](../content/io/avaje/metrics/avaje-metrics-9.7.buildspec) :white_check_mark: | [9.8](../content/io/avaje/metrics/avaje-metrics-9.8.buildspec) | `bin/add-new-release.sh content/io/avaje/metrics/avaje-metrics-9.7.buildspec 9.8` |
| <!-- 20250919013735 --> [pretty-formatter](../content/io/cucumber/pretty-formatter/README.md) | [2.2.0](../content/io/cucumber/pretty-formatter/pretty-formatter-2.2.0.buildspec) :white_check_mark: | [2.3.0](../content/io/cucumber/pretty-formatter/pretty-formatter-2.3.0.buildspec) | `bin/add-new-release.sh content/io/cucumber/pretty-formatter/pretty-formatter-2.2.0.buildspec 2.3.0` |
| <!-- 20250919011129 --> [avaje-validator-parent](../content/io/avaje/validator/README.md) | [2.14-RC1](../content/io/avaje/validator/avaje-validator-2.14-RC1.buildspec) :white_check_mark: | [2.14](../content/io/avaje/validator/avaje-validator-2.14.buildspec) | `bin/add-new-release.sh content/io/avaje/validator/avaje-validator-2.14-RC1.buildspec 2.14` |
| <!-- 20250918203544 --> [opentelemetry-sdk](../content/io/opentelemetry/java/README.md) | [1.54.0](../content/io/opentelemetry/java/opentelemetry-sdk-1.54.0.buildspec) :white_check_mark: | [1.54.1](../content/io/opentelemetry/java/opentelemetry-sdk-1.54.1.buildspec) | `bin/add-new-release.sh content/io/opentelemetry/java/opentelemetry-sdk-1.54.0.buildspec 1.54.1` |
...
| <!-- 20250917204334 --> [guava](../content/com/google/guava/README.md) | [33.4.8-jre](../content/com/google/guava/guava-33.4.8-jre.buildspec) :white_check_mark: | [33.5.0-jre](../content/com/google/guava/guava-33.5.0-jre.buildspec) | `bin/add-new-release.sh content/com/google/guava/guava-33.4.8-jre.buildspec 33.5.0-jre` |
| <!-- 20250917204334 --> [guava](../content/com/google/guava/README.md) | [33.4.8-jre](../content/com/google/guava/guava-33.4.8-jre.buildspec) :white_check_mark: | 33.5.0-android  | `bin/add-new-release.sh content/com/google/guava/guava-33.4.8-jre.buildspec ...` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20250824141836 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-parent](../content/org/apache/commons/parent/README.md) | [87](../content/org/apache/commons/parent/commons-parent-87.buildspec) :white_check_mark: | [88](../content/org/apache/commons/parent/commons-parent-88.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/parent/commons-parent-87.buildspec 88 staging` |
...
| <!-- 20250627071712 --> [:mailbox:](https://lists.apache.org/list?dev@stormcrawler.apache.org:lte=1M:VOTE) | [stormcrawler](../content/org/apache/stormcrawler/README.md) | [3.4.0](../content/org/apache/stormcrawler/stormcrawler-3.4.0.buildspec) :white_check_mark: | [3.5.0](../content/org/apache/stormcrawler/stormcrawler-3.5.0.buildspec)  | `bin/add-new-release.sh content/org/apache/stormcrawler/stormcrawler-3.4.0.buildspec 3.5.0 staging` |
...
| <!-- 20250909200335 --> [plotsquared-bukkit](../content/com/intellectualsites/plotsquared/plotsquared-bukkit/README.md) | [7.5.4](../content/com/intellectualsites/plotsquared/plotsquared-bukkit/plotsquared-7.5.4.buildspec) :x: | [7.5.7](../content/com/intellectualsites/plotsquared/plotsquared-bukkit/plotsquared-7.5.7.buildspec) | `bin/add-new-release.sh content/com/intellectualsites/plotsquared/plotsquared-bukkit/plotsquared-7.5.4.buildspec 7.5.7` |
