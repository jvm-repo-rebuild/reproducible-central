...
| ---------- | ---- | -- | ------- |
| <!-- 20250331170904 --> [nifi-api](../content/org/apache/nifi/nifi-api/README.md) | [2.0.0](../content/org/apache/nifi/nifi-api/nifi-api-2.0.0.buildspec) :white_check_mark: | [2.1.0](../content/org/apache/nifi/nifi-api/nifi-api-2.1.0.buildspec) | `bin/add-new-release.sh content/org/apache/nifi/nifi-api/nifi-api-2.0.0.buildspec 2.1.0` |
| <!-- 20250331145818 --> [sling-initial-content-transform-maven-plugin](../content/io/wcm/maven/plugins/sling-initial-content-transform-maven-plugin/README.md) | [1.1.4](../content/io/wcm/maven/plugins/sling-initial-content-transform-maven-plugin/sling-initial-content-transform-maven-plugin-1.1.4.buildspec) :white_check_mark: | [1.1.6](../content/io/wcm/maven/plugins/sling-initial-content-transform-maven-plugin/sling-initial-content-transform-maven-plugin-1.1.6.buildspec) | `bin/add-new-release.sh content/io/wcm/maven/plugins/sling-initial-content-transform-maven-plugin/sling-initial-content-transform-maven-plugin-1.1.4.buildspec 1.1.6` |
...
| <!-- 20250331085043 --> [airbase](../content/io/airlift/airbase/README.md) | [243](../content/io/airlift/airbase/airbase-243.buildspec) :white_check_mark: | [244](../content/io/airlift/airbase/airbase-244.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-243.buildspec 244` |
| <!-- 20250331062303 --> [byte-buddy-parent](../content/net/bytebuddy/README.md) | [1.17.4](../content/net/bytebuddy/byte-buddy-1.17.4.buildspec) :white_check_mark: | [1.17.5](../content/net/bytebuddy/byte-buddy-1.17.5.buildspec) | `bin/add-new-release.sh content/net/bytebuddy/byte-buddy-1.17.4.buildspec 1.17.5` |
| <!-- 20250331000446 --> [surefire](../content/org/apache/maven/surefire/README.md) | [3.5.2](../content/org/apache/maven/surefire/surefire-3.5.2.buildspec) :white_check_mark: | [3.5.3](../content/org/apache/maven/surefire/surefire-3.5.3.buildspec) | `bin/add-new-release.sh content/org/apache/maven/surefire/surefire-3.5.2.buildspec 3.5.3` |
| <!-- 20250330221558 --> [highcharts](../content/org/webjars/highcharts/README.md) | [12.1.0](../content/org/webjars/highcharts/highcharts-12.1.0.buildspec) :white_check_mark: | [12.1.2](../content/org/webjars/highcharts/highcharts-12.1.2.buildspec) | `bin/add-new-release.sh content/org/webjars/highcharts/highcharts-12.1.0.buildspec 12.1.2` |
| <!-- 20250330221118 --> [maven-plugin-testing](../content/org/apache/maven/plugin-testing/maven-plugin-testing/README.md) | [4.0.0-beta-3](../content/org/apache/maven/plugin-testing/maven-plugin-testing/maven-plugin-testing-4.0.0-beta-3.buildspec) :white_check_mark: | [4.0.0-beta-4](../content/org/apache/maven/plugin-testing/maven-plugin-testing/maven-plugin-testing-4.0.0-beta-4.buildspec) | `bin/add-new-release.sh content/org/apache/maven/plugin-testing/maven-plugin-testing/maven-plugin-testing-4.0.0-beta-3.buildspec 4.0.0-beta-4` |
| <!-- 20250330211434 --> [metrics-parent](../content/io/dropwizard/metrics5/README.md) | [5.0.0-rc24](../content/io/dropwizard/metrics5/dropwizard-metrics-5.0.0-rc24.buildspec) :white_check_mark: | [5.0.0-rc25](../content/io/dropwizard/metrics5/dropwizard-metrics-5.0.0-rc25.buildspec) | `bin/add-new-release.sh content/io/dropwizard/metrics5/dropwizard-metrics-5.0.0-rc24.buildspec 5.0.0-rc25` |
...
| <!-- 20250106182153 --> [rainbowgum-maven-parent](../content/io/jstach/rainbowgum/README.md) | [0.8.1](../content/io/jstach/rainbowgum/rainbowgum-0.8.1.buildspec) :white_check_mark: | 0.8.0 0.7.1 0.7.0 0.6.2 0.6.1 0.6.0 0.5.0 0.4.1 0.4.0  | `bin/add-new-release.sh content/io/jstach/rainbowgum/rainbowgum-0.8.1.buildspec ...` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20250331055158 --> [:mailbox:](https://lists.apache.org/list?dev@camel.apache.org:lte=1M:VOTE) | [camel](../content/org/apache/camel/camel/README.md) | [4.10.0](../content/org/apache/camel/camel/camel-4.10.0.buildspec) :x: | [4.11.0](../content/org/apache/camel/camel/camel-4.11.0.buildspec)  | `bin/add-new-release.sh content/org/apache/camel/camel/camel-4.10.0.buildspec 4.11.0 staging` |
...
| <!-- 20250331055158 --> [camel](../content/org/apache/camel/camel/README.md) | [4.10.0](../content/org/apache/camel/camel/camel-4.10.0.buildspec) :x: | [4.10.3](../content/org/apache/camel/camel/camel-4.10.3.buildspec) | `bin/add-new-release.sh content/org/apache/camel/camel/camel-4.10.0.buildspec 4.10.3` |
...
| <!-- 20250329210418 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.75.3](../content/org/finos/legend/engine/legend-engine-4.75.3.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.75.3` |
