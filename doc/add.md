...
| ---------- | ---- | -- | ------- |
| <!-- 20251102010935 --> [maven-lockfile](../content/io/github/chains-project/maven-lockfile/README.md) | [5.8.3-beta-1](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.8.3-beta-1.buildspec) :white_check_mark: | [5.8.3-beta-2](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.8.3-beta-2.buildspec) | `bin/add-new-release.sh content/io/github/chains-project/maven-lockfile/maven-lockfile-5.8.3-beta-1.buildspec 5.8.3-beta-2` |
| <!-- 20251102010935 --> [hibernate-reactive-core](../content/org/hibernate/reactive/hibernate-reactive/README.md) | [4.1.3.Final](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.1.3.Final.buildspec) :white_check_mark: | [4.1.4.Final](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.1.4.Final.buildspec) | `bin/add-new-release.sh content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.1.3.Final.buildspec 4.1.4.Final` |
| <!-- 20251102010935 --> [hibernate-reactive-core](../content/org/hibernate/reactive/hibernate-reactive/README.md) | [4.1.3.Final](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.1.3.Final.buildspec) :white_check_mark: | 3.1.7.Final 3.0.9.Final  | `bin/add-new-release.sh content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.1.3.Final.buildspec ...` |
| <!-- 20251102010622 --> [pretty-formatter](../content/io/cucumber/pretty-formatter/README.md) | [2.4.0](../content/io/cucumber/pretty-formatter/pretty-formatter-2.4.0.buildspec) :white_check_mark: | [2.4.1](../content/io/cucumber/pretty-formatter/pretty-formatter-2.4.1.buildspec) | `bin/add-new-release.sh content/io/cucumber/pretty-formatter/pretty-formatter-2.4.0.buildspec 2.4.1` |
...
| <!-- 20251101223934 --> [htmlcompressor-maven-plugin](../content/com/github/hazendaz/maven/htmlcompressor-maven-plugin/README.md) | [2.2.0](../content/com/github/hazendaz/maven/htmlcompressor-maven-plugin/htmlcompressor-maven-plugin-2.2.0.buildspec) :white_check_mark: | [2.3.0](../content/com/github/hazendaz/maven/htmlcompressor-maven-plugin/htmlcompressor-maven-plugin-2.3.0.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/maven/htmlcompressor-maven-plugin/htmlcompressor-maven-plugin-2.2.0.buildspec 2.3.0` |
| <!-- 20251101223934 --> [htmlcompressor-maven-plugin](../content/com/github/hazendaz/maven/htmlcompressor-maven-plugin/README.md) | [2.2.0](../content/com/github/hazendaz/maven/htmlcompressor-maven-plugin/htmlcompressor-maven-plugin-2.2.0.buildspec) :white_check_mark: | 1.12.0 1.10.2  | `bin/add-new-release.sh content/com/github/hazendaz/maven/htmlcompressor-maven-plugin/htmlcompressor-maven-plugin-2.2.0.buildspec ...` |
