...
| ---------- | ---- | -- | ------- |
| <!-- 20240925193950 --> [plexus](../content/org/codehaus/plexus/plexus-pom/README.md) | [18](../content/org/codehaus/plexus/plexus-pom/plexus-pom-18.buildspec) :white_check_mark: | [19](../content/org/codehaus/plexus/plexus-pom/plexus-pom-19.buildspec) | `bin/add-new-release.sh content/org/codehaus/plexus/plexus-pom/plexus-pom-18.buildspec 19` |
| <!-- 20240925191320 --> [nifi-nar-maven-plugin](../content/org/apache/nifi/nifi-nar-maven-plugin/README.md) | [2.0.0](../content/org/apache/nifi/nifi-nar-maven-plugin/nifi-nar-maven-plugin-2.0.0.buildspec) :white_check_mark: | [2.1.0](../content/org/apache/nifi/nifi-nar-maven-plugin/nifi-nar-maven-plugin-2.1.0.buildspec) | `bin/add-new-release.sh content/org/apache/nifi/nifi-nar-maven-plugin/nifi-nar-maven-plugin-2.0.0.buildspec 2.1.0` |
| <!-- 20240925172813 --> [jackrabbit-filevault](../content/org/apache/jackrabbit/filevault/README.md) | [3.8.0](../content/org/apache/jackrabbit/filevault/jackrabbit-filevault-3.8.0.buildspec) :white_check_mark: | [3.8.2](../content/org/apache/jackrabbit/filevault/jackrabbit-filevault-3.8.2.buildspec) | `bin/add-new-release.sh content/org/apache/jackrabbit/filevault/jackrabbit-filevault-3.8.0.buildspec 3.8.2` |
| <!-- 20240925115453 --> [qpid-jms-parent](../content/org/apache/qpid/jms/README.md) | [2.5.0](../content/org/apache/qpid/jms/qpid-jms-2.5.0.buildspec) :white_check_mark: | [2.6.0](../content/org/apache/qpid/jms/qpid-jms-2.6.0.buildspec) | `bin/add-new-release.sh content/org/apache/qpid/jms/qpid-jms-2.5.0.buildspec 2.6.0` |
| <!-- 20240925115453 --> [qpid-jms-parent](../content/org/apache/qpid/jms/README.md) | [2.5.0](../content/org/apache/qpid/jms/qpid-jms-2.5.0.buildspec) :white_check_mark: | 1.12.0  | `bin/add-new-release.sh content/org/apache/qpid/jms/qpid-jms-2.5.0.buildspec ...` |
| <!-- 20240925113805 --> [airbase](../content/io/airlift/airbase/README.md) | [178](../content/io/airlift/airbase/airbase-178.buildspec) :white_check_mark: | [179](../content/io/airlift/airbase/airbase-179.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-178.buildspec 179` |
| <!-- 20240925105312 --> [langchain4j](../content/dev/langchain4j/README.md) | [0.34.0](../content/dev/langchain4j/langchain4j-0.34.0.buildspec) :white_check_mark: | [0.35.0](../content/dev/langchain4j/langchain4j-0.35.0.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-0.34.0.buildspec 0.35.0` |
...
| <!-- 20240923145024 --> [scg-base](../content/io/telicent/smart-caches/graph/scg-base/README.md) | [0.82.1](../content/io/telicent/smart-caches/graph/scg-base/scg-base-0.82.1.buildspec) :white_check_mark: | 0.81.0  | `bin/add-new-release.sh content/io/telicent/smart-caches/graph/scg-base/scg-base-0.82.1.buildspec ...` |
| <!-- 20240923002654 --> [mybatis-velocity](../content/org/mybatis/scripting/mybatis-velocity/README.md) | [2.1.2](../content/org/mybatis/scripting/mybatis-velocity/mybatis-velocity-2.1.2.buildspec) :white_check_mark: | [2.2.0](../content/org/mybatis/scripting/mybatis-velocity/mybatis-velocity-2.2.0.buildspec) | `bin/add-new-release.sh content/org/mybatis/scripting/mybatis-velocity/mybatis-velocity-2.1.2.buildspec 2.2.0` |
...
| <!-- 20211230221852 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-archetype](../content/org/apache/maven/archetype/README.md) | [3.2.1](../content/org/apache/maven/archetype/archetype-3.2.1.buildspec) :white_check_mark: | [3.3.0](../content/org/apache/maven/archetype/archetype-3.3.0.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/archetype/archetype-3.2.1.buildspec 3.3.0 staging` |
...
| <!-- 20240918114814 --> [quarkus-project](../content/io/quarkus/README.md) | 3.15.0 :warning: |
