...
| ---------- | ---- | -- | ------- |
| <!-- 20251112205935 --> [protostream-aggregator](../content/org/infinispan/protostream/README.md) | [6.0.1](../content/org/infinispan/protostream/protostream-6.0.1.buildspec) :white_check_mark: | [6.0.2](../content/org/infinispan/protostream/protostream-6.0.2.buildspec) | `bin/add-new-release.sh content/org/infinispan/protostream/protostream-6.0.1.buildspec 6.0.2` |
| <!-- 20251112184522 --> [airbase](../content/io/airlift/airbase/README.md) | [327](../content/io/airlift/airbase/airbase-327.buildspec) :white_check_mark: | [328](../content/io/airlift/airbase/airbase-328.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-327.buildspec 328` |
| <!-- 20251112165949 --> [byte-buddy-parent](../content/net/bytebuddy/README.md) | [1.18.0](../content/net/bytebuddy/byte-buddy-1.18.0.buildspec) :white_check_mark: | [1.18.1](../content/net/bytebuddy/byte-buddy-1.18.1.buildspec) | `bin/add-new-release.sh content/net/bytebuddy/byte-buddy-1.18.0.buildspec 1.18.1` |
| <!-- 20251112151608 --> [jetty-project](../content/org/eclipse/jetty/jetty-project/README.md) | [12.1.3](../content/org/eclipse/jetty/jetty-project/jetty-project-12.1.3.buildspec) :white_check_mark: | [12.1.4](../content/org/eclipse/jetty/jetty-project/jetty-project-12.1.4.buildspec) | `bin/add-new-release.sh content/org/eclipse/jetty/jetty-project/jetty-project-12.1.3.buildspec 12.1.4` |
| <!-- 20251112151608 --> [jetty-project](../content/org/eclipse/jetty/jetty-project/README.md) | [12.1.3](../content/org/eclipse/jetty/jetty-project/jetty-project-12.1.3.buildspec) :white_check_mark: | 12.0.30  | `bin/add-new-release.sh content/org/eclipse/jetty/jetty-project/jetty-project-12.1.3.buildspec ...` |
| <!-- 20251112141105 --> [ratis](../content/org/apache/ratis/README.md) | [3.2.0](../content/org/apache/ratis/ratis-3.2.0.buildspec) :white_check_mark: | [3.2.1](../content/org/apache/ratis/ratis-3.2.1.buildspec) | `bin/add-new-release.sh content/org/apache/ratis/ratis-3.2.0.buildspec 3.2.1` |
| <!-- 20251112132042 --> [toolbox](../content/eu/maveniverse/maven/toolbox/README.md) | [0.14.4](../content/eu/maveniverse/maven/toolbox/toolbox-0.14.4.buildspec) :white_check_mark: | [0.14.5](../content/eu/maveniverse/maven/toolbox/toolbox-0.14.5.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/toolbox/toolbox-0.14.4.buildspec 0.14.5` |
| <!-- 20251112113535 --> [test-distribution](../content/com/github/seregamorph/test-distribution/README.md) | [0.8](../content/com/github/seregamorph/test-distribution/test-distribution-0.8.buildspec) :white_check_mark: | [0.9](../content/com/github/seregamorph/test-distribution/test-distribution-0.9.buildspec) | `bin/add-new-release.sh content/com/github/seregamorph/test-distribution/test-distribution-0.8.buildspec 0.9` |
| <!-- 20251111213535 --> [makeself-maven-plugin](../content/com/github/hazendaz/maven/makeself-maven-plugin/README.md) | [1.9.2](../content/com/github/hazendaz/maven/makeself-maven-plugin/makeself-maven-plugin-1.9.2.buildspec) :white_check_mark: | [1.10.0](../content/com/github/hazendaz/maven/makeself-maven-plugin/makeself-maven-plugin-1.10.0.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/maven/makeself-maven-plugin/makeself-maven-plugin-1.9.2.buildspec 1.10.0` |
...
| <!-- 20250927052831 --> [:mailbox:](https://lists.apache.org/list?dev@pulsar.apache.org:lte=1M:VOTE) | [pulsar](../content/org/apache/pulsar/README.md) | [4.1.1](../content/org/apache/pulsar/pulsar-4.1.1.buildspec) :x: | [4.1.2](../content/org/apache/pulsar/pulsar-4.1.2.buildspec)  | `bin/add-new-release.sh content/org/apache/pulsar/pulsar-4.1.1.buildspec 4.1.2 staging` |
...
| <!-- 20250322053711 --> [:mailbox:](https://lists.apache.org/list?dev@karaf.apache.org:lte=1M:VOTE) | [decanter](../content/org/apache/karaf/decanter/README.md) | [2.11.0](../content/org/apache/karaf/decanter/karaf-decanter-2.11.0.buildspec) :white_check_mark: | [2.12.0](../content/org/apache/karaf/decanter/karaf-decanter-2.12.0.buildspec)  | `bin/add-new-release.sh content/org/apache/karaf/decanter/karaf-decanter-2.11.0.buildspec 2.12.0 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20251112142227 --> [quarkus-project](../content/io/quarkus/README.md) | [3.29.2](../content/io/quarkus/quarkus-3.29.2.buildspec) :warning: | [3.30.0.CR1](../content/io/quarkus/quarkus-3.30.0.CR1.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.29.2.buildspec 3.30.0.CR1` |
| <!-- 20251112113336 --> [jandex-parent](../content/io/smallrye/jandex/README.md) | [3.5.1](../content/io/smallrye/jandex/jandex-3.5.1.buildspec) :warning: | [3.5.2](../content/io/smallrye/jandex/jandex-3.5.2.buildspec) | `bin/add-new-release.sh content/io/smallrye/jandex/jandex-3.5.1.buildspec 3.5.2` |
| <!-- 20251110071934 --> [jpmml-sparkml](../content/org/jpmml/jpmml-sparkml/README.md) | [3.2.2](../content/org/jpmml/jpmml-sparkml/jpmml-sparkml-3.2.2.buildspec) :warning: | [3.2.3](../content/org/jpmml/jpmml-sparkml/jpmml-sparkml-3.2.3.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-sparkml/jpmml-sparkml-3.2.2.buildspec 3.2.3` |
