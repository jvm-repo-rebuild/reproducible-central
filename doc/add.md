...
| ---------- | ---- | -- | ------- |
| <!-- 20241201174214 --> [flexmonster](../content/org/webjars/flexmonster/README.md) | [2.9.90](../content/org/webjars/flexmonster/flexmonster-2.9.90.buildspec) :white_check_mark: | [2.9.91](../content/org/webjars/flexmonster/flexmonster-2.9.91.buildspec) | `bin/add-new-release.sh content/org/webjars/flexmonster/flexmonster-2.9.90.buildspec 2.9.91` |
...
| <!-- 20241201080138 --> [jpmml-r](../content/org/jpmml/jpmml-r/README.md) | [1.6.1](../content/org/jpmml/jpmml-r/jpmml-r-1.6.1.buildspec) :white_check_mark: | [1.6.2](../content/org/jpmml/jpmml-r/jpmml-r-1.6.2.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-r/jpmml-r-1.6.1.buildspec 1.6.2` |
| <!-- 20241201021754 --> [spoon-core](../content/fr/inria/gforge/spoon/spoon-core/README.md) | [11.1.1-beta-15](../content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.1.1-beta-15.buildspec) :white_check_mark: | [11.1.1-beta-16](../content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.1.1-beta-16.buildspec) | `bin/add-new-release.sh content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.1.1-beta-15.buildspec 11.1.1-beta-16` |
| <!-- 20241129223740 --> [avaje-jex-parent](../content/io/avaje/jex/README.md) | [3.0-RC1](../content/io/avaje/jex/avaje-jex-3.0-RC1.buildspec) :white_check_mark: | [3.0-RC4](../content/io/avaje/jex/avaje-jex-3.0-RC4.buildspec) | `bin/add-new-release.sh content/io/avaje/jex/avaje-jex-3.0-RC1.buildspec 3.0-RC4` |
| <!-- 20241129223740 --> [avaje-jex-parent](../content/io/avaje/jex/README.md) | [3.0-RC1](../content/io/avaje/jex/avaje-jex-3.0-RC1.buildspec) :white_check_mark: | 3.0-RC3 3.0-RC2  | `bin/add-new-release.sh content/io/avaje/jex/avaje-jex-3.0-RC1.buildspec ...` |
...
| <!-- 20230508180933 --> [:mailbox:](https://lists.apache.org/list?dev@cxf.apache.org:lte=1M:VOTE) | [cxf-build-utils](../content/org/apache/cxf/cxf-build-utils/README.md) | [4.0.1](../content/org/apache/cxf/cxf-build-utils/cxf-build-utils-4.0.1.buildspec) :white_check_mark: | [4.0.2](../content/org/apache/cxf/cxf-build-utils/cxf-build-utils-4.0.2.buildspec)  | `bin/add-new-release.sh content/org/apache/cxf/cxf-build-utils/cxf-build-utils-4.0.1.buildspec 4.0.2 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20241128212009 --> [quarkus-project](../content/io/quarkus/README.md) | [3.17.1](../content/io/quarkus/quarkus-3.17.1.buildspec) :warning: [:memo:](https://github.com/quarkusio/quarkus/pull/44671) | [3.17.2](../content/io/quarkus/quarkus-3.17.2.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.17.1.buildspec 3.17.2` |
...
| <!-- 20241127104543 --> [avaje-http-parent](../content/io/avaje/http/README.md) | [2.9-RC1](../content/io/avaje/http/avaje-http-2.9-RC1.buildspec) :warning: | [2.9-RC2](../content/io/avaje/http/avaje-http-2.9-RC2.buildspec) | `bin/add-new-release.sh content/io/avaje/http/avaje-http-2.9-RC1.buildspec 2.9-RC2` |
