...
| ---------- | ---- | -- | ------- |
| <!-- 20250708162540 --> [airbase](../content/io/airlift/airbase/README.md) | [276](../content/io/airlift/airbase/airbase-276.buildspec) :white_check_mark: | [277](../content/io/airlift/airbase/airbase-277.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-276.buildspec 277` |
| <!-- 20250708161145 --> [takari-lifecycle-plugin](../content/io/takari/maven/plugins/takari-lifecycle-plugin/README.md) | [2.3.1](../content/io/takari/maven/plugins/takari-lifecycle-plugin/takari-lifecycle-plugin-2.3.1.buildspec) :white_check_mark: | [2.3.2](../content/io/takari/maven/plugins/takari-lifecycle-plugin/takari-lifecycle-plugin-2.3.2.buildspec) | `bin/add-new-release.sh content/io/takari/maven/plugins/takari-lifecycle-plugin/takari-lifecycle-plugin-2.3.1.buildspec 2.3.2` |
| <!-- 20250708160742 --> [njord](../content/eu/maveniverse/maven/njord/README.md) | [0.8.0](../content/eu/maveniverse/maven/njord/njord-0.8.0.buildspec) :white_check_mark: | [0.8.2](../content/eu/maveniverse/maven/njord/njord-0.8.2.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/njord/njord-0.8.0.buildspec 0.8.2` |
| <!-- 20250708160742 --> [njord](../content/eu/maveniverse/maven/njord/README.md) | [0.8.0](../content/eu/maveniverse/maven/njord/njord-0.8.0.buildspec) :white_check_mark: | 0.8.1  | `bin/add-new-release.sh content/eu/maveniverse/maven/njord/njord-0.8.0.buildspec ...` |
| <!-- 20250708041428 --> [orc](../content/org/apache/orc/README.md) | [2.1.2](../content/org/apache/orc/orc-2.1.2.buildspec) :white_check_mark: | 2.0.6  | `bin/add-new-release.sh content/org/apache/orc/orc-2.1.2.buildspec ...` |
| <!-- 20250708011938 --> [oss-parent](../content/com/fasterxml/oss-parent/README.md) | [68](../content/com/fasterxml/oss-parent/oss-parent-68.buildspec) :white_check_mark: | [69](../content/com/fasterxml/oss-parent/oss-parent-69.buildspec) | `bin/add-new-release.sh content/com/fasterxml/oss-parent/oss-parent-68.buildspec 69` |
| <!-- 20250707211943 --> [rockcraft-parent](../content/io/github/rockcrafters/plugins/README.md) | [1.1.2](../content/io/github/rockcrafters/plugins/rockcraft-parent-1.1.2.buildspec) :white_check_mark: | [1.1.3](../content/io/github/rockcrafters/plugins/rockcraft-parent-1.1.3.buildspec) | `bin/add-new-release.sh content/io/github/rockcrafters/plugins/rockcraft-parent-1.1.2.buildspec 1.1.3` |
...
| <!-- 20250706011135 --> [hibernate-reactive-core](../content/org/hibernate/reactive/hibernate-reactive/README.md) | [4.0.0.Beta1](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.0.0.Beta1.buildspec) :white_check_mark: | 3.0.3.Final 3.0.2.Final  | `bin/add-new-release.sh content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.0.0.Beta1.buildspec ...` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20250708041428 --> [:mailbox:](https://lists.apache.org/list?dev@orc.apache.org:lte=1M:VOTE) | [orc](../content/org/apache/orc/README.md) | [2.1.2](../content/org/apache/orc/orc-2.1.2.buildspec) :white_check_mark: | [2.1.3](../content/org/apache/orc/orc-2.1.3.buildspec)  | `bin/add-new-release.sh content/org/apache/orc/orc-2.1.2.buildspec 2.1.3 staging` |
...
| <!-- 20250707090342 --> [avaje-jex-parent](../content/io/avaje/jex/README.md) | [3.2](../content/io/avaje/jex/avaje-jex-3.2.buildspec) :warning: | [3.3-RC1](../content/io/avaje/jex/avaje-jex-3.3-RC1.buildspec) | `bin/add-new-release.sh content/io/avaje/jex/avaje-jex-3.2.buildspec 3.3-RC1` |
| <!-- 20250707085541 --> [java-sql-parent](../content/com/github/nbbrd/java-sql-util/README.md) | [1.0.6](../content/com/github/nbbrd/java-sql-util/java-sql-util-1.0.6.buildspec) :warning: | [1.0.7](../content/com/github/nbbrd/java-sql-util/java-sql-util-1.0.7.buildspec) | `bin/add-new-release.sh content/com/github/nbbrd/java-sql-util/java-sql-util-1.0.6.buildspec 1.0.7` |
...
| <!-- 20250702003344 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.89.4](../content/org/finos/legend/engine/legend-engine-4.89.4.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.89.4` |
...
| <!-- 20250702082300 --> [quarkus-project](../content/io/quarkus/README.md) | 3.24.2 :warning: [:memo:](https://github.com/quarkusio/quarkus/pull/44671) |
