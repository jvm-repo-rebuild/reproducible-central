...
| ---------- | ---- | -- | ------- |
| <!-- 20250324180048 --> [airbase](../content/io/airlift/airbase/README.md) | [238](../content/io/airlift/airbase/airbase-238.buildspec) :white_check_mark: | [241](../content/io/airlift/airbase/airbase-241.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-238.buildspec 241` |
| <!-- 20250324180048 --> [airbase](../content/io/airlift/airbase/README.md) | [238](../content/io/airlift/airbase/airbase-238.buildspec) :white_check_mark: | 240 239  | `bin/add-new-release.sh content/io/airlift/airbase/airbase-238.buildspec ...` |
| <!-- 20250324105813 --> [error-prone-support](../content/tech/picnic/error-prone-support/error-prone-support/README.md) | [0.20.0](../content/tech/picnic/error-prone-support/error-prone-support/error-prone-support-0.20.0.buildspec) :white_check_mark: | [0.21.0](../content/tech/picnic/error-prone-support/error-prone-support/error-prone-support-0.21.0.buildspec) | `bin/add-new-release.sh content/tech/picnic/error-prone-support/error-prone-support/error-prone-support-0.20.0.buildspec 0.21.0` |
| <!-- 20250324065034 --> [junit-bom](../content/org/junit/junit5/README.md) | [5.13.0-M1](../content/org/junit/junit5/junit5-5.13.0-M1.buildspec) :white_check_mark: | [5.13.0-M2](../content/org/junit/junit5/junit5-5.13.0-M2.buildspec) | `bin/add-new-release.sh content/org/junit/junit5/junit5-5.13.0-M1.buildspec 5.13.0-M2` |
| <!-- 20250323220810 --> [byte-buddy-parent](../content/net/bytebuddy/README.md) | [1.17.3](../content/net/bytebuddy/byte-buddy-1.17.3.buildspec) :white_check_mark: | [1.17.4](../content/net/bytebuddy/byte-buddy-1.17.4.buildspec) | `bin/add-new-release.sh content/net/bytebuddy/byte-buddy-1.17.3.buildspec 1.17.4` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250324175424 --> [maven-lockfile](../content/io/github/chains-project/maven-lockfile/README.md) | [5.4.1](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.4.1.buildspec) :warning: | [5.4.2](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.4.2.buildspec) | `bin/add-new-release.sh content/io/github/chains-project/maven-lockfile/maven-lockfile-5.4.1.buildspec 5.4.2` |
