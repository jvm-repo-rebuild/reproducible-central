...
| ---------- | ---- | -- | ------- |
| <!-- 20240905155246 --> [java-spdx-library](../content/org/spdx/java-spdx-library/README.md) | [1.1.12](../content/org/spdx/java-spdx-library/java-spdx-library-1.1.12.buildspec) :white_check_mark: | [2.0.0-Alpha](../content/org/spdx/java-spdx-library/java-spdx-library-2.0.0-Alpha.buildspec) | `bin/add-new-release.sh content/org/spdx/java-spdx-library/java-spdx-library-1.1.12.buildspec 2.0.0-Alpha` |
| <!-- 20240905085221 --> [pomchecker](../content/org/kordamp/pomchecker/README.md) | [1.12.0](../content/org/kordamp/pomchecker/pomchecker-1.12.0.buildspec) :white_check_mark: | [1.13.0](../content/org/kordamp/pomchecker/pomchecker-1.13.0.buildspec) | `bin/add-new-release.sh content/org/kordamp/pomchecker/pomchecker-1.12.0.buildspec 1.13.0` |
| <!-- 20240905021007 --> [spotbugs-maven-plugin](../content/com/github/spotbugs/spotbugs-maven-plugin/README.md) | [4.8.6.2](../content/com/github/spotbugs/spotbugs-maven-plugin/spotbugs-maven-plugin-4.8.6.2.buildspec) :white_check_mark: | [4.8.6.3](../content/com/github/spotbugs/spotbugs-maven-plugin/spotbugs-maven-plugin-4.8.6.3.buildspec) | `bin/add-new-release.sh content/com/github/spotbugs/spotbugs-maven-plugin/spotbugs-maven-plugin-4.8.6.2.buildspec 4.8.6.3` |
| <!-- 20240905013934 --> [htmlcompressor-maven-plugin](../content/com/github/hazendaz/maven/htmlcompressor-maven-plugin/README.md) | [2.0.2](../content/com/github/hazendaz/maven/htmlcompressor-maven-plugin/htmlcompressor-maven-plugin-2.0.2.buildspec) :white_check_mark: | [2.1.0](../content/com/github/hazendaz/maven/htmlcompressor-maven-plugin/htmlcompressor-maven-plugin-2.1.0.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/maven/htmlcompressor-maven-plugin/htmlcompressor-maven-plugin-2.0.2.buildspec 2.1.0` |
| <!-- 20240905005333 --> [yuicompressor-maven-plugin](../content/com/github/hazendaz/maven/yuicompressor-maven-plugin/README.md) | [2.0.1](../content/com/github/hazendaz/maven/yuicompressor-maven-plugin/yuicompressor-maven-plugin-2.0.1.buildspec) :white_check_mark: | [2.1.0](../content/com/github/hazendaz/maven/yuicompressor-maven-plugin/yuicompressor-maven-plugin-2.1.0.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/maven/yuicompressor-maven-plugin/yuicompressor-maven-plugin-2.0.1.buildspec 2.1.0` |
| <!-- 20240905002955 --> [impsort-maven-plugin](../content/net/revelc/code/impsort-maven-plugin/README.md) | [1.11.0](../content/net/revelc/code/impsort-maven-plugin/impsort-maven-plugin-1.11.0.buildspec) :white_check_mark: | [1.12.0](../content/net/revelc/code/impsort-maven-plugin/impsort-maven-plugin-1.12.0.buildspec) | `bin/add-new-release.sh content/net/revelc/code/impsort-maven-plugin/impsort-maven-plugin-1.11.0.buildspec 1.12.0` |
| <!-- 20240904233232 --> [whitespace-maven-plugin](../content/com/github/hazendaz/maven/whitespace-maven-plugin/README.md) | [1.3.2](../content/com/github/hazendaz/maven/whitespace-maven-plugin/whitespace-maven-plugin-1.3.2.buildspec) :white_check_mark: | [1.4.0](../content/com/github/hazendaz/maven/whitespace-maven-plugin/whitespace-maven-plugin-1.4.0.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/maven/whitespace-maven-plugin/whitespace-maven-plugin-1.3.2.buildspec 1.4.0` |
...
| <!-- 20240905060651 --> [org.apache.sling.scripting.core](../content/org/apache/sling/org.apache.sling.scripting.core/README.md) | [2.4.8](../content/org/apache/sling/org.apache.sling.scripting.core/org.apache.sling.scripting.core-2.4.8.buildspec) :warning: | [2.4.10](../content/org/apache/sling/org.apache.sling.scripting.core/org.apache.sling.scripting.core-2.4.10.buildspec) | `bin/add-new-release.sh content/org/apache/sling/org.apache.sling.scripting.core/org.apache.sling.scripting.core-2.4.8.buildspec 2.4.10` |
