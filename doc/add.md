...
| ---------- | ---- | -- | ------- |
| <!-- 20250418175809 --> [airbase](../content/io/airlift/airbase/README.md) | [252](../content/io/airlift/airbase/airbase-252.buildspec) :white_check_mark: | [253](../content/io/airlift/airbase/airbase-253.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-252.buildspec 253` |
| <!-- 20250418115419 --> [mada-style-gradle](../content/dk/mada/style/mada-style-gradle/README.md) | [1.1.3](../content/dk/mada/style/mada-style-gradle/mada-style-gradle-1.1.3.buildspec) :white_check_mark: | [1.1.4](../content/dk/mada/style/mada-style-gradle/mada-style-gradle-1.1.4.buildspec) | `bin/add-new-release.sh content/dk/mada/style/mada-style-gradle/mada-style-gradle-1.1.3.buildspec 1.1.4` |
| <!-- 20250418054639 --> [maven-dependency-analyzer](../content/org/apache/maven/shared/maven-dependency-analyzer/README.md) | [1.15.1](../content/org/apache/maven/shared/maven-dependency-analyzer/maven-dependency-analyzer-1.15.1.buildspec) :white_check_mark: | [1.16.0](../content/org/apache/maven/shared/maven-dependency-analyzer/maven-dependency-analyzer-1.16.0.buildspec) | `bin/add-new-release.sh content/org/apache/maven/shared/maven-dependency-analyzer/maven-dependency-analyzer-1.15.1.buildspec 1.16.0` |
| <!-- 20250418003439 --> [spdx-java-core](../content/org/spdx/spdx-java-core/README.md) | [1.0.0-RC2](../content/org/spdx/spdx-java-core/spdx-java-core-1.0.0-RC2.buildspec) :white_check_mark: | [1.0.0](../content/org/spdx/spdx-java-core/spdx-java-core-1.0.0.buildspec) | `bin/add-new-release.sh content/org/spdx/spdx-java-core/spdx-java-core-1.0.0-RC2.buildspec 1.0.0` |
| <!-- 20250417131445 --> [oras-java-sdk](../content/land/oras/oras-java-sdk/README.md) | [0.2.2](../content/land/oras/oras-java-sdk/oras-java-sdk-0.2.2.buildspec) :white_check_mark: | [0.2.5](../content/land/oras/oras-java-sdk/oras-java-sdk-0.2.5.buildspec) | `bin/add-new-release.sh content/land/oras/oras-java-sdk/oras-java-sdk-0.2.2.buildspec 0.2.5` |
| <!-- 20250417131445 --> [oras-java-sdk](../content/land/oras/oras-java-sdk/README.md) | [0.2.2](../content/land/oras/oras-java-sdk/oras-java-sdk-0.2.2.buildspec) :white_check_mark: | 0.2.4 0.2.3  | `bin/add-new-release.sh content/land/oras/oras-java-sdk/oras-java-sdk-0.2.2.buildspec ...` |
| <!-- 20250417123842 --> [paimon-parent](../content/org/apache/paimon/README.md) | [1.0.1](../content/org/apache/paimon/paimon-parent-1.0.1.buildspec) :white_check_mark: | [1.1.0](../content/org/apache/paimon/paimon-parent-1.1.0.buildspec) | `bin/add-new-release.sh content/org/apache/paimon/paimon-parent-1.0.1.buildspec 1.1.0` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20250409192255 --> [:mailbox:](https://lists.apache.org/list?dev@shiro.apache.org:lte=1M:VOTE) | [shiro-root](../content/org/apache/shiro/README.md) | [2.0.3](../content/org/apache/shiro/shiro-2.0.3.buildspec) :white_check_mark: | [2.0.4](../content/org/apache/shiro/shiro-2.0.4.buildspec)  | `bin/add-new-release.sh content/org/apache/shiro/shiro-2.0.3.buildspec 2.0.4 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250418170042 --> [yupiik-tools-maven-plugin-parent](../content/io/yupiik/maven/plugin/README.md) | [1.2.5](../content/io/yupiik/maven/plugin/yupiik-tools-maven-plugin-1.2.5.buildspec) :warning: | [1.2.6](../content/io/yupiik/maven/plugin/yupiik-tools-maven-plugin-1.2.6.buildspec) | `bin/add-new-release.sh content/io/yupiik/maven/plugin/yupiik-tools-maven-plugin-1.2.5.buildspec 1.2.6` |
