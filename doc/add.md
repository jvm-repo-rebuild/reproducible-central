...
| ---------- | ---- | -- | ------- |
| <!-- 20251128192322 --> [jackson-datatypes-misc-parent](../content/tools/jackson/datatype/jackson-datatypes-misc-parent/README.md) | [3.0.2](../content/tools/jackson/datatype/jackson-datatypes-misc-parent/jackson-datatypes-misc-parent-3.0.2.buildspec) :white_check_mark: | [3.0.3](../content/tools/jackson/datatype/jackson-datatypes-misc-parent/jackson-datatypes-misc-parent-3.0.3.buildspec) | `bin/add-new-release.sh content/tools/jackson/datatype/jackson-datatypes-misc-parent/jackson-datatypes-misc-parent-3.0.2.buildspec 3.0.3` |
| <!-- 20251128192321 --> [jackson-datatype-joda](../content/tools/jackson/datatype/jackson-datatype-joda/README.md) | [3.0.2](../content/tools/jackson/datatype/jackson-datatype-joda/jackson-datatype-joda-3.0.2.buildspec) :white_check_mark: | [3.0.3](../content/tools/jackson/datatype/jackson-datatype-joda/jackson-datatype-joda-3.0.3.buildspec) | `bin/add-new-release.sh content/tools/jackson/datatype/jackson-datatype-joda/jackson-datatype-joda-3.0.2.buildspec 3.0.3` |
| <!-- 20251128192119 --> [jackson-datatypes-collections](../content/tools/jackson/datatype/jackson-datatypes-collections/README.md) | [3.0.2](../content/tools/jackson/datatype/jackson-datatypes-collections/jackson-datatypes-collections-3.0.2.buildspec) :white_check_mark: | [3.0.3](../content/tools/jackson/datatype/jackson-datatypes-collections/jackson-datatypes-collections-3.0.3.buildspec) | `bin/add-new-release.sh content/tools/jackson/datatype/jackson-datatypes-collections/jackson-datatypes-collections-3.0.2.buildspec 3.0.3` |
| <!-- 20251128191514 --> [jackson-dataformat-xml](../content/tools/jackson/dataformat/jackson-dataformat-xml/README.md) | [3.0.2](../content/tools/jackson/dataformat/jackson-dataformat-xml/jackson-dataformat-xml-3.0.2.buildspec) :white_check_mark: | [3.0.3](../content/tools/jackson/dataformat/jackson-dataformat-xml/jackson-dataformat-xml-3.0.3.buildspec) | `bin/add-new-release.sh content/tools/jackson/dataformat/jackson-dataformat-xml/jackson-dataformat-xml-3.0.2.buildspec 3.0.3` |
| <!-- 20251128191319 --> [jackson-dataformats-text](../content/tools/jackson/dataformat/jackson-dataformats-text/README.md) | [3.0.2](../content/tools/jackson/dataformat/jackson-dataformats-text/jackson-dataformats-text-3.0.2.buildspec) :white_check_mark: | [3.0.3](../content/tools/jackson/dataformat/jackson-dataformats-text/jackson-dataformats-text-3.0.3.buildspec) | `bin/add-new-release.sh content/tools/jackson/dataformat/jackson-dataformats-text/jackson-dataformats-text-3.0.2.buildspec 3.0.3` |
| <!-- 20251128191318 --> [jackson-dataformats-binary](../content/tools/jackson/dataformat/jackson-dataformats-binary/README.md) | [3.0.2](../content/tools/jackson/dataformat/jackson-dataformats-binary/jackson-dataformats-binary-3.0.2.buildspec) :white_check_mark: | [3.0.3](../content/tools/jackson/dataformat/jackson-dataformats-binary/jackson-dataformats-binary-3.0.3.buildspec) | `bin/add-new-release.sh content/tools/jackson/dataformat/jackson-dataformats-binary/jackson-dataformats-binary-3.0.2.buildspec 3.0.3` |
| <!-- 20251128185915 --> [jackson-jr-parent](../content/tools/jackson/jr/README.md) | [3.0.2](../content/tools/jackson/jr/jackson-jr-3.0.2.buildspec) :white_check_mark: | [3.0.3](../content/tools/jackson/jr/jackson-jr-3.0.3.buildspec) | `bin/add-new-release.sh content/tools/jackson/jr/jackson-jr-3.0.2.buildspec 3.0.3` |
| <!-- 20251128185714 --> [jackson-databind](../content/tools/jackson/core/jackson-databind/README.md) | [3.0.2](../content/tools/jackson/core/jackson-databind/jackson-databind-3.0.2.buildspec) :white_check_mark: | [3.0.3](../content/tools/jackson/core/jackson-databind/jackson-databind-3.0.3.buildspec) | `bin/add-new-release.sh content/tools/jackson/core/jackson-databind/jackson-databind-3.0.2.buildspec 3.0.3` |
| <!-- 20251128185314 --> [jackson-core](../content/tools/jackson/core/jackson-core/README.md) | [3.0.2](../content/tools/jackson/core/jackson-core/jackson-core-3.0.2.buildspec) :white_check_mark: | [3.0.3](../content/tools/jackson/core/jackson-core/jackson-core-3.0.3.buildspec) | `bin/add-new-release.sh content/tools/jackson/core/jackson-core/jackson-core-3.0.2.buildspec 3.0.3` |
| <!-- 20251128184711 --> [jackson-bom](../content/tools/jackson/jackson-bom/README.md) | [3.0.2](../content/tools/jackson/jackson-bom/jackson-bom-3.0.2.buildspec) :white_check_mark: | [3.0.3](../content/tools/jackson/jackson-bom/jackson-bom-3.0.3.buildspec) | `bin/add-new-release.sh content/tools/jackson/jackson-bom/jackson-bom-3.0.2.buildspec 3.0.3` |
| <!-- 20251128171115 --> [micrometer-jfr](../content/com/github/marschall/micrometer-jfr/README.md) | [1.13.0](../content/com/github/marschall/micrometer-jfr/micrometer-jfr-1.13.0.buildspec) :white_check_mark: | [1.16.1](../content/com/github/marschall/micrometer-jfr/micrometer-jfr-1.16.1.buildspec) | `bin/add-new-release.sh content/com/github/marschall/micrometer-jfr/micrometer-jfr-1.13.0.buildspec 1.16.1` |
| <!-- 20251128160534 --> [maven-war-plugin](../content/org/apache/maven/plugins/maven-war-plugin/README.md) | [3.5.0](../content/org/apache/maven/plugins/maven-war-plugin/maven-war-plugin-3.5.0.buildspec) :white_check_mark: | [3.5.1](../content/org/apache/maven/plugins/maven-war-plugin/maven-war-plugin-3.5.1.buildspec) | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-war-plugin/maven-war-plugin-3.5.0.buildspec 3.5.1` |
| <!-- 20251128115117 --> [jena-kafka](../content/io/telicent/jena/jena-kafka/README.md) | [2.2.0](../content/io/telicent/jena/jena-kafka/jena-kafka-2.2.0.buildspec) :white_check_mark: | [2.3.0](../content/io/telicent/jena/jena-kafka/jena-kafka-2.3.0.buildspec) | `bin/add-new-release.sh content/io/telicent/jena/jena-kafka/jena-kafka-2.2.0.buildspec 2.3.0` |
| <!-- 20251128113521 --> [pmd](../content/net/sourceforge/pmd/README.md) | [7.18.0](../content/net/sourceforge/pmd/pmd-7.18.0.buildspec) :white_check_mark: | [7.19.0](../content/net/sourceforge/pmd/pmd-7.19.0.buildspec) | `bin/add-new-release.sh content/net/sourceforge/pmd/pmd-7.18.0.buildspec 7.19.0` |
| <!-- 20251128090916 --> [langchain4j](../content/dev/langchain4j/README.md) | [1.9.0](../content/dev/langchain4j/langchain4j-1.9.0.buildspec) :white_check_mark: | [1.9.1](../content/dev/langchain4j/langchain4j-1.9.1.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-1.9.0.buildspec 1.9.1` |
| <!-- 20251128080131 --> [mina-parent](../content/org/apache/mina/README.md) | [2.2.4](../content/org/apache/mina/mina-2.2.4.buildspec) :white_check_mark: | [2.2.5](../content/org/apache/mina/mina-2.2.5.buildspec) | `bin/add-new-release.sh content/org/apache/mina/mina-2.2.4.buildspec 2.2.5` |
| <!-- 20251128074000 --> [feature-launcher-maven-plugin](../content/org/apache/sling/feature-launcher-maven-plugin/README.md) | [0.1.10](../content/org/apache/sling/feature-launcher-maven-plugin/feature-launcher-maven-plugin-0.1.10.buildspec) :white_check_mark: | [1.0.0](../content/org/apache/sling/feature-launcher-maven-plugin/feature-launcher-maven-plugin-1.0.0.buildspec) | `bin/add-new-release.sh content/org/apache/sling/feature-launcher-maven-plugin/feature-launcher-maven-plugin-0.1.10.buildspec 1.0.0` |
| <!-- 20251127192119 --> [pmd-designer](../content/net/sourceforge/pmd/pmd-designer/README.md) | [7.19.1](../content/net/sourceforge/pmd/pmd-designer/pmd-designer-7.19.1.buildspec) :white_check_mark: | 7.19.0  | `bin/add-new-release.sh content/net/sourceforge/pmd/pmd-designer/pmd-designer-7.19.1.buildspec ...` |
| <!-- 20251126213519 --> [byte-buddy-parent](../content/net/bytebuddy/README.md) | [1.18.1](../content/net/bytebuddy/byte-buddy-1.18.1.buildspec) :white_check_mark: | [1.18.2](../content/net/bytebuddy/byte-buddy-1.18.2.buildspec) | `bin/add-new-release.sh content/net/bytebuddy/byte-buddy-1.18.1.buildspec 1.18.2` |
| <!-- 20251119232606 --> [avaje-jsonb-parent](../content/io/avaje/jsonb/README.md) | [3.8](../content/io/avaje/jsonb/avaje-jsonb-3.8.buildspec) :white_check_mark: | [3.9-RC1](../content/io/avaje/jsonb/avaje-jsonb-3.9-RC1.buildspec) | `bin/add-new-release.sh content/io/avaje/jsonb/avaje-jsonb-3.8.buildspec 3.9-RC1` |
...
<!-- BEGIN GENERATED MISSING DIFFOSCOPE -->
      content/org/apache/pulsar/pulsar-4.1.2.buildspec
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20251118135548 --> [:mailbox:](https://lists.apache.org/list?dev@sling.apache.org:lte=1M:VOTE) | [org.apache.sling.servlets.resolver](../content/org/apache/sling/org.apache.sling.servlets.resolver/README.md) | [3.0.2](../content/org/apache/sling/org.apache.sling.servlets.resolver/org.apache.sling.servlets.resolver-3.0.2.buildspec) :white_check_mark: | [3.0.4](../content/org/apache/sling/org.apache.sling.servlets.resolver/org.apache.sling.servlets.resolver-3.0.4.buildspec)  | `bin/add-new-release.sh content/org/apache/sling/org.apache.sling.servlets.resolver/org.apache.sling.servlets.resolver-3.0.2.buildspec 3.0.4 staging` |
| <!-- 20251031142707 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-assembly-plugin](../content/org/apache/maven/plugins/maven-assembly-plugin/README.md) | [3.7.1](../content/org/apache/maven/plugins/maven-assembly-plugin/maven-assembly-plugin-3.7.1.buildspec) :white_check_mark: | [3.8.0](../content/org/apache/maven/plugins/maven-assembly-plugin/maven-assembly-plugin-3.8.0.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-assembly-plugin/maven-assembly-plugin-3.7.1.buildspec 3.8.0 staging` |
| <!-- 20250921184320 --> [:mailbox:](https://lists.apache.org/list?dev@nifi.apache.org:lte=1M:VOTE) | [nifi](../content/org/apache/nifi/nifi/README.md) | [2.6.0](../content/org/apache/nifi/nifi/nifi-2.6.0.buildspec) :warning: | [2.7.0](../content/org/apache/nifi/nifi/nifi-2.7.0.buildspec)  | `bin/add-new-release.sh content/org/apache/nifi/nifi/nifi-2.6.0.buildspec 2.7.0 staging` |
| <!-- 20250523140844 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-exec](../content/org/apache/commons/commons-exec/README.md) | [1.5.0](../content/org/apache/commons/commons-exec/commons-exec-1.5.0.buildspec) :white_check_mark: | [1.6.0](../content/org/apache/commons/commons-exec/commons-exec-1.6.0.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/commons-exec/commons-exec-1.5.0.buildspec 1.6.0 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20251128201028 --> [jpmml-evaluator](../content/org/jpmml/jpmml-evaluator/README.md) | [1.7.5](../content/org/jpmml/jpmml-evaluator/jpmml-evaluator-1.7.5.buildspec) :warning: | [1.7.6](../content/org/jpmml/jpmml-evaluator/jpmml-evaluator-1.7.6.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-evaluator/jpmml-evaluator-1.7.5.buildspec 1.7.6` |
| <!-- 20251128142324 --> [tycho](../content/org/eclipse/tycho/README.md) | [5.0.0](../content/org/eclipse/tycho/tycho-5.0.0.buildspec) :warning: [:memo:](https://github.com/eclipse-tycho/tycho/issues/5284) | [5.0.1](../content/org/eclipse/tycho/tycho-5.0.1.buildspec) | `bin/add-new-release.sh content/org/eclipse/tycho/tycho-5.0.0.buildspec 5.0.1` |
| <!-- 20251128133200 --> [hugegraph](../content/org/apache/hugegraph/README.md) | [1.5.0](../content/org/apache/hugegraph/hugegraph-1.5.0.buildspec) :warning: [:memo:](https://github.com/apache/incubator-hugegraph/pull/2874) | [1.7.0](../content/org/apache/hugegraph/hugegraph-1.7.0.buildspec) | `bin/add-new-release.sh content/org/apache/hugegraph/hugegraph-1.5.0.buildspec 1.7.0` |
| <!-- 20251128105054 --> [commons-daemon](../content/org/apache/commons/commons-daemon/README.md) | [1.4.1](../content/org/apache/commons/commons-daemon/commons-daemon-1.4.1.buildspec) :warning: | [1.5.0](../content/org/apache/commons/commons-daemon/commons-daemon-1.5.0.buildspec) | `bin/add-new-release.sh content/org/apache/commons/commons-daemon/commons-daemon-1.4.1.buildspec 1.5.0` |
| <!-- 20251128083720 --> [eforms-sdk-analyzer](../content/eu/europa/ted/eforms/eforms-sdk-analyzer/README.md) | [1.13.1](../content/eu/europa/ted/eforms/eforms-sdk-analyzer/eforms-sdk-analyzer-1.13.1.buildspec) :warning: | [1.14.0](../content/eu/europa/ted/eforms/eforms-sdk-analyzer/eforms-sdk-analyzer-1.14.0.buildspec) | `bin/add-new-release.sh content/eu/europa/ted/eforms/eforms-sdk-analyzer/eforms-sdk-analyzer-1.13.1.buildspec 1.14.0` |
| <!-- 20251127234922 --> [avaje-http-parent](../content/io/avaje/http/README.md) | [3.6-RC1](../content/io/avaje/http/avaje-http-3.6-RC1.buildspec) :warning: | [3.6-RC2](../content/io/avaje/http/avaje-http-3.6-RC2.buildspec) | `bin/add-new-release.sh content/io/avaje/http/avaje-http-3.6-RC1.buildspec 3.6-RC2` |
...
| <!-- 20251126175128 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.113.1](../content/org/finos/legend/engine/legend-engine-4.113.1.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.113.1` |
| <!-- 20251125203732 --> [plotsquared-bukkit](../content/com/intellectualsites/plotsquared/plotsquared-bukkit/README.md) | [7.5.4](../content/com/intellectualsites/plotsquared/plotsquared-bukkit/plotsquared-7.5.4.buildspec) :x: | [7.5.10](../content/com/intellectualsites/plotsquared/plotsquared-bukkit/plotsquared-7.5.10.buildspec) | `bin/add-new-release.sh content/com/intellectualsites/plotsquared/plotsquared-bukkit/plotsquared-7.5.4.buildspec 7.5.10` |
...
| <!-- 20251120023125 --> [paimon-parent](../content/org/apache/paimon/README.md) | [1.3.0](../content/org/apache/paimon/paimon-parent-1.3.0.buildspec) :warning: [:memo:](https://github.com/apache/paimon/issues/6557) | [1.3.1](../content/org/apache/paimon/paimon-parent-1.3.1.buildspec) | `bin/add-new-release.sh content/org/apache/paimon/paimon-parent-1.3.0.buildspec 1.3.1` |
| <!-- 20251118190533 --> [acs-aem-commons](../content/com/adobe/acs/aem-commons/README.md) | [6.15.0](../content/com/adobe/acs/aem-commons/acs-aem-commons-6.15.0.buildspec) :warning: | [6.15.4](../content/com/adobe/acs/aem-commons/acs-aem-commons-6.15.4.buildspec) | `bin/add-new-release.sh content/com/adobe/acs/aem-commons/acs-aem-commons-6.15.0.buildspec 6.15.4` |
...
| artifactId | newest |
| ---------- | ------ |
| <!-- 20251126112935 --> [quarkus-project](../content/io/quarkus/README.md) | 3.30.1 :warning: |
...
| <!-- 20251124154116 --> [avaje-jex-parent](../content/io/avaje/jex/README.md) | 3.4-RC1 :warning: |
...
| <!-- 20251121163519 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | 12.1-RC3 :warning: |
...
| <!-- 20251120042226 --> [opentelemetry-instrumentation-api](../content/io/opentelemetry/instrumentation/README.md) | 2.22.0 :warning: |
| <!-- 20251119204747 --> [gwt-commons-validator](../content/de/knightsoft-net/gwt-commons-validator/README.md) | 1.10.1-0 :warning: |
| <!-- 20251119194129 --> [jpmml-sparkml](../content/org/jpmml/jpmml-sparkml/README.md) | 3.2.5 :warning: |
...
| <!-- 20251112113336 --> [jandex-parent](../content/io/smallrye/jandex/README.md) | 3.5.2 :warning: |
...
| <!-- 20251027043136 --> [avaje-config-toml](../content/io/avaje/config-toml/README.md) | 4.2 :warning: |
...
| <!-- 20251025193135 --> [htmlcompressor](../content/com/github/hazendaz/htmlcompressor/README.md) | 2.3.0 :warning: |
...
| <!-- 20250625092738 --> [paapi5-java-sdk](../content/net/osslabz/paapi5-java-sdk/README.md) | 1.2.2 :warning: |
