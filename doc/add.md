...
| ---------- | ---- | -- | ------- |
| <!-- 20251209191121 --> [aru-parent](../content/io/github/cbarlin/aru/README.md) | [0.7.0](../content/io/github/cbarlin/aru/aru-0.7.0.buildspec) :white_check_mark: | [0.7.1](../content/io/github/cbarlin/aru/aru-0.7.1.buildspec) | `bin/add-new-release.sh content/io/github/cbarlin/aru/aru-0.7.0.buildspec 0.7.1` |
| <!-- 20251209114336 --> [maven-lockfile](../content/io/github/chains-project/maven-lockfile/README.md) | [5.10.1-beta-4](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.10.1-beta-4.buildspec) :white_check_mark: | [5.11.0](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.11.0.buildspec) | `bin/add-new-release.sh content/io/github/chains-project/maven-lockfile/maven-lockfile-5.10.1-beta-4.buildspec 5.11.0` |
| <!-- 20251209095129 --> [avaje-validator-parent](../content/io/avaje/validator/README.md) | [2.15-RC3](../content/io/avaje/validator/avaje-validator-2.15-RC3.buildspec) :white_check_mark: | [2.15](../content/io/avaje/validator/avaje-validator-2.15.buildspec) | `bin/add-new-release.sh content/io/avaje/validator/avaje-validator-2.15-RC3.buildspec 2.15` |
| <!-- 20251209094527 --> [avaje-http-parent](../content/io/avaje/http/README.md) | [3.6-RC4](../content/io/avaje/http/avaje-http-3.6-RC4.buildspec) :white_check_mark: | [3.6](../content/io/avaje/http/avaje-http-3.6.buildspec) | `bin/add-new-release.sh content/io/avaje/http/avaje-http-3.6-RC4.buildspec 3.6` |
| <!-- 20251209090721 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [12.1-RC6](../content/io/avaje/inject/avaje-inject-12.1-RC6.buildspec) :white_check_mark: | [12.1-javax](../content/io/avaje/inject/avaje-inject-12.1-javax.buildspec) | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-12.1-RC6.buildspec 12.1-javax` |
| <!-- 20251209090721 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [12.1-RC6](../content/io/avaje/inject/avaje-inject-12.1-RC6.buildspec) :white_check_mark: | 12.1  | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-12.1-RC6.buildspec ...` |
| <!-- 20251209084235 --> [avaje-jsonb-parent](../content/io/avaje/jsonb/README.md) | [3.9-RC3](../content/io/avaje/jsonb/avaje-jsonb-3.9-RC3.buildspec) :white_check_mark: | [3.9](../content/io/avaje/jsonb/avaje-jsonb-3.9.buildspec) | `bin/add-new-release.sh content/io/avaje/jsonb/avaje-jsonb-3.9-RC3.buildspec 3.9` |
| <!-- 20251209084233 --> [avaje-spi-parent](../content/io/avaje/spi/README.md) | [2.14-RC1](../content/io/avaje/spi/avaje-spi-2.14-RC1.buildspec) :white_check_mark: | [2.14](../content/io/avaje/spi/avaje-spi-2.14.buildspec) | `bin/add-new-release.sh content/io/avaje/spi/avaje-spi-2.14-RC1.buildspec 2.14` |
| <!-- 20251209083341 --> [avaje-prisms-parent](../content/io/avaje/prisms/README.md) | [2.0-RC2](../content/io/avaje/prisms/avaje-prisms-2.0-RC2.buildspec) :white_check_mark: | [2.0](../content/io/avaje/prisms/avaje-prisms-2.0.buildspec) | `bin/add-new-release.sh content/io/avaje/prisms/avaje-prisms-2.0-RC2.buildspec 2.0` |
| <!-- 20251209075247 --> [rockcraft-parent](../content/io/github/rockcrafters/plugins/README.md) | [1.2.2](../content/io/github/rockcrafters/plugins/rockcraft-parent-1.2.2.buildspec) :white_check_mark: | [1.2.3](../content/io/github/rockcrafters/plugins/rockcraft-parent-1.2.3.buildspec) | `bin/add-new-release.sh content/io/github/rockcrafters/plugins/rockcraft-parent-1.2.2.buildspec 1.2.3` |
| <!-- 20251209042316 --> [liftwizard](../content/io/liftwizard/README.md) | [2.1.34](../content/io/liftwizard/liftwizard-2.1.34.buildspec) :white_check_mark: | [2.1.35](../content/io/liftwizard/liftwizard-2.1.35.buildspec) | `bin/add-new-release.sh content/io/liftwizard/liftwizard-2.1.34.buildspec 2.1.35` |
| <!-- 20251209003141 --> [cucumber-jvm](../content/io/cucumber/cucumber-jvm/README.md) | [7.32.0](../content/io/cucumber/cucumber-jvm/cucumber-jvm-7.32.0.buildspec) :white_check_mark: | [7.33.0](../content/io/cucumber/cucumber-jvm/cucumber-jvm-7.33.0.buildspec) | `bin/add-new-release.sh content/io/cucumber/cucumber-jvm/cucumber-jvm-7.32.0.buildspec 7.33.0` |
| <!-- 20251209001120 --> [cucumber-json-formatter](../content/io/cucumber/cucumber-json-formatter/README.md) | [0.3.1](../content/io/cucumber/cucumber-json-formatter/cucumber-json-formatter-0.3.1.buildspec) :white_check_mark: | [0.3.2](../content/io/cucumber/cucumber-json-formatter/cucumber-json-formatter-0.3.2.buildspec) | `bin/add-new-release.sh content/io/cucumber/cucumber-json-formatter/cucumber-json-formatter-0.3.1.buildspec 0.3.2` |
| <!-- 20251208143913 --> [airbase](../content/io/airlift/airbase/README.md) | [334](../content/io/airlift/airbase/airbase-334.buildspec) :white_check_mark: | 333  | `bin/add-new-release.sh content/io/airlift/airbase/airbase-334.buildspec ...` |
...
| <!-- 20251209101535 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.114.1](../content/org/finos/legend/engine/legend-engine-4.114.1.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.114.1` |
| <!-- 20251209093130 --> [jpmml-r](../content/org/jpmml/jpmml-r/README.md) | [1.7.4](../content/org/jpmml/jpmml-r/jpmml-r-1.7.4.buildspec) :warning: | [1.7.5](../content/org/jpmml/jpmml-r/jpmml-r-1.7.5.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-r/jpmml-r-1.7.4.buildspec 1.7.5` |
| <!-- 20251208092359 --> [jpmml-statsmodels](../content/org/jpmml/jpmml-statsmodels/README.md) | [1.3.4](../content/org/jpmml/jpmml-statsmodels/jpmml-statsmodels-1.3.4.buildspec) :warning: | [1.3.5](../content/org/jpmml/jpmml-statsmodels/jpmml-statsmodels-1.3.5.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-statsmodels/jpmml-statsmodels-1.3.4.buildspec 1.3.5` |
