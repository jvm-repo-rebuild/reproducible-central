...
| ---------- | ---- | -- | ------- |
| <!-- 20250930192734 --> [ollama4j](../content/io/github/ollama4j/README.md) | [1.1.0](../content/io/github/ollama4j/ollama4j-1.1.0.buildspec) :white_check_mark: | [1.1.1](../content/io/github/ollama4j/ollama4j-1.1.1.buildspec) | `bin/add-new-release.sh content/io/github/ollama4j/ollama4j-1.1.0.buildspec 1.1.1` |
| <!-- 20250930165337 --> [maven-lockfile](../content/io/github/chains-project/maven-lockfile/README.md) | [5.7.1](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.7.1.buildspec) :white_check_mark: | [5.8.0](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.8.0.buildspec) | `bin/add-new-release.sh content/io/github/chains-project/maven-lockfile/maven-lockfile-5.7.1.buildspec 5.8.0` |
...
| <!-- 20250930082536 --> [airbase](../content/io/airlift/airbase/README.md) | [306](../content/io/airlift/airbase/airbase-306.buildspec) :white_check_mark: | [307](../content/io/airlift/airbase/airbase-307.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-306.buildspec 307` |
| <!-- 20250930062534 --> [exec-maven-plugin](../content/org/codehaus/mojo/exec-maven-plugin/README.md) | [3.5.1](../content/org/codehaus/mojo/exec-maven-plugin/exec-maven-plugin-3.5.1.buildspec) :white_check_mark: | [3.6.0](../content/org/codehaus/mojo/exec-maven-plugin/exec-maven-plugin-3.6.0.buildspec) | `bin/add-new-release.sh content/org/codehaus/mojo/exec-maven-plugin/exec-maven-plugin-3.5.1.buildspec 3.6.0` |
| <!-- 20250929210336 --> [oss-parent](../content/com/fasterxml/oss-parent/README.md) | [71](../content/com/fasterxml/oss-parent/oss-parent-71.buildspec) :white_check_mark: | [72](../content/com/fasterxml/oss-parent/oss-parent-72.buildspec) | `bin/add-new-release.sh content/com/fasterxml/oss-parent/oss-parent-71.buildspec 72` |
...
| <!-- 20250927031930 --> [flowlogix](../content/com/flowlogix/README.md) | [9.0.11](../content/com/flowlogix/flowlogix-9.0.11.buildspec) :white_check_mark: | [10.0.3](../content/com/flowlogix/flowlogix-10.0.3.buildspec) | `bin/add-new-release.sh content/com/flowlogix/flowlogix-9.0.11.buildspec 10.0.3` |
| <!-- 20250927031930 --> [flowlogix](../content/com/flowlogix/README.md) | [9.0.11](../content/com/flowlogix/flowlogix-9.0.11.buildspec) :white_check_mark: | 10.0.2 10.0.1 10  | `bin/add-new-release.sh content/com/flowlogix/flowlogix-9.0.11.buildspec ...` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20250924080739 --> [:mailbox:](https://lists.apache.org/list?dev@camel.apache.org:lte=1M:VOTE) | [camel](../content/org/apache/camel/camel/README.md) | [4.10.0](../content/org/apache/camel/camel/camel-4.10.0.buildspec) :x: | [4.14.1](../content/org/apache/camel/camel/camel-4.14.1.buildspec)  | `bin/add-new-release.sh content/org/apache/camel/camel/camel-4.10.0.buildspec 4.14.1 staging` |
...
| <!-- 20250730060145 --> [:mailbox:](https://lists.apache.org/list?dev@orc.apache.org:lte=1M:VOTE) | [orc](../content/org/apache/orc/README.md) | [2.2.0](../content/org/apache/orc/orc-2.2.0.buildspec) :white_check_mark: | [2.2.1](../content/org/apache/orc/orc-2.2.1.buildspec)  | `bin/add-new-release.sh content/org/apache/orc/orc-2.2.0.buildspec 2.2.1 staging` |
| <!-- 20250715205508 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [enforcer](../content/org/apache/maven/enforcer/README.md) | [3.6.1](../content/org/apache/maven/enforcer/maven-enforcer-plugin-3.6.1.buildspec) :white_check_mark: | [3.6.2](../content/org/apache/maven/enforcer/maven-enforcer-plugin-3.6.2.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/enforcer/maven-enforcer-plugin-3.6.1.buildspec 3.6.2 staging` |
| <!-- 20250712183448 --> [:mailbox:](https://lists.apache.org/list?dev@wicket.apache.org:lte=1M:VOTE) | [wicket-parent](../content/org/apache/wicket/README.md) | [10.6.0](../content/org/apache/wicket/wicket-parent-10.6.0.buildspec) :white_check_mark: | [10.7.0](../content/org/apache/wicket/wicket-parent-10.7.0.buildspec)  | `bin/add-new-release.sh content/org/apache/wicket/wicket-parent-10.6.0.buildspec 10.7.0 staging` |
