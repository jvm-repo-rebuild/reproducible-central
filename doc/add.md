...
| ---------- | ---- | -- | ------- |
| <!-- 20250407091724 --> [micronaut-maven-plugin](../content/io/micronaut/maven/micronaut-maven-plugin/README.md) | [4.8.0](../content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-4.8.0.buildspec) :white_check_mark: | [4.8.1](../content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-4.8.1.buildspec) | `bin/add-new-release.sh content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-4.8.0.buildspec 4.8.1` |
| <!-- 20250407072416 --> [airbase](../content/io/airlift/airbase/README.md) | [248](../content/io/airlift/airbase/airbase-248.buildspec) :white_check_mark: | [249](../content/io/airlift/airbase/airbase-249.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-248.buildspec 249` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250407130336 --> [jandex](../content/io/smallrye/jandex/README.md) | [](../content/io/smallrye/jandex/) :x: | [3.3.0](../content/io/smallrye/jandex/-3.3.0.buildspec) | `bin/add-new-release.sh content/io/smallrye/jandex/ 3.3.0` |
...
| <!-- 20250407073221 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [11.4-javax](../content/io/avaje/inject/avaje-inject-11.4-javax.buildspec) :warning: | [11.5-RC1](../content/io/avaje/inject/avaje-inject-11.5-RC1.buildspec) | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-11.4-javax.buildspec 11.5-RC1` |
| <!-- 20250406034137 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.78.0](../content/org/finos/legend/engine/legend-engine-4.78.0.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.78.0` |
