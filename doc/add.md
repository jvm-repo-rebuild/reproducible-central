...
| ---------- | ---- | -- | ------- |
| <!-- 20230819133030 --> [dependency-check-parent](../content/org/owasp/dependency-check/README.md) | 8.3.1 :heavy_check_mark: | [8.4.0](../content/org/owasp/dependency-check/dependency-check-8.4.0.buildspec) | `bin/add-new-release.sh content/org/owasp/dependency-check/dependency-check-8.3.1.buildspec 8.4.0` |
