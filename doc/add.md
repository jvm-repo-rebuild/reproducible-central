...
| ---------- | ---- | -- | ------- |
| <!-- 20250916192559 --> [commons-skin](../content/org/apache/commons/commons-skin/README.md) | [5.0.0](../content/org/apache/commons/commons-skin/commons-skin-5.0.0.buildspec) :white_check_mark: | [5.1.0](../content/org/apache/commons/commons-skin/commons-skin-5.1.0.buildspec) | `bin/add-new-release.sh content/org/apache/commons/commons-skin/commons-skin-5.0.0.buildspec 5.1.0` |
| <!-- 20250916173152 --> [qpid-jms-parent](../content/org/apache/qpid/jms/README.md) | [2.8.0](../content/org/apache/qpid/jms/qpid-jms-2.8.0.buildspec) :white_check_mark: | [2.9.0](../content/org/apache/qpid/jms/qpid-jms-2.9.0.buildspec) | `bin/add-new-release.sh content/org/apache/qpid/jms/qpid-jms-2.8.0.buildspec 2.9.0` |
| <!-- 20250916173152 --> [qpid-jms-parent](../content/org/apache/qpid/jms/README.md) | [2.8.0](../content/org/apache/qpid/jms/qpid-jms-2.8.0.buildspec) :white_check_mark: | 1.15.0  | `bin/add-new-release.sh content/org/apache/qpid/jms/qpid-jms-2.8.0.buildspec ...` |
| <!-- 20250916135539 --> [toolbox](../content/eu/maveniverse/maven/toolbox/README.md) | [0.12.3](../content/eu/maveniverse/maven/toolbox/toolbox-0.12.3.buildspec) :white_check_mark: | [0.13.1](../content/eu/maveniverse/maven/toolbox/toolbox-0.13.1.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/toolbox/toolbox-0.12.3.buildspec 0.13.1` |
| <!-- 20250916135539 --> [toolbox](../content/eu/maveniverse/maven/toolbox/README.md) | [0.12.3](../content/eu/maveniverse/maven/toolbox/toolbox-0.12.3.buildspec) :white_check_mark: | 0.13.0  | `bin/add-new-release.sh content/eu/maveniverse/maven/toolbox/toolbox-0.12.3.buildspec ...` |
| <!-- 20250916110333 --> [jena-kafka](../content/io/telicent/jena/jena-kafka/README.md) | [2.0.2](../content/io/telicent/jena/jena-kafka/jena-kafka-2.0.2.buildspec) :white_check_mark: | [2.1.0](../content/io/telicent/jena/jena-kafka/jena-kafka-2.1.0.buildspec) | `bin/add-new-release.sh content/io/telicent/jena/jena-kafka/jena-kafka-2.0.2.buildspec 2.1.0` |
| <!-- 20250916095334 --> [langchain4j](../content/dev/langchain4j/README.md) | [1.4.0](../content/dev/langchain4j/langchain4j-1.4.0.buildspec) :white_check_mark: | [1.5.0](../content/dev/langchain4j/langchain4j-1.5.0.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-1.4.0.buildspec 1.5.0` |
| <!-- 20250916084352 --> [dropwizard-project](../content/io/dropwizard/core/README.md) | [5.0.0-rc.5](../content/io/dropwizard/core/dropwizard-5.0.0-rc.5.buildspec) :white_check_mark: | [5.0.0](../content/io/dropwizard/core/dropwizard-5.0.0.buildspec) | `bin/add-new-release.sh content/io/dropwizard/core/dropwizard-5.0.0-rc.5.buildspec 5.0.0` |
| <!-- 20250916082532 --> [airbase](../content/io/airlift/airbase/README.md) | [300](../content/io/airlift/airbase/airbase-300.buildspec) :white_check_mark: | [301](../content/io/airlift/airbase/airbase-301.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-300.buildspec 301` |
| <!-- 20250916082531 --> [heylogs-parent](../content/com/github/nbbrd/heylogs/README.md) | [0.14.0](../content/com/github/nbbrd/heylogs/heylogs-0.14.0.buildspec) :white_check_mark: | [0.14.1](../content/com/github/nbbrd/heylogs/heylogs-0.14.1.buildspec) | `bin/add-new-release.sh content/com/github/nbbrd/heylogs/heylogs-0.14.0.buildspec 0.14.1` |
| <!-- 20250915215346 --> [metrics-parent](../content/io/dropwizard/metrics5/README.md) | [5.0.4](../content/io/dropwizard/metrics5/dropwizard-metrics-5.0.4.buildspec) :white_check_mark: | [5.0.5](../content/io/dropwizard/metrics5/dropwizard-metrics-5.0.5.buildspec) | `bin/add-new-release.sh content/io/dropwizard/metrics5/dropwizard-metrics-5.0.4.buildspec 5.0.5` |
| <!-- 20250915214132 --> [metrics-parent](../content/io/dropwizard/metrics/README.md) | [4.2.36](../content/io/dropwizard/metrics/dropwizard-metrics-4.2.36.buildspec) :white_check_mark: | [4.2.37](../content/io/dropwizard/metrics/dropwizard-metrics-4.2.37.buildspec) | `bin/add-new-release.sh content/io/dropwizard/metrics/dropwizard-metrics-4.2.36.buildspec 4.2.37` |
...
| <!-- 20240820092142 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-statistics-parent](../content/org/apache/commons/statistics/README.md) | [1.1](../content/org/apache/commons/statistics/commons-statistics-1.1.buildspec) :white_check_mark: | [1.2](../content/org/apache/commons/statistics/commons-statistics-1.2.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/statistics/commons-statistics-1.1.buildspec 1.2 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250916154138 --> [zrlog-base](../content/com/hibegin/zrlog-base/README.md) | [3.2.114](../content/com/hibegin/zrlog-base/zrlog-base-3.2.114.buildspec) :warning: [:memo:](https://github.com/zrlog-extensions/zrlog-base/pull/1) | [3.2.115](../content/com/hibegin/zrlog-base/zrlog-base-3.2.115.buildspec) | `bin/add-new-release.sh content/com/hibegin/zrlog-base/zrlog-base-3.2.114.buildspec 3.2.115` |
...
| <!-- 20250915135135 --> [spotbugs-maven-plugin](../content/com/github/spotbugs/spotbugs-maven-plugin/README.md) | [4.9.4.2](../content/com/github/spotbugs/spotbugs-maven-plugin/spotbugs-maven-plugin-4.9.4.2.buildspec) :warning: [:memo:](https://github.com/spotbugs/spotbugs-maven-plugin/issues/1148) | [4.9.5.0](../content/com/github/spotbugs/spotbugs-maven-plugin/spotbugs-maven-plugin-4.9.5.0.buildspec) | `bin/add-new-release.sh content/com/github/spotbugs/spotbugs-maven-plugin/spotbugs-maven-plugin-4.9.4.2.buildspec 4.9.5.0` |
| <!-- 20250915134142 --> [ratis-thirdparty](../content/org/apache/ratis/ratis-thirdparty/README.md) | [1.0.9](../content/org/apache/ratis/ratis-thirdparty/ratis-thirdparty-1.0.9.buildspec) :warning: | [1.0.10](../content/org/apache/ratis/ratis-thirdparty/ratis-thirdparty-1.0.10.buildspec) | `bin/add-new-release.sh content/org/apache/ratis/ratis-thirdparty/ratis-thirdparty-1.0.9.buildspec 1.0.10` |
| <!-- 20250915123130 --> [jpmml-sklearn](../content/org/jpmml/jpmml-sklearn/README.md) | [1.9.15](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.15.buildspec) :warning: | [1.9.16](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.16.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.15.buildspec 1.9.16` |
| <!-- 20250915113625 --> [tika](../content/org/apache/tika/README.md) | [3.2.2](../content/org/apache/tika/tika-3.2.2.buildspec) :warning: [:memo:](https://issues.apache.org/jira/browse/TIKA-4470) | [3.2.3](../content/org/apache/tika/tika-3.2.3.buildspec) | `bin/add-new-release.sh content/org/apache/tika/tika-3.2.2.buildspec 3.2.3` |
| <!-- 20250914212809 --> [opentelemetry-instrumentation-api](../content/io/opentelemetry/instrumentation/README.md) | [2.19.0](../content/io/opentelemetry/instrumentation/opentelemetry-2.19.0.buildspec) :warning: | [2.20.0](../content/io/opentelemetry/instrumentation/opentelemetry-2.20.0.buildspec) | `bin/add-new-release.sh content/io/opentelemetry/instrumentation/opentelemetry-2.19.0.buildspec 2.20.0` |
...
| <!-- 20250910072639 --> [quarkus-project](../content/io/quarkus/README.md) | 3.28.0.CR1 :warning: |
