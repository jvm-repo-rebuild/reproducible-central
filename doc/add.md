...
| ---------- | ---- | -- | ------- |
| <!-- 20241003201850 --> [trino-root](../content/io/trino/README.md) | [459](../content/io/trino/trino-459.buildspec) :white_check_mark: | [460](../content/io/trino/trino-460.buildspec) | `bin/add-new-release.sh content/io/trino/trino-459.buildspec 460` |
| <!-- 20241003175142 --> [metrics-parent](../content/io/dropwizard/metrics5/README.md) | [5.0.0-rc21](../content/io/dropwizard/metrics5/dropwizard-metrics-5.0.0-rc21.buildspec) :white_check_mark: | [5.0.0-rc22](../content/io/dropwizard/metrics5/dropwizard-metrics-5.0.0-rc22.buildspec) | `bin/add-new-release.sh content/io/dropwizard/metrics5/dropwizard-metrics-5.0.0-rc21.buildspec 5.0.0-rc22` |
| <!-- 20241003174832 --> [metrics-parent](../content/io/dropwizard/metrics/README.md) | [4.2.27](../content/io/dropwizard/metrics/dropwizard-metrics-4.2.27.buildspec) :white_check_mark: | [4.2.28](../content/io/dropwizard/metrics/dropwizard-metrics-4.2.28.buildspec) | `bin/add-new-release.sh content/io/dropwizard/metrics/dropwizard-metrics-4.2.27.buildspec 4.2.28` |
