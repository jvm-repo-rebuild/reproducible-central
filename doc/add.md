...
| ---------- | ---- | -- | ------- |
| <!-- 20250724120105 --> [commons-text](../content/org/apache/commons/commons-text/README.md) | [1.13.1](../content/org/apache/commons/commons-text/commons-text-1.13.1.buildspec) :white_check_mark: | [1.14.0](../content/org/apache/commons/commons-text/commons-text-1.14.0.buildspec) | `bin/add-new-release.sh content/org/apache/commons/commons-text/commons-text-1.13.1.buildspec 1.14.0` |
| <!-- 20250724094251 --> [scg-base](../content/io/telicent/smart-caches/graph/scg-base/README.md) | [0.83.16](../content/io/telicent/smart-caches/graph/scg-base/scg-base-0.83.16.buildspec) :white_check_mark: | [0.90.0](../content/io/telicent/smart-caches/graph/scg-base/scg-base-0.90.0.buildspec) | `bin/add-new-release.sh content/io/telicent/smart-caches/graph/scg-base/scg-base-0.83.16.buildspec 0.90.0` |
| <!-- 20250724091348 --> [gemLibPki](../content/de/gematik/pki/gemLibPki/README.md) | [3.1.5](../content/de/gematik/pki/gemLibPki/gemLibPki-3.1.5.buildspec) :white_check_mark: | [3.2.0](../content/de/gematik/pki/gemLibPki/gemLibPki-3.2.0.buildspec) | `bin/add-new-release.sh content/de/gematik/pki/gemLibPki/gemLibPki-3.1.5.buildspec 3.2.0` |
| <!-- 20250724080745 --> [dropwizard-project](../content/io/dropwizard/core/README.md) | [5.0.0-rc.3](../content/io/dropwizard/core/dropwizard-5.0.0-rc.3.buildspec) :white_check_mark: | [5.0.0-rc.4](../content/io/dropwizard/core/dropwizard-5.0.0-rc.4.buildspec) | `bin/add-new-release.sh content/io/dropwizard/core/dropwizard-5.0.0-rc.3.buildspec 5.0.0-rc.4` |
| <!-- 20250724080745 --> [dropwizard-project](../content/io/dropwizard/core/README.md) | [5.0.0-rc.3](../content/io/dropwizard/core/dropwizard-5.0.0-rc.3.buildspec) :white_check_mark: | 4.0.15 3.0.15  | `bin/add-new-release.sh content/io/dropwizard/core/dropwizard-5.0.0-rc.3.buildspec ...` |
| <!-- 20250724073934 --> [heylogs-parent](../content/com/github/nbbrd/heylogs/README.md) | [0.10.0](../content/com/github/nbbrd/heylogs/heylogs-0.10.0.buildspec) :white_check_mark: | [0.11.1](../content/com/github/nbbrd/heylogs/heylogs-0.11.1.buildspec) | `bin/add-new-release.sh content/com/github/nbbrd/heylogs/heylogs-0.10.0.buildspec 0.11.1` |
| <!-- 20250723223335 --> [module-parent](../content/io/dropwizard/modules/parent/README.md) | [5.0.0-rc.1](../content/io/dropwizard/modules/parent/module-parent-5.0.0-rc.1.buildspec) :white_check_mark: | [5.0.0-rc.4](../content/io/dropwizard/modules/parent/module-parent-5.0.0-rc.4.buildspec) | `bin/add-new-release.sh content/io/dropwizard/modules/parent/module-parent-5.0.0-rc.1.buildspec 5.0.0-rc.4` |
| <!-- 20250723223335 --> [module-parent](../content/io/dropwizard/modules/parent/README.md) | [5.0.0-rc.1](../content/io/dropwizard/modules/parent/module-parent-5.0.0-rc.1.buildspec) :white_check_mark: | 4.0.5.1 3.0.5 2.1.5  | `bin/add-new-release.sh content/io/dropwizard/modules/parent/module-parent-5.0.0-rc.1.buildspec ...` |
| <!-- 20250723220943 --> [error-prone-support](../content/tech/picnic/error-prone-support/error-prone-support/README.md) | [0.23.0](../content/tech/picnic/error-prone-support/error-prone-support/error-prone-support-0.23.0.buildspec) :white_check_mark: | [0.24.0](../content/tech/picnic/error-prone-support/error-prone-support/error-prone-support-0.24.0.buildspec) | `bin/add-new-release.sh content/tech/picnic/error-prone-support/error-prone-support/error-prone-support-0.23.0.buildspec 0.24.0` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20250628121714 --> [:mailbox:](https://lists.apache.org/list?dev@sling.apache.org:lte=1M:VOTE) | [org.apache.sling.api](../content/org/apache/sling/org.apache.sling.api/README.md) | [3.0.0](../content/org/apache/sling/org.apache.sling.api/org.apache.sling.api-3.0.0.buildspec) :white_check_mark: | [3.0.2](../content/org/apache/sling/org.apache.sling.api/org.apache.sling.api-3.0.2.buildspec)  | `bin/add-new-release.sh content/org/apache/sling/org.apache.sling.api/org.apache.sling.api-3.0.0.buildspec 3.0.2 staging` |
...
| <!-- 20250111133702 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-release-plugin](../content/org/apache/commons/commons-release-plugin/README.md) | [1.9.0](../content/org/apache/commons/commons-release-plugin/commons-release-plugin-1.9.0.buildspec) :warning: | [1.9.1](../content/org/apache/commons/commons-release-plugin/commons-release-plugin-1.9.1.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/commons-release-plugin/commons-release-plugin-1.9.0.buildspec 1.9.1 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250724131938 --> [jdplus-sdmx](../content/com/github/nbbrd/jdplus-sdmx/README.md) | [3.3.0](../content/com/github/nbbrd/jdplus-sdmx/jdplus-sdmx-3.3.0.buildspec) :warning: | [3.3.1](../content/com/github/nbbrd/jdplus-sdmx/jdplus-sdmx-3.3.1.buildspec) | `bin/add-new-release.sh content/com/github/nbbrd/jdplus-sdmx/jdplus-sdmx-3.3.0.buildspec 3.3.1` |
| <!-- 20250724083945 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.92.0](../content/org/finos/legend/engine/legend-engine-4.92.0.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.92.0` |
...
| <!-- 20250721100347 --> [jooby](../content/io/jooby/README.md) | 3.11.0 :warning: |
