...
| <!-- 20241002142141 --> [:mailbox:](https://lists.apache.org/list?dev@activemq.apache.org:lte=1M:VOTE) | [activemq-parent](../content/org/apache/activemq/README.md) | [6.1.3](../content/org/apache/activemq/activemq-6.1.3.buildspec) :white_check_mark: | [6.1.4](../content/org/apache/activemq/activemq-6.1.4.buildspec)  | `bin/add-new-release.sh content/org/apache/activemq/activemq-6.1.3.buildspec 6.1.4 staging` |
| <!-- 20240929144135 --> [:mailbox:](https://lists.apache.org/list?dev@logging.apache.org:lte=1M:VOTE) | [log4j](../content/org/apache/logging/log4j/log4j/README.md) | [3.0.0-beta2](../content/org/apache/logging/log4j/log4j/log4j-3.0.0-beta2.buildspec) :white_check_mark: | [3.0.0-beta3](../content/org/apache/logging/log4j/log4j/log4j-3.0.0-beta3.buildspec)  | `bin/add-new-release.sh content/org/apache/logging/log4j/log4j/log4j-3.0.0-beta2.buildspec 3.0.0-beta3 staging` |
