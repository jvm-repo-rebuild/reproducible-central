...
| ---------- | ---- | -- | ------- |
| <!-- 20251017194109 --> [mimir](../content/eu/maveniverse/maven/mimir/README.md) | [0.10.0](../content/eu/maveniverse/maven/mimir/mimir-0.10.0.buildspec) :white_check_mark: | [0.10.1](../content/eu/maveniverse/maven/mimir/mimir-0.10.1.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/mimir/mimir-0.10.0.buildspec 0.10.1` |
| <!-- 20251017144538 --> [cui-parent-pom](../content/de/cuioss/cui-parent-pom/README.md) | [1.3.3](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.3.3.buildspec) :white_check_mark: | [1.3.6](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.3.6.buildspec) | `bin/add-new-release.sh content/de/cuioss/cui-parent-pom/cui-parent-pom-1.3.3.buildspec 1.3.6` |
| <!-- 20251017144538 --> [cui-parent-pom](../content/de/cuioss/cui-parent-pom/README.md) | [1.3.3](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.3.3.buildspec) :white_check_mark: | 1.3.5 1.3.4  | `bin/add-new-release.sh content/de/cuioss/cui-parent-pom/cui-parent-pom-1.3.3.buildspec ...` |
| <!-- 20251017140334 --> [micronaut-maven-plugin](../content/io/micronaut/maven/micronaut-maven-plugin/README.md) | [4.10.2](../content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-4.10.2.buildspec) :white_check_mark: | [4.11.0](../content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-4.11.0.buildspec) | `bin/add-new-release.sh content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-4.10.2.buildspec 4.11.0` |
| <!-- 20251016200539 --> [nifi-api](../content/org/apache/nifi/nifi-api/README.md) | [2.3.0](../content/org/apache/nifi/nifi-api/nifi-api-2.3.0.buildspec) :white_check_mark: | [2.4.0](../content/org/apache/nifi/nifi-api/nifi-api-2.4.0.buildspec) | `bin/add-new-release.sh content/org/apache/nifi/nifi-api/nifi-api-2.3.0.buildspec 2.4.0` |
...
| <!-- 20251015201339 --> [avro-toplevel](../content/org/apache/avro/README.md) | [1.12.0](../content/org/apache/avro/avro-1.12.0.buildspec) :white_check_mark: | 1.11.5  | `bin/add-new-release.sh content/org/apache/avro/avro-1.12.0.buildspec ...` |
| <!-- 20251014085135 --> [avaje-jsonb-parent](../content/io/avaje/jsonb/README.md) | [3.8-RC4](../content/io/avaje/jsonb/avaje-jsonb-3.8-RC4.buildspec) :white_check_mark: | 3.8-RC2  | `bin/add-new-release.sh content/io/avaje/jsonb/avaje-jsonb-3.8-RC4.buildspec ...` |
| <!-- 20251014022938 --> [displaytag-doc](../content/com/github/hazendaz/displaytag-doc/README.md) | [3.4.0](../content/com/github/hazendaz/displaytag-doc/displaytag-doc-3.4.0.buildspec) :white_check_mark: | 2.9.0  | `bin/add-new-release.sh content/com/github/hazendaz/displaytag-doc/displaytag-doc-3.4.0.buildspec ...` |
...
| <!-- 20251005082739 --> [:mailbox:](https://lists.apache.org/list?dev@struts.apache.org:lte=1M:VOTE) | [struts2-parent](../content/org/apache/struts/README.md) | [7.0.3](../content/org/apache/struts/struts2-7.0.3.buildspec) :white_check_mark: | [7.1.1](../content/org/apache/struts/struts2-7.1.1.buildspec)  | `bin/add-new-release.sh content/org/apache/struts/struts2-7.0.3.buildspec 7.1.1 staging` |
| <!-- 20250922020619 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-compiler-plugin](../content/org/apache/maven/plugins/maven-compiler-plugin/README.md) | [4.0.0-beta-2](../content/org/apache/maven/plugins/maven-compiler-plugin/maven-compiler-plugin-4.0.0-beta-2.buildspec) :white_check_mark: | [4.0.0-beta-3](../content/org/apache/maven/plugins/maven-compiler-plugin/maven-compiler-plugin-4.0.0-beta-3.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-compiler-plugin/maven-compiler-plugin-4.0.0-beta-2.buildspec 4.0.0-beta-3 staging` |
| <!-- 20250811122850 --> [:mailbox:](https://lists.apache.org/list?dev@syncope.apache.org:lte=1M:VOTE) | [syncope](../content/org/apache/syncope/README.md) | [4.0.1](../content/org/apache/syncope/syncope-4.0.1.buildspec) :warning: | [4.0.2](../content/org/apache/syncope/syncope-4.0.2.buildspec)  | `bin/add-new-release.sh content/org/apache/syncope/syncope-4.0.1.buildspec 4.0.2 staging` |
...
| <!-- 20250508230453 --> [:mailbox:](https://lists.apache.org/list?dev@cxf.apache.org:lte=1M:VOTE) | [cxf-build-utils](../content/org/apache/cxf/cxf-build-utils/README.md) | [4.1.1](../content/org/apache/cxf/cxf-build-utils/cxf-build-utils-4.1.1.buildspec) :white_check_mark: | [4.1.2](../content/org/apache/cxf/cxf-build-utils/cxf-build-utils-4.1.2.buildspec)  | `bin/add-new-release.sh content/org/apache/cxf/cxf-build-utils/cxf-build-utils-4.1.1.buildspec 4.1.2 staging` |
...
| <!-- 20240128192042 --> [:mailbox:](https://lists.apache.org/list?dev@rat.apache.org:lte=1M:VOTE) | [apache-rat-project](../content/org/apache/rat/README.md) | [0.16.1](../content/org/apache/rat/apache-rat-0.16.1.buildspec) :white_check_mark: | [0.17](../content/org/apache/rat/apache-rat-0.17.buildspec)  | `bin/add-new-release.sh content/org/apache/rat/apache-rat-0.16.1.buildspec 0.17 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20251017153730 --> [sdk-parent](../content/com/sap/ai/sdk/README.md) | [1.11.0](../content/com/sap/ai/sdk/sdk-1.11.0.buildspec) :warning: | [1.12.0](../content/com/sap/ai/sdk/sdk-1.12.0.buildspec) | `bin/add-new-release.sh content/com/sap/ai/sdk/sdk-1.11.0.buildspec 1.12.0` |
| <!-- 20251016201200 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.104.0](../content/org/finos/legend/engine/legend-engine-4.104.0.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.104.0` |
| <!-- 20251016111014 --> [quarkus-project](../content/io/quarkus/README.md) | [3.28.3](../content/io/quarkus/quarkus-3.28.3.buildspec) :warning: | [3.29.0.CR1](../content/io/quarkus/quarkus-3.29.0.CR1.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.28.3.buildspec 3.29.0.CR1` |
...
| <!-- 20251015094355 --> [jena](../content/org/apache/jena/jena/README.md) | [5.5.0](../content/org/apache/jena/jena/jena-5.5.0.buildspec) :warning: | [5.6.0](../content/org/apache/jena/jena/jena-5.6.0.buildspec) | `bin/add-new-release.sh content/org/apache/jena/jena/jena-5.5.0.buildspec 5.6.0` |
| <!-- 20251015010536 --> [spotbugs-maven-plugin](../content/com/github/spotbugs/spotbugs-maven-plugin/README.md) | [4.9.6.0](../content/com/github/spotbugs/spotbugs-maven-plugin/spotbugs-maven-plugin-4.9.6.0.buildspec) :warning: [:memo:](https://github.com/spotbugs/spotbugs-maven-plugin/issues/1148) | [4.9.7.0](../content/com/github/spotbugs/spotbugs-maven-plugin/spotbugs-maven-plugin-4.9.7.0.buildspec) | `bin/add-new-release.sh content/com/github/spotbugs/spotbugs-maven-plugin/spotbugs-maven-plugin-4.9.6.0.buildspec 4.9.7.0` |
| <!-- 20251014164933 --> [arthas-all](../content/com/taobao/arthas/README.md) | [4.0.5](../content/com/taobao/arthas/arthas-4.0.5.buildspec) :warning: [:memo:](https://github.com/alibaba/arthas/pull/3001) | [4.1.0](../content/com/taobao/arthas/arthas-4.1.0.buildspec) | `bin/add-new-release.sh content/com/taobao/arthas/arthas-4.0.5.buildspec 4.1.0` |
| <!-- 20251013000157 --> [bcel](../content/org/apache/commons/bcel/README.md) | [6.10.0](../content/org/apache/commons/bcel/bcel-6.10.0.buildspec) :warning: | [6.11.0](../content/org/apache/commons/bcel/bcel-6.11.0.buildspec) | `bin/add-new-release.sh content/org/apache/commons/bcel/bcel-6.10.0.buildspec 6.11.0` |
...
| <!-- 20251014162343 --> [jooby](../content/io/jooby/README.md) | 4.0.7 :warning: |
