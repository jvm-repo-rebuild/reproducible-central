...
| ---------- | ---- | -- | ------- |
| <!-- 20250609183811 --> [mybatis-spring](../content/org/mybatis/mybatis-spring/README.md) | [3.0.4](../content/org/mybatis/mybatis-spring/mybatis-spring-3.0.4.buildspec) :white_check_mark: | [3.0.5](../content/org/mybatis/mybatis-spring/mybatis-spring-3.0.5.buildspec) | `bin/add-new-release.sh content/org/mybatis/mybatis-spring/mybatis-spring-3.0.4.buildspec 3.0.5` |
| <!-- 20250609163610 --> [flexmonster](../content/org/webjars/flexmonster/README.md) | [2.9.104](../content/org/webjars/flexmonster/flexmonster-2.9.104.buildspec) :white_check_mark: | [2.9.105](../content/org/webjars/flexmonster/flexmonster-2.9.105.buildspec) | `bin/add-new-release.sh content/org/webjars/flexmonster/flexmonster-2.9.104.buildspec 2.9.105` |
| <!-- 20250609161721 --> [rdf-abac](../content/io/telicent/jena/rdf-abac/README.md) | [1.0.1](../content/io/telicent/jena/rdf-abac/rdf-abac-1.0.1.buildspec) :white_check_mark: | [1.0.2](../content/io/telicent/jena/rdf-abac/rdf-abac-1.0.2.buildspec) | `bin/add-new-release.sh content/io/telicent/jena/rdf-abac/rdf-abac-1.0.1.buildspec 1.0.2` |
| <!-- 20250609130106 --> [modbus-devices-parent](../content/nl/basjes/modbus/devices/modbus-devices-parent/README.md) | [0.3.0](../content/nl/basjes/modbus/devices/modbus-devices-parent/modbus-devices-parent-0.3.0.buildspec) :white_check_mark: | [0.3.1](../content/nl/basjes/modbus/devices/modbus-devices-parent/modbus-devices-parent-0.3.1.buildspec) | `bin/add-new-release.sh content/nl/basjes/modbus/devices/modbus-devices-parent/modbus-devices-parent-0.3.0.buildspec 0.3.1` |
| <!-- 20250609075900 --> [sunspec-device-parent](../content/nl/basjes/sunspec/sunspec-device-parent/README.md) | [0.4.1](../content/nl/basjes/sunspec/sunspec-device-parent/sunspec-device-parent-0.4.1.buildspec) :white_check_mark: | [0.5.0](../content/nl/basjes/sunspec/sunspec-device-parent/sunspec-device-parent-0.5.0.buildspec) | `bin/add-new-release.sh content/nl/basjes/sunspec/sunspec-device-parent/sunspec-device-parent-0.4.1.buildspec 0.5.0` |
| <!-- 20250609072441 --> [modbus-schema-parent](../content/nl/basjes/modbus/modbus-schema-parent/README.md) | [0.6.0](../content/nl/basjes/modbus/modbus-schema-parent/modbus-schema-parent-0.6.0.buildspec) :white_check_mark: | [0.7.0](../content/nl/basjes/modbus/modbus-schema-parent/modbus-schema-parent-0.7.0.buildspec) | `bin/add-new-release.sh content/nl/basjes/modbus/modbus-schema-parent/modbus-schema-parent-0.6.0.buildspec 0.7.0` |
| <!-- 20250608200201 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [11.6-RC1](../content/io/avaje/inject/avaje-inject-11.6-RC1.buildspec) :white_check_mark: | [11.6-RC2](../content/io/avaje/inject/avaje-inject-11.6-RC2.buildspec) | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-11.6-RC1.buildspec 11.6-RC2` |
| <!-- 20250608200201 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [11.6-RC1](../content/io/avaje/inject/avaje-inject-11.6-RC1.buildspec) :white_check_mark: | 11.5-javax  | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-11.6-RC1.buildspec ...` |
| <!-- 20250607161733 --> [njord](../content/eu/maveniverse/maven/njord/README.md) | [0.7.2](../content/eu/maveniverse/maven/njord/njord-0.7.2.buildspec) :white_check_mark: | [0.7.4](../content/eu/maveniverse/maven/njord/njord-0.7.4.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/njord/njord-0.7.2.buildspec 0.7.4` |
| <!-- 20250607161733 --> [njord](../content/eu/maveniverse/maven/njord/README.md) | [0.7.2](../content/eu/maveniverse/maven/njord/njord-0.7.2.buildspec) :white_check_mark: | 0.7.3  | `bin/add-new-release.sh content/eu/maveniverse/maven/njord/njord-0.7.2.buildspec ...` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250609190657 --> [swagger-ui](../content/org/webjars/swagger-ui/README.md) | [5.15.2](../content/org/webjars/swagger-ui/swagger-ui-5.15.2.buildspec) :x: | [5.24.0](../content/org/webjars/swagger-ui/swagger-ui-5.24.0.buildspec) | `bin/add-new-release.sh content/org/webjars/swagger-ui/swagger-ui-5.15.2.buildspec 5.24.0` |
| <!-- 20250609125118 --> [jpmml-sklearn](../content/org/jpmml/jpmml-sklearn/README.md) | [1.9.8](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.8.buildspec) :warning: | [1.9.9](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.9.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.8.buildspec 1.9.9` |
| <!-- 20250606000326 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.88.1](../content/org/finos/legend/engine/legend-engine-4.88.1.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.88.1` |
...
| <!-- 20250604202401 --> [quarkus-project](../content/io/quarkus/README.md) | 3.23.2 :warning: [:memo:](https://github.com/quarkusio/quarkus/pull/44671) |
