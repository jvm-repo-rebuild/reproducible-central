...
| ---------- | ---- | -- | ------- |
| <!-- 20250622160533 --> [modbus-schema-parent](../content/nl/basjes/modbus/modbus-schema-parent/README.md) | [0.8.0](../content/nl/basjes/modbus/modbus-schema-parent/modbus-schema-parent-0.8.0.buildspec) :white_check_mark: | [0.9.0](../content/nl/basjes/modbus/modbus-schema-parent/modbus-schema-parent-0.9.0.buildspec) | `bin/add-new-release.sh content/nl/basjes/modbus/modbus-schema-parent/modbus-schema-parent-0.8.0.buildspec 0.9.0` |
| <!-- 20250622062933 --> [modbus-devices-parent](../content/nl/basjes/modbus/devices/modbus-devices-parent/README.md) | [0.3.1](../content/nl/basjes/modbus/devices/modbus-devices-parent/modbus-devices-parent-0.3.1.buildspec) :white_check_mark: | [0.4.0](../content/nl/basjes/modbus/devices/modbus-devices-parent/modbus-devices-parent-0.4.0.buildspec) | `bin/add-new-release.sh content/nl/basjes/modbus/devices/modbus-devices-parent/modbus-devices-parent-0.3.1.buildspec 0.4.0` |
| <!-- 20250622062141 --> [activemq-parent](../content/org/apache/activemq/README.md) | [6.1.6](../content/org/apache/activemq/activemq-6.1.6.buildspec) :white_check_mark: | [6.1.7](../content/org/apache/activemq/activemq-6.1.7.buildspec) | `bin/add-new-release.sh content/org/apache/activemq/activemq-6.1.6.buildspec 6.1.7` |
| <!-- 20250622023032 --> [spoon-core](../content/fr/inria/gforge/spoon/spoon-core/README.md) | [11.2.1](../content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.2.1.buildspec) :white_check_mark: | [11.2.2-beta-1](../content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.2.2-beta-1.buildspec) | `bin/add-new-release.sh content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.2.1.buildspec 11.2.2-beta-1` |
| <!-- 20250622005752 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [11.6-RC3](../content/io/avaje/inject/avaje-inject-11.6-RC3.buildspec) :white_check_mark: | [11.6-RC4](../content/io/avaje/inject/avaje-inject-11.6-RC4.buildspec) | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-11.6-RC3.buildspec 11.6-RC4` |
| <!-- 20250622005752 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [11.6-RC3](../content/io/avaje/inject/avaje-inject-11.6-RC3.buildspec) :white_check_mark: | 11.5-javax  | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-11.6-RC3.buildspec ...` |
| <!-- 20250622002541 --> [hibernate-core](../content/org/hibernate/orm/hibernate-core/README.md) | [7.0.2.Final](../content/org/hibernate/orm/hibernate-core/hibernate-core-7.0.2.Final.buildspec) :white_check_mark: | [7.0.3.Final](../content/org/hibernate/orm/hibernate-core/hibernate-core-7.0.3.Final.buildspec) | `bin/add-new-release.sh content/org/hibernate/orm/hibernate-core/hibernate-core-7.0.2.Final.buildspec 7.0.3.Final` |
| <!-- 20250621180336 --> [oras-java-sdk](../content/land/oras/oras-java-sdk/README.md) | [0.2.14](../content/land/oras/oras-java-sdk/oras-java-sdk-0.2.14.buildspec) :white_check_mark: | 0.2.13  | `bin/add-new-release.sh content/land/oras/oras-java-sdk/oras-java-sdk-0.2.14.buildspec ...` |
| <!-- 20250621062137 --> [tiles-maven-plugin](../content/io/repaint/maven/tiles-maven-plugin/README.md) | [2.40](../content/io/repaint/maven/tiles-maven-plugin/tiles-maven-plugin-2.40.buildspec) :white_check_mark: | [2.41](../content/io/repaint/maven/tiles-maven-plugin/tiles-maven-plugin-2.41.buildspec) | `bin/add-new-release.sh content/io/repaint/maven/tiles-maven-plugin/tiles-maven-plugin-2.40.buildspec 2.41` |
...
| <!-- 20241028171704 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-pmd-plugin](../content/org/apache/maven/plugins/maven-pmd-plugin/README.md) | [3.26.0](../content/org/apache/maven/plugins/maven-pmd-plugin/maven-pmd-plugin-3.26.0.buildspec) :white_check_mark: | [3.27.0](../content/org/apache/maven/plugins/maven-pmd-plugin/maven-pmd-plugin-3.27.0.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-pmd-plugin/maven-pmd-plugin-3.26.0.buildspec 3.27.0 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250621194142 --> [jpmml-statsmodels](../content/org/jpmml/jpmml-statsmodels/README.md) | [1.3.1](../content/org/jpmml/jpmml-statsmodels/jpmml-statsmodels-1.3.1.buildspec) :warning: | [1.3.2](../content/org/jpmml/jpmml-statsmodels/jpmml-statsmodels-1.3.2.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-statsmodels/jpmml-statsmodels-1.3.1.buildspec 1.3.2` |
| <!-- 20250621182201 --> [jpmml-python](../content/org/jpmml/jpmml-python/README.md) | [1.3.4](../content/org/jpmml/jpmml-python/jpmml-python-1.3.4.buildspec) :warning: | [1.3.5](../content/org/jpmml/jpmml-python/jpmml-python-1.3.5.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-python/jpmml-python-1.3.4.buildspec 1.3.5` |
| <!-- 20250621100201 --> [license-maven-plugin](../content/org/codehaus/mojo/license-maven-plugin/README.md) | [2.5.0](../content/org/codehaus/mojo/license-maven-plugin/license-maven-plugin-2.5.0.buildspec) :warning: | [2.6.0](../content/org/codehaus/mojo/license-maven-plugin/license-maven-plugin-2.6.0.buildspec) | `bin/add-new-release.sh content/org/codehaus/mojo/license-maven-plugin/license-maven-plugin-2.5.0.buildspec 2.6.0` |
...
| <!-- 20250620072401 --> [jpmml-sklearn](../content/org/jpmml/jpmml-sklearn/README.md) | [1.9.10](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.10.buildspec) :warning: | [1.9.11](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.11.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.10.buildspec 1.9.11` |
...
| <!-- 20250619100530 --> [quarkus-project](../content/io/quarkus/README.md) | [3.24.0.CR1](../content/io/quarkus/quarkus-3.24.0.CR1.buildspec) :warning: [:memo:](https://github.com/quarkusio/quarkus/pull/44671) | [3.24.0](../content/io/quarkus/quarkus-3.24.0.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.24.0.CR1.buildspec 3.24.0` |
