...
| ---------- | ---- | -- | ------- |
| <!-- 20251202184113 --> [spdx-java-core](../content/org/spdx/spdx-java-core/README.md) | [1.0.1](../content/org/spdx/spdx-java-core/spdx-java-core-1.0.1.buildspec) :white_check_mark: | [1.0.2](../content/org/spdx/spdx-java-core/spdx-java-core-1.0.2.buildspec) | `bin/add-new-release.sh content/org/spdx/spdx-java-core/spdx-java-core-1.0.1.buildspec 1.0.2` |
| <!-- 20251202150719 --> [zrlog-base](../content/com/hibegin/zrlog-base/README.md) | [3.2.122](../content/com/hibegin/zrlog-base/zrlog-base-3.2.122.buildspec) :white_check_mark: | [3.2.123](../content/com/hibegin/zrlog-base/zrlog-base-3.2.123.buildspec) | `bin/add-new-release.sh content/com/hibegin/zrlog-base/zrlog-base-3.2.122.buildspec 3.2.123` |
| <!-- 20251202133132 --> [eforms-sdk](../content/eu/europa/ted/eforms/eforms-sdk/README.md) | [2.0.0-alpha.1](../content/eu/europa/ted/eforms/eforms-sdk/eforms-sdk-2.0.0-alpha.1.buildspec) :white_check_mark: | 1.14.0  | `bin/add-new-release.sh content/eu/europa/ted/eforms/eforms-sdk/eforms-sdk-2.0.0-alpha.1.buildspec ...` |
| <!-- 20251202095952 --> [community-connectors](../content/org/metricshub/community-connectors/README.md) | [1.0.16](../content/org/metricshub/community-connectors/community-connectors-1.0.16.buildspec) :white_check_mark: | [1.0.17](../content/org/metricshub/community-connectors/community-connectors-1.0.17.buildspec) | `bin/add-new-release.sh content/org/metricshub/community-connectors/community-connectors-1.0.16.buildspec 1.0.17` |
| <!-- 20251202083515 --> [resolver-proxy-maven-plugin](../content/com/github/veithen/maven/resolver-proxy-maven-plugin/README.md) | [0.5.1](../content/com/github/veithen/maven/resolver-proxy-maven-plugin/resolver-proxy-maven-plugin-0.5.1.buildspec) :white_check_mark: | [0.6.0](../content/com/github/veithen/maven/resolver-proxy-maven-plugin/resolver-proxy-maven-plugin-0.6.0.buildspec) | `bin/add-new-release.sh content/com/github/veithen/maven/resolver-proxy-maven-plugin/resolver-proxy-maven-plugin-0.5.1.buildspec 0.6.0` |
| <!-- 20251202023719 --> [avaje-spi-parent](../content/io/avaje/spi/README.md) | [2.13](../content/io/avaje/spi/avaje-spi-2.13.buildspec) :white_check_mark: | [2.14-RC1](../content/io/avaje/spi/avaje-spi-2.14-RC1.buildspec) | `bin/add-new-release.sh content/io/avaje/spi/avaje-spi-2.13.buildspec 2.14-RC1` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20251202181343 --> [jandex-parent](../content/io/smallrye/jandex/README.md) | [3.5.2](../content/io/smallrye/jandex/jandex-3.5.2.buildspec) :warning: | [3.5.3](../content/io/smallrye/jandex/jandex-3.5.3.buildspec) | `bin/add-new-release.sh content/io/smallrye/jandex/jandex-3.5.2.buildspec 3.5.3` |
| <!-- 20251202055119 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [12.1-RC3](../content/io/avaje/inject/avaje-inject-12.1-RC3.buildspec) :warning: | [12.1-RC6](../content/io/avaje/inject/avaje-inject-12.1-RC6.buildspec) | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-12.1-RC3.buildspec 12.1-RC6` |
| <!-- 20251202052913 --> [avaje-prisms-parent](../content/io/avaje/prisms/README.md) | [1.44](../content/io/avaje/prisms/avaje-prisms-1.44.buildspec) :x: | [2.0-RC2](../content/io/avaje/prisms/avaje-prisms-2.0-RC2.buildspec) | `bin/add-new-release.sh content/io/avaje/prisms/avaje-prisms-1.44.buildspec 2.0-RC2` |
...
| artifactId | newest |
| ---------- | ------ |
| <!-- 20251201153810 --> [avaje-jsonb-parent](../content/io/avaje/jsonb/README.md) | 3.9-RC2 :warning: |
