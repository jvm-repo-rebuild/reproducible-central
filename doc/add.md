...
| ---------- | ---- | -- | ------- |
| <!-- 20250804164016 --> [font-awesome](../content/org/webjars/font-awesome/README.md) | [6.7.2](../content/org/webjars/font-awesome/font-awesome-6.7.2.buildspec) :white_check_mark: | [7.0.0](../content/org/webjars/font-awesome/font-awesome-7.0.0.buildspec) | `bin/add-new-release.sh content/org/webjars/font-awesome/font-awesome-6.7.2.buildspec 7.0.0` |
| <!-- 20250804091134 --> [aru-parent](../content/io/github/cbarlin/aru/README.md) | [0.5.1](../content/io/github/cbarlin/aru/aru-0.5.1.buildspec) :white_check_mark: | [0.6.0](../content/io/github/cbarlin/aru/aru-0.6.0.buildspec) | `bin/add-new-release.sh content/io/github/cbarlin/aru/aru-0.5.1.buildspec 0.6.0` |
...
| <!-- 20240219171831 --> [:mailbox:](https://lists.apache.org/list?dev@plc4x.apache.org:lte=1M:VOTE) | [plc4x-parent](../content/org/apache/plc4x/plc4x/README.md) | [0.12.0](../content/org/apache/plc4x/plc4x/plc4x-0.12.0.buildspec) :x: | [0.13.0](../content/org/apache/plc4x/plc4x/plc4x-0.13.0.buildspec)  | `bin/add-new-release.sh content/org/apache/plc4x/plc4x/plc4x-0.12.0.buildspec 0.13.0 staging` |
...
| <!-- 20250802231626 --> [commons-cli](../content/org/apache/commons/commons-cli/README.md) | [1.9.0](../content/org/apache/commons/commons-cli/commons-cli-1.9.0.buildspec) :warning: | [1.10.0](../content/org/apache/commons/commons-cli/commons-cli-1.10.0.buildspec) | `bin/add-new-release.sh content/org/apache/commons/commons-cli/commons-cli-1.9.0.buildspec 1.10.0` |
...
| <!-- 20250801081822 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.95.0](../content/org/finos/legend/engine/legend-engine-4.95.0.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.95.0` |
