...
| ---------- | ---- | -- | ------- |
| <!-- 20240916160540 --> [com.io7m.xstructural](../content/com/io7m/xstructural/README.md) | [1.8.1](../content/com/io7m/xstructural/com.io7m.xstructural-1.8.1.buildspec) :white_check_mark: | [1.9.0](../content/com/io7m/xstructural/com.io7m.xstructural-1.9.0.buildspec) | `bin/add-new-release.sh content/com/io7m/xstructural/com.io7m.xstructural-1.8.1.buildspec 1.9.0` |
| <!-- 20240916144204 --> [flexmonster](../content/org/webjars/flexmonster/README.md) | [2.9.85](../content/org/webjars/flexmonster/flexmonster-2.9.85.buildspec) :white_check_mark: | [2.9.86](../content/org/webjars/flexmonster/flexmonster-2.9.86.buildspec) | `bin/add-new-release.sh content/org/webjars/flexmonster/flexmonster-2.9.85.buildspec 2.9.86` |
| <!-- 20240916090907 --> [airbase](../content/io/airlift/airbase/README.md) | [174](../content/io/airlift/airbase/airbase-174.buildspec) :white_check_mark: | [175](../content/io/airlift/airbase/airbase-175.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-174.buildspec 175` |
| <!-- 20240916053929 --> [openapi-jaxrs-client](../content/dk/mada/jaxrs/openapi-jaxrs-client/README.md) | [0.11.5](../content/dk/mada/jaxrs/openapi-jaxrs-client/openapi-jaxrs-client-0.11.5.buildspec) :white_check_mark: | [0.11.6](../content/dk/mada/jaxrs/openapi-jaxrs-client/openapi-jaxrs-client-0.11.6.buildspec) | `bin/add-new-release.sh content/dk/mada/jaxrs/openapi-jaxrs-client/openapi-jaxrs-client-0.11.5.buildspec 0.11.6` |
| <!-- 20240916004746 --> [mybatis-freemarker](../content/org/mybatis/scripting/mybatis-freemarker/README.md) | [1.2.4](../content/org/mybatis/scripting/mybatis-freemarker/mybatis-freemarker-1.2.4.buildspec) :white_check_mark: | [1.3.0](../content/org/mybatis/scripting/mybatis-freemarker/mybatis-freemarker-1.3.0.buildspec) | `bin/add-new-release.sh content/org/mybatis/scripting/mybatis-freemarker/mybatis-freemarker-1.2.4.buildspec 1.3.0` |
| <!-- 20240916004745 --> [mybatis-cdi](../content/org/mybatis/cdi/README.md) | [2.0.2](../content/org/mybatis/cdi/mybatis-cdi-2.0.2.buildspec) :white_check_mark: | [2.1.0](../content/org/mybatis/cdi/mybatis-cdi-2.1.0.buildspec) | `bin/add-new-release.sh content/org/mybatis/cdi/mybatis-cdi-2.0.2.buildspec 2.1.0` |
| <!-- 20240916004744 --> [mybatis-ehcache](../content/org/mybatis/caches/mybatis-ehcache/README.md) | [1.2.3](../content/org/mybatis/caches/mybatis-ehcache/mybatis-ehcache-1.2.3.buildspec) :white_check_mark: | [1.3.0](../content/org/mybatis/caches/mybatis-ehcache/mybatis-ehcache-1.3.0.buildspec) | `bin/add-new-release.sh content/org/mybatis/caches/mybatis-ehcache/mybatis-ehcache-1.2.3.buildspec 1.3.0` |
| <!-- 20240916004743 --> [mybatis-caffeine](../content/org/mybatis/caches/mybatis-caffeine/README.md) | [1.1.0](../content/org/mybatis/caches/mybatis-caffeine/mybatis-caffeine-1.1.0.buildspec) :white_check_mark: | [1.2.0](../content/org/mybatis/caches/mybatis-caffeine/mybatis-caffeine-1.2.0.buildspec) | `bin/add-new-release.sh content/org/mybatis/caches/mybatis-caffeine/mybatis-caffeine-1.1.0.buildspec 1.2.0` |
| <!-- 20240916004742 --> [base-bundle-descriptor](../content/org/mybatis/base-bundle-descriptor/README.md) | [11](../content/org/mybatis/base-bundle-descriptor/base-bundle-descriptor-11.buildspec) :white_check_mark: | [12](../content/org/mybatis/base-bundle-descriptor/base-bundle-descriptor-12.buildspec) | `bin/add-new-release.sh content/org/mybatis/base-bundle-descriptor/base-bundle-descriptor-11.buildspec 12` |
| <!-- 20240915233701 --> [nexus-format-archetype](../content/org/sonatype/nexus/archetypes/nexus-format-archetype/README.md) | [1.0.60](../content/org/sonatype/nexus/archetypes/nexus-format-archetype/nexus-format-archetype-1.0.60.buildspec) :white_check_mark: | [1.0.61](../content/org/sonatype/nexus/archetypes/nexus-format-archetype/nexus-format-archetype-1.0.61.buildspec) | `bin/add-new-release.sh content/org/sonatype/nexus/archetypes/nexus-format-archetype/nexus-format-archetype-1.0.60.buildspec 1.0.61` |
| <!-- 20240915222936 --> [alta-maven-plugin](../content/com/github/veithen/alta/README.md) | [0.8.0](../content/com/github/veithen/alta/alta-maven-plugin-0.8.0.buildspec) :white_check_mark: | [0.8.1](../content/com/github/veithen/alta/alta-maven-plugin-0.8.1.buildspec) | `bin/add-new-release.sh content/com/github/veithen/alta/alta-maven-plugin-0.8.0.buildspec 0.8.1` |
| <!-- 20240915220410 --> [parent](../content/com/github/veithen/parent/README.md) | [51](../content/com/github/veithen/parent/veithen-parent-51.buildspec) :white_check_mark: | [52](../content/com/github/veithen/parent/veithen-parent-52.buildspec) | `bin/add-new-release.sh content/com/github/veithen/parent/veithen-parent-51.buildspec 52` |
...
| <!-- 20240626092322 --> [:mailbox:](https://lists.apache.org/list?dev@sling.apache.org:lte=1M:VOTE) | [slingfeature-maven-plugin](../content/org/apache/sling/slingfeature-maven-plugin/README.md) | [1.8.4](../content/org/apache/sling/slingfeature-maven-plugin/slingfeature-maven-plugin-1.8.4.buildspec) :white_check_mark: | [1.9.0](../content/org/apache/sling/slingfeature-maven-plugin/slingfeature-maven-plugin-1.9.0.buildspec)  | `bin/add-new-release.sh content/org/apache/sling/slingfeature-maven-plugin/slingfeature-maven-plugin-1.8.4.buildspec 1.9.0 staging` |
