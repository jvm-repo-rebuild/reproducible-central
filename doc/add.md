...
| ---------- | ---- | -- | ------- |
| <!-- 20250520144902 --> [toolbox](../content/eu/maveniverse/maven/toolbox/README.md) | [0.8.1](../content/eu/maveniverse/maven/toolbox/toolbox-0.8.1.buildspec) :white_check_mark: | [0.9.0](../content/eu/maveniverse/maven/toolbox/toolbox-0.9.0.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/toolbox/toolbox-0.8.1.buildspec 0.9.0` |
| <!-- 20250520144339 --> [mimir](../content/eu/maveniverse/maven/mimir/README.md) | [0.7.4](../content/eu/maveniverse/maven/mimir/mimir-0.7.4.buildspec) :white_check_mark: | [0.7.5](../content/eu/maveniverse/maven/mimir/mimir-0.7.5.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/mimir/mimir-0.7.4.buildspec 0.7.5` |
| <!-- 20250520142438 --> [njord](../content/eu/maveniverse/maven/njord/README.md) | [0.5.3](../content/eu/maveniverse/maven/njord/njord-0.5.3.buildspec) :white_check_mark: | [0.5.4](../content/eu/maveniverse/maven/njord/njord-0.5.4.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/njord/njord-0.5.3.buildspec 0.5.4` |
| <!-- 20250520131742 --> [langchain4j](../content/dev/langchain4j/README.md) | [1.0.0](../content/dev/langchain4j/langchain4j-1.0.0.buildspec) :white_check_mark: | [1.0.1](../content/dev/langchain4j/langchain4j-1.0.1.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-1.0.0.buildspec 1.0.1` |
| <!-- 20250520114714 --> [commons-parent](../content/org/apache/commons/parent/README.md) | [83](../content/org/apache/commons/parent/commons-parent-83.buildspec) :white_check_mark: | [84](../content/org/apache/commons/parent/commons-parent-84.buildspec) | `bin/add-new-release.sh content/org/apache/commons/parent/commons-parent-83.buildspec 84` |
| <!-- 20250520105935 --> [hibernate-validator](../content/org/hibernate/validator/hibernate-validator/README.md) | [9.0.0.CR1](../content/org/hibernate/validator/hibernate-validator/hibernate-validator-9.0.0.CR1.buildspec) :white_check_mark: | [9.0.0.Final](../content/org/hibernate/validator/hibernate-validator/hibernate-validator-9.0.0.Final.buildspec) | `bin/add-new-release.sh content/org/hibernate/validator/hibernate-validator/hibernate-validator-9.0.0.CR1.buildspec 9.0.0.Final` |
| <!-- 20250520074047 --> [airbase](../content/io/airlift/airbase/README.md) | [260](../content/io/airlift/airbase/airbase-260.buildspec) :white_check_mark: | [261](../content/io/airlift/airbase/airbase-261.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-260.buildspec 261` |
| <!-- 20250519235856 --> [hibernate-core](../content/org/hibernate/orm/hibernate-core/README.md) | [7.0.0.CR2](../content/org/hibernate/orm/hibernate-core/hibernate-core-7.0.0.CR2.buildspec) :white_check_mark: | [7.0.0.Final](../content/org/hibernate/orm/hibernate-core/hibernate-core-7.0.0.Final.buildspec) | `bin/add-new-release.sh content/org/hibernate/orm/hibernate-core/hibernate-core-7.0.0.CR2.buildspec 7.0.0.Final` |
| <!-- 20250519222531 --> [nexus-format-archetype](../content/org/sonatype/nexus/archetypes/nexus-format-archetype/README.md) | [1.0.73](../content/org/sonatype/nexus/archetypes/nexus-format-archetype/nexus-format-archetype-1.0.73.buildspec) :white_check_mark: | [1.0.74](../content/org/sonatype/nexus/archetypes/nexus-format-archetype/nexus-format-archetype-1.0.74.buildspec) | `bin/add-new-release.sh content/org/sonatype/nexus/archetypes/nexus-format-archetype/nexus-format-archetype-1.0.73.buildspec 1.0.74` |
...
| <!-- 20250409071736 --> [:mailbox:](https://lists.apache.org/list?dev@pulsar.apache.org:lte=1M:VOTE) | [pulsar](../content/org/apache/pulsar/README.md) | [4.0.4](../content/org/apache/pulsar/pulsar-4.0.4.buildspec) :warning: | [4.0.5](../content/org/apache/pulsar/pulsar-4.0.5.buildspec)  | `bin/add-new-release.sh content/org/apache/pulsar/pulsar-4.0.4.buildspec 4.0.5 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250520192141 --> [mockito-core](../content/org/mockito/mockito-core/README.md) | [5.17.0](../content/org/mockito/mockito-core/mockito-5.17.0.buildspec) :warning: [:memo:](https://github.com/mockito/mockito/issues/3563) | [5.18.0](../content/org/mockito/mockito-core/mockito-5.18.0.buildspec) | `bin/add-new-release.sh content/org/mockito/mockito-core/mockito-5.17.0.buildspec 5.18.0` |
| <!-- 20250520101912 --> [kubernetes-client-project](../content/io/fabric8/kubernetes-client/README.md) | [7.3.0](../content/io/fabric8/kubernetes-client/kubernetes-client-7.3.0.buildspec) :warning: | [7.3.1](../content/io/fabric8/kubernetes-client/kubernetes-client-7.3.1.buildspec) | `bin/add-new-release.sh content/io/fabric8/kubernetes-client/kubernetes-client-7.3.0.buildspec 7.3.1` |
| <!-- 20250520082806 --> [jpmml-sklearn](../content/org/jpmml/jpmml-sklearn/README.md) | [1.9.7](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.7.buildspec) :warning: | [1.9.8](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.8.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.7.buildspec 1.9.8` |
