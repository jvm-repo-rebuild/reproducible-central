...
| ---------- | ---- | -- | ------- |
| <!-- 20241101203444 --> [jackson-databind](../content/com/fasterxml/jackson/databind/README.md) | [2.18.1](../content/com/fasterxml/jackson/databind/jackson-databind-2.18.1.buildspec) :white_check_mark: | 2.17.3  | `bin/add-new-release.sh content/com/fasterxml/jackson/databind/jackson-databind-2.18.1.buildspec ...` |
| <!-- 20241101202043 --> [jackson-core](../content/com/fasterxml/jackson/core/README.md) | [2.18.1](../content/com/fasterxml/jackson/core/jackson-core-2.18.1.buildspec) :white_check_mark: | 2.17.3  | `bin/add-new-release.sh content/com/fasterxml/jackson/core/jackson-core-2.18.1.buildspec ...` |
| <!-- 20241101195018 --> [jackson-annotations](../content/com/fasterxml/jackson/annotations/README.md) | [2.18.1](../content/com/fasterxml/jackson/annotations/jackson-annotations-2.18.1.buildspec) :white_check_mark: | 2.17.3  | `bin/add-new-release.sh content/com/fasterxml/jackson/annotations/jackson-annotations-2.18.1.buildspec ...` |
| <!-- 20241101194714 --> [jackson-bom](../content/com/fasterxml/jackson/jackson-bom/README.md) | [2.18.1](../content/com/fasterxml/jackson/jackson-bom/jackson-bom-2.18.1.buildspec) :white_check_mark: | 2.17.3  | `bin/add-new-release.sh content/com/fasterxml/jackson/jackson-bom/jackson-bom-2.18.1.buildspec ...` |
| <!-- 20241101161227 --> [env-config](../content/com/github/sitture/env-config/README.md) | [1.10.0](../content/com/github/sitture/env-config/env-config-1.10.0.buildspec) :white_check_mark: | [1.12.0](../content/com/github/sitture/env-config/env-config-1.12.0.buildspec) | `bin/add-new-release.sh content/com/github/sitture/env-config/env-config-1.10.0.buildspec 1.12.0` |
| <!-- 20241101161227 --> [env-config](../content/com/github/sitture/env-config/README.md) | [1.10.0](../content/com/github/sitture/env-config/env-config-1.10.0.buildspec) :white_check_mark: | 1.11.0  | `bin/add-new-release.sh content/com/github/sitture/env-config/env-config-1.10.0.buildspec ...` |
| <!-- 20241101124303 --> [maven-resolver](../content/org/apache/maven/resolver/maven-resolver/README.md) | [2.0.2](../content/org/apache/maven/resolver/maven-resolver/maven-resolver-2.0.2.buildspec) :white_check_mark: | [2.0.3](../content/org/apache/maven/resolver/maven-resolver/maven-resolver-2.0.3.buildspec) | `bin/add-new-release.sh content/org/apache/maven/resolver/maven-resolver/maven-resolver-2.0.2.buildspec 2.0.3` |
...
| <!-- 20241006100740 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [surefire](../content/org/apache/maven/surefire/README.md) | [3.5.1](../content/org/apache/maven/surefire/surefire-3.5.1.buildspec) :white_check_mark: | [3.5.2](../content/org/apache/maven/surefire/surefire-3.5.2.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/surefire/surefire-3.5.1.buildspec 3.5.2 staging` |
| <!-- 20241001080844 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-javadoc-plugin](../content/org/apache/maven/plugins/maven-javadoc-plugin/README.md) | [3.10.1](../content/org/apache/maven/plugins/maven-javadoc-plugin/maven-javadoc-plugin-3.10.1.buildspec) :white_check_mark: | [3.11.1](../content/org/apache/maven/plugins/maven-javadoc-plugin/maven-javadoc-plugin-3.11.1.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-javadoc-plugin/maven-javadoc-plugin-3.10.1.buildspec 3.11.1 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20241101174402 --> [byte-buddy-parent](../content/net/bytebuddy/README.md) | [1.15.7](../content/net/bytebuddy/byte-buddy-1.15.7.buildspec) :warning: | [1.15.8](../content/net/bytebuddy/byte-buddy-1.15.8.buildspec) | `bin/add-new-release.sh content/net/bytebuddy/byte-buddy-1.15.7.buildspec 1.15.8` |
| <!-- 20241101123729 --> [org.apache.sling.servlets.resolver](../content/org/apache/sling/org.apache.sling.servlets.resolver/README.md) | [2.11.2](../content/org/apache/sling/org.apache.sling.servlets.resolver/org.apache.sling.servlets.resolver-2.11.2.buildspec) :warning: [:memo:](https://github.com/apache/sling-org-apache-sling-servlets-resolver/pull/39) | [2.11.4](../content/org/apache/sling/org.apache.sling.servlets.resolver/org.apache.sling.servlets.resolver-2.11.4.buildspec) | `bin/add-new-release.sh content/org/apache/sling/org.apache.sling.servlets.resolver/org.apache.sling.servlets.resolver-2.11.2.buildspec 2.11.4` |
| <!-- 20241101102917 --> [glassfish-parent](../content/org/glassfish/main/README.md) | [8.0.0-M1](../content/org/glassfish/main/glassfish-8.0.0-M1.buildspec) :warning: | [8.0.0-JDK17-M7](../content/org/glassfish/main/glassfish-8.0.0-JDK17-M7.buildspec) | `bin/add-new-release.sh content/org/glassfish/main/glassfish-8.0.0-M1.buildspec 8.0.0-JDK17-M7` |
| <!-- 20241101075826 --> [jpmml-statsmodels](../content/org/jpmml/jpmml-statsmodels/README.md) | [1.1.1](../content/org/jpmml/jpmml-statsmodels/jpmml-statsmodels-1.1.1.buildspec) :warning: | [1.1.2](../content/org/jpmml/jpmml-statsmodels/jpmml-statsmodels-1.1.2.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-statsmodels/jpmml-statsmodels-1.1.1.buildspec 1.1.2` |
| <!-- 20241101042343 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.56.0](../content/org/finos/legend/engine/legend-engine-4.56.0.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.65.0](../content/org/finos/legend/engine/legend-engine-4.65.0.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.56.0.buildspec 4.65.0` |
| <!-- 20241029214125 --> [acs-aem-commons](../content/com/adobe/acs/aem-commons/README.md) | [6.7.0](../content/com/adobe/acs/aem-commons/acs-aem-commons-6.7.0.buildspec) :warning: | [6.9.0](../content/com/adobe/acs/aem-commons/acs-aem-commons-6.9.0.buildspec) | `bin/add-new-release.sh content/com/adobe/acs/aem-commons/acs-aem-commons-6.7.0.buildspec 6.9.0` |
...
| artifactId | newest |
| ---------- | ------ |
| <!-- 20241101204032 --> [jackson-jr-parent](../content/com/fasterxml/jackson/jr/README.md) | 2.18.1 :warning: |
| <!-- 20241030100408 --> [quarkus-project](../content/io/quarkus/README.md) | 3.16.1 :warning: |
| <!-- 20241030033015 --> [nifi](../content/org/apache/nifi/nifi/README.md) | 2.0.0-M4 :warning: |
| <!-- 20241029101622 --> [org.apache.sling.models.impl](../content/org/apache/sling/org.apache.sling.models.impl/README.md) | 1.7.2 :warning: [:memo:](https://github.com/apache/sling-org-apache-sling-models-impl/pull/58) |
| <!-- 20241029000623 --> [jackson-dataformats-binary](../content/com/fasterxml/jackson/dataformat/jackson-dataformats-binary/README.md) | 2.18.1 :warning: |
| <!-- 20241028134741 --> [jooby](../content/io/jooby/README.md) | 3.4.3 :warning: |
