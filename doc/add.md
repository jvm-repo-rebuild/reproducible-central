...
| ---------- | ---- | -- | ------- |
| <!-- 20240410160923 --> [swagger-ui](../content/org/webjars/swagger-ui/README.md) | [5.13.0](../content/org/webjars/swagger-ui/swagger-ui-5.13.0.buildspec) :white_check_mark: | [5.15.0](../content/org/webjars/swagger-ui/swagger-ui-5.15.0.buildspec) | `bin/add-new-release.sh content/org/webjars/swagger-ui/swagger-ui-5.13.0.buildspec 5.15.0` |
| <!-- 20240409170609 --> [spotbugs-maven-plugin](../content/com/github/spotbugs/spotbugs-maven-plugin/README.md) | [4.8.3.1](../content/com/github/spotbugs/spotbugs-maven-plugin/spotbugs-maven-plugin-4.8.3.1.buildspec) :white_check_mark: | [4.8.4.0](../content/com/github/spotbugs/spotbugs-maven-plugin/spotbugs-maven-plugin-4.8.4.0.buildspec) | `bin/add-new-release.sh content/com/github/spotbugs/spotbugs-maven-plugin/spotbugs-maven-plugin-4.8.3.1.buildspec 4.8.4.0` |
| <!-- 20240408232650 --> [alluxio-parent](../content/org/alluxio/alluxio/README.md) | [311](../content/org/alluxio/alluxio/alluxio-311.buildspec) :white_check_mark: | [312](../content/org/alluxio/alluxio/alluxio-312.buildspec) | `bin/add-new-release.sh content/org/alluxio/alluxio/alluxio-311.buildspec 312` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20240326084103 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-gpg-plugin](../content/org/apache/maven/plugins/maven-gpg-plugin/README.md) | [3.2.2](../content/org/apache/maven/plugins/maven-gpg-plugin/maven-gpg-plugin-3.2.2.buildspec) :white_check_mark: | [3.2.3](../content/org/apache/maven/plugins/maven-gpg-plugin/maven-gpg-plugin-3.2.3.buildspec) [6 :white_check_mark: ](../content/org/apache/maven/plugins/maven-gpg-plugin/maven-gpg-plugin-3.2.3.buildcompare) | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-gpg-plugin/maven-gpg-plugin-3.2.2.buildspec 3.2.3 staging` |
| <!-- 20240110202953 --> [:mailbox:](https://lists.apache.org/list?dev@karaf.apache.org:lte=1M:VOTE) | [karaf](../content/org/apache/karaf/karaf/README.md) | [4.4.5](../content/org/apache/karaf/karaf/karaf-4.4.5.buildspec) :warning: [:memo:](https://issues.apache.org/jira/browse/KARAF-7797) | [4.4.6](../content/org/apache/karaf/karaf/karaf-4.4.6.buildspec)  | `bin/add-new-release.sh content/org/apache/karaf/karaf/karaf-4.4.5.buildspec 4.4.6 staging` |
...
| <!-- 20220916064032 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-jar-plugin](../content/org/apache/maven/plugins/maven-jar-plugin/README.md) | [3.3.0](../content/org/apache/maven/plugins/maven-jar-plugin/maven-jar-plugin-3.3.0.buildspec) :white_check_mark: | [3.4.0](../content/org/apache/maven/plugins/maven-jar-plugin/maven-jar-plugin-3.4.0.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-jar-plugin/maven-jar-plugin-3.3.0.buildspec 3.4.0 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20240409223325 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.4.5](../content/org/finos/legend/engine/legend-engine-4.4.5.buildspec) :warning: | [4.43.1](../content/org/finos/legend/engine/legend-engine-4.43.1.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.4.5.buildspec 4.43.1` |
| <!-- 20240409075344 --> [logback-parent](../content/ch/qos/logback/README.md) | [1.5.1](../content/ch/qos/logback/logback-1.5.1.buildspec) :warning: | [1.5.4](../content/ch/qos/logback/logback-1.5.4.buildspec) | `bin/add-new-release.sh content/ch/qos/logback/logback-1.5.1.buildspec 1.5.4` |
| <!-- 20240407170739 --> [com.io7m.idstore](../content/com/io7m/idstore/README.md) | [1.0.0](../content/com/io7m/idstore/com.io7m.idstore-1.0.0.buildspec) :warning: | [1.2.1](../content/com/io7m/idstore/com.io7m.idstore-1.2.1.buildspec) | `bin/add-new-release.sh content/com/io7m/idstore/com.io7m.idstore-1.0.0.buildspec 1.2.1` |
| <!-- 20240407163916 --> [psi-probe](../content/com/github/psi-probe/README.md) | [4.1.4](../content/com/github/psi-probe/psi-probe-4.1.4.buildspec) :warning: | [4.1.5](../content/com/github/psi-probe/psi-probe-4.1.5.buildspec) | `bin/add-new-release.sh content/com/github/psi-probe/psi-probe-4.1.4.buildspec 4.1.5` |
| <!-- 20240405180826 --> [opentelemetry-sdk](../content/io/opentelemetry/java/README.md) | [1.14.0](../content/io/opentelemetry/java/opentelemetry-sdk-1.14.0.buildspec) :warning: [:memo:](https://github.com/open-telemetry/opentelemetry-java/issues/4488) | [1.37.0](../content/io/opentelemetry/java/opentelemetry-sdk-1.37.0.buildspec) | `bin/add-new-release.sh content/io/opentelemetry/java/opentelemetry-sdk-1.14.0.buildspec 1.37.0` |
...
| <!-- 20240331142426 --> [glassfish-parent](../content/org/glassfish/main/README.md) | [8.0.0-M1](../content/org/glassfish/main/glassfish-8.0.0-M1.buildspec) :warning: | [8.0.0-M3](../content/org/glassfish/main/glassfish-8.0.0-M3.buildspec) | `bin/add-new-release.sh content/org/glassfish/main/glassfish-8.0.0-M1.buildspec 8.0.0-M3` |
| <!-- 20240328075819 --> [camel](../content/org/apache/camel/camel/README.md) | [4.0.0-RC1](../content/org/apache/camel/camel/camel-4.0.0-RC1.buildspec) :warning: | [4.5.0](../content/org/apache/camel/camel/camel-4.5.0.buildspec) | `bin/add-new-release.sh content/org/apache/camel/camel/camel-4.0.0-RC1.buildspec 4.5.0` |
...
| <!-- 20240325133641 --> [kubernetes-client-project](../content/io/fabric8/kubernetes-client/README.md) | [6.4.0](../content/io/fabric8/kubernetes-client/kubernetes-client-6.4.0.buildspec) :warning: | [6.11.0](../content/io/fabric8/kubernetes-client/kubernetes-client-6.11.0.buildspec) | `bin/add-new-release.sh content/io/fabric8/kubernetes-client/kubernetes-client-6.4.0.buildspec 6.11.0` |
...
| <!-- 20240321044846 --> [orc](../content/org/apache/orc/README.md) | [1.9.2](../content/org/apache/orc/orc-1.9.2.buildspec) :warning: | [2.0.0](../content/org/apache/orc/orc-2.0.0.buildspec) | `bin/add-new-release.sh content/org/apache/orc/orc-1.9.2.buildspec 2.0.0` |
| <!-- 20240320120725 --> [opentelemetry-instrumentation-api](../content/io/opentelemetry/instrumentation/README.md) | [1.17.0-alpha](../content/io/opentelemetry/instrumentation/opentelemetry-1.17.0-alpha.buildspec) :warning: | [2.2.0](../content/io/opentelemetry/instrumentation/opentelemetry-2.2.0.buildspec) | `bin/add-new-release.sh content/io/opentelemetry/instrumentation/opentelemetry-1.17.0-alpha.buildspec 2.2.0` |
...
| <!-- 20240318015825 --> [displaytag-doc](../content/com/github/hazendaz/displaytag-doc/README.md) | [2.5.4](../content/com/github/hazendaz/displaytag-doc/displaytag-doc-2.5.4.buildspec) :warning: | [3.0.1](../content/com/github/hazendaz/displaytag-doc/displaytag-doc-3.0.1.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/displaytag-doc/displaytag-doc-2.5.4.buildspec 3.0.1` |
...
| <!-- 20240313193606 --> [guava](../content/com/google/guava/README.md) | [32.0.1-jre](../content/com/google/guava/guava-32.0.1-jre.buildspec) :warning: | [33.1.0-jre](../content/com/google/guava/guava-33.1.0-jre.buildspec) | `bin/add-new-release.sh content/com/google/guava/guava-32.0.1-jre.buildspec 33.1.0-jre` |
...
| <!-- 20240313093836 --> [io.wcm.handler.media](../content/io/wcm/io.wcm.handler/media/README.md) | [1.15.6](../content/io/wcm/io.wcm.handler/media/wcm-media-1.15.6.buildspec) :warning: | [2.0.2](../content/io/wcm/io.wcm.handler/media/wcm-media-2.0.2.buildspec) | `bin/add-new-release.sh content/io/wcm/io.wcm.handler/media/wcm-media-1.15.6.buildspec 2.0.2` |
...
| <!-- 20240408141700 --> [toolbox](../content/eu/maveniverse/maven/toolbox/README.md) | 0.1.4 :warning: |
| <!-- 20240408042547 --> [jpmml-statsmodels](../content/org/jpmml/jpmml-statsmodels/README.md) | 1.1.0 :warning: |
| <!-- 20240407012912 --> [spoon-core](../content/fr/inria/gforge/spoon/spoon-core/README.md) | 11.0.1-beta-1 :x: |
| <!-- 20240403213055 --> [com.io7m.quixote](../content/com/io7m/quixote/README.md) | 1.2.0 :warning: |
| <!-- 20240403160841 --> [mybatis](../content/org/mybatis/mybatis/README.md) | 3.5.16 :warning: |
| <!-- 20240329181937 --> [hive](../content/org/apache/hive/README.md) | 4.0.0 :warning: [:memo:](https://issues.apache.org/jira/browse/HIVE-28186) |
| <!-- 20240327033253 --> [woodstox-core](../content/com/fasterxml/woodstox/README.md) | 6.6.2 :warning: |
| <!-- 20240322082711 --> [pmd](../content/net/sourceforge/pmd/README.md) | 7.0.0 :warning: |
| <!-- 20240314170258 --> [jdbi3-root](../content/org/jdbi/README.md) | 3.45.1 :warning: [:memo:](https://github.com/basepom/basepom/pull/73) |
| <!-- 20240314105258 --> [jandex-parent](../content/io/smallrye/jandex/README.md) | 3.1.7 :warning: |
| <!-- 20240312221204 --> [jackson-dataformats-binary](../content/com/fasterxml/jackson/dataformat/jackson-dataformats-binary/README.md) | 2.17.0 :warning: |
| <!-- 20240312215625 --> [jackson-jr-parent](../content/com/fasterxml/jackson/jr/README.md) | 2.17.0 :warning: |
...
| <!-- 20240229123805 --> [jreleaser](../content/org/jreleaser/README.md) | 1.11.0 :warning: |
...
| <!-- 20240225160646 --> [bcel](../content/org/apache/commons/bcel/README.md) | 6.8.2 :warning: |
