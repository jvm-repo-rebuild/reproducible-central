...
| ---------- | ---- | -- | ------- |
| <!-- 20250220074216 --> [avaje-jex-parent](../content/io/avaje/jex/README.md) | [3.0-RC18](../content/io/avaje/jex/avaje-jex-3.0-RC18.buildspec) :white_check_mark: | [3.0-RC20](../content/io/avaje/jex/avaje-jex-3.0-RC20.buildspec) | `bin/add-new-release.sh content/io/avaje/jex/avaje-jex-3.0-RC18.buildspec 3.0-RC20` |
| <!-- 20250220074216 --> [avaje-jex-parent](../content/io/avaje/jex/README.md) | [3.0-RC18](../content/io/avaje/jex/avaje-jex-3.0-RC18.buildspec) :white_check_mark: | 3.0-RC19  | `bin/add-new-release.sh content/io/avaje/jex/avaje-jex-3.0-RC18.buildspec ...` |
| <!-- 20250220064243 --> [airbase](../content/io/airlift/airbase/README.md) | [219](../content/io/airlift/airbase/airbase-219.buildspec) :white_check_mark: | [220](../content/io/airlift/airbase/airbase-220.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-219.buildspec 220` |
| <!-- 20250220021921 --> [trino-root](../content/io/trino/README.md) | [470](../content/io/trino/trino-470.buildspec) :white_check_mark: | [471](../content/io/trino/trino-471.buildspec) | `bin/add-new-release.sh content/io/trino/trino-470.buildspec 471` |
| <!-- 20250219095824 --> [qpid-jms-parent](../content/org/apache/qpid/jms/README.md) | [2.7.0](../content/org/apache/qpid/jms/qpid-jms-2.7.0.buildspec) :white_check_mark: | 1.13.0  | `bin/add-new-release.sh content/org/apache/qpid/jms/qpid-jms-2.7.0.buildspec ...` |
| <!-- 20250218223309 --> [maven-clean-plugin](../content/org/apache/maven/plugins/maven-clean-plugin/README.md) | [4.0.0-beta-2](../content/org/apache/maven/plugins/maven-clean-plugin/maven-clean-plugin-4.0.0-beta-2.buildspec) :white_check_mark: | 3.4.1  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-clean-plugin/maven-clean-plugin-4.0.0-beta-2.buildspec ...` |
