...
| ---------- | ---- | -- | ------- |
| <!-- 20250317193038 --> [toolbox](../content/eu/maveniverse/maven/toolbox/README.md) | [0.6.4](../content/eu/maveniverse/maven/toolbox/toolbox-0.6.4.buildspec) :white_check_mark: | [0.7.0](../content/eu/maveniverse/maven/toolbox/toolbox-0.7.0.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/toolbox/toolbox-0.6.4.buildspec 0.7.0` |
| <!-- 20250317191048 --> [jetty-project](../content/org/eclipse/jetty/jetty-project/README.md) | [12.1.0.alpha1](../content/org/eclipse/jetty/jetty-project/jetty-project-12.1.0.alpha1.buildspec) :white_check_mark: | 12.0.18  | `bin/add-new-release.sh content/org/eclipse/jetty/jetty-project/jetty-project-12.1.0.alpha1.buildspec ...` |
| <!-- 20250317184921 --> [artemis-pom](../content/org/apache/activemq/artemis/README.md) | [2.39.0](../content/org/apache/activemq/artemis/artemis-2.39.0.buildspec) :white_check_mark: | [2.40.0](../content/org/apache/activemq/artemis/artemis-2.40.0.buildspec) | `bin/add-new-release.sh content/org/apache/activemq/artemis/artemis-2.39.0.buildspec 2.40.0` |
| <!-- 20250317154906 --> [github-client](../content/com/spotify/github-client/README.md) | [0.3.11](../content/com/spotify/github-client/github-client-0.3.11.buildspec) :white_check_mark: | [0.4.0](../content/com/spotify/github-client/github-client-0.4.0.buildspec) | `bin/add-new-release.sh content/com/spotify/github-client/github-client-0.3.11.buildspec 0.4.0` |
| <!-- 20250317145549 --> [flexmonster](../content/org/webjars/flexmonster/README.md) | [2.9.98](../content/org/webjars/flexmonster/flexmonster-2.9.98.buildspec) :white_check_mark: | [2.9.99](../content/org/webjars/flexmonster/flexmonster-2.9.99.buildspec) | `bin/add-new-release.sh content/org/webjars/flexmonster/flexmonster-2.9.98.buildspec 2.9.99` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250317121336 --> [crypto-commons](../content/net/osslabz/crypto-commons/README.md) | [0.6.0](../content/net/osslabz/crypto-commons/crypto-commons-0.6.0.buildspec) :warning: [:memo:](https://github.com/osslabz/crypto-commons/pull/54) | [0.6.1](../content/net/osslabz/crypto-commons/crypto-commons-0.6.1.buildspec) | `bin/add-new-release.sh content/net/osslabz/crypto-commons/crypto-commons-0.6.0.buildspec 0.6.1` |
| <!-- 20250317082151 --> [bitcoin-commons](../content/net/osslabz/bitcoin-commons/README.md) | [0.2.1](../content/net/osslabz/bitcoin-commons/bitcoin-commons-0.2.1.buildspec) :warning: | [0.3.0](../content/net/osslabz/bitcoin-commons/bitcoin-commons-0.3.0.buildspec) | `bin/add-new-release.sh content/net/osslabz/bitcoin-commons/bitcoin-commons-0.2.1.buildspec 0.3.0` |
