...
| ---------- | ---- | -- | ------- |
| <!-- 20250926172437 --> [error-prone-support](../content/tech/picnic/error-prone-support/error-prone-support/README.md) | [0.24.0](../content/tech/picnic/error-prone-support/error-prone-support/error-prone-support-0.24.0.buildspec) :white_check_mark: | [0.25.0](../content/tech/picnic/error-prone-support/error-prone-support/error-prone-support-0.25.0.buildspec) | `bin/add-new-release.sh content/tech/picnic/error-prone-support/error-prone-support/error-prone-support-0.24.0.buildspec 0.25.0` |
| <!-- 20250926151932 --> [mimir](../content/eu/maveniverse/maven/mimir/README.md) | [0.9.2](../content/eu/maveniverse/maven/mimir/mimir-0.9.2.buildspec) :white_check_mark: | [0.9.3](../content/eu/maveniverse/maven/mimir/mimir-0.9.3.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/mimir/mimir-0.9.2.buildspec 0.9.3` |
| <!-- 20250926105334 --> [langchain4j](../content/dev/langchain4j/README.md) | [1.5.0](../content/dev/langchain4j/langchain4j-1.5.0.buildspec) :white_check_mark: | [1.6.0](../content/dev/langchain4j/langchain4j-1.6.0.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-1.5.0.buildspec 1.6.0` |
| <!-- 20250926075339 --> [micronaut-maven-plugin](../content/io/micronaut/maven/micronaut-maven-plugin/README.md) | [4.10.1](../content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-4.10.1.buildspec) :white_check_mark: | [4.10.2](../content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-4.10.2.buildspec) | `bin/add-new-release.sh content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-4.10.1.buildspec 4.10.2` |
| <!-- 20250926034735 --> [flowlogix](../content/com/flowlogix/README.md) | [9.0.11](../content/com/flowlogix/flowlogix-9.0.11.buildspec) :white_check_mark: | [10.0.2](../content/com/flowlogix/flowlogix-10.0.2.buildspec) | `bin/add-new-release.sh content/com/flowlogix/flowlogix-9.0.11.buildspec 10.0.2` |
| <!-- 20250926034735 --> [flowlogix](../content/com/flowlogix/README.md) | [9.0.11](../content/com/flowlogix/flowlogix-9.0.11.buildspec) :white_check_mark: | 10.0.1 10  | `bin/add-new-release.sh content/com/flowlogix/flowlogix-9.0.11.buildspec ...` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250926194534 --> [jpmml-python](../content/org/jpmml/jpmml-python/README.md) | [1.3.7](../content/org/jpmml/jpmml-python/jpmml-python-1.3.7.buildspec) :warning: | [1.3.8](../content/org/jpmml/jpmml-python/jpmml-python-1.3.8.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-python/jpmml-python-1.3.7.buildspec 1.3.8` |
...
| <!-- 20250926104912 --> [flink-kubernetes-operator-parent](../content/org/apache/flink/flink-kubernetes-operator/README.md) | [1.12.1](../content/org/apache/flink/flink-kubernetes-operator/flink-kubernetes-operator-1.12.1.buildspec) :warning: | [1.13.0](../content/org/apache/flink/flink-kubernetes-operator/flink-kubernetes-operator-1.13.0.buildspec) | `bin/add-new-release.sh content/org/apache/flink/flink-kubernetes-operator/flink-kubernetes-operator-1.12.1.buildspec 1.13.0` |
