...
| ---------- | ---- | -- | ------- |
| <!-- 20240829192212 --> [trino-root](../content/io/trino/README.md) | [454](../content/io/trino/trino-454.buildspec) :white_check_mark: | [455](../content/io/trino/trino-455.buildspec) | `bin/add-new-release.sh content/io/trino/trino-454.buildspec 455` |
| <!-- 20240829163600 --> [byte-buddy-parent](../content/net/bytebuddy/README.md) | [1.15.0](../content/net/bytebuddy/byte-buddy-1.15.0.buildspec) :white_check_mark: | [1.15.1](../content/net/bytebuddy/byte-buddy-1.15.1.buildspec) | `bin/add-new-release.sh content/net/bytebuddy/byte-buddy-1.15.0.buildspec 1.15.1` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20240829202443 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.4.5](../content/org/finos/legend/engine/legend-engine-4.4.5.buildspec) :warning: | [4.55.0](../content/org/finos/legend/engine/legend-engine-4.55.0.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.4.5.buildspec 4.55.0` |
