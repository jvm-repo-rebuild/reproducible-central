...
| ---------- | ---- | -- | ------- |
| <!-- 20250316190945 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [11.3-RC1](../content/io/avaje/inject/avaje-inject-11.3-RC1.buildspec) :white_check_mark: | [11.3-javax](../content/io/avaje/inject/avaje-inject-11.3-javax.buildspec) | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-11.3-RC1.buildspec 11.3-javax` |
| <!-- 20250316190945 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [11.3-RC1](../content/io/avaje/inject/avaje-inject-11.3-RC1.buildspec) :white_check_mark: | 11.3  | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-11.3-RC1.buildspec ...` |
| <!-- 20250316151506 --> [airbase](../content/io/airlift/airbase/README.md) | [231](../content/io/airlift/airbase/airbase-231.buildspec) :white_check_mark: | [232](../content/io/airlift/airbase/airbase-232.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-231.buildspec 232` |
| <!-- 20250316020624 --> [spoon-core](../content/fr/inria/gforge/spoon/spoon-core/README.md) | [11.2.1-beta-7](../content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.2.1-beta-7.buildspec) :white_check_mark: | [11.2.1-beta-8](../content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.2.1-beta-8.buildspec) | `bin/add-new-release.sh content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.2.1-beta-7.buildspec 11.2.1-beta-8` |
| <!-- 20250122170449 --> [metricshub-community-connectors](../content/org/sentrysoftware/metricshub-community-connectors/README.md) | [1.0.04](../content/org/sentrysoftware/metricshub-community-connectors/metricshub-community-connectors-1.0.04.buildspec) :white_check_mark: | [1.0.08](../content/org/sentrysoftware/metricshub-community-connectors/metricshub-community-connectors-1.0.08.buildspec) | `bin/add-new-release.sh content/org/sentrysoftware/metricshub-community-connectors/metricshub-community-connectors-1.0.04.buildspec 1.0.08` |
| <!-- 20250122170449 --> [metricshub-community-connectors](../content/org/sentrysoftware/metricshub-community-connectors/README.md) | [1.0.04](../content/org/sentrysoftware/metricshub-community-connectors/metricshub-community-connectors-1.0.04.buildspec) :white_check_mark: | 1.0.07 1.0.06 1.0.05  | `bin/add-new-release.sh content/org/sentrysoftware/metricshub-community-connectors/metricshub-community-connectors-1.0.04.buildspec ...` |
...
| <!-- 20240709172507 --> [:mailbox:](https://lists.apache.org/list?dev@org.apache.apache.org:lte=1M:VOTE) | [apache](../content/org/apache/apache/README.md) | [33](../content/org/apache/apache/apache-33.buildspec) :white_check_mark: | [34](../content/org/apache/apache/apache-34.buildspec)  | `bin/add-new-release.sh content/org/apache/apache/apache-33.buildspec 34 staging` |
| <!-- 20240709172445 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-parent](../content/org/apache/maven/parent/README.md) | [43](../content/org/apache/maven/parent/maven-parent-43.buildspec) :white_check_mark: | [44](../content/org/apache/maven/parent/maven-parent-44.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/parent/maven-parent-43.buildspec 44 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250315193648 --> [mockito-core](../content/org/mockito/mockito-core/README.md) | [5.16.0](../content/org/mockito/mockito-core/mockito-5.16.0.buildspec) :warning: [:memo:](https://github.com/mockito/mockito/issues/3563) | [5.16.1](../content/org/mockito/mockito-core/mockito-5.16.1.buildspec) | `bin/add-new-release.sh content/org/mockito/mockito-core/mockito-5.16.0.buildspec 5.16.1` |
...
| artifactId | newest |
| ---------- | ------ |
| <!-- 20250314141318 --> [crypto-commons](../content/net/osslabz/crypto-commons/README.md) | 0.6.0 :warning: [:memo:](https://github.com/osslabz/crypto-commons/pull/54) |
...
| <!-- 20250313081333 --> [jpmml-sklearn](../content/org/jpmml/jpmml-sklearn/README.md) | 1.9.2 :warning: |
