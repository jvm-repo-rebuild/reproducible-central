...
| ---------- | ---- | -- | ------- |
| <!-- 20251201155621 --> [org.apache.sling.servlets.resolver](../content/org/apache/sling/org.apache.sling.servlets.resolver/README.md) | [3.0.2](../content/org/apache/sling/org.apache.sling.servlets.resolver/org.apache.sling.servlets.resolver-3.0.2.buildspec) :white_check_mark: | [3.0.4](../content/org/apache/sling/org.apache.sling.servlets.resolver/org.apache.sling.servlets.resolver-3.0.4.buildspec) | `bin/add-new-release.sh content/org/apache/sling/org.apache.sling.servlets.resolver/org.apache.sling.servlets.resolver-3.0.2.buildspec 3.0.4` |
| <!-- 20251201155519 --> [avaje-validator-parent](../content/io/avaje/validator/README.md) | [2.15-RC1](../content/io/avaje/validator/avaje-validator-2.15-RC1.buildspec) :white_check_mark: | [2.15-RC2](../content/io/avaje/validator/avaje-validator-2.15-RC2.buildspec) | `bin/add-new-release.sh content/io/avaje/validator/avaje-validator-2.15-RC1.buildspec 2.15-RC2` |
| <!-- 20251201154534 --> [avaje-http-parent](../content/io/avaje/http/README.md) | [3.6-RC2](../content/io/avaje/http/avaje-http-3.6-RC2.buildspec) :white_check_mark: | [3.6-RC3](../content/io/avaje/http/avaje-http-3.6-RC3.buildspec) | `bin/add-new-release.sh content/io/avaje/http/avaje-http-3.6-RC2.buildspec 3.6-RC3` |
| <!-- 20251201154119 --> [avaje-prisms-parent](../content/io/avaje/prisms/README.md) | [1.44-RC4](../content/io/avaje/prisms/avaje-prisms-1.44-RC4.buildspec) :white_check_mark: | [1.44](../content/io/avaje/prisms/avaje-prisms-1.44.buildspec) | `bin/add-new-release.sh content/io/avaje/prisms/avaje-prisms-1.44-RC4.buildspec 1.44` |
| <!-- 20251201153810 --> [avaje-jsonb-parent](../content/io/avaje/jsonb/README.md) | [3.8](../content/io/avaje/jsonb/avaje-jsonb-3.8.buildspec) :white_check_mark: | [3.9-RC2](../content/io/avaje/jsonb/avaje-jsonb-3.9-RC2.buildspec) | `bin/add-new-release.sh content/io/avaje/jsonb/avaje-jsonb-3.8.buildspec 3.9-RC2` |
| <!-- 20251201153810 --> [avaje-jsonb-parent](../content/io/avaje/jsonb/README.md) | [3.8](../content/io/avaje/jsonb/avaje-jsonb-3.8.buildspec) :white_check_mark: | 3.9-RC1  | `bin/add-new-release.sh content/io/avaje/jsonb/avaje-jsonb-3.8.buildspec ...` |
| <!-- 20251201110741 --> [scg-base](../content/io/telicent/smart-caches/graph/scg-base/README.md) | [0.92.1](../content/io/telicent/smart-caches/graph/scg-base/scg-base-0.92.1.buildspec) :white_check_mark: | [0.92.2](../content/io/telicent/smart-caches/graph/scg-base/scg-base-0.92.2.buildspec) | `bin/add-new-release.sh content/io/telicent/smart-caches/graph/scg-base/scg-base-0.92.1.buildspec 0.92.2` |
| <!-- 20251201102121 --> [airbase](../content/io/airlift/airbase/README.md) | [330](../content/io/airlift/airbase/airbase-330.buildspec) :white_check_mark: | [331](../content/io/airlift/airbase/airbase-331.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-330.buildspec 331` |
| <!-- 20251201095136 --> [hibernate-search-bom](../content/org/hibernate/search/hibernate-search-bom/README.md) | [8.1.2.Final](../content/org/hibernate/search/hibernate-search-bom/hibernate-search-parent-8.1.2.Final.buildspec) :white_check_mark: | [8.2.0.CR1](../content/org/hibernate/search/hibernate-search-bom/hibernate-search-parent-8.2.0.CR1.buildspec) | `bin/add-new-release.sh content/org/hibernate/search/hibernate-search-bom/hibernate-search-parent-8.1.2.Final.buildspec 8.2.0.CR1` |
| <!-- 20251201093738 --> [github-client](../content/com/spotify/github-client/README.md) | [0.5.1](../content/com/spotify/github-client/github-client-0.5.1.buildspec) :white_check_mark: | [0.5.2](../content/com/spotify/github-client/github-client-0.5.2.buildspec) | `bin/add-new-release.sh content/com/spotify/github-client/github-client-0.5.1.buildspec 0.5.2` |
| <!-- 20251201082521 --> [hibernate-core](../content/org/hibernate/orm/hibernate-core/README.md) | [7.2.0.CR3](../content/org/hibernate/orm/hibernate-core/hibernate-core-7.2.0.CR3.buildspec) :white_check_mark: | 7.1.11.Final  | `bin/add-new-release.sh content/org/hibernate/orm/hibernate-core/hibernate-core-7.2.0.CR3.buildspec ...` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20251201192218 --> [avaje-jex-parent](../content/io/avaje/jex/README.md) | [3.4-RC1](../content/io/avaje/jex/avaje-jex-3.4-RC1.buildspec) :warning: | [3.4-RC2](../content/io/avaje/jex/avaje-jex-3.4-RC2.buildspec) | `bin/add-new-release.sh content/io/avaje/jex/avaje-jex-3.4-RC1.buildspec 3.4-RC2` |
| <!-- 20251201155152 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [12.1-RC3](../content/io/avaje/inject/avaje-inject-12.1-RC3.buildspec) :warning: | [12.1-RC5](../content/io/avaje/inject/avaje-inject-12.1-RC5.buildspec) | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-12.1-RC3.buildspec 12.1-RC5` |
| <!-- 20251201061731 --> [mybatis-spring-boot](../content/org/mybatis/spring/boot/mybatis-spring-boot/README.md) | [3.0.5](../content/org/mybatis/spring/boot/mybatis-spring-boot/mybatis-spring-boot-3.0.5.buildspec) :warning: | [4.0.0](../content/org/mybatis/spring/boot/mybatis-spring-boot/mybatis-spring-boot-4.0.0.buildspec) | `bin/add-new-release.sh content/org/mybatis/spring/boot/mybatis-spring-boot/mybatis-spring-boot-3.0.5.buildspec 4.0.0` |
| <!-- 20251201061731 --> [mybatis-spring-boot](../content/org/mybatis/spring/boot/README.md) | [3.0.5](../content/org/mybatis/spring/boot/mybatis-spring-boot-3.0.5.buildspec) :warning: | [4.0.0](../content/org/mybatis/spring/boot/mybatis-spring-boot-4.0.0.buildspec) | `bin/add-new-release.sh content/org/mybatis/spring/boot/mybatis-spring-boot-3.0.5.buildspec 4.0.0` |
| <!-- 20251130174727 --> [com.io7m.looseleaf](../content/com/io7m/looseleaf/README.md) | [3.0.0](../content/com/io7m/looseleaf/com.io7m.looseleaf-3.0.0.buildspec) :warning: [:memo:](https://github.com/mojohaus/buildnumber-maven-plugin/issues/229) | [4.0.0](../content/com/io7m/looseleaf/com.io7m.looseleaf-4.0.0.buildspec) | `bin/add-new-release.sh content/com/io7m/looseleaf/com.io7m.looseleaf-3.0.0.buildspec 4.0.0` |
| <!-- 20251130114712 --> [jpmml-python](../content/org/jpmml/jpmml-python/README.md) | [1.3.9](../content/org/jpmml/jpmml-python/jpmml-python-1.3.9.buildspec) :warning: | [1.3.11](../content/org/jpmml/jpmml-python/jpmml-python-1.3.11.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-python/jpmml-python-1.3.9.buildspec 1.3.11` |
...
| <!-- 20251129105919 --> [com.io7m.dixmont](../content/com/io7m/dixmont/README.md) | 3.0.0 :warning: |
...
| <!-- 20251128105054 --> [commons-daemon](../content/org/apache/commons/commons-daemon/README.md) | 1.5.0 :warning: |
