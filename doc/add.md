...
| ---------- | ---- | -- | ------- |
| <!-- 20241104150246 --> [env-config](../content/com/github/sitture/env-config/README.md) | [1.12.0](../content/com/github/sitture/env-config/env-config-1.12.0.buildspec) :white_check_mark: | [1.12.1](../content/com/github/sitture/env-config/env-config-1.12.1.buildspec) | `bin/add-new-release.sh content/com/github/sitture/env-config/env-config-1.12.0.buildspec 1.12.1` |
| <!-- 20241104120710 --> [airbase](../content/io/airlift/airbase/README.md) | [195](../content/io/airlift/airbase/airbase-195.buildspec) :white_check_mark: | [196](../content/io/airlift/airbase/airbase-196.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-195.buildspec 196` |
...
| <!-- 20241103233526 --> [byte-buddy-parent](../content/net/bytebuddy/README.md) | [1.15.8](../content/net/bytebuddy/byte-buddy-1.15.8.buildspec) :warning: | [1.15.10](../content/net/bytebuddy/byte-buddy-1.15.10.buildspec) | `bin/add-new-release.sh content/net/bytebuddy/byte-buddy-1.15.8.buildspec 1.15.10` |
