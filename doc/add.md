...
| ---------- | ---- | -- | ------- |
| <!-- 20250117152136 --> [github-client](../content/com/spotify/github-client/README.md) | [0.3.2](../content/com/spotify/github-client/github-client-0.3.2.buildspec) :white_check_mark: | [0.3.3](../content/com/spotify/github-client/github-client-0.3.3.buildspec) | `bin/add-new-release.sh content/com/spotify/github-client/github-client-0.3.2.buildspec 0.3.3` |
| <!-- 20250117135925 --> [across-platform-bom](../content/com/foreach/across/platform/README.md) | [6.0.0](../content/com/foreach/across/platform/platform-6.0.0.buildspec) :white_check_mark: | [6.0.1](../content/com/foreach/across/platform/platform-6.0.1.buildspec) | `bin/add-new-release.sh content/com/foreach/across/platform/platform-6.0.0.buildspec 6.0.1` |
| <!-- 20250117135925 --> [across-platform-bom](../content/com/foreach/across/platform/README.md) | [6.0.0](../content/com/foreach/across/platform/platform-6.0.0.buildspec) :white_check_mark: | 5.5.1 5.5.0 5.4.2 5.4.1 5.4.0  | `bin/add-new-release.sh content/com/foreach/across/platform/platform-6.0.0.buildspec ...` |
| <!-- 20250117135923 --> [across-base](../content/com/foreach/across/README.md) | [6.0.0](../content/com/foreach/across/across-6.0.0.buildspec) :white_check_mark: | [6.0.1](../content/com/foreach/across/across-6.0.1.buildspec) | `bin/add-new-release.sh content/com/foreach/across/across-6.0.0.buildspec 6.0.1` |
| <!-- 20250113133522 --> [protostream-aggregator](../content/org/infinispan/protostream/README.md) | [6.0.0.Dev02](../content/org/infinispan/protostream/protostream-6.0.0.Dev02.buildspec) :white_check_mark: | 5.0.11.Final 5.0.10.Final 5.0.9.Final 5.0.8.Final  | `bin/add-new-release.sh content/org/infinispan/protostream/protostream-6.0.0.Dev02.buildspec ...` |
...
| <!-- 20241015135826 --> [:mailbox:](https://lists.apache.org/list?dev@jena.apache.org:lte=1M:VOTE) | [jena](../content/org/apache/jena/jena/README.md) | [4.5.0](../content/org/apache/jena/jena/jena-4.5.0.buildspec) :warning: | [5.3.0](../content/org/apache/jena/jena/jena-5.3.0.buildspec)  | `bin/add-new-release.sh content/org/apache/jena/jena/jena-4.5.0.buildspec 5.3.0 staging` |
...
| <!-- 20250117032600 --> [opentelemetry-instrumentation-api](../content/io/opentelemetry/instrumentation/README.md) | [2.11.0](../content/io/opentelemetry/instrumentation/opentelemetry-2.11.0.buildspec) :warning: | [2.12.0](../content/io/opentelemetry/instrumentation/opentelemetry-2.12.0.buildspec) | `bin/add-new-release.sh content/io/opentelemetry/instrumentation/opentelemetry-2.11.0.buildspec 2.12.0` |
...
| <!-- 20250116110654 --> [jsign](../content/net/jsign/README.md) | [6.0](../content/net/jsign/jsign-6.0.buildspec) :warning: [:memo:](https://github.com/wvengen/proguard-maven-plugin/issues/279) | [7.0](../content/net/jsign/jsign-7.0.buildspec) | `bin/add-new-release.sh content/net/jsign/jsign-6.0.buildspec 7.0` |
| <!-- 20250116063411 --> [ratis](../content/org/apache/ratis/README.md) | [3.1.2](../content/org/apache/ratis/ratis-3.1.2.buildspec) :warning: [:memo:](https://issues.apache.org/jira/browse/MRRESOURCES-150) | [3.1.3](../content/org/apache/ratis/ratis-3.1.3.buildspec) | `bin/add-new-release.sh content/org/apache/ratis/ratis-3.1.2.buildspec 3.1.3` |
