...
| ---------- | ---- | -- | ------- |
| <!-- 20250518190611 --> [psi-probe](../content/com/github/psi-probe/README.md) | [5.1.1](../content/com/github/psi-probe/psi-probe-5.1.1.buildspec) :white_check_mark: | [5.2.0](../content/com/github/psi-probe/psi-probe-5.2.0.buildspec) | `bin/add-new-release.sh content/com/github/psi-probe/psi-probe-5.1.1.buildspec 5.2.0` |
| <!-- 20250518181000 --> [sunspec-device-parent](../content/nl/basjes/sunspec/sunspec-device-parent/README.md) | [0.2.0](../content/nl/basjes/sunspec/sunspec-device-parent/sunspec-device-parent-0.2.0.buildspec) :white_check_mark: | [0.2.1](../content/nl/basjes/sunspec/sunspec-device-parent/sunspec-device-parent-0.2.1.buildspec) | `bin/add-new-release.sh content/nl/basjes/sunspec/sunspec-device-parent/sunspec-device-parent-0.2.0.buildspec 0.2.1` |
| <!-- 20250518180959 --> [modbus-devices-parent](../content/nl/basjes/modbus/devices/modbus-devices-parent/README.md) | [0.2.0](../content/nl/basjes/modbus/devices/modbus-devices-parent/modbus-devices-parent-0.2.0.buildspec) :white_check_mark: | [0.2.1](../content/nl/basjes/modbus/devices/modbus-devices-parent/modbus-devices-parent-0.2.1.buildspec) | `bin/add-new-release.sh content/nl/basjes/modbus/devices/modbus-devices-parent/modbus-devices-parent-0.2.0.buildspec 0.2.1` |
...
| <!-- 20250518161353 --> [modbus-schema-parent](../content/nl/basjes/modbus/modbus-schema-parent/README.md) | [0.2.0](../content/nl/basjes/modbus/modbus-schema-parent/modbus-schema-parent-0.2.0.buildspec) :white_check_mark: | [0.3.0](../content/nl/basjes/modbus/modbus-schema-parent/modbus-schema-parent-0.3.0.buildspec) | `bin/add-new-release.sh content/nl/basjes/modbus/modbus-schema-parent/modbus-schema-parent-0.2.0.buildspec 0.3.0` |
| <!-- 20250518134753 --> [maven-resolver](../content/org/apache/maven/resolver/maven-resolver/README.md) | [2.0.8](../content/org/apache/maven/resolver/maven-resolver/maven-resolver-2.0.8.buildspec) :white_check_mark: | [2.0.9](../content/org/apache/maven/resolver/maven-resolver/maven-resolver-2.0.9.buildspec) | `bin/add-new-release.sh content/org/apache/maven/resolver/maven-resolver/maven-resolver-2.0.8.buildspec 2.0.9` |
| <!-- 20250518021821 --> [spoon-core](../content/fr/inria/gforge/spoon/spoon-core/README.md) | [11.2.1-beta-16](../content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.2.1-beta-16.buildspec) :white_check_mark: | [11.2.1-beta-17](../content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.2.1-beta-17.buildspec) | `bin/add-new-release.sh content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.2.1-beta-16.buildspec 11.2.1-beta-17` |
| <!-- 20250517224338 --> [sitemesh](../content/com/github/hazendaz/sitemesh/README.md) | [2.6.0](../content/com/github/hazendaz/sitemesh/sitemesh-2.6.0.buildspec) :white_check_mark: | [2.6.1](../content/com/github/hazendaz/sitemesh/sitemesh-2.6.1.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/sitemesh/sitemesh-2.6.0.buildspec 2.6.1` |
| <!-- 20250517224338 --> [sitemesh](../content/com/github/hazendaz/sitemesh/README.md) | [2.6.0](../content/com/github/hazendaz/sitemesh/sitemesh-2.6.0.buildspec) :white_check_mark: | 2.5.3  | `bin/add-new-release.sh content/com/github/hazendaz/sitemesh/sitemesh-2.6.0.buildspec ...` |
| <!-- 20250517221542 --> [hsac-fitnesse-pdf](../content/nl/hsac/hsac-fitnesse-pdf/README.md) | [0.1.6](../content/nl/hsac/hsac-fitnesse-pdf/hsac-fitnesse-pdf-0.1.6.buildspec) :white_check_mark: | [0.1.8](../content/nl/hsac/hsac-fitnesse-pdf/hsac-fitnesse-pdf-0.1.8.buildspec) | `bin/add-new-release.sh content/nl/hsac/hsac-fitnesse-pdf/hsac-fitnesse-pdf-0.1.6.buildspec 0.1.8` |
| <!-- 20250517221542 --> [hsac-fitnesse-pdf](../content/nl/hsac/hsac-fitnesse-pdf/README.md) | [0.1.6](../content/nl/hsac/hsac-fitnesse-pdf/hsac-fitnesse-pdf-0.1.6.buildspec) :white_check_mark: | 0.1.7  | `bin/add-new-release.sh content/nl/hsac/hsac-fitnesse-pdf/hsac-fitnesse-pdf-0.1.6.buildspec ...` |
| <!-- 20250517202955 --> [hsac-fitnesse-fixtures](../content/nl/hsac/hsac-fitnesse-fixtures/README.md) | [5.3.20](../content/nl/hsac/hsac-fitnesse-fixtures/hsac-fitnesse-fixtures-5.3.20.buildspec) :white_check_mark: | [5.3.21](../content/nl/hsac/hsac-fitnesse-fixtures/hsac-fitnesse-fixtures-5.3.21.buildspec) | `bin/add-new-release.sh content/nl/hsac/hsac-fitnesse-fixtures/hsac-fitnesse-fixtures-5.3.20.buildspec 5.3.21` |
| <!-- 20250517200358 --> [hsac-fitnesse-plugin](../content/nl/hsac/hsac-fitnesse-plugin/README.md) | [1.33.2](../content/nl/hsac/hsac-fitnesse-plugin/hsac-fitnesse-plugin-1.33.2.buildspec) :white_check_mark: | [1.33.3](../content/nl/hsac/hsac-fitnesse-plugin/hsac-fitnesse-plugin-1.33.3.buildspec) | `bin/add-new-release.sh content/nl/hsac/hsac-fitnesse-plugin/hsac-fitnesse-plugin-1.33.2.buildspec 1.33.3` |
...
| <!-- 20250430113143 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-parent](../content/org/apache/commons/parent/README.md) | [83](../content/org/apache/commons/parent/commons-parent-83.buildspec) :white_check_mark: | [84](../content/org/apache/commons/parent/commons-parent-84.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/parent/commons-parent-83.buildspec 84 staging` |
| <!-- 20250314131245 --> [:mailbox:](https://lists.apache.org/list?dev@sling.apache.org:lte=1M:VOTE) | [org.apache.sling.distribution.core](../content/org/apache/sling/org.apache.sling.distribution.core/README.md) | [0.7.2](../content/org/apache/sling/org.apache.sling.distribution.core/org.apache.sling.distribution.core-0.7.2.buildspec) :warning: | [0.7.4](../content/org/apache/sling/org.apache.sling.distribution.core/org.apache.sling.distribution.core-0.7.4.buildspec)  | `bin/add-new-release.sh content/org/apache/sling/org.apache.sling.distribution.core/org.apache.sling.distribution.core-0.7.2.buildspec 0.7.4 staging` |
...
| <!-- 20240506181903 --> [:mailbox:](https://lists.apache.org/list?dev@sling.apache.org:lte=1M:VOTE) | [org.apache.sling.distribution.journal.messages](../content/org/apache/sling/org.apache.sling.distribution.journal.messages/README.md) | [0.5.10](../content/org/apache/sling/org.apache.sling.distribution.journal.messages/org.apache.sling.distribution.journal.messages-0.5.10.buildspec) :white_check_mark: | [0.5.12](../content/org/apache/sling/org.apache.sling.distribution.journal.messages/org.apache.sling.distribution.journal.messages-0.5.12.buildspec)  | `bin/add-new-release.sh content/org/apache/sling/org.apache.sling.distribution.journal.messages/org.apache.sling.distribution.journal.messages-0.5.10.buildspec 0.5.12 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250517012930 --> [jdbi3-root](../content/org/jdbi/README.md) | [3.49.3](../content/org/jdbi/jdbi3-root-3.49.3.buildspec) :warning: | [3.49.4](../content/org/jdbi/jdbi3-root-3.49.4.buildspec) | `bin/add-new-release.sh content/org/jdbi/jdbi3-root-3.49.3.buildspec 3.49.4` |
| <!-- 20250516164930 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.85.4](../content/org/finos/legend/engine/legend-engine-4.85.4.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.85.4` |
...
| <!-- 20250515115230 --> [quarkus-project](../content/io/quarkus/README.md) | 3.23.0.CR1 :warning: [:memo:](https://github.com/quarkusio/quarkus/pull/44671) |
| <!-- 20250515101947 --> [kubernetes-client-project](../content/io/fabric8/kubernetes-client/README.md) | 7.3.0 :warning: |
...
| <!-- 20250512205341 --> [jooby](../content/io/jooby/README.md) | 3.8.1 :warning: |
