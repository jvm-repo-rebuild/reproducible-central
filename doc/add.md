...
| <!-- 20251019163936 --> [cxf-build-utils](../content/org/apache/cxf/cxf-build-utils/README.md) | [4.1.1](../content/org/apache/cxf/cxf-build-utils/cxf-build-utils-4.1.1.buildspec) :white_check_mark: | [4.1.2](../content/org/apache/cxf/cxf-build-utils/cxf-build-utils-4.1.2.buildspec) | `bin/add-new-release.sh content/org/apache/cxf/cxf-build-utils/cxf-build-utils-4.1.1.buildspec 4.1.2` |
| <!-- 20251019104130 --> [zrlog-base](../content/com/hibegin/zrlog-base/README.md) | [3.2.120](../content/com/hibegin/zrlog-base/zrlog-base-3.2.120.buildspec) :white_check_mark: | [3.2.121](../content/com/hibegin/zrlog-base/zrlog-base-3.2.121.buildspec) | `bin/add-new-release.sh content/com/hibegin/zrlog-base/zrlog-base-3.2.120.buildspec 3.2.121` |
| <!-- 20251019075135 --> [exec-maven-plugin](../content/org/codehaus/mojo/exec-maven-plugin/README.md) | [3.6.1](../content/org/codehaus/mojo/exec-maven-plugin/exec-maven-plugin-3.6.1.buildspec) :white_check_mark: | [3.6.2](../content/org/codehaus/mojo/exec-maven-plugin/exec-maven-plugin-3.6.2.buildspec) | `bin/add-new-release.sh content/org/codehaus/mojo/exec-maven-plugin/exec-maven-plugin-3.6.1.buildspec 3.6.2` |
| <!-- 20251019071225 --> [maven-compiler-plugin](../content/org/apache/maven/plugins/maven-compiler-plugin/README.md) | [4.0.0-beta-2](../content/org/apache/maven/plugins/maven-compiler-plugin/maven-compiler-plugin-4.0.0-beta-2.buildspec) :white_check_mark: | [4.0.0-beta-3](../content/org/apache/maven/plugins/maven-compiler-plugin/maven-compiler-plugin-4.0.0-beta-3.buildspec) | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-compiler-plugin/maven-compiler-plugin-4.0.0-beta-2.buildspec 4.0.0-beta-3` |
| <!-- 20251019010537 --> [github-desktop](../content/com/github/hazendaz/git/github-desktop/README.md) | [3.5.2](../content/com/github/hazendaz/git/github-desktop/github-desktop-3.5.2.buildspec) :white_check_mark: | [3.5.3](../content/com/github/hazendaz/git/github-desktop/github-desktop-3.5.3.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/git/github-desktop/github-desktop-3.5.2.buildspec 3.5.3` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20251019114535 --> [xml-maven-plugin](../content/org/codehaus/mojo/xml-maven-plugin/README.md) | [1.1.0](../content/org/codehaus/mojo/xml-maven-plugin/xml-maven-plugin-1.1.0.buildspec) :warning: | [1.2.0](../content/org/codehaus/mojo/xml-maven-plugin/xml-maven-plugin-1.2.0.buildspec) | `bin/add-new-release.sh content/org/codehaus/mojo/xml-maven-plugin/xml-maven-plugin-1.1.0.buildspec 1.2.0` |
...
| <!-- 20251018193534 --> [jpmml-evaluator](../content/org/jpmml/jpmml-evaluator/README.md) | [1.7.4](../content/org/jpmml/jpmml-evaluator/jpmml-evaluator-1.7.4.buildspec) :warning: | [1.7.5](../content/org/jpmml/jpmml-evaluator/jpmml-evaluator-1.7.5.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-evaluator/jpmml-evaluator-1.7.4.buildspec 1.7.5` |
| <!-- 20251018175938 --> [spotbugs-maven-plugin](../content/com/github/spotbugs/spotbugs-maven-plugin/README.md) | [4.9.7.0](../content/com/github/spotbugs/spotbugs-maven-plugin/spotbugs-maven-plugin-4.9.7.0.buildspec) :warning: [:memo:](https://github.com/spotbugs/spotbugs-maven-plugin/issues/1148) | [4.9.8.0](../content/com/github/spotbugs/spotbugs-maven-plugin/spotbugs-maven-plugin-4.9.8.0.buildspec) | `bin/add-new-release.sh content/com/github/spotbugs/spotbugs-maven-plugin/spotbugs-maven-plugin-4.9.7.0.buildspec 4.9.8.0` |
| <!-- 20251018060534 --> [jpmml-model](../content/org/jpmml/jpmml-model/README.md) | [1.7.4](../content/org/jpmml/jpmml-model/jpmml-model-1.7.4.buildspec) :warning: [:memo:](https://github.com/jpmml/jpmml-model/issues/42) | [1.7.5](../content/org/jpmml/jpmml-model/jpmml-model-1.7.5.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-model/jpmml-model-1.7.4.buildspec 1.7.5` |
...
| <!-- 20251016111014 --> [quarkus-project](../content/io/quarkus/README.md) | [3.28.4](../content/io/quarkus/quarkus-3.28.4.buildspec) :warning: | [3.29.0.CR1](../content/io/quarkus/quarkus-3.29.0.CR1.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.28.4.buildspec 3.29.0.CR1` |
