...
| ---------- | ---- | -- | ------- |
| <!-- 20250428184944 --> [spdx-maven-plugin](../content/org/spdx/spdx-maven-plugin/README.md) | [1.0.0](../content/org/spdx/spdx-maven-plugin/spdx-maven-plugin-1.0.0.buildspec) :white_check_mark: | [1.0.1](../content/org/spdx/spdx-maven-plugin/spdx-maven-plugin-1.0.1.buildspec) | `bin/add-new-release.sh content/org/spdx/spdx-maven-plugin/spdx-maven-plugin-1.0.0.buildspec 1.0.1` |
...
| <!-- 20250428144248 --> [flexmonster](../content/org/webjars/flexmonster/README.md) | [2.9.101](../content/org/webjars/flexmonster/flexmonster-2.9.101.buildspec) :white_check_mark: | [2.9.102](../content/org/webjars/flexmonster/flexmonster-2.9.102.buildspec) | `bin/add-new-release.sh content/org/webjars/flexmonster/flexmonster-2.9.101.buildspec 2.9.102` |
...
| <!-- 20250428054744 --> [avaje-jsonb-parent](../content/io/avaje/jsonb/README.md) | [3.3](../content/io/avaje/jsonb/avaje-jsonb-3.3.buildspec) :white_check_mark: | [3.4-RC1](../content/io/avaje/jsonb/avaje-jsonb-3.4-RC1.buildspec) | `bin/add-new-release.sh content/io/avaje/jsonb/avaje-jsonb-3.3.buildspec 3.4-RC1` |
| <!-- 20250427230421 --> [makeself-maven-plugin](../content/com/github/hazendaz/maven/makeself-maven-plugin/README.md) | [1.9.0](../content/com/github/hazendaz/maven/makeself-maven-plugin/makeself-maven-plugin-1.9.0.buildspec) :white_check_mark: | [1.9.1](../content/com/github/hazendaz/maven/makeself-maven-plugin/makeself-maven-plugin-1.9.1.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/maven/makeself-maven-plugin/makeself-maven-plugin-1.9.0.buildspec 1.9.1` |
| <!-- 20250427220616 --> [avaje-http-parent](../content/io/avaje/http/README.md) | [3.2](../content/io/avaje/http/avaje-http-3.2.buildspec) :white_check_mark: | [3.3-RC1](../content/io/avaje/http/avaje-http-3.3-RC1.buildspec) | `bin/add-new-release.sh content/io/avaje/http/avaje-http-3.2.buildspec 3.3-RC1` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250428144143 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.82.0](../content/org/finos/legend/engine/legend-engine-4.82.0.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.82.0` |
