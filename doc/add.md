...
| ---------- | ---- | -- | ------- |
| <!-- 20251208144320 --> [scg-base](../content/io/telicent/smart-caches/graph/scg-base/README.md) | [0.92.3](../content/io/telicent/smart-caches/graph/scg-base/scg-base-0.92.3.buildspec) :white_check_mark: | [0.92.4](../content/io/telicent/smart-caches/graph/scg-base/scg-base-0.92.4.buildspec) | `bin/add-new-release.sh content/io/telicent/smart-caches/graph/scg-base/scg-base-0.92.3.buildspec 0.92.4` |
| <!-- 20251208144315 --> [zrlog-base](../content/com/hibegin/zrlog-base/README.md) | [3.2.124](../content/com/hibegin/zrlog-base/zrlog-base-3.2.124.buildspec) :white_check_mark: | [3.2.125](../content/com/hibegin/zrlog-base/zrlog-base-3.2.125.buildspec) | `bin/add-new-release.sh content/com/hibegin/zrlog-base/zrlog-base-3.2.124.buildspec 3.2.125` |
| <!-- 20251208143913 --> [airbase](../content/io/airlift/airbase/README.md) | [332](../content/io/airlift/airbase/airbase-332.buildspec) :white_check_mark: | [334](../content/io/airlift/airbase/airbase-334.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-332.buildspec 334` |
| <!-- 20251208143913 --> [airbase](../content/io/airlift/airbase/README.md) | [332](../content/io/airlift/airbase/airbase-332.buildspec) :white_check_mark: | 333  | `bin/add-new-release.sh content/io/airlift/airbase/airbase-332.buildspec ...` |
| <!-- 20251208134925 --> [query](../content/io/cucumber/query/README.md) | [14.6.0](../content/io/cucumber/query/query-14.6.0.buildspec) :white_check_mark: | [14.7.0](../content/io/cucumber/query/query-14.7.0.buildspec) | `bin/add-new-release.sh content/io/cucumber/query/query-14.6.0.buildspec 14.7.0` |
| <!-- 20251208132525 --> [jena-kafka](../content/io/telicent/jena/jena-kafka/README.md) | [2.3.1](../content/io/telicent/jena/jena-kafka/jena-kafka-2.3.1.buildspec) :white_check_mark: | [2.3.2](../content/io/telicent/jena/jena-kafka/jena-kafka-2.3.2.buildspec) | `bin/add-new-release.sh content/io/telicent/jena/jena-kafka/jena-kafka-2.3.1.buildspec 2.3.2` |
| <!-- 20251208012315 --> [yuicompressor-maven-plugin](../content/com/github/hazendaz/maven/yuicompressor-maven-plugin/README.md) | [2.3.0](../content/com/github/hazendaz/maven/yuicompressor-maven-plugin/yuicompressor-maven-plugin-2.3.0.buildspec) :white_check_mark: | [2.3.1](../content/com/github/hazendaz/maven/yuicompressor-maven-plugin/yuicompressor-maven-plugin-2.3.1.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/maven/yuicompressor-maven-plugin/yuicompressor-maven-plugin-2.3.0.buildspec 2.3.1` |
| <!-- 20251207224714 --> [whitespace-maven-plugin](../content/com/github/hazendaz/maven/whitespace-maven-plugin/README.md) | [1.5.0](../content/com/github/hazendaz/maven/whitespace-maven-plugin/whitespace-maven-plugin-1.5.0.buildspec) :white_check_mark: | [1.6.0](../content/com/github/hazendaz/maven/whitespace-maven-plugin/whitespace-maven-plugin-1.6.0.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/maven/whitespace-maven-plugin/whitespace-maven-plugin-1.5.0.buildspec 1.6.0` |
| <!-- 20251207221715 --> [smartsprites-maven-plugin](../content/com/github/hazendaz/maven/smartsprites-maven-plugin/README.md) | [2.4.0](../content/com/github/hazendaz/maven/smartsprites-maven-plugin/smartsprites-maven-plugin-2.4.0.buildspec) :white_check_mark: | [2.4.1](../content/com/github/hazendaz/maven/smartsprites-maven-plugin/smartsprites-maven-plugin-2.4.1.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/maven/smartsprites-maven-plugin/smartsprites-maven-plugin-2.4.0.buildspec 2.4.1` |
| <!-- 20251207221548 --> [commons-text](../content/org/apache/commons/commons-text/README.md) | [1.14.0](../content/org/apache/commons/commons-text/commons-text-1.14.0.buildspec) :white_check_mark: | [1.15.0](../content/org/apache/commons/commons-text/commons-text-1.15.0.buildspec) | `bin/add-new-release.sh content/org/apache/commons/commons-text/commons-text-1.14.0.buildspec 1.15.0` |
