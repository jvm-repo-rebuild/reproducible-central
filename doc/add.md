...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20231116123845 --> [slingfeature-maven-plugin](../content/org/apache/sling/slingfeature-maven-plugin/README.md) | [1.7.4](../content/org/apache/sling/slingfeature-maven-plugin/slingfeature-maven-plugin-1.7.4.buildspec) :warning: | [1.8.0](../content/org/apache/sling/slingfeature-maven-plugin/slingfeature-maven-plugin-1.8.0.buildspec) | `bin/add-new-release.sh content/org/apache/sling/slingfeature-maven-plugin/slingfeature-maven-plugin-1.7.4.buildspec 1.8.0` |
