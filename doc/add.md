...
| ---------- | ---- | -- | ------- |
| <!-- 20250116075554 --> [module-parent](../content/io/dropwizard/modules/parent/README.md) | [4.0.3](../content/io/dropwizard/modules/parent/module-parent-4.0.3.buildspec) :white_check_mark: | [5.0.0-rc.1](../content/io/dropwizard/modules/parent/module-parent-5.0.0-rc.1.buildspec) | `bin/add-new-release.sh content/io/dropwizard/modules/parent/module-parent-4.0.3.buildspec 5.0.0-rc.1` |
| <!-- 20250116075554 --> [module-parent](../content/io/dropwizard/modules/parent/README.md) | [4.0.3](../content/io/dropwizard/modules/parent/module-parent-4.0.3.buildspec) :white_check_mark: | 4.0.4 3.0.4 2.1.4  | `bin/add-new-release.sh content/io/dropwizard/modules/parent/module-parent-4.0.3.buildspec ...` |
| <!-- 20250116050747 --> [avaje-http-parent](../content/io/avaje/http/README.md) | [2.9-RC7](../content/io/avaje/http/avaje-http-2.9-RC7.buildspec) :white_check_mark: | [2.9-RC8](../content/io/avaje/http/avaje-http-2.9-RC8.buildspec) | `bin/add-new-release.sh content/io/avaje/http/avaje-http-2.9-RC7.buildspec 2.9-RC8` |
| <!-- 20250115233513 --> [makeself-maven-plugin](../content/com/github/hazendaz/maven/makeself-maven-plugin/README.md) | [1.8.4](../content/com/github/hazendaz/maven/makeself-maven-plugin/makeself-maven-plugin-1.8.4.buildspec) :white_check_mark: | [1.8.5](../content/com/github/hazendaz/maven/makeself-maven-plugin/makeself-maven-plugin-1.8.5.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/maven/makeself-maven-plugin/makeself-maven-plugin-1.8.4.buildspec 1.8.5` |
| <!-- 20250115230229 --> [dropwizard-project](../content/io/dropwizard/core/README.md) | [5.0.0-alpha.5](../content/io/dropwizard/core/dropwizard-5.0.0-alpha.5.buildspec) :white_check_mark: | [5.0.0-rc.1](../content/io/dropwizard/core/dropwizard-5.0.0-rc.1.buildspec) | `bin/add-new-release.sh content/io/dropwizard/core/dropwizard-5.0.0-alpha.5.buildspec 5.0.0-rc.1` |
| <!-- 20250115230229 --> [dropwizard-project](../content/io/dropwizard/core/README.md) | [5.0.0-alpha.5](../content/io/dropwizard/core/dropwizard-5.0.0-alpha.5.buildspec) :white_check_mark: | 4.0.12 3.0.12  | `bin/add-new-release.sh content/io/dropwizard/core/dropwizard-5.0.0-alpha.5.buildspec ...` |
| <!-- 20250115204044 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [11.2-RC1](../content/io/avaje/inject/avaje-inject-11.2-RC1.buildspec) :white_check_mark: | [11.2-RC2](../content/io/avaje/inject/avaje-inject-11.2-RC2.buildspec) | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-11.2-RC1.buildspec 11.2-RC2` |
...
| <!-- 20250116074622 --> [jackrabbit-oak](../content/org/apache/jackrabbit/oak/README.md) | [1.72.0](../content/org/apache/jackrabbit/oak/jackrabbit-oak-1.72.0.buildspec) :warning: [:memo:](https://issues.apache.org/jira/browse/OAK-10662) | [1.74.0](../content/org/apache/jackrabbit/oak/jackrabbit-oak-1.74.0.buildspec) | `bin/add-new-release.sh content/org/apache/jackrabbit/oak/jackrabbit-oak-1.72.0.buildspec 1.74.0` |
