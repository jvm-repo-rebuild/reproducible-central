...
| ---------- | ---- | -- | ------- |
| <!-- 20250725144536 --> [hibernate-models](../content/org/hibernate/models/hibernate-models/README.md) | [1.0.0](../content/org/hibernate/models/hibernate-models/hibernate-models-1.0.0.buildspec) :white_check_mark: | [1.0.1](../content/org/hibernate/models/hibernate-models/hibernate-models-1.0.1.buildspec) | `bin/add-new-release.sh content/org/hibernate/models/hibernate-models/hibernate-models-1.0.0.buildspec 1.0.1` |
| <!-- 20250725123128 --> [cui-parent-pom](../content/de/cuioss/cui-parent-pom/README.md) | [1.1.2](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.1.2.buildspec) :white_check_mark: | [1.1.3](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.1.3.buildspec) | `bin/add-new-release.sh content/de/cuioss/cui-parent-pom/cui-parent-pom-1.1.2.buildspec 1.1.3` |
| <!-- 20250725103535 --> [io.wcm.parent_toplevel](../content/io/wcm/tooling/README.md) | [2.5.0](../content/io/wcm/tooling/wcm-parent_toplevel-2.5.0.buildspec) :white_check_mark: | [2.5.2](../content/io/wcm/tooling/wcm-parent_toplevel-2.5.2.buildspec) | `bin/add-new-release.sh content/io/wcm/tooling/wcm-parent_toplevel-2.5.0.buildspec 2.5.2` |
| <!-- 20250725103333 --> [java-design-parent](../content/com/github/nbbrd/java-design-util/README.md) | [1.7.0](../content/com/github/nbbrd/java-design-util/java-design-util-1.7.0.buildspec) :white_check_mark: | [1.8.0](../content/com/github/nbbrd/java-design-util/java-design-util-1.8.0.buildspec) | `bin/add-new-release.sh content/com/github/nbbrd/java-design-util/java-design-util-1.7.0.buildspec 1.8.0` |
| <!-- 20250725102337 --> [cui-java-tools](../content/de/cuioss/cui-java-tools/README.md) | [2.4.0](../content/de/cuioss/cui-java-tools/cui-java-tools-2.4.0.buildspec) :white_check_mark: | [2.5.0](../content/de/cuioss/cui-java-tools/cui-java-tools-2.5.0.buildspec) | `bin/add-new-release.sh content/de/cuioss/cui-java-tools/cui-java-tools-2.4.0.buildspec 2.5.0` |
| <!-- 20250725065938 --> [pmd](../content/net/sourceforge/pmd/README.md) | [7.15.0](../content/net/sourceforge/pmd/pmd-7.15.0.buildspec) :white_check_mark: | [7.16.0](../content/net/sourceforge/pmd/pmd-7.16.0.buildspec) | `bin/add-new-release.sh content/net/sourceforge/pmd/pmd-7.15.0.buildspec 7.16.0` |
| <!-- 20250725044731 --> [org.apache.sling.api](../content/org/apache/sling/org.apache.sling.api/README.md) | [3.0.0](../content/org/apache/sling/org.apache.sling.api/org.apache.sling.api-3.0.0.buildspec) :white_check_mark: | [3.0.2](../content/org/apache/sling/org.apache.sling.api/org.apache.sling.api-3.0.2.buildspec) | `bin/add-new-release.sh content/org/apache/sling/org.apache.sling.api/org.apache.sling.api-3.0.0.buildspec 3.0.2` |
| <!-- 20250724230334 --> [avaje-validator-parent](../content/io/avaje/validator/README.md) | [2.12](../content/io/avaje/validator/avaje-validator-2.12.buildspec) :white_check_mark: | [2.13](../content/io/avaje/validator/avaje-validator-2.13.buildspec) | `bin/add-new-release.sh content/io/avaje/validator/avaje-validator-2.12.buildspec 2.13` |
| <!-- 20250724212624 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [11.6-RC8](../content/io/avaje/inject/avaje-inject-11.6-RC8.buildspec) :white_check_mark: | [11.6-javax](../content/io/avaje/inject/avaje-inject-11.6-javax.buildspec) | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-11.6-RC8.buildspec 11.6-javax` |
| <!-- 20250724212624 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [11.6-RC8](../content/io/avaje/inject/avaje-inject-11.6-RC8.buildspec) :white_check_mark: | 11.6  | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-11.6-RC8.buildspec ...` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250725151939 --> [jooby](../content/io/jooby/README.md) | [3.11.0](../content/io/jooby/jooby-3.11.0.buildspec) :warning: | [4.0.0](../content/io/jooby/jooby-4.0.0.buildspec) | `bin/add-new-release.sh content/io/jooby/jooby-3.11.0.buildspec 4.0.0` |
| <!-- 20250724205730 --> [avaje-http-parent](../content/io/avaje/http/README.md) | [3.4-RC4](../content/io/avaje/http/avaje-http-3.4-RC4.buildspec) :warning: | [3.4](../content/io/avaje/http/avaje-http-3.4.buildspec) | `bin/add-new-release.sh content/io/avaje/http/avaje-http-3.4-RC4.buildspec 3.4` |
