...
| ---------- | ---- | -- | ------- |
| <!-- 20250226202949 --> [maven-project-info-reports-plugin](../content/org/apache/maven/plugins/maven-project-info-reports-plugin/README.md) | [3.8.0](../content/org/apache/maven/plugins/maven-project-info-reports-plugin/maven-project-info-reports-plugin-3.8.0.buildspec) :white_check_mark: | [3.9.0](../content/org/apache/maven/plugins/maven-project-info-reports-plugin/maven-project-info-reports-plugin-3.9.0.buildspec) | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-project-info-reports-plugin/maven-project-info-reports-plugin-3.8.0.buildspec 3.9.0` |
| <!-- 20250226160050 --> [scg-base](../content/io/telicent/smart-caches/graph/scg-base/README.md) | [0.82.19](../content/io/telicent/smart-caches/graph/scg-base/scg-base-0.82.19.buildspec) :white_check_mark: | [0.83.0](../content/io/telicent/smart-caches/graph/scg-base/scg-base-0.83.0.buildspec) | `bin/add-new-release.sh content/io/telicent/smart-caches/graph/scg-base/scg-base-0.82.19.buildspec 0.83.0` |
| <!-- 20250226072702 --> [openapi-jaxrs-client](../content/dk/mada/jaxrs/openapi-jaxrs-client/README.md) | [0.11.10](../content/dk/mada/jaxrs/openapi-jaxrs-client/openapi-jaxrs-client-0.11.10.buildspec) :white_check_mark: | [0.11.11](../content/dk/mada/jaxrs/openapi-jaxrs-client/openapi-jaxrs-client-0.11.11.buildspec) | `bin/add-new-release.sh content/dk/mada/jaxrs/openapi-jaxrs-client/openapi-jaxrs-client-0.11.10.buildspec 0.11.11` |
| <!-- 20250226063217 --> [airbase](../content/io/airlift/airbase/README.md) | [223](../content/io/airlift/airbase/airbase-223.buildspec) :white_check_mark: | [224](../content/io/airlift/airbase/airbase-224.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-223.buildspec 224` |
| <!-- 20250226054125 --> [avaje-sigma-parent](../content/io/avaje/sigma/README.md) | [0.4](../content/io/avaje/sigma/avaje-sigma-0.4.buildspec) :white_check_mark: | [1.0](../content/io/avaje/sigma/avaje-sigma-1.0.buildspec) | `bin/add-new-release.sh content/io/avaje/sigma/avaje-sigma-0.4.buildspec 1.0` |
| <!-- 20250226004511 --> [makeself-maven-plugin](../content/com/github/hazendaz/maven/makeself-maven-plugin/README.md) | [1.8.5](../content/com/github/hazendaz/maven/makeself-maven-plugin/makeself-maven-plugin-1.8.5.buildspec) :white_check_mark: | [1.9.0](../content/com/github/hazendaz/maven/makeself-maven-plugin/makeself-maven-plugin-1.9.0.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/maven/makeself-maven-plugin/makeself-maven-plugin-1.8.5.buildspec 1.9.0` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20250208125440 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-resolver](../content/org/apache/maven/resolver/maven-resolver/README.md) | [2.0.6](../content/org/apache/maven/resolver/maven-resolver/maven-resolver-2.0.6.buildspec) :white_check_mark: | [2.0.7](../content/org/apache/maven/resolver/maven-resolver/maven-resolver-2.0.7.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/resolver/maven-resolver/maven-resolver-2.0.6.buildspec 2.0.7 staging` |
...
| <!-- 20241206021342 --> [:mailbox:](https://lists.apache.org/list?dev@cxf.apache.org:lte=1M:VOTE) | [cxf-build-utils](../content/org/apache/cxf/cxf-build-utils/README.md) | [4.0.2](../content/org/apache/cxf/cxf-build-utils/cxf-build-utils-4.0.2.buildspec) :white_check_mark: | [4.1.0](../content/org/apache/cxf/cxf-build-utils/cxf-build-utils-4.1.0.buildspec)  | `bin/add-new-release.sh content/org/apache/cxf/cxf-build-utils/cxf-build-utils-4.0.2.buildspec 4.1.0 staging` |
...
| <!-- 20240819133049 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-deploy-plugin](../content/org/apache/maven/plugins/maven-deploy-plugin/README.md) | [4.0.0-beta-1](../content/org/apache/maven/plugins/maven-deploy-plugin/maven-deploy-plugin-4.0.0-beta-1.buildspec) :white_check_mark: | [4.0.0-beta-2](../content/org/apache/maven/plugins/maven-deploy-plugin/maven-deploy-plugin-4.0.0-beta-2.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-deploy-plugin/maven-deploy-plugin-4.0.0-beta-1.buildspec 4.0.0-beta-2 staging` |
| <!-- 20240819132925 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-install-plugin](../content/org/apache/maven/plugins/maven-install-plugin/README.md) | [4.0.0-beta-1](../content/org/apache/maven/plugins/maven-install-plugin/maven-install-plugin-4.0.0-beta-1.buildspec) :white_check_mark: | [4.0.0-beta-2](../content/org/apache/maven/plugins/maven-install-plugin/maven-install-plugin-4.0.0-beta-2.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-install-plugin/maven-install-plugin-4.0.0-beta-1.buildspec 4.0.0-beta-2 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250226114347 --> [quarkus-project](../content/io/quarkus/README.md) | [3.19.0](../content/io/quarkus/quarkus-3.19.0.buildspec) :warning: [:memo:](https://github.com/quarkusio/quarkus/pull/44671) | [3.19.1](../content/io/quarkus/quarkus-3.19.1.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.19.0.buildspec 3.19.1` |
| <!-- 20250226101218 --> [baremaps](../content/org/apache/baremaps/README.md) | [0.8.1](../content/org/apache/baremaps/baremaps-0.8.1.buildspec) :warning: [:memo:](https://github.com/apache/incubator-baremaps/pull/951) | [0.8.2](../content/org/apache/baremaps/baremaps-0.8.2.buildspec) | `bin/add-new-release.sh content/org/apache/baremaps/baremaps-0.8.1.buildspec 0.8.2` |
...
| <!-- 20250221032654 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.56.0](../content/org/finos/legend/engine/legend-engine-4.56.0.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.70.1](../content/org/finos/legend/engine/legend-engine-4.70.1.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.56.0.buildspec 4.70.1` |
...
| <!-- 20250218182509 --> [opentelemetry-instrumentation-api](../content/io/opentelemetry/instrumentation/README.md) | 2.13.1 :warning: |
