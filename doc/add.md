...
| ---------- | ---- | -- | ------- |
| <!-- 20250620124333 --> [maven-ear-plugin](../content/org/apache/maven/plugins/maven-ear-plugin/README.md) | [3.3.0](../content/org/apache/maven/plugins/maven-ear-plugin/maven-ear-plugin-3.3.0.buildspec) :white_check_mark: | [3.4.0](../content/org/apache/maven/plugins/maven-ear-plugin/maven-ear-plugin-3.4.0.buildspec) | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-ear-plugin/maven-ear-plugin-3.3.0.buildspec 3.4.0` |
| <!-- 20250620060744 --> [metrics-parent](../content/io/dropwizard/metrics5/README.md) | [5.0.0-rc26](../content/io/dropwizard/metrics5/dropwizard-metrics-5.0.0-rc26.buildspec) :white_check_mark: | [5.0.1](../content/io/dropwizard/metrics5/dropwizard-metrics-5.0.1.buildspec) | `bin/add-new-release.sh content/io/dropwizard/metrics5/dropwizard-metrics-5.0.0-rc26.buildspec 5.0.1` |
| <!-- 20250619232146 --> [metrics-parent](../content/io/dropwizard/metrics/README.md) | [4.2.32](../content/io/dropwizard/metrics/dropwizard-metrics-4.2.32.buildspec) :white_check_mark: | [4.2.33](../content/io/dropwizard/metrics/dropwizard-metrics-4.2.33.buildspec) | `bin/add-new-release.sh content/io/dropwizard/metrics/dropwizard-metrics-4.2.32.buildspec 4.2.33` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250620183554 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.88.11](../content/org/finos/legend/engine/legend-engine-4.88.11.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.88.11` |
