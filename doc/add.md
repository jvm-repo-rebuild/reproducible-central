...
| ---------- | ---- | -- | ------- |
| <!-- 20251213082414 --> [maven-release-plugin](../content/org/apache/maven/plugins/maven-release-plugin/README.md) | [3.3.0](../content/org/apache/maven/plugins/maven-release-plugin/maven-release-plugin-3.3.0.buildspec) :white_check_mark: | [3.3.1](../content/org/apache/maven/plugins/maven-release-plugin/maven-release-plugin-3.3.1.buildspec) | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-release-plugin/maven-release-plugin-3.3.0.buildspec 3.3.1` |
| <!-- 20251212104018 --> [hibernate-reactive-core](../content/org/hibernate/reactive/hibernate-reactive/README.md) | [4.2.0.CR2](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.2.0.CR2.buildspec) :white_check_mark: | 3.2.0.CR2  | `bin/add-new-release.sh content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.2.0.CR2.buildspec ...` |
