...
| ---------- | ---- | -- | ------- |
| <!-- 20250110202317 --> [jpmml-python](../content/org/jpmml/jpmml-python/README.md) | [1.2.7](../content/org/jpmml/jpmml-python/jpmml-python-1.2.7.buildspec) :white_check_mark: | [1.2.8](../content/org/jpmml/jpmml-python/jpmml-python-1.2.8.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-python/jpmml-python-1.2.7.buildspec 1.2.8` |
| <!-- 20250110175426 --> [opentelemetry-sdk](../content/io/opentelemetry/java/README.md) | [1.45.0](../content/io/opentelemetry/java/opentelemetry-sdk-1.45.0.buildspec) :white_check_mark: | [1.46.0](../content/io/opentelemetry/java/opentelemetry-sdk-1.46.0.buildspec) | `bin/add-new-release.sh content/io/opentelemetry/java/opentelemetry-sdk-1.45.0.buildspec 1.46.0` |
| <!-- 20250110171736 --> [jpmml-converter](../content/org/jpmml/jpmml-converter/README.md) | [1.5.11](../content/org/jpmml/jpmml-converter/jpmml-converter-1.5.11.buildspec) :white_check_mark: | [1.5.12](../content/org/jpmml/jpmml-converter/jpmml-converter-1.5.12.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-converter/jpmml-converter-1.5.11.buildspec 1.5.12` |
| <!-- 20250110125723 --> [jpmml-evaluator](../content/org/jpmml/jpmml-evaluator/README.md) | [1.6.10](../content/org/jpmml/jpmml-evaluator/jpmml-evaluator-1.6.10.buildspec) :white_check_mark: | [1.6.11](../content/org/jpmml/jpmml-evaluator/jpmml-evaluator-1.6.11.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-evaluator/jpmml-evaluator-1.6.10.buildspec 1.6.11` |
| <!-- 20250110091116 --> [jpmml-model](../content/org/jpmml/jpmml-model/README.md) | [1.6.10](../content/org/jpmml/jpmml-model/jpmml-model-1.6.10.buildspec) :white_check_mark: | [1.6.11](../content/org/jpmml/jpmml-model/jpmml-model-1.6.11.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-model/jpmml-model-1.6.10.buildspec 1.6.11` |
...
| <!-- 20250108163414 --> [io.wcm.parent_toplevel](../content/io/wcm/tooling/README.md) | [2.3.4](../content/io/wcm/tooling/wcm-parent_toplevel-2.3.4.buildspec) :white_check_mark: | [2.4.2](../content/io/wcm/tooling/wcm-parent_toplevel-2.4.2.buildspec) | `bin/add-new-release.sh content/io/wcm/tooling/wcm-parent_toplevel-2.3.4.buildspec 2.4.2` |
| <!-- 20250108163414 --> [io.wcm.parent_toplevel](../content/io/wcm/tooling/README.md) | [2.3.4](../content/io/wcm/tooling/wcm-parent_toplevel-2.3.4.buildspec) :white_check_mark: | 2.4.0  | `bin/add-new-release.sh content/io/wcm/tooling/wcm-parent_toplevel-2.3.4.buildspec ...` |
...
| <!-- 20241112163940 --> [:mailbox:](https://lists.apache.org/list?dev@activemq.apache.org:lte=1M:VOTE) | [activemq-parent](../content/org/apache/activemq/README.md) | [6.1.4](../content/org/apache/activemq/activemq-6.1.4.buildspec) :white_check_mark: | [6.1.5](../content/org/apache/activemq/activemq-6.1.5.buildspec)  | `bin/add-new-release.sh content/org/apache/activemq/activemq-6.1.4.buildspec 6.1.5 staging` |
| <!-- 20241111015604 --> [:mailbox:](https://lists.apache.org/list?dev@ratis.apache.org:lte=1M:VOTE) | [ratis](../content/org/apache/ratis/README.md) | [3.1.2](../content/org/apache/ratis/ratis-3.1.2.buildspec) :warning: [:memo:](https://issues.apache.org/jira/browse/MRRESOURCES-150) | [3.1.3](../content/org/apache/ratis/ratis-3.1.3.buildspec)  | `bin/add-new-release.sh content/org/apache/ratis/ratis-3.1.2.buildspec 3.1.3 staging` |
| <!-- 20241109124721 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-release-plugin](../content/org/apache/commons/commons-release-plugin/README.md) | [1.8.3](../content/org/apache/commons/commons-release-plugin/commons-release-plugin-1.8.3.buildspec) :warning: | [1.9.0](../content/org/apache/commons/commons-release-plugin/commons-release-plugin-1.9.0.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/commons-release-plugin/commons-release-plugin-1.8.3.buildspec 1.9.0 staging` |
| <!-- 20241109124651 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-build-plugin](../content/org/apache/commons/commons-build-plugin/README.md) | [1.14.1](../content/org/apache/commons/commons-build-plugin/commons-build-plugin-1.14.1.buildspec) :white_check_mark: | [1.15.0](../content/org/apache/commons/commons-build-plugin/commons-build-plugin-1.15.0.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/commons-build-plugin/commons-build-plugin-1.14.1.buildspec 1.15.0 staging` |
...
| <!-- 20241030163342 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-artifact-plugin](../content/org/apache/maven/plugins/maven-artifact-plugin/README.md) | [3.5.3](../content/org/apache/maven/plugins/maven-artifact-plugin/maven-artifact-plugin-3.5.3.buildspec) :white_check_mark: | [3.6.0](../content/org/apache/maven/plugins/maven-artifact-plugin/maven-artifact-plugin-3.6.0.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-artifact-plugin/maven-artifact-plugin-3.5.3.buildspec 3.6.0 staging` |
| <!-- 20240925020157 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-csv](../content/org/apache/commons/csv/README.md) | [1.12.0](../content/org/apache/commons/csv/commons-csv-1.12.0.buildspec) :white_check_mark: | [1.13.0](../content/org/apache/commons/csv/commons-csv-1.13.0.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/csv/commons-csv-1.12.0.buildspec 1.13.0 staging` |
...
| <!-- 20250107195356 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | 11.1-javax :warning: [:memo:](https://github.com/avaje/avaje-inject/issues/757) |
