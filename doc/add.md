...
| ---------- | ---- | -- | ------- |
| <!-- 20250313130712 --> [langchain4j](../content/dev/langchain4j/README.md) | [1.0.0-alpha1](../content/dev/langchain4j/langchain4j-1.0.0-alpha1.buildspec) :white_check_mark: | [1.0.0-beta2](../content/dev/langchain4j/langchain4j-1.0.0-beta2.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-1.0.0-alpha1.buildspec 1.0.0-beta2` |
| <!-- 20250313130712 --> [langchain4j](../content/dev/langchain4j/README.md) | [1.0.0-alpha1](../content/dev/langchain4j/langchain4j-1.0.0-alpha1.buildspec) :white_check_mark: | 1.0.0-beta1  | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-1.0.0-alpha1.buildspec ...` |
| <!-- 20250313082520 --> [avaje-jex-parent](../content/io/avaje/jex/README.md) | [3.0-RC21](../content/io/avaje/jex/avaje-jex-3.0-RC21.buildspec) :white_check_mark: | [3.0-RC22](../content/io/avaje/jex/avaje-jex-3.0-RC22.buildspec) | `bin/add-new-release.sh content/io/avaje/jex/avaje-jex-3.0-RC21.buildspec 3.0-RC22` |
| <!-- 20250313080852 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [11.2-javax](../content/io/avaje/inject/avaje-inject-11.2-javax.buildspec) :white_check_mark: | [11.3-RC1](../content/io/avaje/inject/avaje-inject-11.3-RC1.buildspec) | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-11.2-javax.buildspec 11.3-RC1` |
...
| <!-- 20250312134428 --> [quarkus-project](../content/io/quarkus/README.md) | [3.19.3](../content/io/quarkus/quarkus-3.19.3.buildspec) :warning: [:memo:](https://github.com/quarkusio/quarkus/pull/44671) | [3.21.0.CR1](../content/io/quarkus/quarkus-3.21.0.CR1.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.19.3.buildspec 3.21.0.CR1` |
