...
| ---------- | ---- | -- | ------- |
| <!-- 20250808195721 --> [jawk](../content/org/metricshub/jawk/README.md) | [4.0.00](../content/org/metricshub/jawk/jawk-4.0.00.buildspec) :white_check_mark: | [4.0.01](../content/org/metricshub/jawk/jawk-4.0.01.buildspec) | `bin/add-new-release.sh content/org/metricshub/jawk/jawk-4.0.00.buildspec 4.0.01` |
| <!-- 20250808193336 --> [liquibase-percona](../content/org/liquibase/ext/liquibase-percona/README.md) | [4.31.0](../content/org/liquibase/ext/liquibase-percona/liquibase-percona-4.31.0.buildspec) :white_check_mark: | [4.33.0](../content/org/liquibase/ext/liquibase-percona/liquibase-percona-4.33.0.buildspec) | `bin/add-new-release.sh content/org/liquibase/ext/liquibase-percona/liquibase-percona-4.31.0.buildspec 4.33.0` |
| <!-- 20250808193336 --> [liquibase-percona](../content/org/liquibase/ext/liquibase-percona/README.md) | [4.31.0](../content/org/liquibase/ext/liquibase-percona/liquibase-percona-4.31.0.buildspec) :white_check_mark: | 4.32.0  | `bin/add-new-release.sh content/org/liquibase/ext/liquibase-percona/liquibase-percona-4.31.0.buildspec ...` |
| <!-- 20250808185345 --> [opentelemetry-sdk](../content/io/opentelemetry/java/README.md) | [1.52.0](../content/io/opentelemetry/java/opentelemetry-sdk-1.52.0.buildspec) :white_check_mark: | [1.53.0](../content/io/opentelemetry/java/opentelemetry-sdk-1.53.0.buildspec) | `bin/add-new-release.sh content/io/opentelemetry/java/opentelemetry-sdk-1.52.0.buildspec 1.53.0` |
| <!-- 20250808154734 --> [jackson-core](../content/tools/jackson/core/jackson-core/README.md) | [3.0.0-rc6](../content/tools/jackson/core/jackson-core/jackson-core-3.0.0-rc6.buildspec) :white_check_mark: | [3.0.0-rc7](../content/tools/jackson/core/jackson-core/jackson-core-3.0.0-rc7.buildspec) | `bin/add-new-release.sh content/tools/jackson/core/jackson-core/jackson-core-3.0.0-rc6.buildspec 3.0.0-rc7` |
| <!-- 20250808153745 --> [jackson-bom](../content/tools/jackson/jackson-bom/README.md) | [3.0.0-rc6](../content/tools/jackson/jackson-bom/jackson-bom-3.0.0-rc6.buildspec) :white_check_mark: | [3.0.0-rc7](../content/tools/jackson/jackson-bom/jackson-bom-3.0.0-rc7.buildspec) | `bin/add-new-release.sh content/tools/jackson/jackson-bom/jackson-bom-3.0.0-rc6.buildspec 3.0.0-rc7` |
| <!-- 20250808143331 --> [hibernate-search-bom](../content/org/hibernate/search/hibernate-search-bom/README.md) | [8.1.0.CR2](../content/org/hibernate/search/hibernate-search-bom/hibernate-search-parent-8.1.0.CR2.buildspec) :white_check_mark: | [8.1.0.Final](../content/org/hibernate/search/hibernate-search-bom/hibernate-search-parent-8.1.0.Final.buildspec) | `bin/add-new-release.sh content/org/hibernate/search/hibernate-search-bom/hibernate-search-parent-8.1.0.CR2.buildspec 8.1.0.Final` |
| <!-- 20250808094136 --> [fusion](../content/io/yupiik/fusion/README.md) | [1.0.27](../content/io/yupiik/fusion/fusion-1.0.27.buildspec) :white_check_mark: | [1.0.28](../content/io/yupiik/fusion/fusion-1.0.28.buildspec) | `bin/add-new-release.sh content/io/yupiik/fusion/fusion-1.0.27.buildspec 1.0.28` |
| <!-- 20250808093547 --> [okapibarcode](../content/uk/org/okapibarcode/okapibarcode/README.md) | [0.5.1](../content/uk/org/okapibarcode/okapibarcode/okapibarcode-0.5.1.buildspec) :white_check_mark: | [0.5.2](../content/uk/org/okapibarcode/okapibarcode/okapibarcode-0.5.2.buildspec) | `bin/add-new-release.sh content/uk/org/okapibarcode/okapibarcode/okapibarcode-0.5.1.buildspec 0.5.2` |
| <!-- 20250808093138 --> [airbase](../content/io/airlift/airbase/README.md) | [283](../content/io/airlift/airbase/airbase-283.buildspec) :white_check_mark: | [284](../content/io/airlift/airbase/airbase-284.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-283.buildspec 284` |
| <!-- 20250808091939 --> [hibernate-reactive-core](../content/org/hibernate/reactive/hibernate-reactive/README.md) | [4.0.0.Beta1](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.0.0.Beta1.buildspec) :white_check_mark: | 3.1.0.Final  | `bin/add-new-release.sh content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.0.0.Beta1.buildspec ...` |
| <!-- 20250808013931 --> [hibernate-core](../content/org/hibernate/orm/hibernate-core/README.md) | [7.1.0.CR2](../content/org/hibernate/orm/hibernate-core/hibernate-core-7.1.0.CR2.buildspec) :white_check_mark: | [7.1.0.Final](../content/org/hibernate/orm/hibernate-core/hibernate-core-7.1.0.Final.buildspec) | `bin/add-new-release.sh content/org/hibernate/orm/hibernate-core/hibernate-core-7.1.0.CR2.buildspec 7.1.0.Final` |
| <!-- 20250803190135 --> [psi-probe](../content/com/github/psi-probe/README.md) | [5.2.1](../content/com/github/psi-probe/psi-probe-5.2.1.buildspec) :white_check_mark: | [5.3.0](../content/com/github/psi-probe/psi-probe-5.3.0.buildspec) | `bin/add-new-release.sh content/com/github/psi-probe/psi-probe-5.2.1.buildspec 5.3.0` |
| <!-- 20250803190135 --> [psi-probe](../content/com/github/psi-probe/README.md) | [5.2.1](../content/com/github/psi-probe/psi-probe-5.2.1.buildspec) :white_check_mark: | 4.5.0  | `bin/add-new-release.sh content/com/github/psi-probe/psi-probe-5.2.1.buildspec ...` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20250528173039 --> [:mailbox:](https://lists.apache.org/list?dev@syncope.apache.org:lte=1M:VOTE) | [syncope](../content/org/apache/syncope/README.md) | [4.0.0](../content/org/apache/syncope/syncope-4.0.0.buildspec) :warning: | [4.0.1](../content/org/apache/syncope/syncope-4.0.1.buildspec)  | `bin/add-new-release.sh content/org/apache/syncope/syncope-4.0.0.buildspec 4.0.1 staging` |
...
| <!-- 20241202183833 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-archiver](../content/org/apache/maven/shared/maven-archiver/README.md) | [4.0.0-beta-3](../content/org/apache/maven/shared/maven-archiver/maven-archiver-4.0.0-beta-3.buildspec) :white_check_mark: | [4.0.0-beta-4](../content/org/apache/maven/shared/maven-archiver/maven-archiver-4.0.0-beta-4.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/shared/maven-archiver/maven-archiver-4.0.0-beta-3.buildspec 4.0.0-beta-4 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20250808162537 --> [jackson-datatypes-misc-parent](../content/tools/jackson/datatype/jackson-datatypes-misc-parent/README.md) | [3.0.0-rc6](../content/tools/jackson/datatype/jackson-datatypes-misc-parent/jackson-datatypes-misc-parent-3.0.0-rc6.buildspec) :warning: | [3.0.0-rc7](../content/tools/jackson/datatype/jackson-datatypes-misc-parent/jackson-datatypes-misc-parent-3.0.0-rc7.buildspec) | `bin/add-new-release.sh content/tools/jackson/datatype/jackson-datatypes-misc-parent/jackson-datatypes-misc-parent-3.0.0-rc6.buildspec 3.0.0-rc7` |
| <!-- 20250808162136 --> [jackson-datatype-joda](../content/tools/jackson/datatype/jackson-datatype-joda/README.md) | [3.0.0-rc6](../content/tools/jackson/datatype/jackson-datatype-joda/jackson-datatype-joda-3.0.0-rc6.buildspec) :warning: | [3.0.0-rc7](../content/tools/jackson/datatype/jackson-datatype-joda/jackson-datatype-joda-3.0.0-rc7.buildspec) | `bin/add-new-release.sh content/tools/jackson/datatype/jackson-datatype-joda/jackson-datatype-joda-3.0.0-rc6.buildspec 3.0.0-rc7` |
| <!-- 20250808161741 --> [jackson-datatypes-collections](../content/tools/jackson/datatype/jackson-datatypes-collections/README.md) | [3.0.0-rc6](../content/tools/jackson/datatype/jackson-datatypes-collections/jackson-datatypes-collections-3.0.0-rc6.buildspec) :warning: | [3.0.0-rc7](../content/tools/jackson/datatype/jackson-datatypes-collections/jackson-datatypes-collections-3.0.0-rc7.buildspec) | `bin/add-new-release.sh content/tools/jackson/datatype/jackson-datatypes-collections/jackson-datatypes-collections-3.0.0-rc6.buildspec 3.0.0-rc7` |
| <!-- 20250808161351 --> [jackson-dataformat-xml](../content/tools/jackson/dataformat/jackson-dataformat-xml/README.md) | [3.0.0-rc6](../content/tools/jackson/dataformat/jackson-dataformat-xml/jackson-dataformat-xml-3.0.0-rc6.buildspec) :warning: | [3.0.0-rc7](../content/tools/jackson/dataformat/jackson-dataformat-xml/jackson-dataformat-xml-3.0.0-rc7.buildspec) | `bin/add-new-release.sh content/tools/jackson/dataformat/jackson-dataformat-xml/jackson-dataformat-xml-3.0.0-rc6.buildspec 3.0.0-rc7` |
| <!-- 20250808160939 --> [jackson-dataformats-text](../content/tools/jackson/dataformat/jackson-dataformats-text/README.md) | [3.0.0-rc6](../content/tools/jackson/dataformat/jackson-dataformats-text/jackson-dataformats-text-3.0.0-rc6.buildspec) :warning: | [3.0.0-rc7](../content/tools/jackson/dataformat/jackson-dataformats-text/jackson-dataformats-text-3.0.0-rc7.buildspec) | `bin/add-new-release.sh content/tools/jackson/dataformat/jackson-dataformats-text/jackson-dataformats-text-3.0.0-rc6.buildspec 3.0.0-rc7` |
| <!-- 20250808160935 --> [jackson-dataformats-binary](../content/tools/jackson/dataformat/jackson-dataformats-binary/README.md) | [3.0.0-rc6](../content/tools/jackson/dataformat/jackson-dataformats-binary/jackson-dataformats-binary-3.0.0-rc6.buildspec) :warning: | [3.0.0-rc7](../content/tools/jackson/dataformat/jackson-dataformats-binary/jackson-dataformats-binary-3.0.0-rc7.buildspec) | `bin/add-new-release.sh content/tools/jackson/dataformat/jackson-dataformats-binary/jackson-dataformats-binary-3.0.0-rc6.buildspec 3.0.0-rc7` |
| <!-- 20250808160811 --> [jackson-jr-parent](../content/tools/jackson/jr/README.md) | [3.0.0-rc6](../content/tools/jackson/jr/jackson-jr-3.0.0-rc6.buildspec) :warning: | [3.0.0-rc7](../content/tools/jackson/jr/jackson-jr-3.0.0-rc7.buildspec) | `bin/add-new-release.sh content/tools/jackson/jr/jackson-jr-3.0.0-rc6.buildspec 3.0.0-rc7` |
| <!-- 20250808155623 --> [jackson-databind](../content/tools/jackson/core/jackson-databind/README.md) | [3.0.0-rc6](../content/tools/jackson/core/jackson-databind/jackson-databind-3.0.0-rc6.buildspec) :warning: | [3.0.0-rc7](../content/tools/jackson/core/jackson-databind/jackson-databind-3.0.0-rc7.buildspec) | `bin/add-new-release.sh content/tools/jackson/core/jackson-databind/jackson-databind-3.0.0-rc6.buildspec 3.0.0-rc7` |
| <!-- 20250808132025 --> [quarkus-project](../content/io/quarkus/README.md) | [3.25.0](../content/io/quarkus/quarkus-3.25.0.buildspec) :warning: | [3.25.2](../content/io/quarkus/quarkus-3.25.2.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.25.0.buildspec 3.25.2` |
| <!-- 20250808105134 --> [jpmml-sparkml](../content/org/jpmml/jpmml-sparkml/README.md) | [3.1.0](../content/org/jpmml/jpmml-sparkml/jpmml-sparkml-3.1.0.buildspec) :warning: | [3.2.0](../content/org/jpmml/jpmml-sparkml/jpmml-sparkml-3.2.0.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-sparkml/jpmml-sparkml-3.1.0.buildspec 3.2.0` |
| <!-- 20250808033409 --> [tika](../content/org/apache/tika/README.md) | [3.2.1](../content/org/apache/tika/tika-3.2.1.buildspec) :warning: | [3.2.2](../content/org/apache/tika/tika-3.2.2.buildspec) | `bin/add-new-release.sh content/org/apache/tika/tika-3.2.1.buildspec 3.2.2` |
| <!-- 20250807214236 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.96.1](../content/org/finos/legend/engine/legend-engine-4.96.1.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.96.1` |
| <!-- 20250807155131 --> [karaf](../content/org/apache/karaf/karaf/README.md) | [4.4.7](../content/org/apache/karaf/karaf/karaf-4.4.7.buildspec) :warning: [:memo:](https://issues.apache.org/jira/browse/KARAF-7797) | [4.4.8](../content/org/apache/karaf/karaf/karaf-4.4.8.buildspec) | `bin/add-new-release.sh content/org/apache/karaf/karaf/karaf-4.4.7.buildspec 4.4.8` |
...
| <!-- 20250807103141 --> [langchain4j](../content/dev/langchain4j/README.md) | [1.1.0](../content/dev/langchain4j/langchain4j-1.1.0.buildspec) :warning: | [1.3.0](../content/dev/langchain4j/langchain4j-1.3.0.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-1.1.0.buildspec 1.3.0` |
...
| <!-- 20250805203748 --> [yupiik-tools-maven-plugin-parent](../content/io/yupiik/maven/plugin/README.md) | [1.2.11](../content/io/yupiik/maven/plugin/yupiik-tools-maven-plugin-1.2.11.buildspec) :warning: | [1.2.12](../content/io/yupiik/maven/plugin/yupiik-tools-maven-plugin-1.2.12.buildspec) | `bin/add-new-release.sh content/io/yupiik/maven/plugin/yupiik-tools-maven-plugin-1.2.11.buildspec 1.2.12` |
| <!-- 20250805151318 --> [plc4x-parent](../content/org/apache/plc4x/plc4x/README.md) | [0.12.0](../content/org/apache/plc4x/plc4x/plc4x-0.12.0.buildspec) :x: | [0.13.0](../content/org/apache/plc4x/plc4x/plc4x-0.13.0.buildspec) | `bin/add-new-release.sh content/org/apache/plc4x/plc4x/plc4x-0.12.0.buildspec 0.13.0` |
| <!-- 20250805012936 --> [jackson-datatypes-misc-parent](../content/com/fasterxml/jackson/datatype/jackson-datatypes-misc-parent/README.md) | [2.19.2](../content/com/fasterxml/jackson/datatype/jackson-datatypes-misc-parent/jackson-datatypes-misc-parent-2.19.2.buildspec) :warning: | [2.20.0-rc1](../content/com/fasterxml/jackson/datatype/jackson-datatypes-misc-parent/jackson-datatypes-misc-parent-2.20.0-rc1.buildspec) | `bin/add-new-release.sh content/com/fasterxml/jackson/datatype/jackson-datatypes-misc-parent/jackson-datatypes-misc-parent-2.19.2.buildspec 2.20.0-rc1` |
| <!-- 20250805012935 --> [jackson-datatypes-collections](../content/com/fasterxml/jackson/datatype/jackson-datatypes-collections/README.md) | [2.19.2](../content/com/fasterxml/jackson/datatype/jackson-datatypes-collections/jackson-datatypes-collections-2.19.2.buildspec) :warning: | [2.20.0-rc1](../content/com/fasterxml/jackson/datatype/jackson-datatypes-collections/jackson-datatypes-collections-2.20.0-rc1.buildspec) | `bin/add-new-release.sh content/com/fasterxml/jackson/datatype/jackson-datatypes-collections/jackson-datatypes-collections-2.19.2.buildspec 2.20.0-rc1` |
| <!-- 20250805012136 --> [jackson-dataformats-text](../content/com/fasterxml/jackson/dataformat/jackson-dataformats-text/README.md) | [2.19.2](../content/com/fasterxml/jackson/dataformat/jackson-dataformats-text/jackson-dataformats-text-2.19.2.buildspec) :warning: | [2.20.0-rc1](../content/com/fasterxml/jackson/dataformat/jackson-dataformats-text/jackson-dataformats-text-2.20.0-rc1.buildspec) | `bin/add-new-release.sh content/com/fasterxml/jackson/dataformat/jackson-dataformats-text/jackson-dataformats-text-2.19.2.buildspec 2.20.0-rc1` |
| <!-- 20250805012134 --> [jackson-dataformat-xml](../content/com/fasterxml/jackson/dataformat/jackson-dataformat-xml/README.md) | [2.19.2](../content/com/fasterxml/jackson/dataformat/jackson-dataformat-xml/jackson-dataformat-xml-2.19.2.buildspec) :warning: | [2.20.0-rc1](../content/com/fasterxml/jackson/dataformat/jackson-dataformat-xml/jackson-dataformat-xml-2.20.0-rc1.buildspec) | `bin/add-new-release.sh content/com/fasterxml/jackson/dataformat/jackson-dataformat-xml/jackson-dataformat-xml-2.19.2.buildspec 2.20.0-rc1` |
| <!-- 20250805011733 --> [jackson-dataformats-binary](../content/com/fasterxml/jackson/dataformat/jackson-dataformats-binary/README.md) | [2.19.2](../content/com/fasterxml/jackson/dataformat/jackson-dataformats-binary/jackson-dataformats-binary-2.19.2.buildspec) :warning: | [2.20.0-rc1](../content/com/fasterxml/jackson/dataformat/jackson-dataformats-binary/jackson-dataformats-binary-2.20.0-rc1.buildspec) | `bin/add-new-release.sh content/com/fasterxml/jackson/dataformat/jackson-dataformats-binary/jackson-dataformats-binary-2.19.2.buildspec 2.20.0-rc1` |
| <!-- 20250805010936 --> [jackson-jr-parent](../content/com/fasterxml/jackson/jr/README.md) | [2.19.2](../content/com/fasterxml/jackson/jr/jackson-jr-2.19.2.buildspec) :warning: | [2.20.0-rc1](../content/com/fasterxml/jackson/jr/jackson-jr-2.20.0-rc1.buildspec) | `bin/add-new-release.sh content/com/fasterxml/jackson/jr/jackson-jr-2.19.2.buildspec 2.20.0-rc1` |
| <!-- 20250805010535 --> [jackson-databind](../content/com/fasterxml/jackson/databind/README.md) | [2.19.2](../content/com/fasterxml/jackson/databind/jackson-databind-2.19.2.buildspec) :warning: | [2.20.0-rc1](../content/com/fasterxml/jackson/databind/jackson-databind-2.20.0-rc1.buildspec) | `bin/add-new-release.sh content/com/fasterxml/jackson/databind/jackson-databind-2.19.2.buildspec 2.20.0-rc1` |
...
| <!-- 20250804073935 --> [jpmml-sklearn](../content/org/jpmml/jpmml-sklearn/README.md) | [1.9.13](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.13.buildspec) :warning: | [1.9.14](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.14.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.13.buildspec 1.9.14` |
| <!-- 20250804063735 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [12.0-RC3](../content/io/avaje/inject/avaje-inject-12.0-RC3.buildspec) :warning: | [12.0-RC4](../content/io/avaje/inject/avaje-inject-12.0-RC4.buildspec) | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-12.0-RC3.buildspec 12.0-RC4` |
| <!-- 20250801114532 --> [jpmml-python](../content/org/jpmml/jpmml-python/README.md) | [1.3.5](../content/org/jpmml/jpmml-python/jpmml-python-1.3.5.buildspec) :warning: | [1.3.7](../content/org/jpmml/jpmml-python/jpmml-python-1.3.7.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-python/jpmml-python-1.3.5.buildspec 1.3.7` |
...
| artifactId | newest |
| ---------- | ------ |
| <!-- 20250806215033 --> [jetty-project](../content/org/eclipse/jetty/jetty-project/README.md) | 12.1.0.beta2 :warning: |
| <!-- 20250805163733 --> [jpmml-xgboost](../content/org/jpmml/jpmml-xgboost/README.md) | 1.9.2 :warning: |
| <!-- 20250805013334 --> [jackson-datatype-joda](../content/com/fasterxml/jackson/datatype/jackson-datatype-joda/README.md) | 2.20.0-rc1 :warning: |
