...
| ---------- | ---- | -- | ------- |
| <!-- 20251204155338 --> [ollama4j](../content/io/github/ollama4j/README.md) | [1.1.5](../content/io/github/ollama4j/ollama4j-1.1.5.buildspec) :white_check_mark: | [1.1.6](../content/io/github/ollama4j/ollama4j-1.1.6.buildspec) | `bin/add-new-release.sh content/io/github/ollama4j/ollama4j-1.1.5.buildspec 1.1.6` |
| <!-- 20251204132914 --> [toolbox](../content/eu/maveniverse/maven/toolbox/README.md) | [0.14.5](../content/eu/maveniverse/maven/toolbox/toolbox-0.14.5.buildspec) :white_check_mark: | [0.14.6](../content/eu/maveniverse/maven/toolbox/toolbox-0.14.6.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/toolbox/toolbox-0.14.5.buildspec 0.14.6` |
| <!-- 20251204131811 --> [mima](../content/eu/maveniverse/maven/mima/README.md) | [3.0.0-alpha-3](../content/eu/maveniverse/maven/mima/mima-3.0.0-alpha-3.buildspec) :white_check_mark: | 2.4.37  | `bin/add-new-release.sh content/eu/maveniverse/maven/mima/mima-3.0.0-alpha-3.buildspec ...` |
| <!-- 20251204113722 --> [micronaut-maven-plugin](../content/io/micronaut/maven/micronaut-maven-plugin/README.md) | [4.11.3](../content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-4.11.3.buildspec) :white_check_mark: | [4.11.4](../content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-4.11.4.buildspec) | `bin/add-new-release.sh content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-4.11.3.buildspec 4.11.4` |
| <!-- 20251204105522 --> [scg-base](../content/io/telicent/smart-caches/graph/scg-base/README.md) | [0.92.2](../content/io/telicent/smart-caches/graph/scg-base/scg-base-0.92.2.buildspec) :white_check_mark: | [0.92.3](../content/io/telicent/smart-caches/graph/scg-base/scg-base-0.92.3.buildspec) | `bin/add-new-release.sh content/io/telicent/smart-caches/graph/scg-base/scg-base-0.92.2.buildspec 0.92.3` |
| <!-- 20251204102234 --> [jena-kafka](../content/io/telicent/jena/jena-kafka/README.md) | [2.3.0](../content/io/telicent/jena/jena-kafka/jena-kafka-2.3.0.buildspec) :white_check_mark: | [2.3.1](../content/io/telicent/jena/jena-kafka/jena-kafka-2.3.1.buildspec) | `bin/add-new-release.sh content/io/telicent/jena/jena-kafka/jena-kafka-2.3.0.buildspec 2.3.1` |
| <!-- 20251204012321 --> [avaje-validator-parent](../content/io/avaje/validator/README.md) | [2.15-RC2](../content/io/avaje/validator/avaje-validator-2.15-RC2.buildspec) :white_check_mark: | [2.15-RC3](../content/io/avaje/validator/avaje-validator-2.15-RC3.buildspec) | `bin/add-new-release.sh content/io/avaje/validator/avaje-validator-2.15-RC2.buildspec 2.15-RC3` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20251204183329 --> [avaje-jsonb-parent](../content/io/avaje/jsonb/README.md) | [3.9-RC2](../content/io/avaje/jsonb/avaje-jsonb-3.9-RC2.buildspec) :warning: | [3.9-RC3](../content/io/avaje/jsonb/avaje-jsonb-3.9-RC3.buildspec) | `bin/add-new-release.sh content/io/avaje/jsonb/avaje-jsonb-3.9-RC2.buildspec 3.9-RC3` |
