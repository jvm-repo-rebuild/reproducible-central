...
| ---------- | ---- | -- | ------- |
| <!-- 20260605210518 --> [okapibarcode](../content/uk/org/okapibarcode/okapibarcode/README.md) | [0.5.5](../content/uk/org/okapibarcode/okapibarcode/okapibarcode-0.5.5.buildspec) :white_check_mark: | [0.5.6](../content/uk/org/okapibarcode/okapibarcode/okapibarcode-0.5.6.buildspec) | `bin/add-new-release.sh content/uk/org/okapibarcode/okapibarcode/okapibarcode-0.5.5.buildspec 0.5.6` |
| <!-- 20260605202553 --> [grizzly-project](../content/org/glassfish/grizzly/README.md) | [5.0.1](../content/org/glassfish/grizzly/grizzly-5.0.1.buildspec) :white_check_mark: | [5.0.2](../content/org/glassfish/grizzly/grizzly-5.0.2.buildspec) | `bin/add-new-release.sh content/org/glassfish/grizzly/grizzly-5.0.1.buildspec 5.0.2` |
| <!-- 20260605154539 --> [langchain4j](../content/dev/langchain4j/README.md) | [1.15.1](../content/dev/langchain4j/langchain4j-1.15.1.buildspec) :white_check_mark: | [1.16.0](../content/dev/langchain4j/langchain4j-1.16.0.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-1.15.1.buildspec 1.16.0` |
| <!-- 20260605145050 --> [opentelemetry-sdk](../content/io/opentelemetry/java/README.md) | [1.62.0](../content/io/opentelemetry/java/opentelemetry-sdk-1.62.0.buildspec) :white_check_mark: | [1.63.0](../content/io/opentelemetry/java/opentelemetry-sdk-1.63.0.buildspec) | `bin/add-new-release.sh content/io/opentelemetry/java/opentelemetry-sdk-1.62.0.buildspec 1.63.0` |
| <!-- 20260605125520 --> [langchain4j-cdi-parent](../content/dev/langchain4j/cdi/README.md) | [1.3.1](../content/dev/langchain4j/cdi/langchain4j-cdi-1.3.1.buildspec) :white_check_mark: | [1.3.2](../content/dev/langchain4j/cdi/langchain4j-cdi-1.3.2.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/cdi/langchain4j-cdi-1.3.1.buildspec 1.3.2` |
| <!-- 20260605041522 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [12.6-RC4](../content/io/avaje/inject/avaje-inject-12.6-RC4.buildspec) :white_check_mark: | [12.6-javax](../content/io/avaje/inject/avaje-inject-12.6-javax.buildspec) | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-12.6-RC4.buildspec 12.6-javax` |
| <!-- 20260605041522 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [12.6-RC4](../content/io/avaje/inject/avaje-inject-12.6-RC4.buildspec) :white_check_mark: | 12.6  | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-12.6-RC4.buildspec ...` |
| <!-- 20260605030317 --> [dbunit](../content/org/dbunit/README.md) | [3.1.0](../content/org/dbunit/dbunit-3.1.0.buildspec) :white_check_mark: | [3.2.0](../content/org/dbunit/dbunit-3.2.0.buildspec) | `bin/add-new-release.sh content/org/dbunit/dbunit-3.1.0.buildspec 3.2.0` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260605152958 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.130.1](../content/org/finos/legend/engine/legend-engine-4.130.1.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.130.1` |
| <!-- 20260605104520 --> [avaje-metrics-parent](../content/io/avaje/metrics/README.md) | [9.16-RC2](../content/io/avaje/metrics/avaje-metrics-9.16-RC2.buildspec) :warning: | [9.16-RC3](../content/io/avaje/metrics/avaje-metrics-9.16-RC3.buildspec) | `bin/add-new-release.sh content/io/avaje/metrics/avaje-metrics-9.16-RC2.buildspec 9.16-RC3` |
