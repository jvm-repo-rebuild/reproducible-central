...
| ---------- | ---- | -- | ------- |
| <!-- 20260606085912 --> [test-distribution](../content/com/github/seregamorph/test-distribution/README.md) | [0.9](../content/com/github/seregamorph/test-distribution/test-distribution-0.9.buildspec) :white_check_mark: | [0.10](../content/com/github/seregamorph/test-distribution/test-distribution-0.10.buildspec) | `bin/add-new-release.sh content/com/github/seregamorph/test-distribution/test-distribution-0.9.buildspec 0.10` |
| <!-- 20260606075726 --> [langchain4j](../content/dev/langchain4j/README.md) | [1.16.0](../content/dev/langchain4j/langchain4j-1.16.0.buildspec) :white_check_mark: | [1.16.1](../content/dev/langchain4j/langchain4j-1.16.1.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-1.16.0.buildspec 1.16.1` |
| <!-- 20260606040829 --> [nifi-api](../content/org/apache/nifi/nifi-api/README.md) | [2.8.0](../content/org/apache/nifi/nifi-api/nifi-api-2.8.0.buildspec) :white_check_mark: | [2.9.0](../content/org/apache/nifi/nifi-api/nifi-api-2.9.0.buildspec) | `bin/add-new-release.sh content/org/apache/nifi/nifi-api/nifi-api-2.8.0.buildspec 2.9.0` |
| <!-- 20260606003612 --> [maven-lockfile](../content/io/github/chains-project/maven-lockfile/README.md) | [5.16.1-beta-3](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.16.1-beta-3.buildspec) :white_check_mark: | [5.17.0](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.17.0.buildspec) | `bin/add-new-release.sh content/io/github/chains-project/maven-lockfile/maven-lockfile-5.16.1-beta-3.buildspec 5.17.0` |
