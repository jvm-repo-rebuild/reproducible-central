...
| <!-- 20260315012557 --> [hibernate-reactive-core](../content/org/hibernate/reactive/hibernate-reactive/README.md) | [4.3.0.CR1](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.3.0.CR1.buildspec) :white_check_mark: | 4.2.6.Final 4.1.12.Final 3.2.6.Final 3.1.14.Final  | `bin/add-new-release.sh content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.3.0.CR1.buildspec ...` |
| <!-- 20260315002914 --> [hibernate-core](../content/org/hibernate/orm/hibernate-core/README.md) | [8.0.0.Alpha1](../content/org/hibernate/orm/hibernate-core/hibernate-core-8.0.0.Alpha1.buildspec) :white_check_mark: | 7.2.7.Final 7.1.19.Final  | `bin/add-new-release.sh content/org/hibernate/orm/hibernate-core/hibernate-core-8.0.0.Alpha1.buildspec ...` |
