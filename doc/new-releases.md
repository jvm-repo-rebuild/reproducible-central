...
| ---------- | ---- | -- | ------- |
| <!-- 20260812144910 --> [rdf-abac](../content/io/telicent/jena/rdf-abac/README.md) | [3.1.5](../content/io/telicent/jena/rdf-abac/rdf-abac-3.1.5.buildspec) :white_check_mark: | [3.1.6](../content/io/telicent/jena/rdf-abac/rdf-abac-3.1.6.buildspec) | `bin/add-new-release.sh content/io/telicent/jena/rdf-abac/rdf-abac-3.1.5.buildspec 3.1.6` |
| <!-- 20260812141321 --> [jena-kafka](../content/io/telicent/jena/jena-kafka/README.md) | [3.1.0](../content/io/telicent/jena/jena-kafka/jena-kafka-3.1.0.buildspec) :white_check_mark: | [3.1.1](../content/io/telicent/jena/jena-kafka/jena-kafka-3.1.1.buildspec) | `bin/add-new-release.sh content/io/telicent/jena/jena-kafka/jena-kafka-3.1.0.buildspec 3.1.1` |
| <!-- 20260812071516 --> [openapi-jaxrs-client](../content/dk/mada/jaxrs/openapi-jaxrs-client/README.md) | [0.13.1](../content/dk/mada/jaxrs/openapi-jaxrs-client/openapi-jaxrs-client-0.13.1.buildspec) :white_check_mark: | [0.13.2](../content/dk/mada/jaxrs/openapi-jaxrs-client/openapi-jaxrs-client-0.13.2.buildspec) | `bin/add-new-release.sh content/dk/mada/jaxrs/openapi-jaxrs-client/openapi-jaxrs-client-0.13.1.buildspec 0.13.2` |
| <!-- 20260812023613 --> [dbunit](../content/org/dbunit/README.md) | [3.4.0](../content/org/dbunit/dbunit-3.4.0.buildspec) :white_check_mark: | [3.5.0](../content/org/dbunit/dbunit-3.5.0.buildspec) | `bin/add-new-release.sh content/org/dbunit/dbunit-3.4.0.buildspec 3.5.0` |
| <!-- 20260811080856 --> [struts2-project](../content/org/apache/struts/README.md) | [7.3.0](../content/org/apache/struts/struts2-7.3.0.buildspec) :white_check_mark: | 6.11.0  | `bin/add-new-release.sh content/org/apache/struts/struts2-7.3.0.buildspec ...` |
...
| <!-- 20260812153801 --> [ratis](../content/org/apache/ratis/README.md) | [3.2.2](../content/org/apache/ratis/ratis-3.2.2.buildspec) :warning: | [3.3.0](../content/org/apache/ratis/ratis-3.3.0.buildspec) | `bin/add-new-release.sh content/org/apache/ratis/ratis-3.2.2.buildspec 3.3.0` |
| <!-- 20260812152232 --> [scg-base](../content/io/telicent/smart-caches/graph/scg-base/README.md) | [1.1.1](../content/io/telicent/smart-caches/graph/scg-base/scg-base-1.1.1.buildspec) :warning: | [1.1.2](../content/io/telicent/smart-caches/graph/scg-base/scg-base-1.1.2.buildspec) | `bin/add-new-release.sh content/io/telicent/smart-caches/graph/scg-base/scg-base-1.1.1.buildspec 1.1.2` |
| <!-- 20260812073724 --> [arthas-all](../content/com/taobao/arthas/README.md) | [4.1.0](../content/com/taobao/arthas/arthas-4.1.0.buildspec) :warning: [:memo:](https://github.com/alibaba/arthas/pull/3001) | [4.3.3](../content/com/taobao/arthas/arthas-4.3.3.buildspec) | `bin/add-new-release.sh content/com/taobao/arthas/arthas-4.1.0.buildspec 4.3.3` |
| <!-- 20260812023524 --> [avaje-metrics-parent](../content/io/avaje/metrics/README.md) | [10.0](../content/io/avaje/metrics/avaje-metrics-10.0.buildspec) :warning: | [10.1](../content/io/avaje/metrics/avaje-metrics-10.1.buildspec) | `bin/add-new-release.sh content/io/avaje/metrics/avaje-metrics-10.0.buildspec 10.1` |
...
| <!-- 20260810123809 --> [activemq-parent](../content/org/apache/activemq/README.md) | [6.3.0](../content/org/apache/activemq/activemq-6.3.0.buildspec) :warning: | [6.3.1](../content/org/apache/activemq/activemq-6.3.1.buildspec) | `bin/add-new-release.sh content/org/apache/activemq/activemq-6.3.0.buildspec 6.3.1` |
...
| artifactId | newest |
| ---------- | ------ |
| <!-- 20260810121920 --> [convex](../content/world/convex/README.md) | 0.8.11 :warning: |
