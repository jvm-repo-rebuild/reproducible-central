...
| ---------- | ---- | -- | ------- |
| <!-- 20260603220917 --> [jooby](../content/io/jooby/README.md) | [4.5.1](../content/io/jooby/jooby-4.5.1.buildspec) :white_check_mark: | [4.5.2](../content/io/jooby/jooby-4.5.2.buildspec) | `bin/add-new-release.sh content/io/jooby/jooby-4.5.1.buildspec 4.5.2` |
| <!-- 20260603163723 --> [jackson-core](../content/com/fasterxml/jackson/core/README.md) | [2.21.4](../content/com/fasterxml/jackson/core/jackson-core-2.21.4.buildspec) :white_check_mark: | [2.22.0](../content/com/fasterxml/jackson/core/jackson-core-2.22.0.buildspec) | `bin/add-new-release.sh content/com/fasterxml/jackson/core/jackson-core-2.21.4.buildspec 2.22.0` |
| <!-- 20260603135540 --> [byte-buddy-parent](../content/net/bytebuddy/README.md) | [1.18.9-jdk5](../content/net/bytebuddy/byte-buddy-1.18.9-jdk5.buildspec) :white_check_mark: | [1.18.10-jdk5](../content/net/bytebuddy/byte-buddy-1.18.10-jdk5.buildspec) | `bin/add-new-release.sh content/net/bytebuddy/byte-buddy-1.18.9-jdk5.buildspec 1.18.10-jdk5` |
| <!-- 20260603135540 --> [byte-buddy-parent](../content/net/bytebuddy/README.md) | [1.18.9-jdk5](../content/net/bytebuddy/byte-buddy-1.18.9-jdk5.buildspec) :white_check_mark: | 1.18.10 1.18.9 1.18.8 1.18.7-jdk5 1.18.6-jdk6-jdk5 1.18.6-jdk5  | `bin/add-new-release.sh content/net/bytebuddy/byte-buddy-1.18.9-jdk5.buildspec ...` |
| <!-- 20260603114014 --> [commons-parent](../content/org/apache/commons/parent/README.md) | [100](../content/org/apache/commons/parent/commons-parent-100.buildspec) :white_check_mark: | [101](../content/org/apache/commons/parent/commons-parent-101.buildspec) | `bin/add-new-release.sh content/org/apache/commons/parent/commons-parent-100.buildspec 101` |
| <!-- 20260603074127 --> [bnd-plugin-parent](../content/biz/aQute/bnd/plugins/README.md) | [7.2.3](../content/biz/aQute/bnd/plugins/bnd-plugins-7.2.3.buildspec) :white_check_mark: | [7.3.0](../content/biz/aQute/bnd/plugins/bnd-plugins-7.3.0.buildspec) | `bin/add-new-release.sh content/biz/aQute/bnd/plugins/bnd-plugins-7.2.3.buildspec 7.3.0` |
...
| <!-- 20260602060241 --> [mina-parent](../content/org/apache/mina/README.md) | [2.2.8](../content/org/apache/mina/mina-2.2.8.buildspec) :white_check_mark: | 2.1.13  | `bin/add-new-release.sh content/org/apache/mina/mina-2.2.8.buildspec ...` |
| <!-- 20260602051343 --> [jetty-project](../content/org/eclipse/jetty/jetty-project/README.md) | [12.1.10](../content/org/eclipse/jetty/jetty-project/jetty-project-12.1.10.buildspec) :white_check_mark: | 12.0.36  | `bin/add-new-release.sh content/org/eclipse/jetty/jetty-project/jetty-project-12.1.10.buildspec ...` |
...
| <!-- 20260603181734 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.130.0](../content/org/finos/legend/engine/legend-engine-4.130.0.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.130.0` |
| <!-- 20260603111928 --> [avaje-metrics-parent](../content/io/avaje/metrics/README.md) | [9.12](../content/io/avaje/metrics/avaje-metrics-9.12.buildspec) :warning: | [9.15](../content/io/avaje/metrics/avaje-metrics-9.15.buildspec) | `bin/add-new-release.sh content/io/avaje/metrics/avaje-metrics-9.12.buildspec 9.15` |
| <!-- 20260603075353 --> [quarkus-project](../content/io/quarkus/README.md) | [3.36.0](../content/io/quarkus/quarkus-3.36.0.buildspec) :warning: | [3.36.1](../content/io/quarkus/quarkus-3.36.1.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.36.0.buildspec 3.36.1` |
