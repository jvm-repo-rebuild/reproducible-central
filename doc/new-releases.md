...
| <!-- 20260422134351 --> [rdf-abac](../content/io/telicent/jena/rdf-abac/README.md) | [2.0.3](../content/io/telicent/jena/rdf-abac/rdf-abac-2.0.3.buildspec) :white_check_mark: | [3.0.0](../content/io/telicent/jena/rdf-abac/rdf-abac-3.0.0.buildspec) | `bin/add-new-release.sh content/io/telicent/jena/rdf-abac/rdf-abac-2.0.3.buildspec 3.0.0` |
...
| <!-- 20260422110905 --> [jakarta.persistence-api](../content/jakarta/persistence/jakarta.persistence-api/README.md) | [4.0.0-M1](../content/jakarta/persistence/jakarta.persistence-api/jakarta.persistence-api-4.0.0-M1.buildspec) :white_check_mark: | [4.0.0-M2](../content/jakarta/persistence/jakarta.persistence-api/jakarta.persistence-api-4.0.0-M2.buildspec) | `bin/add-new-release.sh content/jakarta/persistence/jakarta.persistence-api/jakarta.persistence-api-4.0.0-M1.buildspec 4.0.0-M2` |
| <!-- 20260421221003 --> [openapi-maven-plugin](../content/io/github/kbuntrock/openapi-maven-plugin/README.md) | [0.0.30](../content/io/github/kbuntrock/openapi-maven-plugin/openapi-maven-plugin-0.0.30.buildspec) :white_check_mark: | [0.0.31](../content/io/github/kbuntrock/openapi-maven-plugin/openapi-maven-plugin-0.0.31.buildspec) | `bin/add-new-release.sh content/io/github/kbuntrock/openapi-maven-plugin/openapi-maven-plugin-0.0.30.buildspec 0.0.31` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260422173741 --> [quarkus-project](../content/io/quarkus/README.md) | [3.34.4](../content/io/quarkus/quarkus-3.34.4.buildspec) :warning: | [3.35.0](../content/io/quarkus/quarkus-3.35.0.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.34.4.buildspec 3.35.0` |
