...
| ---------- | ---- | -- | ------- |
| <!-- 20260214205918 --> [parent](../content/ch/qos/logback/access/README.md) | [2.0.9](../content/ch/qos/logback/access/access-2.0.9.buildspec) :white_check_mark: | [2.0.11](../content/ch/qos/logback/access/access-2.0.11.buildspec) | `bin/add-new-release.sh content/ch/qos/logback/access/access-2.0.9.buildspec 2.0.11` |
| <!-- 20260214205918 --> [parent](../content/ch/qos/logback/access/README.md) | [2.0.9](../content/ch/qos/logback/access/access-2.0.9.buildspec) :white_check_mark: | 2.0.10  | `bin/add-new-release.sh content/ch/qos/logback/access/access-2.0.9.buildspec ...` |
| <!-- 20260214203711 --> [cui-parent-pom](../content/de/cuioss/cui-parent-pom/README.md) | [1.4.1](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.4.1.buildspec) :white_check_mark: | [1.4.2](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.4.2.buildspec) | `bin/add-new-release.sh content/de/cuioss/cui-parent-pom/cui-parent-pom-1.4.1.buildspec 1.4.2` |
| <!-- 20260214200515 --> [logback-parent](../content/ch/qos/logback/README.md) | [1.5.29](../content/ch/qos/logback/logback-1.5.29.buildspec) :white_check_mark: | [1.5.31](../content/ch/qos/logback/logback-1.5.31.buildspec) | `bin/add-new-release.sh content/ch/qos/logback/logback-1.5.29.buildspec 1.5.31` |
| <!-- 20260214200515 --> [logback-parent](../content/ch/qos/logback/README.md) | [1.5.29](../content/ch/qos/logback/logback-1.5.29.buildspec) :white_check_mark: | 1.5.30  | `bin/add-new-release.sh content/ch/qos/logback/logback-1.5.29.buildspec ...` |
| <!-- 20260214074117 --> [byte-buddy-parent](../content/net/bytebuddy/README.md) | [1.18.4](../content/net/bytebuddy/byte-buddy-1.18.4.buildspec) :white_check_mark: | [1.18.5](../content/net/bytebuddy/byte-buddy-1.18.5.buildspec) | `bin/add-new-release.sh content/net/bytebuddy/byte-buddy-1.18.4.buildspec 1.18.5` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260214165914 --> [toolbox](../content/eu/maveniverse/maven/toolbox/README.md) | [0.15.1](../content/eu/maveniverse/maven/toolbox/toolbox-0.15.1.buildspec) :warning: | [0.15.2](../content/eu/maveniverse/maven/toolbox/toolbox-0.15.2.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/toolbox/toolbox-0.15.1.buildspec 0.15.2` |
| <!-- 20260214115116 --> [jpmml-sklearn](../content/org/jpmml/jpmml-sklearn/README.md) | [1.9.28](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.28.buildspec) :warning: | [1.9.29](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.29.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.28.buildspec 1.9.29` |
| <!-- 20260214052920 --> [avaje-http-parent](../content/io/avaje/http/README.md) | [3.7](../content/io/avaje/http/avaje-http-3.7.buildspec) :warning: [:memo:](https://github.com/avaje/avaje-spi-service/issues/78) | [3.8-RC1](../content/io/avaje/http/avaje-http-3.8-RC1.buildspec) | `bin/add-new-release.sh content/io/avaje/http/avaje-http-3.7.buildspec 3.8-RC1` |
