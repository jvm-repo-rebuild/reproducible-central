...
| ---------- | ---- | -- | ------- |
| <!-- 20260527210807 --> [openapi-maven-plugin](../content/io/github/kbuntrock/openapi-maven-plugin/README.md) | [0.0.31](../content/io/github/kbuntrock/openapi-maven-plugin/openapi-maven-plugin-0.0.31.buildspec) :white_check_mark: | [0.0.32](../content/io/github/kbuntrock/openapi-maven-plugin/openapi-maven-plugin-0.0.32.buildspec) | `bin/add-new-release.sh content/io/github/kbuntrock/openapi-maven-plugin/openapi-maven-plugin-0.0.31.buildspec 0.0.32` |
| <!-- 20260527202934 --> [surefire](../content/org/apache/maven/surefire/README.md) | [3.5.5](../content/org/apache/maven/surefire/surefire-3.5.5.buildspec) :white_check_mark: | [3.5.6](../content/org/apache/maven/surefire/surefire-3.5.6.buildspec) | `bin/add-new-release.sh content/org/apache/maven/surefire/surefire-3.5.5.buildspec 3.5.6` |
| <!-- 20260527201718 --> [logback-parent](../content/ch/qos/logback/README.md) | [1.5.32](../content/ch/qos/logback/logback-1.5.32.buildspec) :white_check_mark: | [1.5.33](../content/ch/qos/logback/logback-1.5.33.buildspec) | `bin/add-new-release.sh content/ch/qos/logback/logback-1.5.32.buildspec 1.5.33` |
| <!-- 20260527185318 --> [oras-java-sdk](../content/land/oras/oras-java-sdk/README.md) | [0.6.3](../content/land/oras/oras-java-sdk/oras-java-sdk-0.6.3.buildspec) :white_check_mark: | [0.6.4](../content/land/oras/oras-java-sdk/oras-java-sdk-0.6.4.buildspec) | `bin/add-new-release.sh content/land/oras/oras-java-sdk/oras-java-sdk-0.6.3.buildspec 0.6.4` |
| <!-- 20260527142415 --> [hibernate-search-bom](../content/org/hibernate/search/hibernate-search-bom/README.md) | [8.4.0.CR1](../content/org/hibernate/search/hibernate-search-bom/hibernate-search-parent-8.4.0.CR1.buildspec) :white_check_mark: | [8.4.0.Final](../content/org/hibernate/search/hibernate-search-bom/hibernate-search-parent-8.4.0.Final.buildspec) | `bin/add-new-release.sh content/org/hibernate/search/hibernate-search-bom/hibernate-search-parent-8.4.0.CR1.buildspec 8.4.0.Final` |
| <!-- 20260527121917 --> [hibernate-reactive-core](../content/org/hibernate/reactive/hibernate-reactive/README.md) | [4.4.0.CR1](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.4.0.CR1.buildspec) :white_check_mark: | [4.4.0.Final](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.4.0.Final.buildspec) | `bin/add-new-release.sh content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.4.0.CR1.buildspec 4.4.0.Final` |
| <!-- 20260527121917 --> [hibernate-reactive-core](../content/org/hibernate/reactive/hibernate-reactive/README.md) | [4.4.0.CR1](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.4.0.CR1.buildspec) :white_check_mark: | 3.4.0.Final  | `bin/add-new-release.sh content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.4.0.CR1.buildspec ...` |
| <!-- 20260527115915 --> [scg-base](../content/io/telicent/smart-caches/graph/scg-base/README.md) | [1.0.2](../content/io/telicent/smart-caches/graph/scg-base/scg-base-1.0.2.buildspec) :white_check_mark: | [1.0.3](../content/io/telicent/smart-caches/graph/scg-base/scg-base-1.0.3.buildspec) | `bin/add-new-release.sh content/io/telicent/smart-caches/graph/scg-base/scg-base-1.0.2.buildspec 1.0.3` |
| <!-- 20260527050443 --> [project](../content/org/apache/directory/project/README.md) | [50](../content/org/apache/directory/project/project-50.buildspec) :white_check_mark: | [51](../content/org/apache/directory/project/project-51.buildspec) | `bin/add-new-release.sh content/org/apache/directory/project/project-50.buildspec 51` |
| <!-- 20260526225921 --> [semanticcms-bom-book](../content/com/semanticcms/semanticcms-bom-book/README.md) | [2.0.1](../content/com/semanticcms/semanticcms-bom-book/semanticcms-bom-book-2.0.1.buildspec) :white_check_mark: | [2.1.0](../content/com/semanticcms/semanticcms-bom-book/semanticcms-bom-book-2.1.0.buildspec) | `bin/add-new-release.sh content/com/semanticcms/semanticcms-bom-book/semanticcms-bom-book-2.0.1.buildspec 2.1.0` |
| <!-- 20260526224721 --> [semanticcms-bom](../content/com/semanticcms/semanticcms-bom/README.md) | [2.0.1](../content/com/semanticcms/semanticcms-bom/semanticcms-bom-2.0.1.buildspec) :white_check_mark: | [2.1.0](../content/com/semanticcms/semanticcms-bom/semanticcms-bom-2.1.0.buildspec) | `bin/add-new-release.sh content/com/semanticcms/semanticcms-bom/semanticcms-bom-2.0.1.buildspec 2.1.0` |
| <!-- 20260526224115 --> [semanticcms-all-book](../content/com/semanticcms/semanticcms-all-book/README.md) | [2.0.1](../content/com/semanticcms/semanticcms-all-book/semanticcms-all-book-2.0.1.buildspec) :white_check_mark: | [2.1.0](../content/com/semanticcms/semanticcms-all-book/semanticcms-all-book-2.1.0.buildspec) | `bin/add-new-release.sh content/com/semanticcms/semanticcms-all-book/semanticcms-all-book-2.0.1.buildspec 2.1.0` |
| <!-- 20260526223515 --> [semanticcms-all](../content/com/semanticcms/semanticcms-all/README.md) | [2.0.1](../content/com/semanticcms/semanticcms-all/semanticcms-all-2.0.1.buildspec) :white_check_mark: | [2.1.0](../content/com/semanticcms/semanticcms-all/semanticcms-all-2.1.0.buildspec) | `bin/add-new-release.sh content/com/semanticcms/semanticcms-all/semanticcms-all-2.0.1.buildspec 2.1.0` |
| <!-- 20260526222915 --> [semanticcms-tag-reference-book](../content/com/semanticcms/semanticcms-tag-reference-book/README.md) | [2.0.0](../content/com/semanticcms/semanticcms-tag-reference-book/semanticcms-tag-reference-book-2.0.0.buildspec) :white_check_mark: | [2.1.0](../content/com/semanticcms/semanticcms-tag-reference-book/semanticcms-tag-reference-book-2.1.0.buildspec) | `bin/add-new-release.sh content/com/semanticcms/semanticcms-tag-reference-book/semanticcms-tag-reference-book-2.0.0.buildspec 2.1.0` |
| <!-- 20260526221716 --> [semanticcms-tag-reference](../content/com/semanticcms/semanticcms-tag-reference/README.md) | [2.0.0](../content/com/semanticcms/semanticcms-tag-reference/semanticcms-tag-reference-2.0.0.buildspec) :white_check_mark: | [2.1.0](../content/com/semanticcms/semanticcms-tag-reference/semanticcms-tag-reference-2.1.0.buildspec) | `bin/add-new-release.sh content/com/semanticcms/semanticcms-tag-reference/semanticcms-tag-reference-2.0.0.buildspec 2.1.0` |
| <!-- 20260526220920 --> [semanticcms-parent-book](../content/com/semanticcms/semanticcms-parent-book/README.md) | [2.0.1](../content/com/semanticcms/semanticcms-parent-book/semanticcms-parent-book-2.0.1.buildspec) :white_check_mark: | [2.1.0](../content/com/semanticcms/semanticcms-parent-book/semanticcms-parent-book-2.1.0.buildspec) | `bin/add-new-release.sh content/com/semanticcms/semanticcms-parent-book/semanticcms-parent-book-2.0.1.buildspec 2.1.0` |
| <!-- 20260526220136 --> [semanticcms-parent](../content/com/semanticcms/semanticcms-parent/README.md) | [2.0.1](../content/com/semanticcms/semanticcms-parent/semanticcms-parent-2.0.1.buildspec) :white_check_mark: | [2.1.0](../content/com/semanticcms/semanticcms-parent/semanticcms-parent-2.1.0.buildspec) | `bin/add-new-release.sh content/com/semanticcms/semanticcms-parent/semanticcms-parent-2.0.1.buildspec 2.1.0` |
...
| <!-- 20260406190340 --> [:mailbox:](https://lists.apache.org/list?dev@sshd.apache.org:lte=1M:VOTE) | [sshd](../content/org/apache/sshd/README.md) | [3.0.0-M3](../content/org/apache/sshd/sshd-3.0.0-M3.buildspec) :white_check_mark: | [3.0.0-M4](../content/org/apache/sshd/sshd-3.0.0-M4.buildspec)  | `bin/add-new-release.sh content/org/apache/sshd/sshd-3.0.0-M3.buildspec 3.0.0-M4 staging` |
| <!-- 20260208213500 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-dependency-plugin](../content/org/apache/maven/plugins/maven-dependency-plugin/README.md) | [3.10.0](../content/org/apache/maven/plugins/maven-dependency-plugin/maven-dependency-plugin-3.10.0.buildspec) :white_check_mark: | [3.11.0](../content/org/apache/maven/plugins/maven-dependency-plugin/maven-dependency-plugin-3.11.0.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-dependency-plugin/maven-dependency-plugin-3.10.0.buildspec 3.11.0 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260526221508 --> [axis2](../content/org/apache/axis2/README.md) | [2.0.0](../content/org/apache/axis2/axis2-2.0.0.buildspec) :warning: [:memo:](https://github.com/apache/axis-axis2-java-core/pull/879) | [2.0.1](../content/org/apache/axis2/axis2-2.0.1.buildspec) | `bin/add-new-release.sh content/org/apache/axis2/axis2-2.0.0.buildspec 2.0.1` |
...
| <!-- 20260526103915 --> [electrum-client](../content/net/osslabz/electrum-client/README.md) | [0.2.16](../content/net/osslabz/electrum-client/electrum-client-0.2.16.buildspec) :warning: | [0.3.0](../content/net/osslabz/electrum-client/electrum-client-0.3.0.buildspec) | `bin/add-new-release.sh content/net/osslabz/electrum-client/electrum-client-0.2.16.buildspec 0.3.0` |
...
| <!-- 20260526031717 --> [avaje-metrics-parent](../content/io/avaje/metrics/README.md) | [9.9-RC7](../content/io/avaje/metrics/avaje-metrics-9.9-RC7.buildspec) :warning: | [9.10](../content/io/avaje/metrics/avaje-metrics-9.10.buildspec) | `bin/add-new-release.sh content/io/avaje/metrics/avaje-metrics-9.9-RC7.buildspec 9.10` |
...
| <!-- 20260523064723 --> [jline](../content/org/jline/README.md) | [4.0.10](../content/org/jline/jline-4.0.10.buildspec) :warning: | [4.1.2](../content/org/jline/jline-4.1.2.buildspec) | `bin/add-new-release.sh content/org/jline/jline-4.0.10.buildspec 4.1.2` |
...
| <!-- 20260521164145 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.129.8](../content/org/finos/legend/engine/legend-engine-4.129.8.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.129.8` |
...
| <!-- 20260522110715 --> [toolbox](../content/eu/maveniverse/maven/toolbox/README.md) | 0.15.13 :warning: |
...
| <!-- 20260515154316 --> [langchain4j](../content/dev/langchain4j/README.md) | 1.15.0 :warning: |
