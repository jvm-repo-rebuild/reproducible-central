...
| ---------- | ---- | -- | ------- |
| <!-- 20260312203615 --> [maven-jlink-plugin](../content/org/apache/maven/plugins/maven-jlink-plugin/README.md) | [3.2.0](../content/org/apache/maven/plugins/maven-jlink-plugin/maven-jlink-plugin-3.2.0.buildspec) :white_check_mark: | [3.3.0](../content/org/apache/maven/plugins/maven-jlink-plugin/maven-jlink-plugin-3.3.0.buildspec) | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-jlink-plugin/maven-jlink-plugin-3.2.0.buildspec 3.3.0` |
| <!-- 20260312170041 --> [micronaut-maven-plugin](../content/io/micronaut/maven/micronaut-maven-plugin/README.md) | [4.11.6](../content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-4.11.6.buildspec) :white_check_mark: | [5.0.0-M1](../content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-5.0.0-M1.buildspec) | `bin/add-new-release.sh content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-4.11.6.buildspec 5.0.0-M1` |
| <!-- 20260312140957 --> [maven-boms](../content/eu/maveniverse/maven/maven-boms/README.md) | [3.9.13-01](../content/eu/maveniverse/maven/maven-boms/maven-boms-3.9.13-01.buildspec) :white_check_mark: | [3.9.14-01](../content/eu/maveniverse/maven/maven-boms/maven-boms-3.9.14-01.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/maven-boms/maven-boms-3.9.13-01.buildspec 3.9.14-01` |
| <!-- 20260312140127 --> [mima](../content/eu/maveniverse/maven/mima/README.md) | [3.0.0-alpha-3](../content/eu/maveniverse/maven/mima/mima-3.0.0-alpha-3.buildspec) :white_check_mark: | 2.4.42  | `bin/add-new-release.sh content/eu/maveniverse/maven/mima/mima-3.0.0-alpha-3.buildspec ...` |
| <!-- 20260312112905 --> [maven](../content/org/apache/maven/maven/README.md) | [4.0.0-rc-5](../content/org/apache/maven/maven/maven-4.0.0-rc-5.buildspec) :white_check_mark: | 3.9.14  | `bin/add-new-release.sh content/org/apache/maven/maven/maven-4.0.0-rc-5.buildspec ...` |
| <!-- 20260312090717 --> [aru-parent](../content/io/github/cbarlin/aru/README.md) | [0.8.1](../content/io/github/cbarlin/aru/aru-0.8.1.buildspec) :white_check_mark: | [0.8.2](../content/io/github/cbarlin/aru/aru-0.8.2.buildspec) | `bin/add-new-release.sh content/io/github/cbarlin/aru/aru-0.8.1.buildspec 0.8.2` |
| <!-- 20260312005317 --> [mybatis-dynamic-sql](../content/org/mybatis/dynamic-sql/README.md) | [1.5.2](../content/org/mybatis/dynamic-sql/mybatis-dynamic-sql-1.5.2.buildspec) :white_check_mark: | [2.0.0](../content/org/mybatis/dynamic-sql/mybatis-dynamic-sql-2.0.0.buildspec) | `bin/add-new-release.sh content/org/mybatis/dynamic-sql/mybatis-dynamic-sql-1.5.2.buildspec 2.0.0` |
| <!-- 20260311220053 --> [spdx-java-core](../content/org/spdx/spdx-java-core/README.md) | [1.0.2](../content/org/spdx/spdx-java-core/spdx-java-core-1.0.2.buildspec) :white_check_mark: | [1.0.3](../content/org/spdx/spdx-java-core/spdx-java-core-1.0.3.buildspec) | `bin/add-new-release.sh content/org/spdx/spdx-java-core/spdx-java-core-1.0.2.buildspec 1.0.3` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260312165510 --> [quarkus-project](../content/io/quarkus/README.md) | [3.32.3](../content/io/quarkus/quarkus-3.32.3.buildspec) :warning: | [3.34.0.CR1](../content/io/quarkus/quarkus-3.34.0.CR1.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.32.3.buildspec 3.34.0.CR1` |
