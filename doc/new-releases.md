...
| ---------- | ---- | -- | ------- |
| <!-- 20260519203514 --> [airbase](../content/io/airlift/airbase/README.md) | [375](../content/io/airlift/airbase/airbase-375.buildspec) :white_check_mark: | [377](../content/io/airlift/airbase/airbase-377.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-375.buildspec 377` |
| <!-- 20260519203514 --> [airbase](../content/io/airlift/airbase/README.md) | [375](../content/io/airlift/airbase/airbase-375.buildspec) :white_check_mark: | 376  | `bin/add-new-release.sh content/io/airlift/airbase/airbase-375.buildspec ...` |
| <!-- 20260519184116 --> [micronaut-maven-plugin](../content/io/micronaut/maven/micronaut-maven-plugin/README.md) | [5.0.0-RC1](../content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-5.0.0-RC1.buildspec) :white_check_mark: | [5.0.0](../content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-5.0.0.buildspec) | `bin/add-new-release.sh content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-5.0.0-RC1.buildspec 5.0.0` |
| <!-- 20260519183949 --> [junit-bom](../content/org/junit/junit5/README.md) | [6.1.0-RC1](../content/org/junit/junit5/junit5-6.1.0-RC1.buildspec) :white_check_mark: | [6.1.0](../content/org/junit/junit5/junit5-6.1.0.buildspec) | `bin/add-new-release.sh content/org/junit/junit5/junit5-6.1.0-RC1.buildspec 6.1.0` |
| <!-- 20260519183235 --> [nisse](../content/eu/maveniverse/maven/nisse/README.md) | [0.9.0](../content/eu/maveniverse/maven/nisse/nisse-0.9.0.buildspec) :white_check_mark: | [0.9.1](../content/eu/maveniverse/maven/nisse/nisse-0.9.1.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/nisse/nisse-0.9.0.buildspec 0.9.1` |
| <!-- 20260519174010 --> [rdf-abac](../content/io/telicent/jena/rdf-abac/README.md) | [3.1.1](../content/io/telicent/jena/rdf-abac/rdf-abac-3.1.1.buildspec) :white_check_mark: | [3.1.2](../content/io/telicent/jena/rdf-abac/rdf-abac-3.1.2.buildspec) | `bin/add-new-release.sh content/io/telicent/jena/rdf-abac/rdf-abac-3.1.1.buildspec 3.1.2` |
| <!-- 20260519174007 --> [jena-kafka](../content/io/telicent/jena/jena-kafka/README.md) | [3.0.2](../content/io/telicent/jena/jena-kafka/jena-kafka-3.0.2.buildspec) :white_check_mark: | [3.0.3](../content/io/telicent/jena/jena-kafka/jena-kafka-3.0.3.buildspec) | `bin/add-new-release.sh content/io/telicent/jena/jena-kafka/jena-kafka-3.0.2.buildspec 3.0.3` |
| <!-- 20260519160935 --> [community-connectors](../content/org/metricshub/community-connectors/README.md) | [1.0.20](../content/org/metricshub/community-connectors/community-connectors-1.0.20.buildspec) :white_check_mark: | [1.0.21](../content/org/metricshub/community-connectors/community-connectors-1.0.21.buildspec) | `bin/add-new-release.sh content/org/metricshub/community-connectors/community-connectors-1.0.20.buildspec 1.0.21` |
| <!-- 20260519130449 --> [heylogs-parent](../content/com/github/nbbrd/heylogs/README.md) | [0.17.1](../content/com/github/nbbrd/heylogs/heylogs-0.17.1.buildspec) :white_check_mark: | [0.18.0](../content/com/github/nbbrd/heylogs/heylogs-0.18.0.buildspec) | `bin/add-new-release.sh content/com/github/nbbrd/heylogs/heylogs-0.17.1.buildspec 0.18.0` |
| <!-- 20260519125217 --> [langchain4j-cdi-parent](../content/dev/langchain4j/cdi/README.md) | [1.2.0](../content/dev/langchain4j/cdi/langchain4j-cdi-1.2.0.buildspec) :white_check_mark: | [1.3.0](../content/dev/langchain4j/cdi/langchain4j-cdi-1.3.0.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/cdi/langchain4j-cdi-1.2.0.buildspec 1.3.0` |
| <!-- 20260519120742 --> [project](../content/org/eclipse/ee4j/project/README.md) | [2.0.3](../content/org/eclipse/ee4j/project/project-2.0.3.buildspec) :white_check_mark: | [2.0.4](../content/org/eclipse/ee4j/project/project-2.0.4.buildspec) | `bin/add-new-release.sh content/org/eclipse/ee4j/project/project-2.0.3.buildspec 2.0.4` |
| <!-- 20260519072331 --> [domtrip](../content/eu/maveniverse/maven/domtrip/README.md) | [1.5.0](../content/eu/maveniverse/maven/domtrip/domtrip-1.5.0.buildspec) :white_check_mark: | [1.5.1](../content/eu/maveniverse/maven/domtrip/domtrip-1.5.1.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/domtrip/domtrip-1.5.0.buildspec 1.5.1` |
| <!-- 20260516035114 --> [avaje-jsonb-parent](../content/io/avaje/jsonb/README.md) | [3.14-RC4](../content/io/avaje/jsonb/avaje-jsonb-3.14-RC4.buildspec) :white_check_mark: | 3.14-RC2 3.14-RC1  | `bin/add-new-release.sh content/io/avaje/jsonb/avaje-jsonb-3.14-RC4.buildspec ...` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20260515105008 --> [:mailbox:](https://lists.apache.org/list?dev@wicket.apache.org:lte=1M:VOTE) | [wicket-parent](../content/org/apache/wicket/README.md) | [10.9.0](../content/org/apache/wicket/wicket-parent-10.9.0.buildspec) :white_check_mark: | [10.9.1](../content/org/apache/wicket/wicket-parent-10.9.1.buildspec)  | `bin/add-new-release.sh content/org/apache/wicket/wicket-parent-10.9.0.buildspec 10.9.1 staging` |
| <!-- 20260513181315 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-configuration2](../content/org/apache/commons/configuration2/README.md) | [2.15.0](../content/org/apache/commons/configuration2/commons-configuration2-2.15.0.buildspec) :white_check_mark: | [2.15.1](../content/org/apache/commons/configuration2/commons-configuration2-2.15.1.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/configuration2/commons-configuration2-2.15.0.buildspec 2.15.1 staging` |
...
| <!-- 20260126235620 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-build-cache-extension](../content/org/apache/maven/extensions/maven-build-cache-extension/README.md) | [1.2.2](../content/org/apache/maven/extensions/maven-build-cache-extension/maven-build-cache-extension-1.2.2.buildspec) :white_check_mark: | [1.2.3](../content/org/apache/maven/extensions/maven-build-cache-extension/maven-build-cache-extension-1.2.3.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/extensions/maven-build-cache-extension/maven-build-cache-extension-1.2.2.buildspec 1.2.3 staging` |
| <!-- 20251031151701 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-changelog-plugin](../content/org/apache/maven/plugins/maven-changelog-plugin/README.md) | [3.0.0-M1](../content/org/apache/maven/plugins/maven-changelog-plugin/maven-changelog-plugin-3.0.0-M1.buildspec) :white_check_mark: | [3.0.0-M2](../content/org/apache/maven/plugins/maven-changelog-plugin/maven-changelog-plugin-3.0.0-M2.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-changelog-plugin/maven-changelog-plugin-3.0.0-M1.buildspec 3.0.0-M2 staging` |
...
| <!-- 20250310171441 --> [:mailbox:](https://lists.apache.org/list?dev@axis2.apache.org:lte=1M:VOTE) | [axis2](../content/org/apache/axis2/README.md) | [2.0.0](../content/org/apache/axis2/axis2-2.0.0.buildspec) :warning: [:memo:](https://github.com/apache/axis-axis2-java-core/pull/879) | [2.0.1](../content/org/apache/axis2/axis2-2.0.1.buildspec)  | `bin/add-new-release.sh content/org/apache/axis2/axis2-2.0.0.buildspec 2.0.1 staging` |
| <!-- 20241221111722 --> [:mailbox:](https://lists.apache.org/list?dev@sling.apache.org:lte=1M:VOTE) | [org.apache.sling.feature](../content/org/apache/sling/org.apache.sling.feature/README.md) | [2.0.4](../content/org/apache/sling/org.apache.sling.feature/org.apache.sling.feature-2.0.4.buildspec) :white_check_mark: | [2.0.6](../content/org/apache/sling/org.apache.sling.feature/org.apache.sling.feature-2.0.6.buildspec)  | `bin/add-new-release.sh content/org/apache/sling/org.apache.sling.feature/org.apache.sling.feature-2.0.4.buildspec 2.0.6 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260519183905 --> [toolbox](../content/eu/maveniverse/maven/toolbox/README.md) | [0.15.10](../content/eu/maveniverse/maven/toolbox/toolbox-0.15.10.buildspec) :warning: | [0.15.12](../content/eu/maveniverse/maven/toolbox/toolbox-0.15.12.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/toolbox/toolbox-0.15.10.buildspec 0.15.12` |
| <!-- 20260519103744 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.129.7](../content/org/finos/legend/engine/legend-engine-4.129.7.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.129.7` |
| <!-- 20260519035623 --> [opentelemetry-instrumentation-api](../content/io/opentelemetry/instrumentation/README.md) | [2.25.0](../content/io/opentelemetry/instrumentation/opentelemetry-2.25.0.buildspec) :x: | [2.28.0](../content/io/opentelemetry/instrumentation/opentelemetry-2.28.0.buildspec) | `bin/add-new-release.sh content/io/opentelemetry/instrumentation/opentelemetry-2.25.0.buildspec 2.28.0` |
| <!-- 20260518114937 --> [jakarta.servlet-api](../content/jakarta/servlet/jakarta.servlet-api/README.md) | [6.2.0-M1](../content/jakarta/servlet/jakarta.servlet-api/jakarta.servlet-api-6.2.0-M1.buildspec) :x: | [6.2.0-M2](../content/jakarta/servlet/jakarta.servlet-api/jakarta.servlet-api-6.2.0-M2.buildspec) | `bin/add-new-release.sh content/jakarta/servlet/jakarta.servlet-api/jakarta.servlet-api-6.2.0-M1.buildspec 6.2.0-M2` |
...
| <!-- 20260518072422 --> [shiro-root](../content/org/apache/shiro/README.md) | [2.1.0](../content/org/apache/shiro/shiro-2.1.0.buildspec) :warning: | [3.0.0-alpha-1](../content/org/apache/shiro/shiro-3.0.0-alpha-1.buildspec) | `bin/add-new-release.sh content/org/apache/shiro/shiro-2.1.0.buildspec 3.0.0-alpha-1` |
| <!-- 20260518014721 --> [htmlcompressor](../content/com/github/hazendaz/htmlcompressor/README.md) | [2.3.1](../content/com/github/hazendaz/htmlcompressor/htmlcompressor-2.3.1.buildspec) :warning: | [2.4.0](../content/com/github/hazendaz/htmlcompressor/htmlcompressor-2.4.0.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/htmlcompressor/htmlcompressor-2.3.1.buildspec 2.4.0` |
| <!-- 20260515154316 --> [langchain4j](../content/dev/langchain4j/README.md) | [1.14.1](../content/dev/langchain4j/langchain4j-1.14.1.buildspec) :warning: | [1.15.0](../content/dev/langchain4j/langchain4j-1.15.0.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-1.14.1.buildspec 1.15.0` |
...
| artifactId | newest |
| ---------- | ------ |
| <!-- 20260513111321 --> [quarkus-project](../content/io/quarkus/README.md) | 3.36.0.CR1 :warning: |
