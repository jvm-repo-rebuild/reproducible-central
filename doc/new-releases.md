...
| ---------- | ---- | -- | ------- |
| <!-- 20260630195218 --> [jline](../content/org/jline/README.md) | [4.2.1](../content/org/jline/jline-4.2.1.buildspec) :white_check_mark: | [4.3.1](../content/org/jline/jline-4.3.1.buildspec) | `bin/add-new-release.sh content/org/jline/jline-4.2.1.buildspec 4.3.1` |
| <!-- 20260630195218 --> [jline](../content/org/jline/README.md) | [4.2.1](../content/org/jline/jline-4.2.1.buildspec) :white_check_mark: | 4.3.0 4.0.16 4.0.11 4.0.9 4.0.8 4.0.7 4.0.6 4.0.5 4.0.4 4.0.3 4.0.2 3.30.15 3.30.14  | `bin/add-new-release.sh content/org/jline/jline-4.2.1.buildspec ...` |
| <!-- 20260630165119 --> [langchain4j](../content/dev/langchain4j/README.md) | [1.17.0](../content/dev/langchain4j/langchain4j-1.17.0.buildspec) :white_check_mark: | [1.17.1](../content/dev/langchain4j/langchain4j-1.17.1.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-1.17.0.buildspec 1.17.1` |
| <!-- 20260630155944 --> [avaje-jex-parent](../content/io/avaje/jex/README.md) | [3.7-RC1](../content/io/avaje/jex/avaje-jex-3.7-RC1.buildspec) :white_check_mark: | [3.7-RC2](../content/io/avaje/jex/avaje-jex-3.7-RC2.buildspec) | `bin/add-new-release.sh content/io/avaje/jex/avaje-jex-3.7-RC1.buildspec 3.7-RC2` |
| <!-- 20260630120520 --> [langchain4j-cdi-parent](../content/dev/langchain4j/cdi/README.md) | [1.3.3](../content/dev/langchain4j/cdi/langchain4j-cdi-1.3.3.buildspec) :white_check_mark: | [1.3.4](../content/dev/langchain4j/cdi/langchain4j-cdi-1.3.4.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/cdi/langchain4j-cdi-1.3.3.buildspec 1.3.4` |
...
| <!-- 20260629045503 --> [activemq-parent](../content/org/apache/activemq/README.md) | [6.2.7](../content/org/apache/activemq/activemq-6.2.7.buildspec) :white_check_mark: | 5.19.8  | `bin/add-new-release.sh content/org/apache/activemq/activemq-6.2.7.buildspec ...` |
...
| <!-- 20260628014914 --> [mybatis-ehcache](../content/org/mybatis/caches/mybatis-ehcache/README.md) | [2.0.0](../content/org/mybatis/caches/mybatis-ehcache/mybatis-ehcache-2.0.0.buildspec) :white_check_mark: | 1.4.0  | `bin/add-new-release.sh content/org/mybatis/caches/mybatis-ehcache/mybatis-ehcache-2.0.0.buildspec ...` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20260628112356 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-jexl3](../content/org/apache/commons/commons-jexl3/README.md) | [3.6.4](../content/org/apache/commons/commons-jexl3/commons-jexl3-3.6.4.buildspec) :white_check_mark: | [3.7.0](../content/org/apache/commons/commons-jexl3/commons-jexl3-3.7.0.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/commons-jexl3/commons-jexl3-3.6.4.buildspec 3.7.0 staging` |
...
| <!-- 20260604023841 --> [:mailbox:](https://lists.apache.org/list?dev@helix.apache.org:lte=1M:VOTE) | [helix](../content/org/apache/helix/README.md) | [2.0.0](../content/org/apache/helix/helix-2.0.0.buildspec) :white_check_mark: | [2.0.1](../content/org/apache/helix/helix-2.0.1.buildspec)  | `bin/add-new-release.sh content/org/apache/helix/helix-2.0.0.buildspec 2.0.1 staging` |
...
| <!-- 20260526105511 --> [:mailbox:](https://lists.apache.org/list?dev@tika.apache.org:lte=1M:VOTE) | [tika](../content/org/apache/tika/README.md) | [4.0.0-alpha-1](../content/org/apache/tika/tika-4.0.0-alpha-1.buildspec) :warning: | [4.0.0-beta-1](../content/org/apache/tika/tika-4.0.0-beta-1.buildspec)  | `bin/add-new-release.sh content/org/apache/tika/tika-4.0.0-alpha-1.buildspec 4.0.0-beta-1 staging` |
| <!-- 20260518091538 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-resolver](../content/org/apache/maven/resolver/maven-resolver/README.md) | [2.0.18](../content/org/apache/maven/resolver/maven-resolver/maven-resolver-2.0.18.buildspec) :warning: | [2.0.20](../content/org/apache/maven/resolver/maven-resolver/maven-resolver-2.0.20.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/resolver/maven-resolver/maven-resolver-2.0.18.buildspec 2.0.20 staging` |
...
| <!-- 20251031142734 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-help-plugin](../content/org/apache/maven/plugins/maven-help-plugin/README.md) | [3.5.1](../content/org/apache/maven/plugins/maven-help-plugin/maven-help-plugin-3.5.1.buildspec) :white_check_mark: | [3.5.2](../content/org/apache/maven/plugins/maven-help-plugin/maven-help-plugin-3.5.2.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-help-plugin/maven-help-plugin-3.5.1.buildspec 3.5.2 staging` |
...
| <!-- 20260630100502 --> [jpmml-sklearn](../content/org/jpmml/jpmml-sklearn/README.md) | [1.9.38](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.38.buildspec) :warning: | [1.9.39](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.39.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.38.buildspec 1.9.39` |
| <!-- 20260630061548 --> [jpmml-python](../content/org/jpmml/jpmml-python/README.md) | [1.3.20](../content/org/jpmml/jpmml-python/jpmml-python-1.3.20.buildspec) :warning: | [1.3.21](../content/org/jpmml/jpmml-python/jpmml-python-1.3.21.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-python/jpmml-python-1.3.20.buildspec 1.3.21` |
...
| <!-- 20260526105511 --> [tika](../content/org/apache/tika/README.md) | 4.0.0-alpha-1 :warning: |
