...
| ---------- | ---- | -- | ------- |
| <!-- 20260604165412 --> [langchain4j-cdi-parent](../content/dev/langchain4j/cdi/README.md) | [1.3.0](../content/dev/langchain4j/cdi/langchain4j-cdi-1.3.0.buildspec) :white_check_mark: | [1.3.1](../content/dev/langchain4j/cdi/langchain4j-cdi-1.3.1.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/cdi/langchain4j-cdi-1.3.0.buildspec 1.3.1` |
| <!-- 20260604164414 --> [pmd-build-tools-config](../content/net/sourceforge/pmd/pmd-build-tools-config/README.md) | [38](../content/net/sourceforge/pmd/pmd-build-tools-config/pmd-build-tools-config-38.buildspec) :white_check_mark: | [39](../content/net/sourceforge/pmd/pmd-build-tools-config/pmd-build-tools-config-39.buildspec) | `bin/add-new-release.sh content/net/sourceforge/pmd/pmd-build-tools-config/pmd-build-tools-config-38.buildspec 39` |
| <!-- 20260604152726 --> [scram-aggregator](../content/com/ongres/scram/README.md) | [3.2](../content/com/ongres/scram/scram-aggregator-3.2.buildspec) :white_check_mark: | [3.3](../content/com/ongres/scram/scram-aggregator-3.3.buildspec) | `bin/add-new-release.sh content/com/ongres/scram/scram-aggregator-3.2.buildspec 3.3` |
| <!-- 20260604132149 --> [jena-kafka](../content/io/telicent/jena/jena-kafka/README.md) | [3.0.3](../content/io/telicent/jena/jena-kafka/jena-kafka-3.0.3.buildspec) :white_check_mark: | [3.0.4](../content/io/telicent/jena/jena-kafka/jena-kafka-3.0.4.buildspec) | `bin/add-new-release.sh content/io/telicent/jena/jena-kafka/jena-kafka-3.0.3.buildspec 3.0.4` |
| <!-- 20260604023841 --> [helix](../content/org/apache/helix/README.md) | [1.4.3](../content/org/apache/helix/helix-1.4.3.buildspec) :white_check_mark: | [2.0.0](../content/org/apache/helix/helix-2.0.0.buildspec) | `bin/add-new-release.sh content/org/apache/helix/helix-1.4.3.buildspec 2.0.0` |
...
| <!-- 20260602110916 --> [airbase](../content/io/airlift/airbase/README.md) | [382](../content/io/airlift/airbase/airbase-382.buildspec) :white_check_mark: | 381  | `bin/add-new-release.sh content/io/airlift/airbase/airbase-382.buildspec ...` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260604144721 --> [stringprep-aggregator](../content/com/ongres/stringprep/README.md) | [2.3](../content/com/ongres/stringprep/stringprep-aggregator-2.3.buildspec) :warning: | [2.4](../content/com/ongres/stringprep/stringprep-aggregator-2.4.buildspec) | `bin/add-new-release.sh content/com/ongres/stringprep/stringprep-aggregator-2.3.buildspec 2.4` |
...
| <!-- 20260604042322 --> [avaje-metrics-parent](../content/io/avaje/metrics/README.md) | [9.12](../content/io/avaje/metrics/avaje-metrics-9.12.buildspec) :warning: | [9.16-RC2](../content/io/avaje/metrics/avaje-metrics-9.16-RC2.buildspec) | `bin/add-new-release.sh content/io/avaje/metrics/avaje-metrics-9.12.buildspec 9.16-RC2` |
