...
| ---------- | ---- | -- | ------- |
| <!-- 20260712035117 --> [spoon-core](../content/fr/inria/gforge/spoon/spoon-core/README.md) | [11.4.1-beta-2](../content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.4.1-beta-2.buildspec) :white_check_mark: | [11.4.1-beta-3](../content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.4.1-beta-3.buildspec) | `bin/add-new-release.sh content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.4.1-beta-2.buildspec 11.4.1-beta-3` |
| <!-- 20260712021715 --> [maven-lockfile](../content/io/github/chains-project/maven-lockfile/README.md) | [5.17.1-beta-4](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.17.1-beta-4.buildspec) :white_check_mark: | [5.17.1-beta-5](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.17.1-beta-5.buildspec) | `bin/add-new-release.sh content/io/github/chains-project/maven-lockfile/maven-lockfile-5.17.1-beta-4.buildspec 5.17.1-beta-5` |
| <!-- 20260712005722 --> [hibernate-core](../content/org/hibernate/orm/hibernate-core/README.md) | [8.0.0.Beta1](../content/org/hibernate/orm/hibernate-core/hibernate-core-8.0.0.Beta1.buildspec) :white_check_mark: | 7.4.5.Final 7.3.12.Final 7.2.23.Final 7.1.34.Final  | `bin/add-new-release.sh content/org/hibernate/orm/hibernate-core/hibernate-core-8.0.0.Beta1.buildspec ...` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260712124514 --> [junit-bom](../content/org/junit/junit5/README.md) | [6.1.1](../content/org/junit/junit5/junit5-6.1.1.buildspec) :warning: | [6.1.2](../content/org/junit/junit5/junit5-6.1.2.buildspec) | `bin/add-new-release.sh content/org/junit/junit5/junit5-6.1.1.buildspec 6.1.2` |
