...
| ---------- | ---- | -- | ------- |
| <!-- 20260814201721 --> [jackson-jr-parent](../content/tools/jackson/jr/README.md) | [3.2.1](../content/tools/jackson/jr/jackson-jr-3.2.1.buildspec) :white_check_mark: | 3.1.6  | `bin/add-new-release.sh content/tools/jackson/jr/jackson-jr-3.2.1.buildspec ...` |
| <!-- 20260814201716 --> [jackson-databind](../content/tools/jackson/core/jackson-databind/README.md) | [3.2.1](../content/tools/jackson/core/jackson-databind/jackson-databind-3.2.1.buildspec) :white_check_mark: | 3.1.6  | `bin/add-new-release.sh content/tools/jackson/core/jackson-databind/jackson-databind-3.2.1.buildspec ...` |
| <!-- 20260814200523 --> [jackson-core](../content/tools/jackson/core/jackson-core/README.md) | [3.2.1](../content/tools/jackson/core/jackson-core/jackson-core-3.2.1.buildspec) :white_check_mark: | 3.1.6  | `bin/add-new-release.sh content/tools/jackson/core/jackson-core/jackson-core-3.2.1.buildspec ...` |
| <!-- 20260814195528 --> [jackson-bom](../content/tools/jackson/jackson-bom/README.md) | [3.2.1](../content/tools/jackson/jackson-bom/jackson-bom-3.2.1.buildspec) :white_check_mark: | 3.1.6  | `bin/add-new-release.sh content/tools/jackson/jackson-bom/jackson-bom-3.2.1.buildspec ...` |
| <!-- 20260814113318 --> [langchain4j](../content/dev/langchain4j/README.md) | [1.18.1](../content/dev/langchain4j/langchain4j-1.18.1.buildspec) :white_check_mark: | [1.19.0](../content/dev/langchain4j/langchain4j-1.19.0.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-1.18.1.buildspec 1.19.0` |
| <!-- 20260814094337 --> [parent](../content/ch/qos/logback/access/README.md) | [2.0.14](../content/ch/qos/logback/access/access-2.0.14.buildspec) :white_check_mark: | [2.0.15](../content/ch/qos/logback/access/access-2.0.15.buildspec) | `bin/add-new-release.sh content/ch/qos/logback/access/access-2.0.14.buildspec 2.0.15` |
| <!-- 20260814082519 --> [java-io-parent](../content/com/github/nbbrd/java-io-util/README.md) | [0.0.38](../content/com/github/nbbrd/java-io-util/java-io-parent-0.0.38.buildspec) :white_check_mark: | [0.0.39](../content/com/github/nbbrd/java-io-util/java-io-parent-0.0.39.buildspec) | `bin/add-new-release.sh content/com/github/nbbrd/java-io-util/java-io-parent-0.0.38.buildspec 0.0.39` |
| <!-- 20260814081920 --> [logback-parent](../content/ch/qos/logback/README.md) | [1.6.2](../content/ch/qos/logback/logback-1.6.2.buildspec) :white_check_mark: | [1.6.3](../content/ch/qos/logback/logback-1.6.3.buildspec) | `bin/add-new-release.sh content/ch/qos/logback/logback-1.6.2.buildspec 1.6.3` |
...
| <!-- 20260814130722 --> [sdmx-dl-parent](../content/com/github/nbbrd/sdmx-dl/README.md) | [3.1.1](../content/com/github/nbbrd/sdmx-dl/sdmx-dl-3.1.1.buildspec) :warning: | [3.2.0](../content/com/github/nbbrd/sdmx-dl/sdmx-dl-3.2.0.buildspec) | `bin/add-new-release.sh content/com/github/nbbrd/sdmx-dl/sdmx-dl-3.1.1.buildspec 3.2.0` |
| <!-- 20260814123343 --> [scg-base](../content/io/telicent/smart-caches/graph/scg-base/README.md) | [1.1.2](../content/io/telicent/smart-caches/graph/scg-base/scg-base-1.1.2.buildspec) :warning: | [1.1.3](../content/io/telicent/smart-caches/graph/scg-base/scg-base-1.1.3.buildspec) | `bin/add-new-release.sh content/io/telicent/smart-caches/graph/scg-base/scg-base-1.1.2.buildspec 1.1.3` |
| <!-- 20260813202533 --> [avaje-metrics-parent](../content/io/avaje/metrics/README.md) | [10.3](../content/io/avaje/metrics/avaje-metrics-10.3.buildspec) :warning: | [10.4-RC1](../content/io/avaje/metrics/avaje-metrics-10.4-RC1.buildspec) | `bin/add-new-release.sh content/io/avaje/metrics/avaje-metrics-10.3.buildspec 10.4-RC1` |
