...
| ---------- | ---- | -- | ------- |
| <!-- 20260521184500 --> [sigstore-maven-plugin](../content/dev/sigstore/sigstore-maven-plugin/README.md) | [2.0.0](../content/dev/sigstore/sigstore-maven-plugin/sigstore-maven-plugin-2.0.0.buildspec) :white_check_mark: | [2.1.0](../content/dev/sigstore/sigstore-maven-plugin/sigstore-maven-plugin-2.1.0.buildspec) | `bin/add-new-release.sh content/dev/sigstore/sigstore-maven-plugin/sigstore-maven-plugin-2.0.0.buildspec 2.1.0` |
| <!-- 20260521103931 --> [avaje-metrics-parent](../content/io/avaje/metrics/README.md) | [9.9-RC3](../content/io/avaje/metrics/avaje-metrics-9.9-RC3.buildspec) :white_check_mark: | [9.9-RC5](../content/io/avaje/metrics/avaje-metrics-9.9-RC5.buildspec) | `bin/add-new-release.sh content/io/avaje/metrics/avaje-metrics-9.9-RC3.buildspec 9.9-RC5` |
| <!-- 20260521103931 --> [avaje-metrics-parent](../content/io/avaje/metrics/README.md) | [9.9-RC3](../content/io/avaje/metrics/avaje-metrics-9.9-RC3.buildspec) :white_check_mark: | 9.9-RC4  | `bin/add-new-release.sh content/io/avaje/metrics/avaje-metrics-9.9-RC3.buildspec ...` |
| <!-- 20260521101128 --> [airbase](../content/io/airlift/airbase/README.md) | [377](../content/io/airlift/airbase/airbase-377.buildspec) :white_check_mark: | [378](../content/io/airlift/airbase/airbase-378.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-377.buildspec 378` |
| <!-- 20260521072737 --> [aru-parent](../content/io/github/cbarlin/aru/README.md) | [0.9.1](../content/io/github/cbarlin/aru/aru-0.9.1.buildspec) :white_check_mark: | [0.10.0](../content/io/github/cbarlin/aru/aru-0.10.0.buildspec) | `bin/add-new-release.sh content/io/github/cbarlin/aru/aru-0.9.1.buildspec 0.10.0` |
| <!-- 20260520224515 --> [avaje-jsonb-parent](../content/io/avaje/jsonb/README.md) | [3.14-RC4](../content/io/avaje/jsonb/avaje-jsonb-3.14-RC4.buildspec) :white_check_mark: | [3.14-RC5](../content/io/avaje/jsonb/avaje-jsonb-3.14-RC5.buildspec) | `bin/add-new-release.sh content/io/avaje/jsonb/avaje-jsonb-3.14-RC4.buildspec 3.14-RC5` |
