...
| ---------- | ---- | -- | ------- |
| <!-- 20260711185714 --> [mybatis-redis](../content/org/mybatis/caches/mybatis-redis/README.md) | [1.1.0](../content/org/mybatis/caches/mybatis-redis/mybatis-redis-1.1.0.buildspec) :white_check_mark: | [1.2.1](../content/org/mybatis/caches/mybatis-redis/mybatis-redis-1.2.1.buildspec) | `bin/add-new-release.sh content/org/mybatis/caches/mybatis-redis/mybatis-redis-1.1.0.buildspec 1.2.1` |
| <!-- 20260711171720 --> [mybatis-spring](../content/org/mybatis/mybatis-spring/README.md) | [4.1.0](../content/org/mybatis/mybatis-spring/mybatis-spring-4.1.0.buildspec) :white_check_mark: | 3.0.6  | `bin/add-new-release.sh content/org/mybatis/mybatis-spring/mybatis-spring-4.1.0.buildspec ...` |
| <!-- 20260711134013 --> [nifi-api](../content/org/apache/nifi/nifi-api/README.md) | [2.9.0](../content/org/apache/nifi/nifi-api/nifi-api-2.9.0.buildspec) :white_check_mark: | [2.10.0](../content/org/apache/nifi/nifi-api/nifi-api-2.10.0.buildspec) | `bin/add-new-release.sh content/org/apache/nifi/nifi-api/nifi-api-2.9.0.buildspec 2.10.0` |
| <!-- 20260711095753 --> [cui-parent-pom](../content/de/cuioss/cui-parent-pom/README.md) | [1.5.0](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.5.0.buildspec) :white_check_mark: | [1.5.1](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.5.1.buildspec) | `bin/add-new-release.sh content/de/cuioss/cui-parent-pom/cui-parent-pom-1.5.0.buildspec 1.5.1` |
| <!-- 20260710234040 --> [migrations-maven-plugin](../content/org/mybatis/maven/migrations-maven-plugin/README.md) | [1.3.0](../content/org/mybatis/maven/migrations-maven-plugin/migrations-maven-plugin-1.3.0.buildspec) :white_check_mark: | [1.4.0](../content/org/mybatis/maven/migrations-maven-plugin/migrations-maven-plugin-1.4.0.buildspec) | `bin/add-new-release.sh content/org/mybatis/maven/migrations-maven-plugin/migrations-maven-plugin-1.3.0.buildspec 1.4.0` |
| <!-- 20260710224515 --> [mybatis-migrations](../content/org/mybatis/migrations/README.md) | [3.5.0](../content/org/mybatis/migrations/migrations-3.5.0.buildspec) :white_check_mark: | [3.6.0](../content/org/mybatis/migrations/migrations-3.6.0.buildspec) | `bin/add-new-release.sh content/org/mybatis/migrations/migrations-3.5.0.buildspec 3.6.0` |
