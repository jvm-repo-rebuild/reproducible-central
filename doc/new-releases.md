...
| ---------- | ---- | -- | ------- |
| <!-- 20260612172515 --> [flowlogix](../content/com/flowlogix/README.md) | [11.4](../content/com/flowlogix/flowlogix-11.4.buildspec) :white_check_mark: | [11.4.1](../content/com/flowlogix/flowlogix-11.4.1.buildspec) | `bin/add-new-release.sh content/com/flowlogix/flowlogix-11.4.buildspec 11.4.1` |
| <!-- 20260612161529 --> [io.wcm.tooling.commons.crx-packmgr-helper](../content/io/wcm/tooling/commons/crx-packmgr-helper/README.md) | [2.4.0](../content/io/wcm/tooling/commons/crx-packmgr-helper/wcm-crx-packmgr-helper-2.4.0.buildspec) :white_check_mark: | [2.5.0](../content/io/wcm/tooling/commons/crx-packmgr-helper/wcm-crx-packmgr-helper-2.5.0.buildspec) | `bin/add-new-release.sh content/io/wcm/tooling/commons/crx-packmgr-helper/wcm-crx-packmgr-helper-2.4.0.buildspec 2.5.0` |
| <!-- 20260612142519 --> [avaje-jex-parent](../content/io/avaje/jex/README.md) | [3.5](../content/io/avaje/jex/avaje-jex-3.5.buildspec) :white_check_mark: | [3.6](../content/io/avaje/jex/avaje-jex-3.6.buildspec) | `bin/add-new-release.sh content/io/avaje/jex/avaje-jex-3.5.buildspec 3.6` |
| <!-- 20260612080732 --> [jakarta.persistence-api](../content/jakarta/persistence/jakarta.persistence-api/README.md) | [4.0.0-M4](../content/jakarta/persistence/jakarta.persistence-api/jakarta.persistence-api-4.0.0-M4.buildspec) :white_check_mark: | [4.0.0-M5](../content/jakarta/persistence/jakarta.persistence-api/jakarta.persistence-api-4.0.0-M5.buildspec) | `bin/add-new-release.sh content/jakarta/persistence/jakarta.persistence-api/jakarta.persistence-api-4.0.0-M4.buildspec 4.0.0-M5` |
| <!-- 20260612022914 --> [makeself-maven-plugin](../content/com/github/hazendaz/maven/makeself-maven-plugin/README.md) | [1.11.1](../content/com/github/hazendaz/maven/makeself-maven-plugin/makeself-maven-plugin-1.11.1.buildspec) :white_check_mark: | [1.12.0](../content/com/github/hazendaz/maven/makeself-maven-plugin/makeself-maven-plugin-1.12.0.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/maven/makeself-maven-plugin/makeself-maven-plugin-1.11.1.buildspec 1.12.0` |
| <!-- 20260612015714 --> [yuicompressor-maven-plugin](../content/com/github/hazendaz/maven/yuicompressor-maven-plugin/README.md) | [2.3.1](../content/com/github/hazendaz/maven/yuicompressor-maven-plugin/yuicompressor-maven-plugin-2.3.1.buildspec) :white_check_mark: | [2.4.0](../content/com/github/hazendaz/maven/yuicompressor-maven-plugin/yuicompressor-maven-plugin-2.4.0.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/maven/yuicompressor-maven-plugin/yuicompressor-maven-plugin-2.3.1.buildspec 2.4.0` |
...
| <!-- 20260611063737 --> [jaxb-tools-project](../content/org/jvnet/jaxb/README.md) | [4.0.16](../content/org/jvnet/jaxb/jaxb-tools-4.0.16.buildspec) :white_check_mark: | 4.0.0 3.0.1 3.0.0  | `bin/add-new-release.sh content/org/jvnet/jaxb/jaxb-tools-4.0.16.buildspec ...` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260612032942 --> [avaje-metrics-parent](../content/io/avaje/metrics/README.md) | [9.16-RC7](../content/io/avaje/metrics/avaje-metrics-9.16-RC7.buildspec) :warning: | [9.16-RC8](../content/io/avaje/metrics/avaje-metrics-9.16-RC8.buildspec) | `bin/add-new-release.sh content/io/avaje/metrics/avaje-metrics-9.16-RC7.buildspec 9.16-RC8` |
