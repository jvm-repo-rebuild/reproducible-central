...
| ---------- | ---- | -- | ------- |
| <!-- 20260314164121 --> [extra-enforcer-rules](../content/org/codehaus/mojo/extra-enforcer-rules/README.md) | [1.11.0](../content/org/codehaus/mojo/extra-enforcer-rules/extra-enforcer-rules-1.11.0.buildspec) :white_check_mark: | [1.12.0](../content/org/codehaus/mojo/extra-enforcer-rules/extra-enforcer-rules-1.12.0.buildspec) | `bin/add-new-release.sh content/org/codehaus/mojo/extra-enforcer-rules/extra-enforcer-rules-1.11.0.buildspec 1.12.0` |
| <!-- 20260314135912 --> [mojo-parent](../content/org/codehaus/mojo/mojo-parent/README.md) | [95](../content/org/codehaus/mojo/mojo-parent/mojo-parent-95.buildspec) :white_check_mark: | [96](../content/org/codehaus/mojo/mojo-parent/mojo-parent-96.buildspec) | `bin/add-new-release.sh content/org/codehaus/mojo/mojo-parent/mojo-parent-95.buildspec 96` |
| <!-- 20260314073917 --> [aru-parent](../content/io/github/cbarlin/aru/README.md) | [0.8.2](../content/io/github/cbarlin/aru/aru-0.8.2.buildspec) :white_check_mark: | [0.8.3](../content/io/github/cbarlin/aru/aru-0.8.3.buildspec) | `bin/add-new-release.sh content/io/github/cbarlin/aru/aru-0.8.2.buildspec 0.8.3` |
| <!-- 20260313205614 --> [hsac-fitnesse-fixtures](../content/nl/hsac/hsac-fitnesse-fixtures/README.md) | [5.3.22](../content/nl/hsac/hsac-fitnesse-fixtures/hsac-fitnesse-fixtures-5.3.22.buildspec) :white_check_mark: | [5.3.24](../content/nl/hsac/hsac-fitnesse-fixtures/hsac-fitnesse-fixtures-5.3.24.buildspec) | `bin/add-new-release.sh content/nl/hsac/hsac-fitnesse-fixtures/hsac-fitnesse-fixtures-5.3.22.buildspec 5.3.24` |
| <!-- 20260313205614 --> [hsac-fitnesse-fixtures](../content/nl/hsac/hsac-fitnesse-fixtures/README.md) | [5.3.22](../content/nl/hsac/hsac-fitnesse-fixtures/hsac-fitnesse-fixtures-5.3.22.buildspec) :white_check_mark: | 5.3.23  | `bin/add-new-release.sh content/nl/hsac/hsac-fitnesse-fixtures/hsac-fitnesse-fixtures-5.3.22.buildspec ...` |
| <!-- 20260313103920 --> [project](../content/org/eclipse/ee4j/project/README.md) | [2.0.1](../content/org/eclipse/ee4j/project/project-2.0.1.buildspec) :white_check_mark: | [2.0.2](../content/org/eclipse/ee4j/project/project-2.0.2.buildspec) | `bin/add-new-release.sh content/org/eclipse/ee4j/project/project-2.0.1.buildspec 2.0.2` |
| <!-- 20260312220936 --> [java-spdx-library](../content/org/spdx/java-spdx-library/README.md) | [2.0.2](../content/org/spdx/java-spdx-library/java-spdx-library-2.0.2.buildspec) :white_check_mark: | [2.0.3](../content/org/spdx/java-spdx-library/java-spdx-library-2.0.3.buildspec) | `bin/add-new-release.sh content/org/spdx/java-spdx-library/java-spdx-library-2.0.2.buildspec 2.0.3` |
...
| <!-- 20260313180531 --> [toolbox](../content/eu/maveniverse/maven/toolbox/README.md) | [0.15.4](../content/eu/maveniverse/maven/toolbox/toolbox-0.15.4.buildspec) :warning: | [0.15.5](../content/eu/maveniverse/maven/toolbox/toolbox-0.15.5.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/toolbox/toolbox-0.15.4.buildspec 0.15.5` |
| <!-- 20260313072331 --> [jpmml-sklearn](../content/org/jpmml/jpmml-sklearn/README.md) | [1.9.31](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.31.buildspec) :warning: | [1.9.33](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.33.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.31.buildspec 1.9.33` |
| <!-- 20260312234538 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.123.0](../content/org/finos/legend/engine/legend-engine-4.123.0.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.123.0` |
| <!-- 20260312165510 --> [quarkus-project](../content/io/quarkus/README.md) | [3.33.0.CR1](../content/io/quarkus/quarkus-3.33.0.CR1.buildspec) :warning: | [3.34.0.CR1](../content/io/quarkus/quarkus-3.34.0.CR1.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.33.0.CR1.buildspec 3.34.0.CR1` |
