...
| ---------- | ---- | -- | ------- |
| <!-- 20260820173239 --> [nisse](../content/eu/maveniverse/maven/nisse/README.md) | [0.9.5](../content/eu/maveniverse/maven/nisse/nisse-0.9.5.buildspec) :white_check_mark: | [0.9.7](../content/eu/maveniverse/maven/nisse/nisse-0.9.7.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/nisse/nisse-0.9.5.buildspec 0.9.7` |
| <!-- 20260820173239 --> [nisse](../content/eu/maveniverse/maven/nisse/README.md) | [0.9.5](../content/eu/maveniverse/maven/nisse/nisse-0.9.5.buildspec) :white_check_mark: | 0.9.6  | `bin/add-new-release.sh content/eu/maveniverse/maven/nisse/nisse-0.9.5.buildspec ...` |
| <!-- 20260820142404 --> [sdk-parent](../content/com/sap/ai/sdk/README.md) | [1.22.0](../content/com/sap/ai/sdk/sdk-1.22.0.buildspec) :white_check_mark: | [1.23.0](../content/com/sap/ai/sdk/sdk-1.23.0.buildspec) | `bin/add-new-release.sh content/com/sap/ai/sdk/sdk-1.22.0.buildspec 1.23.0` |
| <!-- 20260820140518 --> [nbbrd-maven-tools](../content/com/github/nbbrd/nbbrd-maven-tools/README.md) | [1.2.0](../content/com/github/nbbrd/nbbrd-maven-tools/nbbrd-maven-tools-1.2.0.buildspec) :white_check_mark: | [1.3.0](../content/com/github/nbbrd/nbbrd-maven-tools/nbbrd-maven-tools-1.3.0.buildspec) | `bin/add-new-release.sh content/com/github/nbbrd/nbbrd-maven-tools/nbbrd-maven-tools-1.2.0.buildspec 1.3.0` |
...
| <!-- 20260820115935 --> [jena-kafka](../content/io/telicent/jena/jena-kafka/README.md) | [3.1.1](../content/io/telicent/jena/jena-kafka/jena-kafka-3.1.1.buildspec) :white_check_mark: | [3.2.1](../content/io/telicent/jena/jena-kafka/jena-kafka-3.2.1.buildspec) | `bin/add-new-release.sh content/io/telicent/jena/jena-kafka/jena-kafka-3.1.1.buildspec 3.2.1` |
| <!-- 20260820115935 --> [jena-kafka](../content/io/telicent/jena/jena-kafka/README.md) | [3.1.1](../content/io/telicent/jena/jena-kafka/jena-kafka-3.1.1.buildspec) :white_check_mark: | 3.2.0 3.1.2  | `bin/add-new-release.sh content/io/telicent/jena/jena-kafka/jena-kafka-3.1.1.buildspec ...` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260820151812 --> [scg-base](../content/io/telicent/smart-caches/graph/scg-base/README.md) | [1.1.5](../content/io/telicent/smart-caches/graph/scg-base/scg-base-1.1.5.buildspec) :warning: | [1.1.6](../content/io/telicent/smart-caches/graph/scg-base/scg-base-1.1.6.buildspec) | `bin/add-new-release.sh content/io/telicent/smart-caches/graph/scg-base/scg-base-1.1.5.buildspec 1.1.6` |
...
| <!-- 20260820084520 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.140.1](../content/org/finos/legend/engine/legend-engine-4.140.1.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.140.1` |
| <!-- 20260820041519 --> [spotbugs-maven-plugin](../content/com/github/spotbugs/spotbugs-maven-plugin/README.md) | [4.10.3.0](../content/com/github/spotbugs/spotbugs-maven-plugin/spotbugs-maven-plugin-4.10.3.0.buildspec) :warning: | [4.10.4.0](../content/com/github/spotbugs/spotbugs-maven-plugin/spotbugs-maven-plugin-4.10.4.0.buildspec) | `bin/add-new-release.sh content/com/github/spotbugs/spotbugs-maven-plugin/spotbugs-maven-plugin-4.10.3.0.buildspec 4.10.4.0` |
