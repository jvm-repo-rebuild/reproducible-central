...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260221062928 --> [avaje-http-parent](../content/io/avaje/http/README.md) | [3.8-RC2](../content/io/avaje/http/avaje-http-3.8-RC2.buildspec) :warning: | [3.8-RC3](../content/io/avaje/http/avaje-http-3.8-RC3.buildspec) | `bin/add-new-release.sh content/io/avaje/http/avaje-http-3.8-RC2.buildspec 3.8-RC3` |
