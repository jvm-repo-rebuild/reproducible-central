...
| ---------- | ---- | -- | ------- |
| <!-- 20260207200316 --> [sisu-inject](../content/org/eclipse/sisu/README.md) | [0.9.0.M4](../content/org/eclipse/sisu/sisu-0.9.0.M4.buildspec) :white_check_mark: | [1.0.0](../content/org/eclipse/sisu/sisu-1.0.0.buildspec) | `bin/add-new-release.sh content/org/eclipse/sisu/sisu-0.9.0.M4.buildspec 1.0.0` |
| <!-- 20260207183912 --> [airbase](../content/io/airlift/airbase/README.md) | [350](../content/io/airlift/airbase/airbase-350.buildspec) :white_check_mark: | [351](../content/io/airlift/airbase/airbase-351.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-350.buildspec 351` |
| <!-- 20260207182514 --> [docker-maven-plugin](../content/io/fabric8/docker-maven-plugin/README.md) | [0.48.0](../content/io/fabric8/docker-maven-plugin/docker-maven-plugin-0.48.0.buildspec) :white_check_mark: | [0.48.1](../content/io/fabric8/docker-maven-plugin/docker-maven-plugin-0.48.1.buildspec) | `bin/add-new-release.sh content/io/fabric8/docker-maven-plugin/docker-maven-plugin-0.48.0.buildspec 0.48.1` |
...
| <!-- 20260207115347 --> [maven-lockfile](../content/io/github/chains-project/maven-lockfile/README.md) | [5.13.0](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.13.0.buildspec) :white_check_mark: | [5.13.1](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.13.1.buildspec) | `bin/add-new-release.sh content/io/github/chains-project/maven-lockfile/maven-lockfile-5.13.0.buildspec 5.13.1` |
| <!-- 20260206232717 --> [cui-parent-pom](../content/de/cuioss/cui-parent-pom/README.md) | [1.3.7](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.3.7.buildspec) :white_check_mark: | [1.4.1](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.4.1.buildspec) | `bin/add-new-release.sh content/de/cuioss/cui-parent-pom/cui-parent-pom-1.3.7.buildspec 1.4.1` |
| <!-- 20260206232717 --> [cui-parent-pom](../content/de/cuioss/cui-parent-pom/README.md) | [1.3.7](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.3.7.buildspec) :white_check_mark: | 1.4.0 1.3.8  | `bin/add-new-release.sh content/de/cuioss/cui-parent-pom/cui-parent-pom-1.3.7.buildspec ...` |
| <!-- 20260206143418 --> [opentelemetry-sdk](../content/io/opentelemetry/java/README.md) | [1.58.0](../content/io/opentelemetry/java/opentelemetry-sdk-1.58.0.buildspec) :white_check_mark: | [1.59.0](../content/io/opentelemetry/java/opentelemetry-sdk-1.59.0.buildspec) | `bin/add-new-release.sh content/io/opentelemetry/java/opentelemetry-sdk-1.58.0.buildspec 1.59.0` |
| <!-- 20260205085048 --> [jquery-ui](../content/org/webjars/jquery-ui/README.md) | [1.14.1](../content/org/webjars/jquery-ui/jquery-ui-1.14.1.buildspec) :white_check_mark: | [1.14.2](../content/org/webjars/jquery-ui/jquery-ui-1.14.2.buildspec) | `bin/add-new-release.sh content/org/webjars/jquery-ui/jquery-ui-1.14.1.buildspec 1.14.2` |
...
| <!-- 20251214154449 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-jexl3](../content/org/apache/commons/commons-jexl3/README.md) | [3.6.1](../content/org/apache/commons/commons-jexl3/commons-jexl3-3.6.1.buildspec) :white_check_mark: | [3.6.2](../content/org/apache/commons/commons-jexl3/commons-jexl3-3.6.2.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/commons-jexl3/commons-jexl3-3.6.1.buildspec 3.6.2 staging` |
| <!-- 20251002171619 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-dependency-plugin](../content/org/apache/maven/plugins/maven-dependency-plugin/README.md) | [3.9.0](../content/org/apache/maven/plugins/maven-dependency-plugin/maven-dependency-plugin-3.9.0.buildspec) :white_check_mark: | [3.10.0](../content/org/apache/maven/plugins/maven-dependency-plugin/maven-dependency-plugin-3.10.0.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-dependency-plugin/maven-dependency-plugin-3.9.0.buildspec 3.10.0 staging` |
...
| <!-- 20250908150053 --> [:mailbox:](https://lists.apache.org/list?dev@sling.apache.org:lte=1M:VOTE) | [org.apache.sling.xss](../content/org/apache/sling/org.apache.sling.xss/README.md) | [2.4.8](../content/org/apache/sling/org.apache.sling.xss/org.apache.sling.xss-2.4.8.buildspec) :white_check_mark: | [2.4.10](../content/org/apache/sling/org.apache.sling.xss/org.apache.sling.xss-2.4.10.buildspec)  | `bin/add-new-release.sh content/org/apache/sling/org.apache.sling.xss/org.apache.sling.xss-2.4.8.buildspec 2.4.10 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260207204730 --> [shiro-root](../content/org/apache/shiro/README.md) | [2.0.6](../content/org/apache/shiro/shiro-2.0.6.buildspec) :warning: | [2.1.0](../content/org/apache/shiro/shiro-2.1.0.buildspec) | `bin/add-new-release.sh content/org/apache/shiro/shiro-2.0.6.buildspec 2.1.0` |
...
| <!-- 20260206080940 --> [jpmml-sparkml](../content/org/jpmml/jpmml-sparkml/README.md) | [3.3.1](../content/org/jpmml/jpmml-sparkml/jpmml-sparkml-3.3.1.buildspec) :warning: | [3.3.2](../content/org/jpmml/jpmml-sparkml/jpmml-sparkml-3.3.2.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-sparkml/jpmml-sparkml-3.3.1.buildspec 3.3.2` |
| <!-- 20260205185517 --> [jpmml-codemodel](../content/org/jpmml/jpmml-codemodel/README.md) | [1.2.1](../content/org/jpmml/jpmml-codemodel/jpmml-codemodel-1.2.1.buildspec) :warning: | [1.2.2](../content/org/jpmml/jpmml-codemodel/jpmml-codemodel-1.2.2.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-codemodel/jpmml-codemodel-1.2.1.buildspec 1.2.2` |
| <!-- 20260205180917 --> [jpmml-r](../content/org/jpmml/jpmml-r/README.md) | [1.7.8](../content/org/jpmml/jpmml-r/jpmml-r-1.7.8.buildspec) :warning: | [1.7.9](../content/org/jpmml/jpmml-r/jpmml-r-1.7.9.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-r/jpmml-r-1.7.8.buildspec 1.7.9` |
| <!-- 20260205180916 --> [jpmml-sklearn](../content/org/jpmml/jpmml-sklearn/README.md) | [1.9.27](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.27.buildspec) :warning: | [1.9.28](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.28.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.27.buildspec 1.9.28` |
