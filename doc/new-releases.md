...
| ---------- | ---- | -- | ------- |
| <!-- 20260902202915 --> [airbase](../content/io/airlift/airbase/README.md) | [406](../content/io/airlift/airbase/airbase-406.buildspec) :white_check_mark: | [408](../content/io/airlift/airbase/airbase-408.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-406.buildspec 408` |
| <!-- 20260902202915 --> [airbase](../content/io/airlift/airbase/README.md) | [406](../content/io/airlift/airbase/airbase-406.buildspec) :white_check_mark: | 407  | `bin/add-new-release.sh content/io/airlift/airbase/airbase-406.buildspec ...` |
| <!-- 20260902195425 --> [maven-compiler-plugin](../content/org/apache/maven/plugins/maven-compiler-plugin/README.md) | [4.0.0-beta-5](../content/org/apache/maven/plugins/maven-compiler-plugin/maven-compiler-plugin-4.0.0-beta-5.buildspec) :white_check_mark: | 3.16.0  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-compiler-plugin/maven-compiler-plugin-4.0.0-beta-5.buildspec ...` |
| <!-- 20260902125714 --> [maven-bundle-plugin](../content/org/apache/felix/maven-bundle-plugin/README.md) | [6.1.0](../content/org/apache/felix/maven-bundle-plugin/maven-bundle-plugin-6.1.0.buildspec) :white_check_mark: | [6.1.2](../content/org/apache/felix/maven-bundle-plugin/maven-bundle-plugin-6.1.2.buildspec) | `bin/add-new-release.sh content/org/apache/felix/maven-bundle-plugin/maven-bundle-plugin-6.1.0.buildspec 6.1.2` |
| <!-- 20260902110935 --> [cui-parent-pom](../content/de/cuioss/cui-parent-pom/README.md) | [1.5.10](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.5.10.buildspec) :white_check_mark: | [1.5.11](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.5.11.buildspec) | `bin/add-new-release.sh content/de/cuioss/cui-parent-pom/cui-parent-pom-1.5.10.buildspec 1.5.11` |
| <!-- 20260902100740 --> [byte-buddy-parent](../content/net/bytebuddy/README.md) | [1.18.12-jdk5](../content/net/bytebuddy/byte-buddy-1.18.12-jdk5.buildspec) :white_check_mark: | [1.18.13-jdk5](../content/net/bytebuddy/byte-buddy-1.18.13-jdk5.buildspec) | `bin/add-new-release.sh content/net/bytebuddy/byte-buddy-1.18.12-jdk5.buildspec 1.18.13-jdk5` |
| <!-- 20260902100740 --> [byte-buddy-parent](../content/net/bytebuddy/README.md) | [1.18.12-jdk5](../content/net/bytebuddy/byte-buddy-1.18.12-jdk5.buildspec) :white_check_mark: | 1.18.13  | `bin/add-new-release.sh content/net/bytebuddy/byte-buddy-1.18.12-jdk5.buildspec ...` |
| <!-- 20260902084512 --> [checksum](../content/eu/maveniverse/maven/checksum/README.md) | [0.2.1](../content/eu/maveniverse/maven/checksum/checksum-0.2.1.buildspec) :white_check_mark: | [0.2.2](../content/eu/maveniverse/maven/checksum/checksum-0.2.2.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/checksum/checksum-0.2.1.buildspec 0.2.2` |
| <!-- 20260902053315 --> [flowlogix](../content/com/flowlogix/README.md) | [11.4.3](../content/com/flowlogix/flowlogix-11.4.3.buildspec) :white_check_mark: | [11.5](../content/com/flowlogix/flowlogix-11.5.buildspec) | `bin/add-new-release.sh content/com/flowlogix/flowlogix-11.4.3.buildspec 11.5` |
...
| <!-- 20260831180534 --> [jline](../content/org/jline/README.md) | [4.4.1](../content/org/jline/jline-4.4.1.buildspec) :white_check_mark: | 4.0.16 4.0.11 4.0.9 4.0.8 4.0.7 4.0.6 4.0.5 4.0.4 4.0.3 4.0.2 3.30.16 3.30.15 3.30.14  | `bin/add-new-release.sh content/org/jline/jline-4.4.1.buildspec ...` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20260902125714 --> [:mailbox:](https://lists.apache.org/list?dev@felix.apache.org:lte=1M:VOTE) | [maven-bundle-plugin](../content/org/apache/felix/maven-bundle-plugin/README.md) | [6.1.0](../content/org/apache/felix/maven-bundle-plugin/maven-bundle-plugin-6.1.0.buildspec) :white_check_mark: | [6.2.0](../content/org/apache/felix/maven-bundle-plugin/maven-bundle-plugin-6.2.0.buildspec)  | `bin/add-new-release.sh content/org/apache/felix/maven-bundle-plugin/maven-bundle-plugin-6.1.0.buildspec 6.2.0 staging` |
| <!-- 20260605044101 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [surefire](../content/org/apache/maven/surefire/README.md) | [3.6.0-M1](../content/org/apache/maven/surefire/surefire-3.6.0-M1.buildspec) :white_check_mark: | [3.6.0](../content/org/apache/maven/surefire/surefire-3.6.0.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/surefire/surefire-3.6.0-M1.buildspec 3.6.0 staging` |
...
| <!-- 20260902184717 --> [convex](../content/world/convex/README.md) | [0.8.15](../content/world/convex/convex-0.8.15.buildspec) :warning: | [0.8.16](../content/world/convex/convex-0.8.16.buildspec) | `bin/add-new-release.sh content/world/convex/convex-0.8.15.buildspec 0.8.16` |
| <!-- 20260902143624 --> [activemq-parent](../content/org/apache/activemq/README.md) | [6.3.1](../content/org/apache/activemq/activemq-6.3.1.buildspec) :warning: | [6.3.2](../content/org/apache/activemq/activemq-6.3.2.buildspec) | `bin/add-new-release.sh content/org/apache/activemq/activemq-6.3.1.buildspec 6.3.2` |
| <!-- 20260902095937 --> [quarkus-project](../content/io/quarkus/README.md) | [3.39.1](../content/io/quarkus/quarkus-3.39.1.buildspec) :warning: | [3.39.2](../content/io/quarkus/quarkus-3.39.2.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.39.1.buildspec 3.39.2` |
...
| <!-- 20260901102014 --> [scg-base](../content/io/telicent/smart-caches/graph/scg-base/README.md) | [1.1.6](../content/io/telicent/smart-caches/graph/scg-base/scg-base-1.1.6.buildspec) :warning: | [1.1.7](../content/io/telicent/smart-caches/graph/scg-base/scg-base-1.1.7.buildspec) | `bin/add-new-release.sh content/io/telicent/smart-caches/graph/scg-base/scg-base-1.1.6.buildspec 1.1.7` |
| <!-- 20260901084954 --> [jdplus-sdmx](../content/com/github/nbbrd/jdplus-sdmx/README.md) | [3.4.0](../content/com/github/nbbrd/jdplus-sdmx/jdplus-sdmx-3.4.0.buildspec) :warning: [:memo:](https://github.com/apache/netbeans-mavenutils-nbm-maven-plugin/issues/133) | [3.5.0](../content/com/github/nbbrd/jdplus-sdmx/jdplus-sdmx-3.5.0.buildspec) | `bin/add-new-release.sh content/com/github/nbbrd/jdplus-sdmx/jdplus-sdmx-3.4.0.buildspec 3.5.0` |
