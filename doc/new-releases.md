...
| ---------- | ---- | -- | ------- |
| <!-- 20260408175525 --> [domtrip](../content/eu/maveniverse/maven/domtrip/README.md) | [1.0.0](../content/eu/maveniverse/maven/domtrip/domtrip-1.0.0.buildspec) :white_check_mark: | [1.1.0](../content/eu/maveniverse/maven/domtrip/domtrip-1.1.0.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/domtrip/domtrip-1.0.0.buildspec 1.1.0` |
| <!-- 20260408144904 --> [commons-configuration2](../content/org/apache/commons/configuration2/README.md) | [2.13.0](../content/org/apache/commons/configuration2/commons-configuration2-2.13.0.buildspec) :white_check_mark: | [2.14.0](../content/org/apache/commons/configuration2/commons-configuration2-2.14.0.buildspec) | `bin/add-new-release.sh content/org/apache/commons/configuration2/commons-configuration2-2.13.0.buildspec 2.14.0` |
| <!-- 20260408140921 --> [bom-builder](../content/eu/maveniverse/maven/bom-builder/README.md) | [1.3.2](../content/eu/maveniverse/maven/bom-builder/bom-builder-1.3.2.buildspec) :white_check_mark: | [1.3.3](../content/eu/maveniverse/maven/bom-builder/bom-builder-1.3.3.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/bom-builder/bom-builder-1.3.2.buildspec 1.3.3` |
| <!-- 20260408132756 --> [mimir](../content/eu/maveniverse/maven/mimir/README.md) | [0.11.2](../content/eu/maveniverse/maven/mimir/mimir-0.11.2.buildspec) :white_check_mark: | [0.11.3](../content/eu/maveniverse/maven/mimir/mimir-0.11.3.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/mimir/mimir-0.11.2.buildspec 0.11.3` |
| <!-- 20260408131526 --> [njord](../content/eu/maveniverse/maven/njord/README.md) | [0.9.4](../content/eu/maveniverse/maven/njord/njord-0.9.4.buildspec) :white_check_mark: | [0.9.5](../content/eu/maveniverse/maven/njord/njord-0.9.5.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/njord/njord-0.9.4.buildspec 0.9.5` |
| <!-- 20260408101754 --> [nisse](../content/eu/maveniverse/maven/nisse/README.md) | [0.8.2](../content/eu/maveniverse/maven/nisse/nisse-0.8.2.buildspec) :white_check_mark: | [0.8.3](../content/eu/maveniverse/maven/nisse/nisse-0.8.3.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/nisse/nisse-0.8.2.buildspec 0.8.3` |
| <!-- 20260408080123 --> [heylogs-parent](../content/com/github/nbbrd/heylogs/README.md) | [0.17.0](../content/com/github/nbbrd/heylogs/heylogs-0.17.0.buildspec) :white_check_mark: | [0.17.1](../content/com/github/nbbrd/heylogs/heylogs-0.17.1.buildspec) | `bin/add-new-release.sh content/com/github/nbbrd/heylogs/heylogs-0.17.0.buildspec 0.17.1` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20260331073819 --> [:mailbox:](https://lists.apache.org/list?dev@activemq.apache.org:lte=1M:VOTE) | [activemq-parent](../content/org/apache/activemq/README.md) | [6.2.3](../content/org/apache/activemq/activemq-6.2.3.buildspec) :white_check_mark: | [6.2.4](../content/org/apache/activemq/activemq-6.2.4.buildspec)  | `bin/add-new-release.sh content/org/apache/activemq/activemq-6.2.3.buildspec 6.2.4 staging` |
| <!-- 20260213223947 --> [:mailbox:](https://lists.apache.org/list?dev@nifi.apache.org:lte=1M:VOTE) | [nifi](../content/org/apache/nifi/nifi/README.md) | [2.8.0](../content/org/apache/nifi/nifi/nifi-2.8.0.buildspec) :warning: | [2.9.0](../content/org/apache/nifi/nifi/nifi-2.9.0.buildspec)  | `bin/add-new-release.sh content/org/apache/nifi/nifi/nifi-2.8.0.buildspec 2.9.0 staging` |
| <!-- 20260116113544 --> [:mailbox:](https://lists.apache.org/list?dev@jackrabbit.apache.org:lte=1M:VOTE) | [jackrabbit-parent](../content/org/apache/jackrabbit/jackrabbit/README.md) | [2.23.3-beta](../content/org/apache/jackrabbit/jackrabbit/jackrabbit-2.23.3-beta.buildspec) :white_check_mark: | [2.23.4-beta](../content/org/apache/jackrabbit/jackrabbit/jackrabbit-2.23.4-beta.buildspec)  | `bin/add-new-release.sh content/org/apache/jackrabbit/jackrabbit/jackrabbit-2.23.3-beta.buildspec 2.23.4-beta staging` |
...
| <!-- 20260408152748 --> [mybatis-generator](../content/org/mybatis/generator/README.md) | [1.4.2](../content/org/mybatis/generator/mybatis-generator-1.4.2.buildspec) :warning: | [2.0.0](../content/org/mybatis/generator/mybatis-generator-2.0.0.buildspec) | `bin/add-new-release.sh content/org/mybatis/generator/mybatis-generator-1.4.2.buildspec 2.0.0` |
| <!-- 20260408122716 --> [toolbox](../content/eu/maveniverse/maven/toolbox/README.md) | [0.15.7](../content/eu/maveniverse/maven/toolbox/toolbox-0.15.7.buildspec) :warning: | [0.15.8](../content/eu/maveniverse/maven/toolbox/toolbox-0.15.8.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/toolbox/toolbox-0.15.7.buildspec 0.15.8` |
| <!-- 20260408114328 --> [quarkus-project](../content/io/quarkus/README.md) | [3.34.2](../content/io/quarkus/quarkus-3.34.2.buildspec) :warning: | [3.34.3](../content/io/quarkus/quarkus-3.34.3.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.34.2.buildspec 3.34.3` |
| <!-- 20260408101124 --> [jdplus-incubator](../content/eu/europa/ec/joinup/sat/jdplus-incubator/README.md) | [2.4.0](../content/eu/europa/ec/joinup/sat/jdplus-incubator/jdplus-incubator-2.4.0.buildspec) :warning: | [2.4.1](../content/eu/europa/ec/joinup/sat/jdplus-incubator/jdplus-incubator-2.4.1.buildspec) | `bin/add-new-release.sh content/eu/europa/ec/joinup/sat/jdplus-incubator/jdplus-incubator-2.4.0.buildspec 2.4.1` |
...
| <!-- 20260407154944 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.125.0](../content/org/finos/legend/engine/legend-engine-4.125.0.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.125.0` |
