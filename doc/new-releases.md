...
| ---------- | ---- | -- | ------- |
| <!-- 20260421155810 --> [jackrabbit-oak](../content/org/apache/jackrabbit/oak/README.md) | [1.92.0](../content/org/apache/jackrabbit/oak/jackrabbit-oak-1.92.0.buildspec) :white_check_mark: | [2.0.0](../content/org/apache/jackrabbit/oak/jackrabbit-oak-2.0.0.buildspec) | `bin/add-new-release.sh content/org/apache/jackrabbit/oak/jackrabbit-oak-1.92.0.buildspec 2.0.0` |
| <!-- 20260421105534 --> [hibernate-reactive-core](../content/org/hibernate/reactive/hibernate-reactive/README.md) | [4.3.2.Final](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.3.2.Final.buildspec) :white_check_mark: | [4.3.3.Final](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.3.3.Final.buildspec) | `bin/add-new-release.sh content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.3.2.Final.buildspec 4.3.3.Final` |
| <!-- 20260421105534 --> [hibernate-reactive-core](../content/org/hibernate/reactive/hibernate-reactive/README.md) | [4.3.2.Final](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.3.2.Final.buildspec) :white_check_mark: | 3.3.5.Final  | `bin/add-new-release.sh content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.3.2.Final.buildspec ...` |
| <!-- 20260421093829 --> [java-design-parent](../content/com/github/nbbrd/java-design-util/README.md) | [1.10.1](../content/com/github/nbbrd/java-design-util/java-design-util-1.10.1.buildspec) :white_check_mark: | [1.10.2](../content/com/github/nbbrd/java-design-util/java-design-util-1.10.2.buildspec) | `bin/add-new-release.sh content/com/github/nbbrd/java-design-util/java-design-util-1.10.1.buildspec 1.10.2` |
...
| <!-- 20260420223147 --> [tiles-maven-plugin](../content/io/repaint/maven/tiles-maven-plugin/README.md) | [2.43](../content/io/repaint/maven/tiles-maven-plugin/tiles-maven-plugin-2.43.buildspec) :white_check_mark: | [2.44](../content/io/repaint/maven/tiles-maven-plugin/tiles-maven-plugin-2.44.buildspec) | `bin/add-new-release.sh content/io/repaint/maven/tiles-maven-plugin/tiles-maven-plugin-2.43.buildspec 2.44` |
