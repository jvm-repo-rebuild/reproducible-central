...
| ---------- | ---- | -- | ------- |
| <!-- 20260704155713 --> [github-desktop](../content/com/github/hazendaz/git/github-desktop/README.md) | [3.6.1](../content/com/github/hazendaz/git/github-desktop/github-desktop-3.6.1.buildspec) :white_check_mark: | [3.6.2](../content/com/github/hazendaz/git/github-desktop/github-desktop-3.6.2.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/git/github-desktop/github-desktop-3.6.1.buildspec 3.6.2` |
| <!-- 20260704154113 --> [7zip](../content/com/github/hazendaz/7zip/README.md) | [26.01](../content/com/github/hazendaz/7zip/7zip-26.01.buildspec) :white_check_mark: | [26.02](../content/com/github/hazendaz/7zip/7zip-26.02.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/7zip/7zip-26.01.buildspec 26.02` |
| <!-- 20260704123717 --> [common-dao](../content/com/hibegin/common-dao/README.md) | [1.1.10](../content/com/hibegin/common-dao/common-dao-1.1.10.buildspec) :white_check_mark: | [1.1.11](../content/com/hibegin/common-dao/common-dao-1.1.11.buildspec) | `bin/add-new-release.sh content/com/hibegin/common-dao/common-dao-1.1.10.buildspec 1.1.11` |
| <!-- 20260702212137 --> [byte-buddy-parent](../content/net/bytebuddy/README.md) | [1.18.11-jdk5](../content/net/bytebuddy/byte-buddy-1.18.11-jdk5.buildspec) :white_check_mark: | 1.18.10 1.18.9 1.18.8 1.18.7-jdk5 1.18.6-jdk5  | `bin/add-new-release.sh content/net/bytebuddy/byte-buddy-1.18.11-jdk5.buildspec ...` |
