...
| ---------- | ---- | -- | ------- |
| <!-- 20260908212022 --> [sigstore-maven-plugin](../content/dev/sigstore/sigstore-maven-plugin/README.md) | [2.2.0](../content/dev/sigstore/sigstore-maven-plugin/sigstore-maven-plugin-2.2.0.buildspec) :white_check_mark: | [2.3.0](../content/dev/sigstore/sigstore-maven-plugin/sigstore-maven-plugin-2.3.0.buildspec) | `bin/add-new-release.sh content/dev/sigstore/sigstore-maven-plugin/sigstore-maven-plugin-2.2.0.buildspec 2.3.0` |
| <!-- 20260908154207 --> [nifi-api](../content/org/apache/nifi/nifi-api/README.md) | [2.11.0](../content/org/apache/nifi/nifi-api/nifi-api-2.11.0.buildspec) :white_check_mark: | [2.12.0](../content/org/apache/nifi/nifi-api/nifi-api-2.12.0.buildspec) | `bin/add-new-release.sh content/org/apache/nifi/nifi-api/nifi-api-2.11.0.buildspec 2.12.0` |
| <!-- 20260908152519 --> [cui-parent-pom](../content/de/cuioss/cui-parent-pom/README.md) | [1.7.0](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.7.0.buildspec) :white_check_mark: | [1.7.3](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.7.3.buildspec) | `bin/add-new-release.sh content/de/cuioss/cui-parent-pom/cui-parent-pom-1.7.0.buildspec 1.7.3` |
| <!-- 20260908152519 --> [cui-parent-pom](../content/de/cuioss/cui-parent-pom/README.md) | [1.7.0](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.7.0.buildspec) :white_check_mark: | 1.7.2 1.7.1  | `bin/add-new-release.sh content/de/cuioss/cui-parent-pom/cui-parent-pom-1.7.0.buildspec ...` |
| <!-- 20260908124754 --> [io.wcm.handler.richtext](../content/io/wcm/io.wcm.handler/richtext/README.md) | [2.1.0](../content/io/wcm/io.wcm.handler/richtext/wcm-richtext-2.1.0.buildspec) :white_check_mark: | [2.1.2](../content/io/wcm/io.wcm.handler/richtext/wcm-richtext-2.1.2.buildspec) | `bin/add-new-release.sh content/io/wcm/io.wcm.handler/richtext/wcm-richtext-2.1.0.buildspec 2.1.2` |
| <!-- 20260908095821 --> [airbase](../content/io/airlift/airbase/README.md) | [409](../content/io/airlift/airbase/airbase-409.buildspec) :white_check_mark: | [410](../content/io/airlift/airbase/airbase-410.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-409.buildspec 410` |
| <!-- 20260908062809 --> [jline](../content/org/jline/README.md) | [4.4.2](../content/org/jline/jline-4.4.2.buildspec) :white_check_mark: | [4.4.3](../content/org/jline/jline-4.4.3.buildspec) | `bin/add-new-release.sh content/org/jline/jline-4.4.2.buildspec 4.4.3` |
| <!-- 20260908062809 --> [jline](../content/org/jline/README.md) | [4.4.2](../content/org/jline/jline-4.4.2.buildspec) :white_check_mark: | 4.0.16 4.0.11 4.0.9 4.0.8 4.0.7 4.0.6 4.0.5 3.30.17  | `bin/add-new-release.sh content/org/jline/jline-4.4.2.buildspec ...` |
| <!-- 20260908021741 --> [dbunit](../content/org/dbunit/README.md) | [3.5.1](../content/org/dbunit/dbunit-3.5.1.buildspec) :white_check_mark: | [3.5.2](../content/org/dbunit/dbunit-3.5.2.buildspec) | `bin/add-new-release.sh content/org/dbunit/dbunit-3.5.1.buildspec 3.5.2` |
| <!-- 20260908000338 --> [oss-parent](../content/com/fasterxml/oss-parent/README.md) | [79](../content/com/fasterxml/oss-parent/oss-parent-79.buildspec) :white_check_mark: | [80](../content/com/fasterxml/oss-parent/oss-parent-80.buildspec) | `bin/add-new-release.sh content/com/fasterxml/oss-parent/oss-parent-79.buildspec 80` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260908184255 --> [acs-aem-commons](../content/com/adobe/acs/aem-commons/README.md) | [6.17.4](../content/com/adobe/acs/aem-commons/acs-aem-commons-6.17.4.buildspec) :warning: | [6.17.6](../content/com/adobe/acs/aem-commons/acs-aem-commons-6.17.6.buildspec) | `bin/add-new-release.sh content/com/adobe/acs/aem-commons/acs-aem-commons-6.17.4.buildspec 6.17.6` |
