...
| ---------- | ---- | -- | ------- |
| <!-- 20260406190340 --> [sshd](../content/org/apache/sshd/README.md) | [3.0.0-M2](../content/org/apache/sshd/sshd-3.0.0-M2.buildspec) :white_check_mark: | [3.0.0-M3](../content/org/apache/sshd/sshd-3.0.0-M3.buildspec) | `bin/add-new-release.sh content/org/apache/sshd/sshd-3.0.0-M2.buildspec 3.0.0-M3` |
| <!-- 20260406183119 --> [takari-lifecycle-plugin](../content/io/takari/maven/plugins/takari-lifecycle-plugin/README.md) | [2.3.2](../content/io/takari/maven/plugins/takari-lifecycle-plugin/takari-lifecycle-plugin-2.3.2.buildspec) :white_check_mark: | [2.3.3](../content/io/takari/maven/plugins/takari-lifecycle-plugin/takari-lifecycle-plugin-2.3.3.buildspec) | `bin/add-new-release.sh content/io/takari/maven/plugins/takari-lifecycle-plugin/takari-lifecycle-plugin-2.3.2.buildspec 2.3.3` |
| <!-- 20260406104115 --> [flowlogix](../content/com/flowlogix/README.md) | [11.2.1](../content/com/flowlogix/flowlogix-11.2.1.buildspec) :white_check_mark: | [11.2.3](../content/com/flowlogix/flowlogix-11.2.3.buildspec) | `bin/add-new-release.sh content/com/flowlogix/flowlogix-11.2.1.buildspec 11.2.3` |
| <!-- 20260406104115 --> [flowlogix](../content/com/flowlogix/README.md) | [11.2.1](../content/com/flowlogix/flowlogix-11.2.1.buildspec) :white_check_mark: | 11.2.2  | `bin/add-new-release.sh content/com/flowlogix/flowlogix-11.2.1.buildspec ...` |
| <!-- 20260406015515 --> [zrlog-base](../content/com/hibegin/zrlog-base/README.md) | [3.3.8](../content/com/hibegin/zrlog-base/zrlog-base-3.3.8.buildspec) :white_check_mark: | [3.3.9](../content/com/hibegin/zrlog-base/zrlog-base-3.3.9.buildspec) | `bin/add-new-release.sh content/com/hibegin/zrlog-base/zrlog-base-3.3.8.buildspec 3.3.9` |
| <!-- 20260405200654 --> [nifi-api](../content/org/apache/nifi/nifi-api/README.md) | [2.7.0](../content/org/apache/nifi/nifi-api/nifi-api-2.7.0.buildspec) :white_check_mark: | [2.8.0](../content/org/apache/nifi/nifi-api/nifi-api-2.8.0.buildspec) | `bin/add-new-release.sh content/org/apache/nifi/nifi-api/nifi-api-2.7.0.buildspec 2.8.0` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260405080611 --> [jpmml-sklearn](../content/org/jpmml/jpmml-sklearn/README.md) | [1.9.34](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.34.buildspec) :warning: | [1.9.36](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.36.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.34.buildspec 1.9.36` |
