...
| ---------- | ---- | -- | ------- |
| <!-- 20260305152318 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [12.4-javax](../content/io/avaje/inject/avaje-inject-12.4-javax.buildspec) :white_check_mark: | [12.5-RC1](../content/io/avaje/inject/avaje-inject-12.5-RC1.buildspec) | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-12.4-javax.buildspec 12.5-RC1` |
| <!-- 20260305142919 --> [langchain4j](../content/dev/langchain4j/README.md) | [1.11.0](../content/dev/langchain4j/langchain4j-1.11.0.buildspec) :white_check_mark: | [1.12.1](../content/dev/langchain4j/langchain4j-1.12.1.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-1.11.0.buildspec 1.12.1` |
| <!-- 20260305112316 --> [airbase](../content/io/airlift/airbase/README.md) | [357](../content/io/airlift/airbase/airbase-357.buildspec) :white_check_mark: | [359](../content/io/airlift/airbase/airbase-359.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-357.buildspec 359` |
| <!-- 20260305112316 --> [airbase](../content/io/airlift/airbase/README.md) | [357](../content/io/airlift/airbase/airbase-357.buildspec) :white_check_mark: | 358  | `bin/add-new-release.sh content/io/airlift/airbase/airbase-357.buildspec ...` |
| <!-- 20260305110028 --> [domtrip](../content/eu/maveniverse/maven/domtrip/README.md) | [0.5.0](../content/eu/maveniverse/maven/domtrip/domtrip-0.5.0.buildspec) :white_check_mark: | [0.6.0](../content/eu/maveniverse/maven/domtrip/domtrip-0.6.0.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/domtrip/domtrip-0.5.0.buildspec 0.6.0` |
| <!-- 20260305095633 --> [maven-resources-plugin](../content/org/apache/maven/plugins/maven-resources-plugin/README.md) | [4.0.0-beta-1](../content/org/apache/maven/plugins/maven-resources-plugin/maven-resources-plugin-4.0.0-beta-1.buildspec) :white_check_mark: | 3.5.0  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-resources-plugin/maven-resources-plugin-4.0.0-beta-1.buildspec ...` |
| <!-- 20260305095622 --> [maven-filtering](../content/org/apache/maven/shared/maven-filtering/README.md) | [4.0.0-beta-1](../content/org/apache/maven/shared/maven-filtering/maven-filtering-4.0.0-beta-1.buildspec) :white_check_mark: | 3.5.0  | `bin/add-new-release.sh content/org/apache/maven/shared/maven-filtering/maven-filtering-4.0.0-beta-1.buildspec ...` |
| <!-- 20260305093629 --> [maven-shade-plugin](../content/org/apache/maven/plugins/maven-shade-plugin/README.md) | [3.6.1](../content/org/apache/maven/plugins/maven-shade-plugin/maven-shade-plugin-3.6.1.buildspec) :white_check_mark: | [3.6.2](../content/org/apache/maven/plugins/maven-shade-plugin/maven-shade-plugin-3.6.2.buildspec) | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-shade-plugin/maven-shade-plugin-3.6.1.buildspec 3.6.2` |
| <!-- 20260305080150 --> [maven-lockfile](../content/io/github/chains-project/maven-lockfile/README.md) | [5.14.1](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.14.1.buildspec) :white_check_mark: | [5.14.2](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.14.2.buildspec) | `bin/add-new-release.sh content/io/github/chains-project/maven-lockfile/maven-lockfile-5.14.1.buildspec 5.14.2` |
| <!-- 20260305042320 --> [avaje-jex-parent](../content/io/avaje/jex/README.md) | [3.5-RC6](../content/io/avaje/jex/avaje-jex-3.5-RC6.buildspec) :white_check_mark: | [3.5-RC7](../content/io/avaje/jex/avaje-jex-3.5-RC7.buildspec) | `bin/add-new-release.sh content/io/avaje/jex/avaje-jex-3.5-RC6.buildspec 3.5-RC7` |
| <!-- 20260304151802 --> [oras-java-sdk](../content/land/oras/oras-java-sdk/README.md) | [0.4.1](../content/land/oras/oras-java-sdk/oras-java-sdk-0.4.1.buildspec) :white_check_mark: | [0.4.2](../content/land/oras/oras-java-sdk/oras-java-sdk-0.4.2.buildspec) | `bin/add-new-release.sh content/land/oras/oras-java-sdk/oras-java-sdk-0.4.1.buildspec 0.4.2` |
...
| <!-- 20260305122410 --> [kubernetes-client-project](../content/io/fabric8/kubernetes-client/README.md) | [7.6.0](../content/io/fabric8/kubernetes-client/kubernetes-client-7.6.0.buildspec) :warning: | [7.6.1](../content/io/fabric8/kubernetes-client/kubernetes-client-7.6.1.buildspec) | `bin/add-new-release.sh content/io/fabric8/kubernetes-client/kubernetes-client-7.6.0.buildspec 7.6.1` |
...
| <!-- 20260304231613 --> [jetty-project](../content/org/eclipse/jetty/jetty-project/README.md) | [12.1.6](../content/org/eclipse/jetty/jetty-project/jetty-project-12.1.6.buildspec) :warning: | [12.1.7](../content/org/eclipse/jetty/jetty-project/jetty-project-12.1.7.buildspec) | `bin/add-new-release.sh content/org/eclipse/jetty/jetty-project/jetty-project-12.1.6.buildspec 12.1.7` |
| <!-- 20260304153717 --> [quarkus-project](../content/io/quarkus/README.md) | [3.32.1](../content/io/quarkus/quarkus-3.32.1.buildspec) :warning: | [3.32.2](../content/io/quarkus/quarkus-3.32.2.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.32.1.buildspec 3.32.2` |
| <!-- 20260304124538 --> [project](../content/org/glassfish/mq/README.md) | [6.7.0](../content/org/glassfish/mq/openmq-6.7.0.buildspec) :warning: | [6.8.0](../content/org/glassfish/mq/openmq-6.8.0.buildspec) | `bin/add-new-release.sh content/org/glassfish/mq/openmq-6.7.0.buildspec 6.8.0` |
| <!-- 20260304051722 --> [avaje-validator-parent](../content/io/avaje/validator/README.md) | [2.17-RC1](../content/io/avaje/validator/avaje-validator-2.17-RC1.buildspec) :warning: [:memo:](https://github.com/avaje/avaje-validator/issues/362) | [2.17](../content/io/avaje/validator/avaje-validator-2.17.buildspec) | `bin/add-new-release.sh content/io/avaje/validator/avaje-validator-2.17-RC1.buildspec 2.17` |
