...
| ---------- | ---- | -- | ------- |
| <!-- 20260525204741 --> [metrics-parent](../content/io/dropwizard/metrics5/README.md) | [5.0.6](../content/io/dropwizard/metrics5/dropwizard-metrics-5.0.6.buildspec) :white_check_mark: | [5.0.7](../content/io/dropwizard/metrics5/dropwizard-metrics-5.0.7.buildspec) | `bin/add-new-release.sh content/io/dropwizard/metrics5/dropwizard-metrics-5.0.6.buildspec 5.0.7` |
| <!-- 20260525204343 --> [metrics-parent](../content/io/dropwizard/metrics/README.md) | [4.2.38](../content/io/dropwizard/metrics/dropwizard-metrics-4.2.38.buildspec) :white_check_mark: | [4.2.39](../content/io/dropwizard/metrics/dropwizard-metrics-4.2.39.buildspec) | `bin/add-new-release.sh content/io/dropwizard/metrics/dropwizard-metrics-4.2.38.buildspec 4.2.39` |
| <!-- 20260525181516 --> [coveralls-maven-plugin](../content/com/github/hazendaz/maven/coveralls-maven-plugin/README.md) | [5.0.0](../content/com/github/hazendaz/maven/coveralls-maven-plugin/coveralls-maven-plugin-5.0.0.buildspec) :white_check_mark: | [5.1.0](../content/com/github/hazendaz/maven/coveralls-maven-plugin/coveralls-maven-plugin-5.1.0.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/maven/coveralls-maven-plugin/coveralls-maven-plugin-5.0.0.buildspec 5.1.0` |
| <!-- 20260525180516 --> [catch-exception-parent](../content/com/github/hazendaz/catch-exception/README.md) | [2.3.5](../content/com/github/hazendaz/catch-exception/catch-exception-2.3.5.buildspec) :white_check_mark: | [2.4.0](../content/com/github/hazendaz/catch-exception/catch-exception-2.4.0.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/catch-exception/catch-exception-2.3.5.buildspec 2.4.0` |
| <!-- 20260525160154 --> [jakarta.persistence-api](../content/jakarta/persistence/jakarta.persistence-api/README.md) | [4.0.0-M3](../content/jakarta/persistence/jakarta.persistence-api/jakarta.persistence-api-4.0.0-M3.buildspec) :white_check_mark: | [4.0.0-M4](../content/jakarta/persistence/jakarta.persistence-api/jakarta.persistence-api-4.0.0-M4.buildspec) | `bin/add-new-release.sh content/jakarta/persistence/jakarta.persistence-api/jakarta.persistence-api-4.0.0-M3.buildspec 4.0.0-M4` |
| <!-- 20260524230320 --> [avaje-jsonb-parent](../content/io/avaje/jsonb/README.md) | [3.14-RC5](../content/io/avaje/jsonb/avaje-jsonb-3.14-RC5.buildspec) :white_check_mark: | [3.14-RC6](../content/io/avaje/jsonb/avaje-jsonb-3.14-RC6.buildspec) | `bin/add-new-release.sh content/io/avaje/jsonb/avaje-jsonb-3.14-RC5.buildspec 3.14-RC6` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260525190715 --> [jpmml-xgboost](../content/org/jpmml/jpmml-xgboost/README.md) | [1.9.7](../content/org/jpmml/jpmml-xgboost/jpmml-xgboost-1.9.7.buildspec) :warning: | [1.9.8](../content/org/jpmml/jpmml-xgboost/jpmml-xgboost-1.9.8.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-xgboost/jpmml-xgboost-1.9.7.buildspec 1.9.8` |
...
| artifactId | newest |
| ---------- | ------ |
| <!-- 20260522100159 --> [json-rpc-client](../content/net/osslabz/json-rpc-client/README.md) | 0.0.6 :warning: [:memo:](https://github.com/osslabz/json-rpc-client/pull/47) |
