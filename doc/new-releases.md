...
| ---------- | ---- | -- | ------- |
| <!-- 20260224210326 --> [maven-lockfile](../content/io/github/chains-project/maven-lockfile/README.md) | [5.13.4-beta-1](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.13.4-beta-1.buildspec) :white_check_mark: | [5.14.0](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.14.0.buildspec) | `bin/add-new-release.sh content/io/github/chains-project/maven-lockfile/maven-lockfile-5.13.4-beta-1.buildspec 5.14.0` |
| <!-- 20260224173124 --> [airbase](../content/io/airlift/airbase/README.md) | [355](../content/io/airlift/airbase/airbase-355.buildspec) :white_check_mark: | [356](../content/io/airlift/airbase/airbase-356.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-355.buildspec 356` |
| <!-- 20260224125840 --> [oras-java-sdk](../content/land/oras/oras-java-sdk/README.md) | [0.4.0](../content/land/oras/oras-java-sdk/oras-java-sdk-0.4.0.buildspec) :white_check_mark: | [0.4.1](../content/land/oras/oras-java-sdk/oras-java-sdk-0.4.1.buildspec) | `bin/add-new-release.sh content/land/oras/oras-java-sdk/oras-java-sdk-0.4.0.buildspec 0.4.1` |
| <!-- 20260224103330 --> [env-config](../content/com/github/sitture/env-config/README.md) | [2.2.0](../content/com/github/sitture/env-config/env-config-2.2.0.buildspec) :white_check_mark: | [2.3.0](../content/com/github/sitture/env-config/env-config-2.3.0.buildspec) | `bin/add-new-release.sh content/com/github/sitture/env-config/env-config-2.2.0.buildspec 2.3.0` |
...
| <!-- 20260224100944 --> [io.wcm.handler.link](../content/io/wcm/io.wcm.handler/link/README.md) | [2.3.0](../content/io/wcm/io.wcm.handler/link/io.wcm.handler.link-2.3.0.buildspec) :white_check_mark: | [2.3.2](../content/io/wcm/io.wcm.handler/link/io.wcm.handler.link-2.3.2.buildspec) | `bin/add-new-release.sh content/io/wcm/io.wcm.handler/link/io.wcm.handler.link-2.3.0.buildspec 2.3.2` |
| <!-- 20260224100940 --> [io.wcm.wcm.commons](../content/io/wcm/io.wcm.wcm/commons/README.md) | [1.11.2](../content/io/wcm/io.wcm.wcm/commons/wcm-commons-1.11.2.buildspec) :white_check_mark: | [1.11.4](../content/io/wcm/io.wcm.wcm/commons/wcm-commons-1.11.4.buildspec) | `bin/add-new-release.sh content/io/wcm/io.wcm.wcm/commons/wcm-commons-1.11.2.buildspec 1.11.4` |
| <!-- 20260224095328 --> [io.wcm.parent_toplevel](../content/io/wcm/tooling/README.md) | [2.6.2](../content/io/wcm/tooling/wcm-parent_toplevel-2.6.2.buildspec) :white_check_mark: | [2.7.0](../content/io/wcm/tooling/wcm-parent_toplevel-2.7.0.buildspec) | `bin/add-new-release.sh content/io/wcm/tooling/wcm-parent_toplevel-2.6.2.buildspec 2.7.0` |
| <!-- 20260224002117 --> [compatibility-kit](../content/io/cucumber/compatibility-kit/README.md) | [29.1.3](../content/io/cucumber/compatibility-kit/compatibility-kit-29.1.3.buildspec) :white_check_mark: | [29.1.4](../content/io/cucumber/compatibility-kit/compatibility-kit-29.1.4.buildspec) | `bin/add-new-release.sh content/io/cucumber/compatibility-kit/compatibility-kit-29.1.3.buildspec 29.1.4` |
| <!-- 20260223214938 --> [jackson-datatypes-misc-parent](../content/tools/jackson/datatype/jackson-datatypes-misc-parent/README.md) | [3.1.0-rc1](../content/tools/jackson/datatype/jackson-datatypes-misc-parent/jackson-datatypes-misc-parent-3.1.0-rc1.buildspec) :white_check_mark: | [3.1.0](../content/tools/jackson/datatype/jackson-datatypes-misc-parent/jackson-datatypes-misc-parent-3.1.0.buildspec) | `bin/add-new-release.sh content/tools/jackson/datatype/jackson-datatypes-misc-parent/jackson-datatypes-misc-parent-3.1.0-rc1.buildspec 3.1.0` |
| <!-- 20260223214937 --> [jackson-datatypes-collections](../content/tools/jackson/datatype/jackson-datatypes-collections/README.md) | [3.1.0-rc1](../content/tools/jackson/datatype/jackson-datatypes-collections/jackson-datatypes-collections-3.1.0-rc1.buildspec) :white_check_mark: | [3.1.0](../content/tools/jackson/datatype/jackson-datatypes-collections/jackson-datatypes-collections-3.1.0.buildspec) | `bin/add-new-release.sh content/tools/jackson/datatype/jackson-datatypes-collections/jackson-datatypes-collections-3.1.0-rc1.buildspec 3.1.0` |
| <!-- 20260223214931 --> [jackson-datatype-joda](../content/tools/jackson/datatype/jackson-datatype-joda/README.md) | [3.1.0-rc1](../content/tools/jackson/datatype/jackson-datatype-joda/jackson-datatype-joda-3.1.0-rc1.buildspec) :white_check_mark: | [3.1.0](../content/tools/jackson/datatype/jackson-datatype-joda/jackson-datatype-joda-3.1.0.buildspec) | `bin/add-new-release.sh content/tools/jackson/datatype/jackson-datatype-joda/jackson-datatype-joda-3.1.0-rc1.buildspec 3.1.0` |
| <!-- 20260223214921 --> [jackson-dataformat-xml](../content/tools/jackson/dataformat/jackson-dataformat-xml/README.md) | [3.1.0-rc1](../content/tools/jackson/dataformat/jackson-dataformat-xml/jackson-dataformat-xml-3.1.0-rc1.buildspec) :white_check_mark: | [3.1.0](../content/tools/jackson/dataformat/jackson-dataformat-xml/jackson-dataformat-xml-3.1.0.buildspec) | `bin/add-new-release.sh content/tools/jackson/dataformat/jackson-dataformat-xml/jackson-dataformat-xml-3.1.0-rc1.buildspec 3.1.0` |
| <!-- 20260223214359 --> [jackson-dataformats-text](../content/tools/jackson/dataformat/jackson-dataformats-text/README.md) | [3.1.0-rc1](../content/tools/jackson/dataformat/jackson-dataformats-text/jackson-dataformats-text-3.1.0-rc1.buildspec) :white_check_mark: | [3.1.0](../content/tools/jackson/dataformat/jackson-dataformats-text/jackson-dataformats-text-3.1.0.buildspec) | `bin/add-new-release.sh content/tools/jackson/dataformat/jackson-dataformats-text/jackson-dataformats-text-3.1.0-rc1.buildspec 3.1.0` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260224193719 --> [apache-resource-bundles](../content/org/apache/apache/resources/README.md) | [1.7](../content/org/apache/apache/resources/apache-resource-bundles-1.7.buildspec) :warning: [:memo:](https://github.com/apache/maven-apache-parent/pull/288/files) | [1.8](../content/org/apache/apache/resources/apache-resource-bundles-1.8.buildspec) | `bin/add-new-release.sh content/org/apache/apache/resources/apache-resource-bundles-1.7.buildspec 1.8` |
| <!-- 20260224122924 --> [toolbox](../content/eu/maveniverse/maven/toolbox/README.md) | [0.15.3](../content/eu/maveniverse/maven/toolbox/toolbox-0.15.3.buildspec) :warning: | [0.15.4](../content/eu/maveniverse/maven/toolbox/toolbox-0.15.4.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/toolbox/toolbox-0.15.3.buildspec 0.15.4` |
| <!-- 20260224102454 --> [io.wcm.wcm.parsys](../content/io/wcm/io.wcm.wcm/parsys/README.md) | [1.6.4](../content/io/wcm/io.wcm.wcm/parsys/wcm-parsys-1.6.4.buildspec) :warning: | [1.7.6](../content/io/wcm/io.wcm.wcm/parsys/wcm-parsys-1.7.6.buildspec) | `bin/add-new-release.sh content/io/wcm/io.wcm.wcm/parsys/wcm-parsys-1.6.4.buildspec 1.7.6` |
| <!-- 20260224100331 --> [io.wcm.caconfig.editor.root](../content/io/wcm/io.wcm.caconfig/README.md) | [1.16.8](../content/io/wcm/io.wcm.caconfig/wcm-caconfig-editor-1.16.8.buildspec) :warning: | [1.16.10](../content/io/wcm/io.wcm.caconfig/wcm-caconfig-editor-1.16.10.buildspec) | `bin/add-new-release.sh content/io/wcm/io.wcm.caconfig/wcm-caconfig-editor-1.16.8.buildspec 1.16.10` |
