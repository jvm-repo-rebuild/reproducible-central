...
| ---------- | ---- | -- | ------- |
| <!-- 20260830213523 --> [modello](../content/org/codehaus/modello/README.md) | [2.8.0](../content/org/codehaus/modello/modello-2.8.0.buildspec) :white_check_mark: | [2.8.1](../content/org/codehaus/modello/modello-2.8.1.buildspec) | `bin/add-new-release.sh content/org/codehaus/modello/modello-2.8.0.buildspec 2.8.1` |
| <!-- 20260830205123 --> [maven-lockfile](../content/io/github/chains-project/maven-lockfile/README.md) | [5.17.4-beta-3](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.17.4-beta-3.buildspec) :white_check_mark: | [5.18.1](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.18.1.buildspec) | `bin/add-new-release.sh content/io/github/chains-project/maven-lockfile/maven-lockfile-5.17.4-beta-3.buildspec 5.18.1` |
| <!-- 20260830205123 --> [maven-lockfile](../content/io/github/chains-project/maven-lockfile/README.md) | [5.17.4-beta-3](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.17.4-beta-3.buildspec) :white_check_mark: | 5.18.1-beta-1 5.18.0  | `bin/add-new-release.sh content/io/github/chains-project/maven-lockfile/maven-lockfile-5.17.4-beta-3.buildspec ...` |
| <!-- 20260830200717 --> [fusion](../content/io/yupiik/fusion/README.md) | [1.0.37](../content/io/yupiik/fusion/fusion-1.0.37.buildspec) :white_check_mark: | [1.1.0](../content/io/yupiik/fusion/fusion-1.1.0.buildspec) | `bin/add-new-release.sh content/io/yupiik/fusion/fusion-1.0.37.buildspec 1.1.0` |
| <!-- 20260830172514 --> [base-parent](../content/com/github/hazendaz/base-parent/README.md) | [60](../content/com/github/hazendaz/base-parent/base-parent-60.buildspec) :white_check_mark: | [61](../content/com/github/hazendaz/base-parent/base-parent-61.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/base-parent/base-parent-60.buildspec 61` |
| <!-- 20260830125609 --> [maven-compiler-plugin](../content/org/apache/maven/plugins/maven-compiler-plugin/README.md) | [4.0.0-beta-4](../content/org/apache/maven/plugins/maven-compiler-plugin/maven-compiler-plugin-4.0.0-beta-4.buildspec) :white_check_mark: | [4.0.0-beta-5](../content/org/apache/maven/plugins/maven-compiler-plugin/maven-compiler-plugin-4.0.0-beta-5.buildspec) | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-compiler-plugin/maven-compiler-plugin-4.0.0-beta-4.buildspec 4.0.0-beta-5` |
| <!-- 20260830110141 --> [oras-java-sdk](../content/land/oras/oras-java-sdk/README.md) | [0.8.3](../content/land/oras/oras-java-sdk/oras-java-sdk-0.8.3.buildspec) :white_check_mark: | [0.8.4](../content/land/oras/oras-java-sdk/oras-java-sdk-0.8.4.buildspec) | `bin/add-new-release.sh content/land/oras/oras-java-sdk/oras-java-sdk-0.8.3.buildspec 0.8.4` |
| <!-- 20260830105721 --> [wicket-parent](../content/org/apache/wicket/README.md) | [10.10.0](../content/org/apache/wicket/wicket-parent-10.10.0.buildspec) :white_check_mark: | [10.11.0](../content/org/apache/wicket/wicket-parent-10.11.0.buildspec) | `bin/add-new-release.sh content/org/apache/wicket/wicket-parent-10.10.0.buildspec 10.11.0` |
| <!-- 20260830084316 --> [sunspec-device-parent](../content/nl/basjes/sunspec/sunspec-device-parent/README.md) | [0.7.3](../content/nl/basjes/sunspec/sunspec-device-parent/sunspec-device-parent-0.7.3.buildspec) :white_check_mark: | [0.8.0](../content/nl/basjes/sunspec/sunspec-device-parent/sunspec-device-parent-0.8.0.buildspec) | `bin/add-new-release.sh content/nl/basjes/sunspec/sunspec-device-parent/sunspec-device-parent-0.7.3.buildspec 0.8.0` |
| <!-- 20260830082629 --> [modbus-devices-parent](../content/nl/basjes/modbus/devices/modbus-devices-parent/README.md) | [0.6.2](../content/nl/basjes/modbus/devices/modbus-devices-parent/modbus-devices-parent-0.6.2.buildspec) :white_check_mark: | [0.7.0](../content/nl/basjes/modbus/devices/modbus-devices-parent/modbus-devices-parent-0.7.0.buildspec) | `bin/add-new-release.sh content/nl/basjes/modbus/devices/modbus-devices-parent/modbus-devices-parent-0.6.2.buildspec 0.7.0` |
| <!-- 20260830051515 --> [spoon-core](../content/fr/inria/gforge/spoon/spoon-core/README.md) | [11.5.1-beta-6](../content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.5.1-beta-6.buildspec) :white_check_mark: | [11.5.1-beta-7](../content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.5.1-beta-7.buildspec) | `bin/add-new-release.sh content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.5.1-beta-6.buildspec 11.5.1-beta-7` |
| <!-- 20260830002923 --> [hibernate-core](../content/org/hibernate/orm/hibernate-core/README.md) | [8.0.0.Beta1](../content/org/hibernate/orm/hibernate-core/hibernate-core-8.0.0.Beta1.buildspec) :white_check_mark: | 7.4.7.Final  | `bin/add-new-release.sh content/org/hibernate/orm/hibernate-core/hibernate-core-8.0.0.Beta1.buildspec ...` |
| <!-- 20260826193720 --> [jline](../content/org/jline/README.md) | [4.4.0](../content/org/jline/jline-4.4.0.buildspec) :white_check_mark: | 4.0.16 4.0.11 4.0.9 4.0.8 4.0.7 4.0.6 4.0.5 4.0.4 4.0.3 4.0.2 3.30.16 3.30.15 3.30.14  | `bin/add-new-release.sh content/org/jline/jline-4.4.0.buildspec ...` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20260810123809 --> [:mailbox:](https://lists.apache.org/list?dev@activemq.apache.org:lte=1M:VOTE) | [activemq-parent](../content/org/apache/activemq/README.md) | [6.3.1](../content/org/apache/activemq/activemq-6.3.1.buildspec) :warning: | [6.3.2](../content/org/apache/activemq/activemq-6.3.2.buildspec)  | `bin/add-new-release.sh content/org/apache/activemq/activemq-6.3.1.buildspec 6.3.2 staging` |
| <!-- 20260730074901 --> [:mailbox:](https://lists.apache.org/list?dev@felix.apache.org:lte=1M:VOTE) | [maven-bundle-plugin](../content/org/apache/felix/maven-bundle-plugin/README.md) | [6.1.0](../content/org/apache/felix/maven-bundle-plugin/maven-bundle-plugin-6.1.0.buildspec) :white_check_mark: | [6.1.2](../content/org/apache/felix/maven-bundle-plugin/maven-bundle-plugin-6.1.2.buildspec)  | `bin/add-new-release.sh content/org/apache/felix/maven-bundle-plugin/maven-bundle-plugin-6.1.0.buildspec 6.1.2 staging` |
| <!-- 20260622204344 --> [:mailbox:](https://lists.apache.org/list?dev@tooling.apache.org:lte=1M:VOTE) | [atr-maven-plugin](../content/org/apache/tooling/atr-maven-plugin/README.md) | [1.0.0-alpha-1](../content/org/apache/tooling/atr-maven-plugin/atr-maven-plugin-1.0.0-alpha-1.buildspec) :white_check_mark: | [1.0.0-beta-1](../content/org/apache/tooling/atr-maven-plugin/atr-maven-plugin-1.0.0-beta-1.buildspec)  | `bin/add-new-release.sh content/org/apache/tooling/atr-maven-plugin/atr-maven-plugin-1.0.0-alpha-1.buildspec 1.0.0-beta-1 staging` |
...
| <!-- 20251021124155 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-skin](../content/org/apache/commons/commons-skin/README.md) | [5.2.0](../content/org/apache/commons/commons-skin/commons-skin-5.2.0.buildspec) :white_check_mark: | [5.3.0](../content/org/apache/commons/commons-skin/commons-skin-5.3.0.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/commons-skin/commons-skin-5.2.0.buildspec 5.3.0 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260830112544 --> [jpmml-sklearn](../content/org/jpmml/jpmml-sklearn/README.md) | [1.9.40](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.40.buildspec) :warning: | [1.9.41](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.41.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.40.buildspec 1.9.41` |
| <!-- 20260827151941 --> [shiro-root](../content/org/apache/shiro/README.md) | [3.0.0](../content/org/apache/shiro/shiro-3.0.0.buildspec) :warning: | [3.0.1](../content/org/apache/shiro/shiro-3.0.1.buildspec) | `bin/add-new-release.sh content/org/apache/shiro/shiro-3.0.0.buildspec 3.0.1` |
| <!-- 20260824195127 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.141.0](../content/org/finos/legend/engine/legend-engine-4.141.0.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.141.0` |
...
| artifactId | newest |
| ---------- | ------ |
| <!-- 20260826121010 --> [quarkus-project](../content/io/quarkus/README.md) | 3.39.1 :warning: |
| <!-- 20260826023519 --> [avaje-metrics-parent](../content/io/avaje/metrics/README.md) | 10.4-RC6 :warning: |
| <!-- 20260825193826 --> [clojure](../content/org/clojure/README.md) | 1.13.0-alpha6 :warning: [:memo:](https://clojure.atlassian.net/browse/CLJ-2959) |
| <!-- 20260825151832 --> [yupiik-tools-maven-plugin-parent](../content/io/yupiik/maven/plugin/README.md) | 1.2.16 :warning: |
| <!-- 20260824180518 --> [convex](../content/world/convex/README.md) | 0.8.15 :warning: |
