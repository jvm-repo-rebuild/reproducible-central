...
| ---------- | ---- | -- | ------- |
| <!-- 20260813170350 --> [airbase](../content/io/airlift/airbase/README.md) | [400](../content/io/airlift/airbase/airbase-400.buildspec) :white_check_mark: | [401](../content/io/airlift/airbase/airbase-401.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-400.buildspec 401` |
| <!-- 20260813142530 --> [metricshub-connector-maven-plugin](../content/org/metricshub/maven/metricshub-connector-maven-plugin/README.md) | [1.0.13](../content/org/metricshub/maven/metricshub-connector-maven-plugin/metricshub-connector-maven-plugin-1.0.13.buildspec) :white_check_mark: | [1.0.15](../content/org/metricshub/maven/metricshub-connector-maven-plugin/metricshub-connector-maven-plugin-1.0.15.buildspec) | `bin/add-new-release.sh content/org/metricshub/maven/metricshub-connector-maven-plugin/metricshub-connector-maven-plugin-1.0.13.buildspec 1.0.15` |
| <!-- 20260813142530 --> [metricshub-connector-maven-plugin](../content/org/metricshub/maven/metricshub-connector-maven-plugin/README.md) | [1.0.13](../content/org/metricshub/maven/metricshub-connector-maven-plugin/metricshub-connector-maven-plugin-1.0.13.buildspec) :white_check_mark: | 1.0.14  | `bin/add-new-release.sh content/org/metricshub/maven/metricshub-connector-maven-plugin/metricshub-connector-maven-plugin-1.0.13.buildspec ...` |
| <!-- 20260813085836 --> [community-connectors](../content/org/metricshub/community-connectors/README.md) | [1.0.21](../content/org/metricshub/community-connectors/community-connectors-1.0.21.buildspec) :white_check_mark: | [1.0.22](../content/org/metricshub/community-connectors/community-connectors-1.0.22.buildspec) | `bin/add-new-release.sh content/org/metricshub/community-connectors/community-connectors-1.0.21.buildspec 1.0.22` |
...
| <!-- 20260813125257 --> [convex](../content/world/convex/README.md) | [0.8.11](../content/world/convex/convex-0.8.11.buildspec) :warning: | [0.8.12](../content/world/convex/convex-0.8.12.buildspec) | `bin/add-new-release.sh content/world/convex/convex-0.8.11.buildspec 0.8.12` |
| <!-- 20260813101205 --> [avaje-metrics-parent](../content/io/avaje/metrics/README.md) | [10.1](../content/io/avaje/metrics/avaje-metrics-10.1.buildspec) :warning: | [10.3](../content/io/avaje/metrics/avaje-metrics-10.3.buildspec) | `bin/add-new-release.sh content/io/avaje/metrics/avaje-metrics-10.1.buildspec 10.3` |
| <!-- 20260812190610 --> [quarkus-project](../content/io/quarkus/README.md) | [3.38.1](../content/io/quarkus/quarkus-3.38.1.buildspec) :warning: | [3.39.0.CR1](../content/io/quarkus/quarkus-3.39.0.CR1.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.38.1.buildspec 3.39.0.CR1` |
| <!-- 20260812173013 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.139.2](../content/org/finos/legend/engine/legend-engine-4.139.2.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.139.2` |
...
| <!-- 20260812152232 --> [scg-base](../content/io/telicent/smart-caches/graph/scg-base/README.md) | 1.1.2 :warning: |
