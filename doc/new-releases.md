...
| ---------- | ---- | -- | ------- |
| <!-- 20260126155248 --> [nbpackage](../content/org/apache/netbeans/nbpackage/README.md) | [1.0-beta6](../content/org/apache/netbeans/nbpackage/nbpackage-1.0-beta6.buildspec) :white_check_mark: | [1.0](../content/org/apache/netbeans/nbpackage/nbpackage-1.0.buildspec) | `bin/add-new-release.sh content/org/apache/netbeans/nbpackage/nbpackage-1.0-beta6.buildspec 1.0` |
| <!-- 20260126150650 --> [airbase](../content/io/airlift/airbase/README.md) | [344](../content/io/airlift/airbase/airbase-344.buildspec) :white_check_mark: | [345](../content/io/airlift/airbase/airbase-345.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-344.buildspec 345` |
| <!-- 20260126150321 --> [liftwizard](../content/io/liftwizard/README.md) | [2.1.40](../content/io/liftwizard/liftwizard-2.1.40.buildspec) :white_check_mark: | [2.1.41](../content/io/liftwizard/liftwizard-2.1.41.buildspec) | `bin/add-new-release.sh content/io/liftwizard/liftwizard-2.1.40.buildspec 2.1.41` |
| <!-- 20260126140410 --> [cui-parent-pom](../content/de/cuioss/cui-parent-pom/README.md) | [1.3.6](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.3.6.buildspec) :white_check_mark: | [1.3.7](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.3.7.buildspec) | `bin/add-new-release.sh content/de/cuioss/cui-parent-pom/cui-parent-pom-1.3.6.buildspec 1.3.7` |
| <!-- 20260126133516 --> [parent](../content/ch/qos/logback/access/README.md) | [2.0.8](../content/ch/qos/logback/access/access-2.0.8.buildspec) :white_check_mark: | [2.0.9](../content/ch/qos/logback/access/access-2.0.9.buildspec) | `bin/add-new-release.sh content/ch/qos/logback/access/access-2.0.8.buildspec 2.0.9` |
| <!-- 20260126112913 --> [ci-environment](../content/io/cucumber/ci-environment/README.md) | [12.0.0](../content/io/cucumber/ci-environment/ci-environment-12.0.0.buildspec) :white_check_mark: | [13.0.0](../content/io/cucumber/ci-environment/ci-environment-13.0.0.buildspec) | `bin/add-new-release.sh content/io/cucumber/ci-environment/ci-environment-12.0.0.buildspec 13.0.0` |
| <!-- 20260126105315 --> [openapi-diff-parent](../content/org/openapitools/openapidiff/README.md) | [2.1.6](../content/org/openapitools/openapidiff/openapi-diff-2.1.6.buildspec) :white_check_mark: | [2.1.7](../content/org/openapitools/openapidiff/openapi-diff-2.1.7.buildspec) | `bin/add-new-release.sh content/org/openapitools/openapidiff/openapi-diff-2.1.6.buildspec 2.1.7` |
| <!-- 20260125235511 --> [modello](../content/org/codehaus/modello/README.md) | [2.5.1](../content/org/codehaus/modello/modello-2.5.1.buildspec) :white_check_mark: | [2.6.0](../content/org/codehaus/modello/modello-2.6.0.buildspec) | `bin/add-new-release.sh content/org/codehaus/modello/modello-2.5.1.buildspec 2.6.0` |
| <!-- 20260125233209 --> [metrics-parent](../content/io/dropwizard/metrics/README.md) | [4.2.37](../content/io/dropwizard/metrics/dropwizard-metrics-4.2.37.buildspec) :white_check_mark: | [4.2.38](../content/io/dropwizard/metrics/dropwizard-metrics-4.2.38.buildspec) | `bin/add-new-release.sh content/io/dropwizard/metrics/dropwizard-metrics-4.2.37.buildspec 4.2.38` |
| <!-- 20260125233139 --> [metrics-parent](../content/io/dropwizard/metrics5/README.md) | [5.0.5](../content/io/dropwizard/metrics5/dropwizard-metrics-5.0.5.buildspec) :white_check_mark: | [5.0.6](../content/io/dropwizard/metrics5/dropwizard-metrics-5.0.6.buildspec) | `bin/add-new-release.sh content/io/dropwizard/metrics5/dropwizard-metrics-5.0.5.buildspec 5.0.6` |
| <!-- 20260125225321 --> [plexus-compiler](../content/org/codehaus/plexus/plexus-compiler/README.md) | [2.16.1](../content/org/codehaus/plexus/plexus-compiler/plexus-compiler-2.16.1.buildspec) :white_check_mark: | [2.16.2](../content/org/codehaus/plexus/plexus-compiler/plexus-compiler-2.16.2.buildspec) | `bin/add-new-release.sh content/org/codehaus/plexus/plexus-compiler/plexus-compiler-2.16.1.buildspec 2.16.2` |
| <!-- 20260125223113 --> [plexus-xml](../content/org/codehaus/plexus/plexus-xml/README.md) | [4.1.0](../content/org/codehaus/plexus/plexus-xml/plexus-xml-4.1.0.buildspec) :white_check_mark: | [4.1.1](../content/org/codehaus/plexus/plexus-xml/plexus-xml-4.1.1.buildspec) | `bin/add-new-release.sh content/org/codehaus/plexus/plexus-xml/plexus-xml-4.1.0.buildspec 4.1.1` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260126185715 --> [avaje-config](../content/io/avaje/config/README.md) | [5.0](../content/io/avaje/config/avaje-config-5.0.buildspec) :warning: | [5.1](../content/io/avaje/config/avaje-config-5.1.buildspec) | `bin/add-new-release.sh content/io/avaje/config/avaje-config-5.0.buildspec 5.1` |
| <!-- 20260126132353 --> [jpmml-statsmodels](../content/org/jpmml/jpmml-statsmodels/README.md) | [1.3.9](../content/org/jpmml/jpmml-statsmodels/jpmml-statsmodels-1.3.9.buildspec) :warning: | [1.3.11](../content/org/jpmml/jpmml-statsmodels/jpmml-statsmodels-1.3.11.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-statsmodels/jpmml-statsmodels-1.3.9.buildspec 1.3.11` |
| <!-- 20260126130145 --> [jpmml-python](../content/org/jpmml/jpmml-python/README.md) | [1.3.17](../content/org/jpmml/jpmml-python/jpmml-python-1.3.17.buildspec) :warning: | [1.3.18](../content/org/jpmml/jpmml-python/jpmml-python-1.3.18.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-python/jpmml-python-1.3.17.buildspec 1.3.18` |
| <!-- 20260126022316 --> [athena-parent](../content/io/github/gls-athena/README.md) | [0.0.17](../content/io/github/gls-athena/athena-0.0.17.buildspec) :warning: [:memo:](https://github.com/gls-athena/athena-parent/pull/31) | [0.0.18](../content/io/github/gls-athena/athena-0.0.18.buildspec) | `bin/add-new-release.sh content/io/github/gls-athena/athena-0.0.17.buildspec 0.0.18` |
