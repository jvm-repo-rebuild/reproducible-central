...
| ---------- | ---- | -- | ------- |
| <!-- 20260401171320 --> [hibernate-reactive-core](../content/org/hibernate/reactive/hibernate-reactive/README.md) | [4.3.0.Final](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.3.0.Final.buildspec) :white_check_mark: | 4.2.9.Final 4.2.8.Final 3.2.9.Final 3.2.8.Final  | `bin/add-new-release.sh content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.3.0.Final.buildspec ...` |
| <!-- 20260401164518 --> [plexus-utils](../content/org/codehaus/plexus/plexus-utils/README.md) | [4.0.3](../content/org/codehaus/plexus/plexus-utils/plexus-utils-4.0.3.buildspec) :white_check_mark: | 3.6.1  | `bin/add-new-release.sh content/org/codehaus/plexus/plexus-utils/plexus-utils-4.0.3.buildspec ...` |
...
| <!-- 20260401085720 --> [mada-style-gradle](../content/dk/mada/style/mada-style-gradle/README.md) | [1.20](../content/dk/mada/style/mada-style-gradle/mada-style-gradle-1.20.buildspec) :white_check_mark: | 1.2.2  | `bin/add-new-release.sh content/dk/mada/style/mada-style-gradle/mada-style-gradle-1.20.buildspec ...` |
| <!-- 20260401071410 --> [maven-turbo-builder](../content/com/github/seregamorph/maven-turbo-builder/README.md) | [0.14](../content/com/github/seregamorph/maven-turbo-builder/maven-turbo-builder-0.14.buildspec) :white_check_mark: | [1.0](../content/com/github/seregamorph/maven-turbo-builder/maven-turbo-builder-1.0.buildspec) | `bin/add-new-release.sh content/com/github/seregamorph/maven-turbo-builder/maven-turbo-builder-0.14.buildspec 1.0` |
| <!-- 20260401045714 --> [avaje-jsonb-parent](../content/io/avaje/jsonb/README.md) | [3.12-RC1](../content/io/avaje/jsonb/avaje-jsonb-3.12-RC1.buildspec) :white_check_mark: | [3.12-RC2](../content/io/avaje/jsonb/avaje-jsonb-3.12-RC2.buildspec) | `bin/add-new-release.sh content/io/avaje/jsonb/avaje-jsonb-3.12-RC1.buildspec 3.12-RC2` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20260223062243 --> [:mailbox:](https://lists.apache.org/list?dev@syncope.apache.org:lte=1M:VOTE) | [syncope](../content/org/apache/syncope/README.md) | [4.1.0-M0](../content/org/apache/syncope/syncope-4.1.0-M0.buildspec) :warning: | [4.1.0](../content/org/apache/syncope/syncope-4.1.0.buildspec)  | `bin/add-new-release.sh content/org/apache/syncope/syncope-4.1.0-M0.buildspec 4.1.0 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260401183946 --> [quarkus-project](../content/io/quarkus/README.md) | [3.34.1](../content/io/quarkus/quarkus-3.34.1.buildspec) :warning: | [3.34.2](../content/io/quarkus/quarkus-3.34.2.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.34.1.buildspec 3.34.2` |
...
| <!-- 20260331145005 --> [jooby](../content/io/jooby/README.md) | [4.1.0](../content/io/jooby/jooby-4.1.0.buildspec) :warning: | [4.2.0](../content/io/jooby/jooby-4.2.0.buildspec) | `bin/add-new-release.sh content/io/jooby/jooby-4.1.0.buildspec 4.2.0` |
| <!-- 20260330221331 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.124.4](../content/org/finos/legend/engine/legend-engine-4.124.4.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.124.4` |
| <!-- 20260329195516 --> [git-commit-id-maven-plugin](../content/io/github/git-commit-id/README.md) | [9.0.0](../content/io/github/git-commit-id/git-commit-id-maven-plugin-9.0.0.buildspec) :x: | [9.1.0](../content/io/github/git-commit-id/git-commit-id-maven-plugin-9.1.0.buildspec) | `bin/add-new-release.sh content/io/github/git-commit-id/git-commit-id-maven-plugin-9.0.0.buildspec 9.1.0` |
