...
| ---------- | ---- | -- | ------- |
| <!-- 20260619151324 --> [mug-root](../content/com/google/mug/README.md) | [10.3.1](../content/com/google/mug/mug-10.3.1.buildspec) :white_check_mark: | [10.4.3](../content/com/google/mug/mug-10.4.3.buildspec) | `bin/add-new-release.sh content/com/google/mug/mug-10.3.1.buildspec 10.4.3` |
| <!-- 20260619151324 --> [mug-root](../content/com/google/mug/README.md) | [10.3.1](../content/com/google/mug/mug-10.3.1.buildspec) :white_check_mark: | 10.4.2 10.4.1 10.4  | `bin/add-new-release.sh content/com/google/mug/mug-10.3.1.buildspec ...` |
| <!-- 20260619145721 --> [rdf-abac](../content/io/telicent/jena/rdf-abac/README.md) | [3.1.2](../content/io/telicent/jena/rdf-abac/rdf-abac-3.1.2.buildspec) :white_check_mark: | [3.1.4](../content/io/telicent/jena/rdf-abac/rdf-abac-3.1.4.buildspec) | `bin/add-new-release.sh content/io/telicent/jena/rdf-abac/rdf-abac-3.1.2.buildspec 3.1.4` |
| <!-- 20260619085343 --> [airbase](../content/io/airlift/airbase/README.md) | [389](../content/io/airlift/airbase/airbase-389.buildspec) :white_check_mark: | [390](../content/io/airlift/airbase/airbase-390.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-389.buildspec 390` |
| <!-- 20260619043737 --> [mina-parent](../content/org/apache/mina/README.md) | [2.2.8](../content/org/apache/mina/mina-2.2.8.buildspec) :white_check_mark: | [2.2.9](../content/org/apache/mina/mina-2.2.9.buildspec) | `bin/add-new-release.sh content/org/apache/mina/mina-2.2.8.buildspec 2.2.9` |
| <!-- 20260619043737 --> [mina-parent](../content/org/apache/mina/README.md) | [2.2.8](../content/org/apache/mina/mina-2.2.8.buildspec) :white_check_mark: | 2.1.14  | `bin/add-new-release.sh content/org/apache/mina/mina-2.2.8.buildspec ...` |
| <!-- 20260617060527 --> [jline](../content/org/jline/README.md) | [4.2.1](../content/org/jline/jline-4.2.1.buildspec) :white_check_mark: | 4.0.15 4.0.14 4.0.13 4.0.12 4.0.11 4.0.9 4.0.8 4.0.7 4.0.6 4.0.5 4.0.4 4.0.3 4.0.2  | `bin/add-new-release.sh content/org/jline/jline-4.2.1.buildspec ...` |
...
| <!-- 20260619100917 --> [jdplus-sdmx](../content/com/github/nbbrd/jdplus-sdmx/README.md) | [3.3.4](../content/com/github/nbbrd/jdplus-sdmx/jdplus-sdmx-3.3.4.buildspec) :warning: [:memo:](https://github.com/apache/netbeans-mavenutils-nbm-maven-plugin/issues/133) | [3.4.0](../content/com/github/nbbrd/jdplus-sdmx/jdplus-sdmx-3.4.0.buildspec) | `bin/add-new-release.sh content/com/github/nbbrd/jdplus-sdmx/jdplus-sdmx-3.3.4.buildspec 3.4.0` |
