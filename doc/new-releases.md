...
| ---------- | ---- | -- | ------- |
| <!-- 20260626184920 --> [io.wcm.parent_toplevel](../content/io/wcm/tooling/README.md) | [2.8.0](../content/io/wcm/tooling/wcm-parent_toplevel-2.8.0.buildspec) :white_check_mark: | [2.9.0](../content/io/wcm/tooling/wcm-parent_toplevel-2.9.0.buildspec) | `bin/add-new-release.sh content/io/wcm/tooling/wcm-parent_toplevel-2.8.0.buildspec 2.9.0` |
...
| <!-- 20260626170532 --> [github-desktop](../content/com/github/hazendaz/git/github-desktop/README.md) | [3.5.12](../content/com/github/hazendaz/git/github-desktop/github-desktop-3.5.12.buildspec) :white_check_mark: | [3.6.1](../content/com/github/hazendaz/git/github-desktop/github-desktop-3.6.1.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/git/github-desktop/github-desktop-3.5.12.buildspec 3.6.1` |
| <!-- 20260626141750 --> [logback-parent](../content/ch/qos/logback/README.md) | [1.5.36](../content/ch/qos/logback/logback-1.5.36.buildspec) :white_check_mark: | [1.5.37](../content/ch/qos/logback/logback-1.5.37.buildspec) | `bin/add-new-release.sh content/ch/qos/logback/logback-1.5.36.buildspec 1.5.37` |
| <!-- 20260626131120 --> [langchain4j](../content/dev/langchain4j/README.md) | [1.16.3](../content/dev/langchain4j/langchain4j-1.16.3.buildspec) :white_check_mark: | [1.17.0](../content/dev/langchain4j/langchain4j-1.17.0.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-1.16.3.buildspec 1.17.0` |
| <!-- 20260626121732 --> [cucumber-jvm](../content/io/cucumber/cucumber-jvm/README.md) | [7.34.3](../content/io/cucumber/cucumber-jvm/cucumber-jvm-7.34.3.buildspec) :white_check_mark: | [7.34.4](../content/io/cucumber/cucumber-jvm/cucumber-jvm-7.34.4.buildspec) | `bin/add-new-release.sh content/io/cucumber/cucumber-jvm/cucumber-jvm-7.34.3.buildspec 7.34.4` |
| <!-- 20260626115932 --> [messages-ndjson](../content/io/cucumber/messages-ndjson/README.md) | [0.5.1](../content/io/cucumber/messages-ndjson/messages-ndjson-0.5.1.buildspec) :white_check_mark: | 0.3.4  | `bin/add-new-release.sh content/io/cucumber/messages-ndjson/messages-ndjson-0.5.1.buildspec ...` |
| <!-- 20260626115924 --> [scalpel](../content/eu/maveniverse/maven/scalpel/README.md) | [0.3.5](../content/eu/maveniverse/maven/scalpel/scalpel-0.3.5.buildspec) :white_check_mark: | [0.3.7](../content/eu/maveniverse/maven/scalpel/scalpel-0.3.7.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/scalpel/scalpel-0.3.5.buildspec 0.3.7` |
| <!-- 20260626115924 --> [scalpel](../content/eu/maveniverse/maven/scalpel/README.md) | [0.3.5](../content/eu/maveniverse/maven/scalpel/scalpel-0.3.5.buildspec) :white_check_mark: | 0.3.6  | `bin/add-new-release.sh content/eu/maveniverse/maven/scalpel/scalpel-0.3.5.buildspec ...` |
| <!-- 20260625215706 --> [avaje-jex-parent](../content/io/avaje/jex/README.md) | [3.6](../content/io/avaje/jex/avaje-jex-3.6.buildspec) :white_check_mark: | [3.7-RC1](../content/io/avaje/jex/avaje-jex-3.7-RC1.buildspec) | `bin/add-new-release.sh content/io/avaje/jex/avaje-jex-3.6.buildspec 3.7-RC1` |
| <!-- 20260624053128 --> [migratedb](../content/de/unentscheidbar/migratedb/README.md) | [1.5.0](../content/de/unentscheidbar/migratedb/migratedb-1.5.0.buildspec) :white_check_mark: | [1.6.0](../content/de/unentscheidbar/migratedb/migratedb-1.6.0.buildspec) | `bin/add-new-release.sh content/de/unentscheidbar/migratedb/migratedb-1.5.0.buildspec 1.6.0` |
...
| <!-- 20260531044724 --> [:mailbox:](https://lists.apache.org/list?dev@activemq.apache.org:lte=1M:VOTE) | [activemq-parent](../content/org/apache/activemq/README.md) | [6.2.6](../content/org/apache/activemq/activemq-6.2.6.buildspec) :white_check_mark: | [6.2.7](../content/org/apache/activemq/activemq-6.2.7.buildspec)  | `bin/add-new-release.sh content/org/apache/activemq/activemq-6.2.6.buildspec 6.2.7 staging` |
...
| <!-- 20260520021041 --> [:mailbox:](https://lists.apache.org/list?dev@artemis.apache.org:lte=1M:VOTE) | [artemis-project](../content/org/apache/artemis/README.md) | [2.54.0](../content/org/apache/artemis/artemis-2.54.0.buildspec) :white_check_mark: | [2.55.0](../content/org/apache/artemis/artemis-2.55.0.buildspec)  | `bin/add-new-release.sh content/org/apache/artemis/artemis-2.54.0.buildspec 2.55.0 staging` |
| <!-- 20260520021024 --> [:mailbox:](https://lists.apache.org/list?dev@activemq.apache.org:lte=1M:VOTE) | [artemis-pom](../content/org/apache/activemq/artemis/README.md) | [2.54.0](../content/org/apache/activemq/artemis/artemis-2.54.0.buildspec) :white_check_mark: | [2.55.0](../content/org/apache/activemq/artemis/artemis-2.55.0.buildspec)  | `bin/add-new-release.sh content/org/apache/activemq/artemis/artemis-2.54.0.buildspec 2.55.0 staging` |
...
| <!-- 20260510093314 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-parent](../content/org/apache/maven/parent/README.md) | [48](../content/org/apache/maven/parent/maven-parent-48.buildspec) :white_check_mark: | [49](../content/org/apache/maven/parent/maven-parent-49.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/parent/maven-parent-48.buildspec 49 staging` |
| <!-- 20260510093312 --> [:mailbox:](https://lists.apache.org/list?dev@org.apache.apache.org:lte=1M:VOTE) | [apache](../content/org/apache/apache/README.md) | [38](../content/org/apache/apache/apache-38.buildspec) :white_check_mark: | [39](../content/org/apache/apache/apache-39.buildspec)  | `bin/add-new-release.sh content/org/apache/apache/apache-38.buildspec 39 staging` |
...
| <!-- 20260626134538 --> [toolbox](../content/eu/maveniverse/maven/toolbox/README.md) | [0.15.14](../content/eu/maveniverse/maven/toolbox/toolbox-0.15.14.buildspec) :warning: | [0.15.15](../content/eu/maveniverse/maven/toolbox/toolbox-0.15.15.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/toolbox/toolbox-0.15.14.buildspec 0.15.15` |
| <!-- 20260625214537 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.132.0](../content/org/finos/legend/engine/legend-engine-4.132.0.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.132.0` |
