...
| <!-- 20260512152319 --> [scalpel](../content/eu/maveniverse/maven/scalpel/README.md) | [0.3.1](../content/eu/maveniverse/maven/scalpel/scalpel-0.3.1.buildspec) :white_check_mark: | [0.3.3](../content/eu/maveniverse/maven/scalpel/scalpel-0.3.3.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/scalpel/scalpel-0.3.1.buildspec 0.3.3` |
| <!-- 20260512152319 --> [scalpel](../content/eu/maveniverse/maven/scalpel/README.md) | [0.3.1](../content/eu/maveniverse/maven/scalpel/scalpel-0.3.1.buildspec) :white_check_mark: | 0.3.2  | `bin/add-new-release.sh content/eu/maveniverse/maven/scalpel/scalpel-0.3.1.buildspec ...` |
| <!-- 20260512102320 --> [utilities-parent](../content/org/apache/netbeans/utilities/README.md) | [14.4](../content/org/apache/netbeans/utilities/utilities-14.4.buildspec) :white_check_mark: | [14.5](../content/org/apache/netbeans/utilities/utilities-14.5.buildspec) | `bin/add-new-release.sh content/org/apache/netbeans/utilities/utilities-14.4.buildspec 14.5` |
| <!-- 20260511213515 --> [domtrip](../content/eu/maveniverse/maven/domtrip/README.md) | [1.4.0](../content/eu/maveniverse/maven/domtrip/domtrip-1.4.0.buildspec) :white_check_mark: | [1.5.0](../content/eu/maveniverse/maven/domtrip/domtrip-1.5.0.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/domtrip/domtrip-1.4.0.buildspec 1.5.0` |
| <!-- 20260511210925 --> [compatibility-kit](../content/io/cucumber/compatibility-kit/README.md) | [29.1.4](../content/io/cucumber/compatibility-kit/compatibility-kit-29.1.4.buildspec) :white_check_mark: | [29.2.2](../content/io/cucumber/compatibility-kit/compatibility-kit-29.2.2.buildspec) | `bin/add-new-release.sh content/io/cucumber/compatibility-kit/compatibility-kit-29.1.4.buildspec 29.2.2` |
| <!-- 20260511210925 --> [compatibility-kit](../content/io/cucumber/compatibility-kit/README.md) | [29.1.4](../content/io/cucumber/compatibility-kit/compatibility-kit-29.1.4.buildspec) :white_check_mark: | 29.2.1 29.2.0  | `bin/add-new-release.sh content/io/cucumber/compatibility-kit/compatibility-kit-29.1.4.buildspec ...` |
| <!-- 20260511200131 --> [avaje-jsonb-parent](../content/io/avaje/jsonb/README.md) | [3.13](../content/io/avaje/jsonb/avaje-jsonb-3.13.buildspec) :white_check_mark: | [3.14-RC2](../content/io/avaje/jsonb/avaje-jsonb-3.14-RC2.buildspec) | `bin/add-new-release.sh content/io/avaje/jsonb/avaje-jsonb-3.13.buildspec 3.14-RC2` |
| <!-- 20260511200131 --> [avaje-jsonb-parent](../content/io/avaje/jsonb/README.md) | [3.13](../content/io/avaje/jsonb/avaje-jsonb-3.13.buildspec) :white_check_mark: | 3.14-RC1  | `bin/add-new-release.sh content/io/avaje/jsonb/avaje-jsonb-3.13.buildspec ...` |
| <!-- 20260511182731 --> [plexus-classworlds](../content/org/codehaus/plexus/plexus-classworlds/README.md) | [2.10.0](../content/org/codehaus/plexus/plexus-classworlds/plexus-classworlds-2.10.0.buildspec) :white_check_mark: | [2.11.0](../content/org/codehaus/plexus/plexus-classworlds/plexus-classworlds-2.11.0.buildspec) | `bin/add-new-release.sh content/org/codehaus/plexus/plexus-classworlds/plexus-classworlds-2.10.0.buildspec 2.11.0` |
...
| <!-- 20260511155231 --> [liftwizard](../content/io/liftwizard/README.md) | [2.1.44](../content/io/liftwizard/liftwizard-2.1.44.buildspec) :white_check_mark: | [2.1.45](../content/io/liftwizard/liftwizard-2.1.45.buildspec) | `bin/add-new-release.sh content/io/liftwizard/liftwizard-2.1.44.buildspec 2.1.45` |
| <!-- 20260511124522 --> [jena](../content/org/apache/jena/jena/README.md) | [6.0.0](../content/org/apache/jena/jena/jena-6.0.0.buildspec) :white_check_mark: | [6.1.0](../content/org/apache/jena/jena/jena-6.1.0.buildspec) | `bin/add-new-release.sh content/org/apache/jena/jena/jena-6.0.0.buildspec 6.1.0` |
| <!-- 20260511123321 --> [oras-java-sdk](../content/land/oras/oras-java-sdk/README.md) | [0.6.0](../content/land/oras/oras-java-sdk/oras-java-sdk-0.6.0.buildspec) :white_check_mark: | [0.6.1](../content/land/oras/oras-java-sdk/oras-java-sdk-0.6.1.buildspec) | `bin/add-new-release.sh content/land/oras/oras-java-sdk/oras-java-sdk-0.6.0.buildspec 0.6.1` |
| <!-- 20260511104236 --> [hibernate-search-bom](../content/org/hibernate/search/hibernate-search-bom/README.md) | [8.3.1.Final](../content/org/hibernate/search/hibernate-search-bom/hibernate-search-parent-8.3.1.Final.buildspec) :white_check_mark: | [8.4.0.CR1](../content/org/hibernate/search/hibernate-search-bom/hibernate-search-parent-8.4.0.CR1.buildspec) | `bin/add-new-release.sh content/org/hibernate/search/hibernate-search-bom/hibernate-search-parent-8.3.1.Final.buildspec 8.4.0.CR1` |
...
| <!-- 20260508204929 --> [avaje-inject-parent](../content/io/avaje/inject/README.md) | [12.6-RC2](../content/io/avaje/inject/avaje-inject-12.6-RC2.buildspec) :white_check_mark: | 12.5  | `bin/add-new-release.sh content/io/avaje/inject/avaje-inject-12.6-RC2.buildspec ...` |
...
| <!-- 20260408144904 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-configuration2](../content/org/apache/commons/configuration2/README.md) | [2.14.0](../content/org/apache/commons/configuration2/commons-configuration2-2.14.0.buildspec) :white_check_mark: | [2.15.0](../content/org/apache/commons/configuration2/commons-configuration2-2.15.0.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/configuration2/commons-configuration2-2.14.0.buildspec 2.15.0 staging` |
...
| <!-- 20260511222516 --> [jooby](../content/io/jooby/README.md) | [4.2.0](../content/io/jooby/jooby-4.2.0.buildspec) :warning: | [4.5.0](../content/io/jooby/jooby-4.5.0.buildspec) | `bin/add-new-release.sh content/io/jooby/jooby-4.2.0.buildspec 4.5.0` |
...
| <!-- 20260507142914 --> [openfasttrace](../content/org/itsallcode/openfasttrace/README.md) | [4.2.1](../content/org/itsallcode/openfasttrace/openfasttrace-4.2.1.buildspec) :warning: | [4.3.0](../content/org/itsallcode/openfasttrace/openfasttrace-4.3.0.buildspec) | `bin/add-new-release.sh content/org/itsallcode/openfasttrace/openfasttrace-4.2.1.buildspec 4.3.0` |
| <!-- 20260507030139 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.129.1](../content/org/finos/legend/engine/legend-engine-4.129.1.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.129.1` |
...
| <!-- 20260504145453 --> [quarkus-project](../content/io/quarkus/README.md) | 3.35.2 :warning: |
