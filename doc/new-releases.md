...
| ---------- | ---- | -- | ------- |
| <!-- 20260307205120 --> [github-desktop](../content/com/github/hazendaz/git/github-desktop/README.md) | [3.5.4](../content/com/github/hazendaz/git/github-desktop/github-desktop-3.5.4.buildspec) :white_check_mark: | [3.5.5](../content/com/github/hazendaz/git/github-desktop/github-desktop-3.5.5.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/git/github-desktop/github-desktop-3.5.4.buildspec 3.5.5` |
| <!-- 20260307163522 --> [fusion](../content/io/yupiik/fusion/README.md) | [1.0.33](../content/io/yupiik/fusion/fusion-1.0.33.buildspec) :white_check_mark: | [1.0.34](../content/io/yupiik/fusion/fusion-1.0.34.buildspec) | `bin/add-new-release.sh content/io/yupiik/fusion/fusion-1.0.33.buildspec 1.0.34` |
| <!-- 20260306231246 --> [hibernate-models](../content/org/hibernate/models/hibernate-models/README.md) | [1.0.1](../content/org/hibernate/models/hibernate-models/hibernate-models-1.0.1.buildspec) :white_check_mark: | [1.1.0](../content/org/hibernate/models/hibernate-models/hibernate-models-1.1.0.buildspec) | `bin/add-new-release.sh content/org/hibernate/models/hibernate-models/hibernate-models-1.0.1.buildspec 1.1.0` |
| <!-- 20260306213547 --> [opentelemetry-sdk](../content/io/opentelemetry/java/README.md) | [1.59.0](../content/io/opentelemetry/java/opentelemetry-sdk-1.59.0.buildspec) :white_check_mark: | [1.60.0](../content/io/opentelemetry/java/opentelemetry-sdk-1.60.0.buildspec) | `bin/add-new-release.sh content/io/opentelemetry/java/opentelemetry-sdk-1.59.0.buildspec 1.60.0` |
| <!-- 20260304231613 --> [jetty-project](../content/org/eclipse/jetty/jetty-project/README.md) | [12.1.7](../content/org/eclipse/jetty/jetty-project/jetty-project-12.1.7.buildspec) :white_check_mark: | 12.0.33  | `bin/add-new-release.sh content/org/eclipse/jetty/jetty-project/jetty-project-12.1.7.buildspec ...` |
