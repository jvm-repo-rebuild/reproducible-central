...
| ---------- | ---- | -- | ------- |
| <!-- 20260131184912 --> [semanticcms-parent](../content/com/semanticcms/semanticcms-parent/README.md) | [1.20.3](../content/com/semanticcms/semanticcms-parent/semanticcms-parent-1.20.3.buildspec) :white_check_mark: | [2.0.0](../content/com/semanticcms/semanticcms-parent/semanticcms-parent-2.0.0.buildspec) | `bin/add-new-release.sh content/com/semanticcms/semanticcms-parent/semanticcms-parent-1.20.3.buildspec 2.0.0` |
| <!-- 20260131184912 --> [semanticcms-parent](../content/com/semanticcms/semanticcms-parent/README.md) | [1.20.3](../content/com/semanticcms/semanticcms-parent/semanticcms-parent-1.20.3.buildspec) :white_check_mark: | 1.21.0  | `bin/add-new-release.sh content/com/semanticcms/semanticcms-parent/semanticcms-parent-1.20.3.buildspec ...` |
| <!-- 20260131131936 --> [commons-release-plugin](../content/org/apache/commons/commons-release-plugin/README.md) | [1.9.1](../content/org/apache/commons/commons-release-plugin/commons-release-plugin-1.9.1.buildspec) :white_check_mark: | [1.9.2](../content/org/apache/commons/commons-release-plugin/commons-release-plugin-1.9.2.buildspec) | `bin/add-new-release.sh content/org/apache/commons/commons-release-plugin/commons-release-plugin-1.9.1.buildspec 1.9.2` |
| <!-- 20260131131915 --> [commons-build-plugin](../content/org/apache/commons/commons-build-plugin/README.md) | [1.16.0](../content/org/apache/commons/commons-build-plugin/commons-build-plugin-1.16.0.buildspec) :white_check_mark: | [1.16.1](../content/org/apache/commons/commons-build-plugin/commons-build-plugin-1.16.1.buildspec) | `bin/add-new-release.sh content/org/apache/commons/commons-build-plugin/commons-build-plugin-1.16.0.buildspec 1.16.1` |
| <!-- 20260131030117 --> [pretty-formatter](../content/io/cucumber/pretty-formatter/README.md) | [2.4.1](../content/io/cucumber/pretty-formatter/pretty-formatter-2.4.1.buildspec) :white_check_mark: | [3.0.0](../content/io/cucumber/pretty-formatter/pretty-formatter-3.0.0.buildspec) | `bin/add-new-release.sh content/io/cucumber/pretty-formatter/pretty-formatter-2.4.1.buildspec 3.0.0` |
| <!-- 20260131000350 --> [airbase](../content/io/airlift/airbase/README.md) | [346](../content/io/airlift/airbase/airbase-346.buildspec) :white_check_mark: | [347](../content/io/airlift/airbase/airbase-347.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-346.buildspec 347` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260131143729 --> [avaje-jex-parent](../content/io/avaje/jex/README.md) | [3.4](../content/io/avaje/jex/avaje-jex-3.4.buildspec) :x: | [3.5-RC1](../content/io/avaje/jex/avaje-jex-3.5-RC1.buildspec) | `bin/add-new-release.sh content/io/avaje/jex/avaje-jex-3.4.buildspec 3.5-RC1` |
| <!-- 20260131133916 --> [jpmml-model](../content/org/jpmml/jpmml-model/README.md) | [1.7.6](../content/org/jpmml/jpmml-model/jpmml-model-1.7.6.buildspec) :warning: [:memo:](https://github.com/jpmml/jpmml-model/issues/42) | [1.7.7](../content/org/jpmml/jpmml-model/jpmml-model-1.7.7.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-model/jpmml-model-1.7.6.buildspec 1.7.7` |
