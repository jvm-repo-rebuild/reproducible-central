...
| ---------- | ---- | -- | ------- |
| <!-- 20260806182714 --> [aru-parent](../content/io/github/cbarlin/aru/README.md) | [0.10.1](../content/io/github/cbarlin/aru/aru-0.10.1.buildspec) :white_check_mark: | [0.11.1](../content/io/github/cbarlin/aru/aru-0.11.1.buildspec) | `bin/add-new-release.sh content/io/github/cbarlin/aru/aru-0.10.1.buildspec 0.11.1` |
| <!-- 20260806182714 --> [aru-parent](../content/io/github/cbarlin/aru/README.md) | [0.10.1](../content/io/github/cbarlin/aru/aru-0.10.1.buildspec) :white_check_mark: | 0.11.0  | `bin/add-new-release.sh content/io/github/cbarlin/aru/aru-0.10.1.buildspec ...` |
| <!-- 20260806144025 --> [airbase](../content/io/airlift/airbase/README.md) | [399](../content/io/airlift/airbase/airbase-399.buildspec) :white_check_mark: | [400](../content/io/airlift/airbase/airbase-400.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-399.buildspec 400` |
| <!-- 20260806112307 --> [jackrabbit-parent](../content/org/apache/jackrabbit/jackrabbit/README.md) | [2.23.5-beta](../content/org/apache/jackrabbit/jackrabbit/jackrabbit-2.23.5-beta.buildspec) :white_check_mark: | 2.22.4  | `bin/add-new-release.sh content/org/apache/jackrabbit/jackrabbit/jackrabbit-2.23.5-beta.buildspec ...` |
| <!-- 20260805205732 --> [compatibility-kit](../content/io/cucumber/compatibility-kit/README.md) | [29.2.2](../content/io/cucumber/compatibility-kit/compatibility-kit-29.2.2.buildspec) :white_check_mark: | [30.0.0](../content/io/cucumber/compatibility-kit/compatibility-kit-30.0.0.buildspec) | `bin/add-new-release.sh content/io/cucumber/compatibility-kit/compatibility-kit-29.2.2.buildspec 30.0.0` |
| <!-- 20260805204931 --> [ci-environment](../content/io/cucumber/ci-environment/README.md) | [14.0.0](../content/io/cucumber/ci-environment/ci-environment-14.0.0.buildspec) :white_check_mark: | [15.0.0](../content/io/cucumber/ci-environment/ci-environment-15.0.0.buildspec) | `bin/add-new-release.sh content/io/cucumber/ci-environment/ci-environment-14.0.0.buildspec 15.0.0` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20260727155308 --> [:mailbox:](https://lists.apache.org/list?dev@activemq.apache.org:lte=1M:VOTE) | [activemq-parent](../content/org/apache/activemq/README.md) | [6.3.0](../content/org/apache/activemq/activemq-6.3.0.buildspec) :warning: | [6.3.1](../content/org/apache/activemq/activemq-6.3.1.buildspec)  | `bin/add-new-release.sh content/org/apache/activemq/activemq-6.3.0.buildspec 6.3.1 staging` |
...
| <!-- 20260806084126 --> [lz4-java](../content/at/yawk/lz4/lz4-java/README.md) | [1.11.1](../content/at/yawk/lz4/lz4-java/lz4-java-1.11.1.buildspec) :warning: | [1.11.2](../content/at/yawk/lz4/lz4-java/lz4-java-1.11.2.buildspec) | `bin/add-new-release.sh content/at/yawk/lz4/lz4-java/lz4-java-1.11.1.buildspec 1.11.2` |
| <!-- 20260805210519 --> [toolbox](../content/eu/maveniverse/maven/toolbox/README.md) | [0.15.15](../content/eu/maveniverse/maven/toolbox/toolbox-0.15.15.buildspec) :warning: | [0.15.16](../content/eu/maveniverse/maven/toolbox/toolbox-0.15.16.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/toolbox/toolbox-0.15.15.buildspec 0.15.16` |
