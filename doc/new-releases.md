...
| ---------- | ---- | -- | ------- |
| <!-- 20260729184322 --> [jooby](../content/io/jooby/README.md) | [4.5.3](../content/io/jooby/jooby-4.5.3.buildspec) :white_check_mark: | [4.5.4](../content/io/jooby/jooby-4.5.4.buildspec) | `bin/add-new-release.sh content/io/jooby/jooby-4.5.3.buildspec 4.5.4` |
| <!-- 20260729184322 --> [jooby](../content/io/jooby/README.md) | [4.5.3](../content/io/jooby/jooby-4.5.3.buildspec) :white_check_mark: | 3.11.10  | `bin/add-new-release.sh content/io/jooby/jooby-4.5.3.buildspec ...` |
| <!-- 20260729163506 --> [langchain4j](../content/dev/langchain4j/README.md) | [1.18.0](../content/dev/langchain4j/langchain4j-1.18.0.buildspec) :white_check_mark: | [1.18.1](../content/dev/langchain4j/langchain4j-1.18.1.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-1.18.0.buildspec 1.18.1` |
| <!-- 20260729163506 --> [langchain4j](../content/dev/langchain4j/README.md) | [1.18.0](../content/dev/langchain4j/langchain4j-1.18.0.buildspec) :white_check_mark: | 1.11.10 1.11.9 1.5.3  | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-1.18.0.buildspec ...` |
| <!-- 20260729122926 --> [oras-java-sdk](../content/land/oras/oras-java-sdk/README.md) | [0.8.1](../content/land/oras/oras-java-sdk/oras-java-sdk-0.8.1.buildspec) :white_check_mark: | [0.8.2](../content/land/oras/oras-java-sdk/oras-java-sdk-0.8.2.buildspec) | `bin/add-new-release.sh content/land/oras/oras-java-sdk/oras-java-sdk-0.8.1.buildspec 0.8.2` |
| <!-- 20260729033917 --> [dbunit](../content/org/dbunit/README.md) | [3.3.0](../content/org/dbunit/dbunit-3.3.0.buildspec) :white_check_mark: | [3.4.0](../content/org/dbunit/dbunit-3.4.0.buildspec) | `bin/add-new-release.sh content/org/dbunit/dbunit-3.3.0.buildspec 3.4.0` |
| <!-- 20260729023117 --> [rockcraft-parent](../content/io/github/rockcrafters/plugins/README.md) | [1.2.5](../content/io/github/rockcrafters/plugins/rockcraft-parent-1.2.5.buildspec) :white_check_mark: | [1.2.6](../content/io/github/rockcrafters/plugins/rockcraft-parent-1.2.6.buildspec) | `bin/add-new-release.sh content/io/github/rockcrafters/plugins/rockcraft-parent-1.2.5.buildspec 1.2.6` |
| <!-- 20260728161542 --> [maven-lockfile](../content/io/github/chains-project/maven-lockfile/README.md) | [5.17.3](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.17.3.buildspec) :white_check_mark: | 5.17.2  | `bin/add-new-release.sh content/io/github/chains-project/maven-lockfile/maven-lockfile-5.17.3.buildspec ...` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20260713085950 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven](../content/org/apache/maven/maven/README.md) | [4.0.0-rc-5](../content/org/apache/maven/maven/maven-4.0.0-rc-5.buildspec) :white_check_mark: | [4.0.0-rc-6](../content/org/apache/maven/maven/maven-4.0.0-rc-6.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/maven/maven-4.0.0-rc-5.buildspec 4.0.0-rc-6 staging` |
| <!-- 20260526092933 --> [:mailbox:](https://lists.apache.org/list?dev@stormcrawler.apache.org:lte=1M:VOTE) | [stormcrawler](../content/org/apache/stormcrawler/README.md) | [3.6.0](../content/org/apache/stormcrawler/stormcrawler-3.6.0.buildspec) :white_check_mark: | [3.7.0](../content/org/apache/stormcrawler/stormcrawler-3.7.0.buildspec)  | `bin/add-new-release.sh content/org/apache/stormcrawler/stormcrawler-3.6.0.buildspec 3.7.0 staging` |
| <!-- 20260511124522 --> [:mailbox:](https://lists.apache.org/list?dev@jena.apache.org:lte=1M:VOTE) | [jena](../content/org/apache/jena/jena/README.md) | [6.1.0](../content/org/apache/jena/jena/jena-6.1.0.buildspec) :white_check_mark: | [6.2.0](../content/org/apache/jena/jena/jena-6.2.0.buildspec)  | `bin/add-new-release.sh content/org/apache/jena/jena/jena-6.1.0.buildspec 6.2.0 staging` |
...
| <!-- 20260228122655 --> [:mailbox:](https://lists.apache.org/list?dev@sling.apache.org:lte=1M:VOTE) | [org.apache.sling.servlets.resolver](../content/org/apache/sling/org.apache.sling.servlets.resolver/README.md) | [3.0.6](../content/org/apache/sling/org.apache.sling.servlets.resolver/org.apache.sling.servlets.resolver-3.0.6.buildspec) :white_check_mark: | [3.0.8](../content/org/apache/sling/org.apache.sling.servlets.resolver/org.apache.sling.servlets.resolver-3.0.8.buildspec)  | `bin/add-new-release.sh content/org/apache/sling/org.apache.sling.servlets.resolver/org.apache.sling.servlets.resolver-3.0.6.buildspec 3.0.8 staging` |
| <!-- 20260227085526 --> [:mailbox:](https://lists.apache.org/list?dev@felix.apache.org:lte=1M:VOTE) | [maven-bundle-plugin](../content/org/apache/felix/maven-bundle-plugin/README.md) | [6.0.2](../content/org/apache/felix/maven-bundle-plugin/maven-bundle-plugin-6.0.2.buildspec) :white_check_mark: | [6.1.0](../content/org/apache/felix/maven-bundle-plugin/maven-bundle-plugin-6.1.0.buildspec)  | `bin/add-new-release.sh content/org/apache/felix/maven-bundle-plugin/maven-bundle-plugin-6.0.2.buildspec 6.1.0 staging` |
...
| <!-- 20250414190503 --> [:mailbox:](https://lists.apache.org/list?dev@plc4x.apache.org:lte=1M:VOTE) | [plc4x-code-generation](../content/org/apache/plc4x/plc4x-code-generation/README.md) | [1.8.0](../content/org/apache/plc4x/plc4x-code-generation/plc4x-code-generation-1.8.0.buildspec) :white_check_mark: | [1.9.0](../content/org/apache/plc4x/plc4x-code-generation/plc4x-code-generation-1.9.0.buildspec)  | `bin/add-new-release.sh content/org/apache/plc4x/plc4x-code-generation/plc4x-code-generation-1.8.0.buildspec 1.9.0 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260729174930 --> [winrm-java](../content/org/metricshub/winrm-java/README.md) | [1.1.02](../content/org/metricshub/winrm-java/winrm-java-1.1.02.buildspec) :warning: | [2.0.00](../content/org/metricshub/winrm-java/winrm-java-2.0.00.buildspec) | `bin/add-new-release.sh content/org/metricshub/winrm-java/winrm-java-1.1.02.buildspec 2.0.00` |
| <!-- 20260729120413 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.137.0](../content/org/finos/legend/engine/legend-engine-4.137.0.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.137.0` |
