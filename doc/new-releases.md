...
| ---------- | ---- | -- | ------- |
| <!-- 20260405131522 --> [com.io7m.primogenitor](../content/com/io7m/primogenitor/README.md) | [9.1.0](../content/com/io7m/primogenitor/com.io7m.primogenitor-9.1.0.buildspec) :white_check_mark: | [9.2.0](../content/com/io7m/primogenitor/com.io7m.primogenitor-9.2.0.buildspec) | `bin/add-new-release.sh content/com/io7m/primogenitor/com.io7m.primogenitor-9.1.0.buildspec 9.2.0` |
| <!-- 20260405013317 --> [maven-lockfile](../content/io/github/chains-project/maven-lockfile/README.md) | [5.15.0](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.15.0.buildspec) :white_check_mark: | [5.15.1-beta-1](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.15.1-beta-1.buildspec) | `bin/add-new-release.sh content/io/github/chains-project/maven-lockfile/maven-lockfile-5.15.0.buildspec 5.15.1-beta-1` |
| <!-- 20260405011916 --> [hibernate-reactive-core](../content/org/hibernate/reactive/hibernate-reactive/README.md) | [4.3.0.Final](../content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.3.0.Final.buildspec) :white_check_mark: | 4.2.10.Final 4.1.14.Final 3.3.2.Final 3.2.10.Final 3.1.16.Final  | `bin/add-new-release.sh content/org/hibernate/reactive/hibernate-reactive/hibernate-reactive-4.3.0.Final.buildspec ...` |
| <!-- 20260405002851 --> [hibernate-core](../content/org/hibernate/orm/hibernate-core/README.md) | [8.0.0.Alpha1](../content/org/hibernate/orm/hibernate-core/hibernate-core-8.0.0.Alpha1.buildspec) :white_check_mark: | 7.2.10.Final 7.1.22.Final  | `bin/add-new-release.sh content/org/hibernate/orm/hibernate-core/hibernate-core-8.0.0.Alpha1.buildspec ...` |
| <!-- 20260404181512 --> [plexus-classworlds](../content/org/codehaus/plexus/plexus-classworlds/README.md) | [2.9.0](../content/org/codehaus/plexus/plexus-classworlds/plexus-classworlds-2.9.0.buildspec) :white_check_mark: | [2.10.0](../content/org/codehaus/plexus/plexus-classworlds/plexus-classworlds-2.10.0.buildspec) | `bin/add-new-release.sh content/org/codehaus/plexus/plexus-classworlds/plexus-classworlds-2.9.0.buildspec 2.10.0` |
| <!-- 20260402015311 --> [jetty-project](../content/org/eclipse/jetty/jetty-project/README.md) | [12.1.8](../content/org/eclipse/jetty/jetty-project/jetty-project-12.1.8.buildspec) :white_check_mark: | 12.0.34  | `bin/add-new-release.sh content/org/eclipse/jetty/jetty-project/jetty-project-12.1.8.buildspec ...` |
| <!-- 20260401100918 --> [openapi-jaxrs-client](../content/dk/mada/jaxrs/openapi-jaxrs-client/README.md) | [0.12.7](../content/dk/mada/jaxrs/openapi-jaxrs-client/openapi-jaxrs-client-0.12.7.buildspec) :white_check_mark: | [0.13.0](../content/dk/mada/jaxrs/openapi-jaxrs-client/openapi-jaxrs-client-0.13.0.buildspec) | `bin/add-new-release.sh content/dk/mada/jaxrs/openapi-jaxrs-client/openapi-jaxrs-client-0.12.7.buildspec 0.13.0` |
| <!-- 20260331204322 --> [langchain4j](../content/dev/langchain4j/README.md) | [1.12.2](../content/dev/langchain4j/langchain4j-1.12.2.buildspec) :white_check_mark: | 1.11.6 1.11.5 1.11.4  | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-1.12.2.buildspec ...` |
| <!-- 20260331073819 --> [activemq-parent](../content/org/apache/activemq/README.md) | [6.2.3](../content/org/apache/activemq/activemq-6.2.3.buildspec) :white_check_mark: | 5.19.4  | `bin/add-new-release.sh content/org/apache/activemq/activemq-6.2.3.buildspec ...` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20260309120717 --> [:mailbox:](https://lists.apache.org/list?dev@nifi.apache.org:lte=1M:VOTE) | [nifi-api](../content/org/apache/nifi/nifi-api/README.md) | [2.7.0](../content/org/apache/nifi/nifi-api/nifi-api-2.7.0.buildspec) :white_check_mark: | [2.8.0](../content/org/apache/nifi/nifi-api/nifi-api-2.8.0.buildspec)  | `bin/add-new-release.sh content/org/apache/nifi/nifi-api/nifi-api-2.7.0.buildspec 2.8.0 staging` |
| <!-- 20260226130231 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-parent](../content/org/apache/commons/parent/README.md) | [97](../content/org/apache/commons/parent/commons-parent-97.buildspec) :white_check_mark: | [98](../content/org/apache/commons/parent/commons-parent-98.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/parent/commons-parent-97.buildspec 98 staging` |
...
| <!-- 20251126122443 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-configuration2](../content/org/apache/commons/configuration2/README.md) | [2.13.0](../content/org/apache/commons/configuration2/commons-configuration2-2.13.0.buildspec) :white_check_mark: | [2.14.0](../content/org/apache/commons/configuration2/commons-configuration2-2.14.0.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/configuration2/commons-configuration2-2.13.0.buildspec 2.14.0 staging` |
...
| <!-- 20241009181519 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [doxia-sitetools](../content/org/apache/maven/doxia/doxia-sitetools/README.md) | [2.0.0](../content/org/apache/maven/doxia/doxia-sitetools/doxia-sitetools-2.0.0.buildspec) :white_check_mark: | [2.1.0](../content/org/apache/maven/doxia/doxia-sitetools/doxia-sitetools-2.1.0.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/doxia/doxia-sitetools/doxia-sitetools-2.0.0.buildspec 2.1.0 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260405080611 --> [jpmml-sklearn](../content/org/jpmml/jpmml-sklearn/README.md) | [1.9.33](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.33.buildspec) :warning: | [1.9.36](../content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.36.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-sklearn/jpmml-sklearn-1.9.33.buildspec 1.9.36` |
| <!-- 20260404032907 --> [ratis](../content/org/apache/ratis/README.md) | [3.2.1](../content/org/apache/ratis/ratis-3.2.1.buildspec) :warning: | [3.2.2](../content/org/apache/ratis/ratis-3.2.2.buildspec) | `bin/add-new-release.sh content/org/apache/ratis/ratis-3.2.1.buildspec 3.2.2` |
| <!-- 20260403120336 --> [syncope](../content/org/apache/syncope/README.md) | [4.1.0-M0](../content/org/apache/syncope/syncope-4.1.0-M0.buildspec) :warning: | [4.1.0](../content/org/apache/syncope/syncope-4.1.0.buildspec) | `bin/add-new-release.sh content/org/apache/syncope/syncope-4.1.0-M0.buildspec 4.1.0` |
...
| <!-- 20260402202743 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.124.5](../content/org/finos/legend/engine/legend-engine-4.124.5.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.124.5` |
| <!-- 20260402112712 --> [jline](../content/org/jline/README.md) | [4.0.0](../content/org/jline/jline-4.0.0.buildspec) :warning: | [4.0.10](../content/org/jline/jline-4.0.10.buildspec) | `bin/add-new-release.sh content/org/jline/jline-4.0.0.buildspec 4.0.10` |
...
| <!-- 20260331230730 --> [byte-buddy-parent](../content/net/bytebuddy/README.md) | [1.18.7](../content/net/bytebuddy/byte-buddy-1.18.7.buildspec) :warning: | [1.18.8-jdk5](../content/net/bytebuddy/byte-buddy-1.18.8-jdk5.buildspec) | `bin/add-new-release.sh content/net/bytebuddy/byte-buddy-1.18.7.buildspec 1.18.8-jdk5` |
| <!-- 20260331210846 --> [pulsar](../content/org/apache/pulsar/README.md) | [4.1.3](../content/org/apache/pulsar/pulsar-4.1.3.buildspec) :warning: [:memo:](https://github.com/apache/pulsar/issues/24718) | [4.2.0](../content/org/apache/pulsar/pulsar-4.2.0.buildspec) | `bin/add-new-release.sh content/org/apache/pulsar/pulsar-4.1.3.buildspec 4.2.0` |
...
| <!-- 20260401183946 --> [quarkus-project](../content/io/quarkus/README.md) | 3.34.2 :warning: |
| <!-- 20260331200850 --> [toolbox](../content/eu/maveniverse/maven/toolbox/README.md) | 0.15.7 :warning: |
| <!-- 20260331145005 --> [jooby](../content/io/jooby/README.md) | 4.2.0 :warning: |
