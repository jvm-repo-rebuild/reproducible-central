...
| ---------- | ---- | -- | ------- |
| <!-- 20260829010400 --> [mug-root](../content/com/google/mug/README.md) | [10.8.1](../content/com/google/mug/mug-10.8.1.buildspec) :white_check_mark: | [10.9](../content/com/google/mug/mug-10.9.buildspec) | `bin/add-new-release.sh content/com/google/mug/mug-10.8.1.buildspec 10.9` |
| <!-- 20260828203357 --> [metrics-parent](../content/io/dropwizard/metrics5/README.md) | [5.0.7](../content/io/dropwizard/metrics5/dropwizard-metrics-5.0.7.buildspec) :white_check_mark: | [5.0.8](../content/io/dropwizard/metrics5/dropwizard-metrics-5.0.8.buildspec) | `bin/add-new-release.sh content/io/dropwizard/metrics5/dropwizard-metrics-5.0.7.buildspec 5.0.8` |
| <!-- 20260828203246 --> [metrics-parent](../content/io/dropwizard/metrics/README.md) | [4.2.39](../content/io/dropwizard/metrics/dropwizard-metrics-4.2.39.buildspec) :white_check_mark: | [4.2.40](../content/io/dropwizard/metrics/dropwizard-metrics-4.2.40.buildspec) | `bin/add-new-release.sh content/io/dropwizard/metrics/dropwizard-metrics-4.2.39.buildspec 4.2.40` |
| <!-- 20260828165935 --> [toolrunner](../content/eu/maveniverse/maven/toolrunner/README.md) | [0.4.1](../content/eu/maveniverse/maven/toolrunner/toolrunner-0.4.1.buildspec) :white_check_mark: | [0.4.2](../content/eu/maveniverse/maven/toolrunner/toolrunner-0.4.2.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/toolrunner/toolrunner-0.4.1.buildspec 0.4.2` |
| <!-- 20260828124041 --> [pmd](../content/net/sourceforge/pmd/README.md) | [7.26.0](../content/net/sourceforge/pmd/pmd-7.26.0.buildspec) :white_check_mark: | [7.27.0](../content/net/sourceforge/pmd/pmd-7.27.0.buildspec) | `bin/add-new-release.sh content/net/sourceforge/pmd/pmd-7.26.0.buildspec 7.27.0` |
| <!-- 20260828102745 --> [nisse](../content/eu/maveniverse/maven/nisse/README.md) | [0.9.9](../content/eu/maveniverse/maven/nisse/nisse-0.9.9.buildspec) :white_check_mark: | [0.9.10](../content/eu/maveniverse/maven/nisse/nisse-0.9.10.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/nisse/nisse-0.9.9.buildspec 0.9.10` |
| <!-- 20260828071929 --> [sdk-parent](../content/com/sap/ai/sdk/README.md) | [1.23.0](../content/com/sap/ai/sdk/sdk-1.23.0.buildspec) :white_check_mark: | [1.24.0](../content/com/sap/ai/sdk/sdk-1.24.0.buildspec) | `bin/add-new-release.sh content/com/sap/ai/sdk/sdk-1.23.0.buildspec 1.24.0` |
| <!-- 20260828045137 --> [nifi-api](../content/org/apache/nifi/nifi-api/README.md) | [2.10.0](../content/org/apache/nifi/nifi-api/nifi-api-2.10.0.buildspec) :white_check_mark: | [2.11.0](../content/org/apache/nifi/nifi-api/nifi-api-2.11.0.buildspec) | `bin/add-new-release.sh content/org/apache/nifi/nifi-api/nifi-api-2.10.0.buildspec 2.11.0` |
| <!-- 20260828031117 --> [avaje-jsonb-parent](../content/io/avaje/jsonb/README.md) | [3.15-RC5](../content/io/avaje/jsonb/avaje-jsonb-3.15-RC5.buildspec) :white_check_mark: | [3.15](../content/io/avaje/jsonb/avaje-jsonb-3.15.buildspec) | `bin/add-new-release.sh content/io/avaje/jsonb/avaje-jsonb-3.15-RC5.buildspec 3.15` |
| <!-- 20260827181319 --> [rainbowgum-maven-parent](../content/io/jstach/rainbowgum/README.md) | [0.9.0](../content/io/jstach/rainbowgum/rainbowgum-0.9.0.buildspec) :white_check_mark: | [0.10.0](../content/io/jstach/rainbowgum/rainbowgum-0.10.0.buildspec) | `bin/add-new-release.sh content/io/jstach/rainbowgum/rainbowgum-0.9.0.buildspec 0.10.0` |
...
| <!-- 20260826104731 --> [cui-parent-pom](../content/de/cuioss/cui-parent-pom/README.md) | [1.5.9](../content/de/cuioss/cui-parent-pom/cui-parent-pom-1.5.9.buildspec) :white_check_mark: | 1.5.8  | `bin/add-new-release.sh content/de/cuioss/cui-parent-pom/cui-parent-pom-1.5.9.buildspec ...` |
...
| <!-- 20260726201147 --> [:mailbox:](https://lists.apache.org/list?dev@wicket.apache.org:lte=1M:VOTE) | [wicket-parent](../content/org/apache/wicket/README.md) | [10.10.0](../content/org/apache/wicket/wicket-parent-10.10.0.buildspec) :white_check_mark: | [10.11.0](../content/org/apache/wicket/wicket-parent-10.11.0.buildspec)  | `bin/add-new-release.sh content/org/apache/wicket/wicket-parent-10.10.0.buildspec 10.11.0 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260827230420 --> [avaje-http-parent](../content/io/avaje/http/README.md) | [3.11](../content/io/avaje/http/avaje-http-3.11.buildspec) :warning: | [3.12-RC1](../content/io/avaje/http/avaje-http-3.12-RC1.buildspec) | `bin/add-new-release.sh content/io/avaje/http/avaje-http-3.11.buildspec 3.12-RC1` |
...
| <!-- 20260826121010 --> [quarkus-project](../content/io/quarkus/README.md) | [3.39.0](../content/io/quarkus/quarkus-3.39.0.buildspec) :warning: | [3.39.1](../content/io/quarkus/quarkus-3.39.1.buildspec) | `bin/add-new-release.sh content/io/quarkus/quarkus-3.39.0.buildspec 3.39.1` |
| <!-- 20260826023519 --> [avaje-metrics-parent](../content/io/avaje/metrics/README.md) | [10.4-RC5](../content/io/avaje/metrics/avaje-metrics-10.4-RC5.buildspec) :warning: | [10.4-RC6](../content/io/avaje/metrics/avaje-metrics-10.4-RC6.buildspec) | `bin/add-new-release.sh content/io/avaje/metrics/avaje-metrics-10.4-RC5.buildspec 10.4-RC6` |
