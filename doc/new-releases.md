...
| ---------- | ---- | -- | ------- |
| <!-- 20260818140539 --> [avaje-jsonb-parent](../content/io/avaje/jsonb/README.md) | [3.15-RC4](../content/io/avaje/jsonb/avaje-jsonb-3.15-RC4.buildspec) :white_check_mark: | [3.15-RC5](../content/io/avaje/jsonb/avaje-jsonb-3.15-RC5.buildspec) | `bin/add-new-release.sh content/io/avaje/jsonb/avaje-jsonb-3.15-RC4.buildspec 3.15-RC5` |
| <!-- 20260818100949 --> [bnd-plugin-parent](../content/biz/aQute/bnd/plugins/README.md) | [7.3.0](../content/biz/aQute/bnd/plugins/bnd-plugins-7.3.0.buildspec) :white_check_mark: | [7.4.0](../content/biz/aQute/bnd/plugins/bnd-plugins-7.4.0.buildspec) | `bin/add-new-release.sh content/biz/aQute/bnd/plugins/bnd-plugins-7.3.0.buildspec 7.4.0` |
| <!-- 20260818082332 --> [langchain4j-cdi-parent](../content/dev/langchain4j/cdi/README.md) | [1.3.4](../content/dev/langchain4j/cdi/langchain4j-cdi-1.3.4.buildspec) :white_check_mark: | [1.4.0](../content/dev/langchain4j/cdi/langchain4j-cdi-1.4.0.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/cdi/langchain4j-cdi-1.3.4.buildspec 1.4.0` |
| <!-- 20260818081946 --> [avaje-http-parent](../content/io/avaje/http/README.md) | [3.11-RC1](../content/io/avaje/http/avaje-http-3.11-RC1.buildspec) :white_check_mark: | [3.11](../content/io/avaje/http/avaje-http-3.11.buildspec) | `bin/add-new-release.sh content/io/avaje/http/avaje-http-3.11-RC1.buildspec 3.11` |
| <!-- 20260818035315 --> [guava](../content/com/google/guava/README.md) | [33.7.0-jre](../content/com/google/guava/guava-33.7.0-jre.buildspec) :white_check_mark: | [33.7.1-jre](../content/com/google/guava/guava-33.7.1-jre.buildspec) | `bin/add-new-release.sh content/com/google/guava/guava-33.7.0-jre.buildspec 33.7.1-jre` |
| <!-- 20260818035315 --> [guava](../content/com/google/guava/README.md) | [33.7.0-jre](../content/com/google/guava/guava-33.7.0-jre.buildspec) :white_check_mark: | 33.7.1-android  | `bin/add-new-release.sh content/com/google/guava/guava-33.7.0-jre.buildspec ...` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260818040137 --> [avaje-metrics-parent](../content/io/avaje/metrics/README.md) | [10.4-RC2](../content/io/avaje/metrics/avaje-metrics-10.4-RC2.buildspec) :warning: | [10.4-RC5](../content/io/avaje/metrics/avaje-metrics-10.4-RC5.buildspec) | `bin/add-new-release.sh content/io/avaje/metrics/avaje-metrics-10.4-RC2.buildspec 10.4-RC5` |
...
| artifactId | newest |
| ---------- | ------ |
| <!-- 20260817180516 --> [convex](../content/world/convex/README.md) | 0.8.13 :warning: |
