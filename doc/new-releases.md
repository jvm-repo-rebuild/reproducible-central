...
| ---------- | ---- | -- | ------- |
| <!-- 20260629143303 --> [artemis-project](../content/org/apache/artemis/README.md) | [2.54.0](../content/org/apache/artemis/artemis-2.54.0.buildspec) :white_check_mark: | [2.55.0](../content/org/apache/artemis/artemis-2.55.0.buildspec) | `bin/add-new-release.sh content/org/apache/artemis/artemis-2.54.0.buildspec 2.55.0` |
| <!-- 20260629143256 --> [artemis-pom](../content/org/apache/activemq/artemis/README.md) | [2.54.0](../content/org/apache/activemq/artemis/artemis-2.54.0.buildspec) :white_check_mark: | [2.55.0](../content/org/apache/activemq/artemis/artemis-2.55.0.buildspec) | `bin/add-new-release.sh content/org/apache/activemq/artemis/artemis-2.54.0.buildspec 2.55.0` |
| <!-- 20260629134921 --> [airbase](../content/io/airlift/airbase/README.md) | [391](../content/io/airlift/airbase/airbase-391.buildspec) :white_check_mark: | [392](../content/io/airlift/airbase/airbase-392.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-391.buildspec 392` |
| <!-- 20260629124717 --> [struts2-project](../content/org/apache/struts/README.md) | [7.1.1](../content/org/apache/struts/struts2-7.1.1.buildspec) :white_check_mark: | [7.2.1](../content/org/apache/struts/struts2-7.2.1.buildspec) | `bin/add-new-release.sh content/org/apache/struts/struts2-7.1.1.buildspec 7.2.1` |
| <!-- 20260629092624 --> [pmd](../content/net/sourceforge/pmd/README.md) | [7.25.0](../content/net/sourceforge/pmd/pmd-7.25.0.buildspec) :white_check_mark: | [7.26.0](../content/net/sourceforge/pmd/pmd-7.26.0.buildspec) | `bin/add-new-release.sh content/net/sourceforge/pmd/pmd-7.25.0.buildspec 7.26.0` |
| <!-- 20260629045503 --> [activemq-parent](../content/org/apache/activemq/README.md) | [6.2.6](../content/org/apache/activemq/activemq-6.2.6.buildspec) :white_check_mark: | [6.2.7](../content/org/apache/activemq/activemq-6.2.7.buildspec) | `bin/add-new-release.sh content/org/apache/activemq/activemq-6.2.6.buildspec 6.2.7` |
| <!-- 20260629045503 --> [activemq-parent](../content/org/apache/activemq/README.md) | [6.2.6](../content/org/apache/activemq/activemq-6.2.6.buildspec) :white_check_mark: | 5.19.8  | `bin/add-new-release.sh content/org/apache/activemq/activemq-6.2.6.buildspec ...` |
| <!-- 20260628221852 --> [maven-parent](../content/org/apache/maven/parent/README.md) | [48](../content/org/apache/maven/parent/maven-parent-48.buildspec) :white_check_mark: | [49](../content/org/apache/maven/parent/maven-parent-49.buildspec) | `bin/add-new-release.sh content/org/apache/maven/parent/maven-parent-48.buildspec 49` |
| <!-- 20260628220515 --> [spdx-maven-plugin](../content/org/spdx/spdx-maven-plugin/README.md) | [1.0.3](../content/org/spdx/spdx-maven-plugin/spdx-maven-plugin-1.0.3.buildspec) :white_check_mark: | [1.0.4](../content/org/spdx/spdx-maven-plugin/spdx-maven-plugin-1.0.4.buildspec) | `bin/add-new-release.sh content/org/spdx/spdx-maven-plugin/spdx-maven-plugin-1.0.3.buildspec 1.0.4` |
| <!-- 20260628215022 --> [apache](../content/org/apache/apache/README.md) | [38](../content/org/apache/apache/apache-38.buildspec) :white_check_mark: | [39](../content/org/apache/apache/apache-39.buildspec) | `bin/add-new-release.sh content/org/apache/apache/apache-38.buildspec 39` |
| <!-- 20260628200930 --> [mybatis-hazelcast](../content/org/mybatis/caches/mybatis-hazelcast/README.md) | [1.4.0](../content/org/mybatis/caches/mybatis-hazelcast/mybatis-hazelcast-1.4.0.buildspec) :white_check_mark: | [1.4.1](../content/org/mybatis/caches/mybatis-hazelcast/mybatis-hazelcast-1.4.1.buildspec) | `bin/add-new-release.sh content/org/mybatis/caches/mybatis-hazelcast/mybatis-hazelcast-1.4.0.buildspec 1.4.1` |
| <!-- 20260628200321 --> [mug-root](../content/com/google/mug/README.md) | [10.5](../content/com/google/mug/mug-10.5.buildspec) :white_check_mark: | [10.5.1](../content/com/google/mug/mug-10.5.1.buildspec) | `bin/add-new-release.sh content/com/google/mug/mug-10.5.buildspec 10.5.1` |
| <!-- 20260628192524 --> [mybatis-guice](../content/org/mybatis/guice/README.md) | [4.1.0](../content/org/mybatis/guice/mybatis-guice-4.1.0.buildspec) :white_check_mark: | [4.1.1](../content/org/mybatis/guice/mybatis-guice-4.1.1.buildspec) | `bin/add-new-release.sh content/org/mybatis/guice/mybatis-guice-4.1.0.buildspec 4.1.1` |
| <!-- 20260628190115 --> [java-spdx-library](../content/org/spdx/java-spdx-library/README.md) | [2.0.3](../content/org/spdx/java-spdx-library/java-spdx-library-2.0.3.buildspec) :white_check_mark: | [2.0.4](../content/org/spdx/java-spdx-library/java-spdx-library-2.0.4.buildspec) | `bin/add-new-release.sh content/org/spdx/java-spdx-library/java-spdx-library-2.0.3.buildspec 2.0.4` |
| <!-- 20260628183915 --> [mybatis-freemarker](../content/org/mybatis/scripting/mybatis-freemarker/README.md) | [1.3.1](../content/org/mybatis/scripting/mybatis-freemarker/mybatis-freemarker-1.3.1.buildspec) :white_check_mark: | [1.3.2](../content/org/mybatis/scripting/mybatis-freemarker/mybatis-freemarker-1.3.2.buildspec) | `bin/add-new-release.sh content/org/mybatis/scripting/mybatis-freemarker/mybatis-freemarker-1.3.1.buildspec 1.3.2` |
| <!-- 20260628112356 --> [commons-jexl3](../content/org/apache/commons/commons-jexl3/README.md) | [3.6.3](../content/org/apache/commons/commons-jexl3/commons-jexl3-3.6.3.buildspec) :white_check_mark: | [3.6.4](../content/org/apache/commons/commons-jexl3/commons-jexl3-3.6.4.buildspec) | `bin/add-new-release.sh content/org/apache/commons/commons-jexl3/commons-jexl3-3.6.3.buildspec 3.6.4` |
| <!-- 20260628095514 --> [junit-bom](../content/org/junit/junit5/README.md) | [6.1.0](../content/org/junit/junit5/junit5-6.1.0.buildspec) :white_check_mark: | [6.1.1](../content/org/junit/junit5/junit5-6.1.1.buildspec) | `bin/add-new-release.sh content/org/junit/junit5/junit5-6.1.0.buildspec 6.1.1` |
| <!-- 20260628044915 --> [spoon-core](../content/fr/inria/gforge/spoon/spoon-core/README.md) | [11.4.0](../content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.4.0.buildspec) :white_check_mark: | [11.4.1-beta-1](../content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.4.1-beta-1.buildspec) | `bin/add-new-release.sh content/fr/inria/gforge/spoon/spoon-core/spoon-core-11.4.0.buildspec 11.4.1-beta-1` |
| <!-- 20260628024717 --> [maven-lockfile](../content/io/github/chains-project/maven-lockfile/README.md) | [5.17.1-beta-2](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.17.1-beta-2.buildspec) :white_check_mark: | [5.17.1-beta-3](../content/io/github/chains-project/maven-lockfile/maven-lockfile-5.17.1-beta-3.buildspec) | `bin/add-new-release.sh content/io/github/chains-project/maven-lockfile/maven-lockfile-5.17.1-beta-2.buildspec 5.17.1-beta-3` |
| <!-- 20260628014914 --> [mybatis-ehcache](../content/org/mybatis/caches/mybatis-ehcache/README.md) | [1.3.1](../content/org/mybatis/caches/mybatis-ehcache/mybatis-ehcache-1.3.1.buildspec) :white_check_mark: | [2.0.0](../content/org/mybatis/caches/mybatis-ehcache/mybatis-ehcache-2.0.0.buildspec) | `bin/add-new-release.sh content/org/mybatis/caches/mybatis-ehcache/mybatis-ehcache-1.3.1.buildspec 2.0.0` |
| <!-- 20260628014914 --> [mybatis-ehcache](../content/org/mybatis/caches/mybatis-ehcache/README.md) | [1.3.1](../content/org/mybatis/caches/mybatis-ehcache/mybatis-ehcache-1.3.1.buildspec) :white_check_mark: | 1.4.0  | `bin/add-new-release.sh content/org/mybatis/caches/mybatis-ehcache/mybatis-ehcache-1.3.1.buildspec ...` |
| <!-- 20260628013915 --> [mybatis-cdi](../content/org/mybatis/cdi/README.md) | [2.1.1](../content/org/mybatis/cdi/mybatis-cdi-2.1.1.buildspec) :white_check_mark: | [2.1.2](../content/org/mybatis/cdi/mybatis-cdi-2.1.2.buildspec) | `bin/add-new-release.sh content/org/mybatis/cdi/mybatis-cdi-2.1.1.buildspec 2.1.2` |
| <!-- 20260628005922 --> [hibernate-core](../content/org/hibernate/orm/hibernate-core/README.md) | [8.0.0.Beta1](../content/org/hibernate/orm/hibernate-core/hibernate-core-8.0.0.Beta1.buildspec) :white_check_mark: | 7.4.3.Final 7.3.10.Final 7.2.21.Final 7.1.32.Final  | `bin/add-new-release.sh content/org/hibernate/orm/hibernate-core/hibernate-core-8.0.0.Beta1.buildspec ...` |
| <!-- 20260628002913 --> [mybatis-caffeine](../content/org/mybatis/caches/mybatis-caffeine/README.md) | [1.2.1](../content/org/mybatis/caches/mybatis-caffeine/mybatis-caffeine-1.2.1.buildspec) :white_check_mark: | [1.2.2](../content/org/mybatis/caches/mybatis-caffeine/mybatis-caffeine-1.2.2.buildspec) | `bin/add-new-release.sh content/org/mybatis/caches/mybatis-caffeine/mybatis-caffeine-1.2.1.buildspec 1.2.2` |
| <!-- 20260627230553 --> [mybatis-spring](../content/org/mybatis/mybatis-spring/README.md) | [4.0.0](../content/org/mybatis/mybatis-spring/mybatis-spring-4.0.0.buildspec) :white_check_mark: | [4.1.0](../content/org/mybatis/mybatis-spring/mybatis-spring-4.1.0.buildspec) | `bin/add-new-release.sh content/org/mybatis/mybatis-spring/mybatis-spring-4.0.0.buildspec 4.1.0` |
| <!-- 20260626183151 --> [jline](../content/org/jline/README.md) | [4.2.1](../content/org/jline/jline-4.2.1.buildspec) :white_check_mark: | 4.0.16 4.0.11 4.0.9 4.0.8 4.0.7 4.0.6 4.0.5 4.0.4 4.0.3 4.0.2 3.30.14  | `bin/add-new-release.sh content/org/jline/jline-4.2.1.buildspec ...` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20260628112356 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-jexl3](../content/org/apache/commons/commons-jexl3/README.md) | [3.6.3](../content/org/apache/commons/commons-jexl3/commons-jexl3-3.6.3.buildspec) :white_check_mark: | [3.7.0](../content/org/apache/commons/commons-jexl3/commons-jexl3-3.7.0.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/commons-jexl3/commons-jexl3-3.6.3.buildspec 3.7.0 staging` |
...
| <!-- 20260526105511 --> [:mailbox:](https://lists.apache.org/list?dev@tika.apache.org:lte=1M:VOTE) | [tika](../content/org/apache/tika/README.md) | [3.3.1](../content/org/apache/tika/tika-3.3.1.buildspec) :warning: | [4.0.0-beta-1](../content/org/apache/tika/tika-4.0.0-beta-1.buildspec)  | `bin/add-new-release.sh content/org/apache/tika/tika-3.3.1.buildspec 4.0.0-beta-1 staging` |
| <!-- 20260518091538 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-resolver](../content/org/apache/maven/resolver/maven-resolver/README.md) | [2.0.18](../content/org/apache/maven/resolver/maven-resolver/maven-resolver-2.0.18.buildspec) :warning: | [2.0.19](../content/org/apache/maven/resolver/maven-resolver/maven-resolver-2.0.19.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/resolver/maven-resolver/maven-resolver-2.0.18.buildspec 2.0.19 staging` |
...
| <!-- 20260425105350 --> [:mailbox:](https://lists.apache.org/list?dev@camel.apache.org:lte=1M:VOTE) | [camel](../content/org/apache/camel/camel/README.md) | [4.10.0](../content/org/apache/camel/camel/camel-4.10.0.buildspec) :x: | [4.21.0](../content/org/apache/camel/camel/camel-4.21.0.buildspec)  | `bin/add-new-release.sh content/org/apache/camel/camel/camel-4.10.0.buildspec 4.21.0 staging` |
| <!-- 20260414202339 --> [:mailbox:](https://lists.apache.org/list?dev@pinot.apache.org:lte=1M:VOTE) | [pinot](../content/org/apache/pinot/README.md) | [1.5.0](../content/org/apache/pinot/pinot-1.5.0.buildspec) :warning: [:memo:](https://github.com/apache/pinot/pull/18812) | [1.5.1](../content/org/apache/pinot/pinot-1.5.1.buildspec)  | `bin/add-new-release.sh content/org/apache/pinot/pinot-1.5.0.buildspec 1.5.1 staging` |
| <!-- 20251021135021 --> [:mailbox:](https://lists.apache.org/list?dev@sling.apache.org:lte=1M:VOTE) | [org.apache.sling.event](../content/org/apache/sling/org.apache.sling.event/README.md) | [4.4.0](../content/org/apache/sling/org.apache.sling.event/org.apache.sling.event-4.4.0.buildspec) :white_check_mark: | [4.4.2](../content/org/apache/sling/org.apache.sling.event/org.apache.sling.event-4.4.2.buildspec)  | `bin/add-new-release.sh content/org/apache/sling/org.apache.sling.event/org.apache.sling.event-4.4.0.buildspec 4.4.2 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260629144943 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.132.2](../content/org/finos/legend/engine/legend-engine-4.132.2.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.132.2` |
| <!-- 20260629094558 --> [kubernetes-client-project](../content/io/fabric8/kubernetes-client/README.md) | [7.7.0](../content/io/fabric8/kubernetes-client/kubernetes-client-7.7.0.buildspec) :warning: | [7.8.0](../content/io/fabric8/kubernetes-client/kubernetes-client-7.8.0.buildspec) | `bin/add-new-release.sh content/io/fabric8/kubernetes-client/kubernetes-client-7.7.0.buildspec 7.8.0` |
| <!-- 20260629081526 --> [jreleaser](../content/org/jreleaser/README.md) | [1.24.0](../content/org/jreleaser/jreleaser-1.24.0.buildspec) :warning: | [1.25.0](../content/org/jreleaser/jreleaser-1.25.0.buildspec) | `bin/add-new-release.sh content/org/jreleaser/jreleaser-1.24.0.buildspec 1.25.0` |
...
| <!-- 20260627220031 --> [glassfish-parent](../content/org/glassfish/main/README.md) | [8.0.3](../content/org/glassfish/main/glassfish-8.0.3.buildspec) :warning: [:memo:](https://github.com/eclipse-ee4j/glassfish/issues/24615#issuecomment-3850537179) | [9.0.0-M2](../content/org/glassfish/main/glassfish-9.0.0-M2.buildspec) | `bin/add-new-release.sh content/org/glassfish/main/glassfish-8.0.3.buildspec 9.0.0-M2` |
| <!-- 20260626175117 --> [com.io7m.primogenitor](../content/com/io7m/primogenitor/README.md) | [9.2.0](../content/com/io7m/primogenitor/com.io7m.primogenitor-9.2.0.buildspec) :warning: | [10.0.0-beta0002](../content/com/io7m/primogenitor/com.io7m.primogenitor-10.0.0-beta0002.buildspec) | `bin/add-new-release.sh content/com/io7m/primogenitor/com.io7m.primogenitor-9.2.0.buildspec 10.0.0-beta0002` |
...
| <!-- 20260526105511 --> [tika](../content/org/apache/tika/README.md) | [3.3.1](../content/org/apache/tika/tika-3.3.1.buildspec) :warning: | [4.0.0-alpha-1](../content/org/apache/tika/tika-4.0.0-alpha-1.buildspec) | `bin/add-new-release.sh content/org/apache/tika/tika-3.3.1.buildspec 4.0.0-alpha-1` |
...
| <!-- 20260622165208 --> [convex](../content/world/convex/README.md) | 0.8.6 :warning: |
...
| <!-- 20260617175317 --> [quarkus-project](../content/io/quarkus/README.md) | 3.37.0 :warning: |
...
| <!-- 20260414202339 --> [pinot](../content/org/apache/pinot/README.md) | 1.5.0 :warning: [:memo:](https://github.com/apache/pinot/pull/18812) |
