...
| ---------- | ---- | -- | ------- |
| <!-- 20260720200128 --> [maven-skin-tools](../content/org/sentrysoftware/maven/maven-skin-tools/README.md) | [1.7.00](../content/org/sentrysoftware/maven/maven-skin-tools/maven-skin-tools-1.7.00.buildspec) :white_check_mark: | [1.8.00](../content/org/sentrysoftware/maven/maven-skin-tools/maven-skin-tools-1.8.00.buildspec) | `bin/add-new-release.sh content/org/sentrysoftware/maven/maven-skin-tools/maven-skin-tools-1.7.00.buildspec 1.8.00` |
| <!-- 20260720181049 --> [mojo-parent](../content/org/codehaus/mojo/mojo-parent/README.md) | [96](../content/org/codehaus/mojo/mojo-parent/mojo-parent-96.buildspec) :white_check_mark: | [97](../content/org/codehaus/mojo/mojo-parent/mojo-parent-97.buildspec) | `bin/add-new-release.sh content/org/codehaus/mojo/mojo-parent/mojo-parent-96.buildspec 97` |
| <!-- 20260720015034 --> [mybatis-memcached](../content/org/mybatis/caches/mybatis-memcached/README.md) | [1.2.1](../content/org/mybatis/caches/mybatis-memcached/mybatis-memcached-1.2.1.buildspec) :white_check_mark: | [1.3.0](../content/org/mybatis/caches/mybatis-memcached/mybatis-memcached-1.3.0.buildspec) | `bin/add-new-release.sh content/org/mybatis/caches/mybatis-memcached/mybatis-memcached-1.2.1.buildspec 1.3.0` |
| <!-- 20260719231911 --> [base-bundle-descriptor](../content/org/mybatis/base-bundle-descriptor/README.md) | [13](../content/org/mybatis/base-bundle-descriptor/base-bundle-descriptor-13.buildspec) :white_check_mark: | [14](../content/org/mybatis/base-bundle-descriptor/base-bundle-descriptor-14.buildspec) | `bin/add-new-release.sh content/org/mybatis/base-bundle-descriptor/base-bundle-descriptor-13.buildspec 14` |
| <!-- 20260719230514 --> [mybatis-velocity](../content/org/mybatis/scripting/mybatis-velocity/README.md) | [2.3.1](../content/org/mybatis/scripting/mybatis-velocity/mybatis-velocity-2.3.1.buildspec) :white_check_mark: | [2.3.2](../content/org/mybatis/scripting/mybatis-velocity/mybatis-velocity-2.3.2.buildspec) | `bin/add-new-release.sh content/org/mybatis/scripting/mybatis-velocity/mybatis-velocity-2.3.1.buildspec 2.3.2` |
| <!-- 20260719225912 --> [mybatis-typehandlers-threeten-extra](../content/org/mybatis/mybatis-typehandlers-threeten-extra/README.md) | [1.1.1](../content/org/mybatis/mybatis-typehandlers-threeten-extra/mybatis-typehandlers-threeten-extra-1.1.1.buildspec) :white_check_mark: | [1.2.0](../content/org/mybatis/mybatis-typehandlers-threeten-extra/mybatis-typehandlers-threeten-extra-1.2.0.buildspec) | `bin/add-new-release.sh content/org/mybatis/mybatis-typehandlers-threeten-extra/mybatis-typehandlers-threeten-extra-1.1.1.buildspec 1.2.0` |
| <!-- 20260719223715 --> [mybatis-thymeleaf](../content/org/mybatis/scripting/mybatis-thymeleaf/README.md) | [1.1.1](../content/org/mybatis/scripting/mybatis-thymeleaf/mybatis-thymeleaf-1.1.1.buildspec) :white_check_mark: | [1.2.0](../content/org/mybatis/scripting/mybatis-thymeleaf/mybatis-thymeleaf-1.2.0.buildspec) | `bin/add-new-release.sh content/org/mybatis/scripting/mybatis-thymeleaf/mybatis-thymeleaf-1.1.1.buildspec 1.2.0` |
...
|    | artifactId | from | to | command |
| -- | ---------- | ---- | -- | ------- |
| <!-- 20260703151031 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-resolver](../content/org/apache/maven/resolver/maven-resolver/README.md) | [2.0.20](../content/org/apache/maven/resolver/maven-resolver/maven-resolver-2.0.20.buildspec) :warning: | [2.0.21](../content/org/apache/maven/resolver/maven-resolver/maven-resolver-2.0.21.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/resolver/maven-resolver/maven-resolver-2.0.20.buildspec 2.0.21 staging` |
| <!-- 20260610234225 --> [:mailbox:](https://lists.apache.org/list?dev@commons.apache.org:lte=1M:VOTE) | [commons-parent](../content/org/apache/commons/parent/README.md) | [102](../content/org/apache/commons/parent/commons-parent-102.buildspec) :white_check_mark: | [103](../content/org/apache/commons/parent/commons-parent-103.buildspec)  | `bin/add-new-release.sh content/org/apache/commons/parent/commons-parent-102.buildspec 103 staging` |
| <!-- 20260520201939 --> [:mailbox:](https://lists.apache.org/list?dev@wicket.apache.org:lte=1M:VOTE) | [wicket-parent](../content/org/apache/wicket/README.md) | [10.9.1](../content/org/apache/wicket/wicket-parent-10.9.1.buildspec) :white_check_mark: | [10.10.0](../content/org/apache/wicket/wicket-parent-10.10.0.buildspec)  | `bin/add-new-release.sh content/org/apache/wicket/wicket-parent-10.9.1.buildspec 10.10.0 staging` |
...
| <!-- 20250818192534 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-resolver-ant-tasks](../content/org/apache/maven/resolver/maven-resolver-ant-tasks/README.md) | [1.6.0](../content/org/apache/maven/resolver/maven-resolver-ant-tasks/maven-resolver-ant-tasks-1.6.0.buildspec) :white_check_mark: | [1.6.1](../content/org/apache/maven/resolver/maven-resolver-ant-tasks/maven-resolver-ant-tasks-1.6.1.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/resolver/maven-resolver-ant-tasks/maven-resolver-ant-tasks-1.6.0.buildspec 1.6.1 staging` |
| <!-- 20250418115815 --> [:mailbox:](https://lists.apache.org/list?dev@systemds.apache.org:lte=1M:VOTE) | [systemds](../content/org/apache/systemds/README.md) | [3.3.0](../content/org/apache/systemds/systemds-3.3.0.buildspec) :warning: [:memo:](https://github.com/apache/systemds/pull/2257) | [3.4.0](../content/org/apache/systemds/systemds-3.4.0.buildspec)  | `bin/add-new-release.sh content/org/apache/systemds/systemds-3.3.0.buildspec 3.4.0 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260720191442 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.135.1](../content/org/finos/legend/engine/legend-engine-4.135.1.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.135.1` |
| <!-- 20260720084710 --> [syncope](../content/org/apache/syncope/README.md) | [4.1.1](../content/org/apache/syncope/syncope-4.1.1.buildspec) :warning: | [4.1.2](../content/org/apache/syncope/syncope-4.1.2.buildspec) | `bin/add-new-release.sh content/org/apache/syncope/syncope-4.1.1.buildspec 4.1.2` |
