...
| ---------- | ---- | -- | ------- |
| <!-- 20260116080916 --> [maven-surefire-cached](../content/com/github/seregamorph/maven-surefire-cached/README.md) | [0.25](../content/com/github/seregamorph/maven-surefire-cached/maven-surefire-cached-0.25.buildspec) :white_check_mark: | [0.26](../content/com/github/seregamorph/maven-surefire-cached/maven-surefire-cached-0.26.buildspec) | `bin/add-new-release.sh content/com/github/seregamorph/maven-surefire-cached/maven-surefire-cached-0.25.buildspec 0.26` |
| <!-- 20260116002812 --> [cxf-build-utils](../content/org/apache/cxf/cxf-build-utils/README.md) | [4.1.2](../content/org/apache/cxf/cxf-build-utils/cxf-build-utils-4.1.2.buildspec) :white_check_mark: | [4.1.3](../content/org/apache/cxf/cxf-build-utils/cxf-build-utils-4.1.3.buildspec) | `bin/add-new-release.sh content/org/apache/cxf/cxf-build-utils/cxf-build-utils-4.1.2.buildspec 4.1.3` |
| <!-- 20260115231117 --> [byte-buddy-parent](../content/net/bytebuddy/README.md) | [1.18.3](../content/net/bytebuddy/byte-buddy-1.18.3.buildspec) :white_check_mark: | [1.18.4](../content/net/bytebuddy/byte-buddy-1.18.4.buildspec) | `bin/add-new-release.sh content/net/bytebuddy/byte-buddy-1.18.3.buildspec 1.18.4` |
...
| <!-- 20260116083720 --> [jpmml-transpiler](../content/org/jpmml/jpmml-transpiler/README.md) | [1.4.7](../content/org/jpmml/jpmml-transpiler/jpmml-transpiler-1.4.7.buildspec) :warning: | [1.4.8](../content/org/jpmml/jpmml-transpiler/jpmml-transpiler-1.4.8.buildspec) | `bin/add-new-release.sh content/org/jpmml/jpmml-transpiler/jpmml-transpiler-1.4.7.buildspec 1.4.8` |
