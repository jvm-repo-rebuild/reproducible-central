...
| ---------- | ---- | -- | ------- |
| <!-- 20260615185148 --> [takari-smart-builder](../content/io/takari/maven/takari-smart-builder/README.md) | [1.1.0](../content/io/takari/maven/takari-smart-builder/takari-smart-builder-1.1.0.buildspec) :white_check_mark: | [1.1.1](../content/io/takari/maven/takari-smart-builder/takari-smart-builder-1.1.1.buildspec) | `bin/add-new-release.sh content/io/takari/maven/takari-smart-builder/takari-smart-builder-1.1.0.buildspec 1.1.1` |
| <!-- 20260615182914 --> [takari-lifecycle-plugin](../content/io/takari/maven/plugins/takari-lifecycle-plugin/README.md) | [2.3.3](../content/io/takari/maven/plugins/takari-lifecycle-plugin/takari-lifecycle-plugin-2.3.3.buildspec) :white_check_mark: | [2.3.4](../content/io/takari/maven/plugins/takari-lifecycle-plugin/takari-lifecycle-plugin-2.3.4.buildspec) | `bin/add-new-release.sh content/io/takari/maven/plugins/takari-lifecycle-plugin/takari-lifecycle-plugin-2.3.3.buildspec 2.3.4` |
| <!-- 20260615181949 --> [nodejs-maven-plugin](../content/io/wcm/maven/plugins/nodejs-maven-plugin/README.md) | [3.0.8](../content/io/wcm/maven/plugins/nodejs-maven-plugin/nodejs-maven-plugin-3.0.8.buildspec) :white_check_mark: | [3.1.0](../content/io/wcm/maven/plugins/nodejs-maven-plugin/nodejs-maven-plugin-3.1.0.buildspec) | `bin/add-new-release.sh content/io/wcm/maven/plugins/nodejs-maven-plugin/nodejs-maven-plugin-3.0.8.buildspec 3.1.0` |
| <!-- 20260615180916 --> [cq-maven-plugin](../content/io/wcm/maven/plugins/cq-maven-plugin/README.md) | [1.2.2](../content/io/wcm/maven/plugins/cq-maven-plugin/cq-maven-plugin-1.2.2.buildspec) :white_check_mark: | [1.3.0](../content/io/wcm/maven/plugins/cq-maven-plugin/cq-maven-plugin-1.3.0.buildspec) | `bin/add-new-release.sh content/io/wcm/maven/plugins/cq-maven-plugin/cq-maven-plugin-1.2.2.buildspec 1.3.0` |
| <!-- 20260615173533 --> [takari-archiver](../content/io/takari/takari-archiver/README.md) | [1.0.7](../content/io/takari/takari-archiver/takari-archiver-1.0.7.buildspec) :white_check_mark: | [1.0.8](../content/io/takari/takari-archiver/takari-archiver-1.0.8.buildspec) | `bin/add-new-release.sh content/io/takari/takari-archiver/takari-archiver-1.0.7.buildspec 1.0.8` |
| <!-- 20260615145325 --> [langchain4j-cdi-parent](../content/dev/langchain4j/cdi/README.md) | [1.3.2](../content/dev/langchain4j/cdi/langchain4j-cdi-1.3.2.buildspec) :white_check_mark: | [1.3.3](../content/dev/langchain4j/cdi/langchain4j-cdi-1.3.3.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/cdi/langchain4j-cdi-1.3.2.buildspec 1.3.3` |
| <!-- 20260615143918 --> [scalpel](../content/eu/maveniverse/maven/scalpel/README.md) | [0.3.3](../content/eu/maveniverse/maven/scalpel/scalpel-0.3.3.buildspec) :white_check_mark: | [0.3.4](../content/eu/maveniverse/maven/scalpel/scalpel-0.3.4.buildspec) | `bin/add-new-release.sh content/eu/maveniverse/maven/scalpel/scalpel-0.3.3.buildspec 0.3.4` |
| <!-- 20260615131738 --> [langchain4j](../content/dev/langchain4j/README.md) | [1.16.2](../content/dev/langchain4j/langchain4j-1.16.2.buildspec) :white_check_mark: | [1.16.3](../content/dev/langchain4j/langchain4j-1.16.3.buildspec) | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-1.16.2.buildspec 1.16.3` |
| <!-- 20260615131738 --> [langchain4j](../content/dev/langchain4j/README.md) | [1.16.2](../content/dev/langchain4j/langchain4j-1.16.2.buildspec) :white_check_mark: | 1.11.8 1.2.1  | `bin/add-new-release.sh content/dev/langchain4j/langchain4j-1.16.2.buildspec ...` |
| <!-- 20260615014515 --> [htmlcompressor-maven-plugin](../content/com/github/hazendaz/maven/htmlcompressor-maven-plugin/README.md) | [2.4.0](../content/com/github/hazendaz/maven/htmlcompressor-maven-plugin/htmlcompressor-maven-plugin-2.4.0.buildspec) :white_check_mark: | [2.5.0](../content/com/github/hazendaz/maven/htmlcompressor-maven-plugin/htmlcompressor-maven-plugin-2.5.0.buildspec) | `bin/add-new-release.sh content/com/github/hazendaz/maven/htmlcompressor-maven-plugin/htmlcompressor-maven-plugin-2.4.0.buildspec 2.5.0` |
| <!-- 20260615014515 --> [htmlcompressor-maven-plugin](../content/com/github/hazendaz/maven/htmlcompressor-maven-plugin/README.md) | [2.4.0](../content/com/github/hazendaz/maven/htmlcompressor-maven-plugin/htmlcompressor-maven-plugin-2.4.0.buildspec) :white_check_mark: | 1.14.0  | `bin/add-new-release.sh content/com/github/hazendaz/maven/htmlcompressor-maven-plugin/htmlcompressor-maven-plugin-2.4.0.buildspec ...` |
...
| <!-- 20260607152256 --> [glassfish-parent](../content/org/glassfish/main/README.md) | [8.0.2](../content/org/glassfish/main/glassfish-8.0.2.buildspec) :warning: [:memo:](https://github.com/eclipse-ee4j/glassfish/issues/24615#issuecomment-3850537179) | [9.0.0-M2](../content/org/glassfish/main/glassfish-9.0.0-M2.buildspec) | `bin/add-new-release.sh content/org/glassfish/main/glassfish-8.0.2.buildspec 9.0.0-M2` |
