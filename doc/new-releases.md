...
| ---------- | ---- | -- | ------- |
| <!-- 20260723155914 --> [parent](../content/ch/qos/logback/access/README.md) | [2.0.13](../content/ch/qos/logback/access/access-2.0.13.buildspec) :white_check_mark: | [2.0.14](../content/ch/qos/logback/access/access-2.0.14.buildspec) | `bin/add-new-release.sh content/ch/qos/logback/access/access-2.0.13.buildspec 2.0.14` |
| <!-- 20260723140151 --> [cucumber-jvm](../content/io/cucumber/cucumber-jvm/README.md) | [7.34.4](../content/io/cucumber/cucumber-jvm/cucumber-jvm-7.34.4.buildspec) :white_check_mark: | [7.34.5](../content/io/cucumber/cucumber-jvm/cucumber-jvm-7.34.5.buildspec) | `bin/add-new-release.sh content/io/cucumber/cucumber-jvm/cucumber-jvm-7.34.4.buildspec 7.34.5` |
| <!-- 20260723133140 --> [oras-java-sdk](../content/land/oras/oras-java-sdk/README.md) | [0.8.0](../content/land/oras/oras-java-sdk/oras-java-sdk-0.8.0.buildspec) :white_check_mark: | [0.8.1](../content/land/oras/oras-java-sdk/oras-java-sdk-0.8.1.buildspec) | `bin/add-new-release.sh content/land/oras/oras-java-sdk/oras-java-sdk-0.8.0.buildspec 0.8.1` |
| <!-- 20260723132325 --> [messages-ndjson](../content/io/cucumber/messages-ndjson/README.md) | [0.5.1](../content/io/cucumber/messages-ndjson/messages-ndjson-0.5.1.buildspec) :white_check_mark: | 0.3.5  | `bin/add-new-release.sh content/io/cucumber/messages-ndjson/messages-ndjson-0.5.1.buildspec ...` |
| <!-- 20260723123123 --> [logback-parent](../content/ch/qos/logback/README.md) | [1.5.38](../content/ch/qos/logback/logback-1.5.38.buildspec) :white_check_mark: | [1.6.0](../content/ch/qos/logback/logback-1.6.0.buildspec) | `bin/add-new-release.sh content/ch/qos/logback/logback-1.5.38.buildspec 1.6.0` |
| <!-- 20260723112838 --> [tag-expressions](../content/io/cucumber/tag-expressions/README.md) | [10.0.0](../content/io/cucumber/tag-expressions/tag-expressions-10.0.0.buildspec) :white_check_mark: | [11.0.0](../content/io/cucumber/tag-expressions/tag-expressions-11.0.0.buildspec) | `bin/add-new-release.sh content/io/cucumber/tag-expressions/tag-expressions-10.0.0.buildspec 11.0.0` |
| <!-- 20260723093114 --> [airbase](../content/io/airlift/airbase/README.md) | [396](../content/io/airlift/airbase/airbase-396.buildspec) :white_check_mark: | [397](../content/io/airlift/airbase/airbase-397.buildspec) | `bin/add-new-release.sh content/io/airlift/airbase/airbase-396.buildspec 397` |
| <!-- 20260723092730 --> [micronaut-maven-plugin](../content/io/micronaut/maven/micronaut-maven-plugin/README.md) | [5.0.0](../content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-5.0.0.buildspec) :white_check_mark: | [5.0.2](../content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-5.0.2.buildspec) | `bin/add-new-release.sh content/io/micronaut/maven/micronaut-maven-plugin/micronaut-maven-plugin-5.0.0.buildspec 5.0.2` |
...
| <!-- 20251031142503 --> [:mailbox:](https://lists.apache.org/list?dev@maven.apache.org:lte=1M:VOTE) | [maven-toolchains-plugin](../content/org/apache/maven/plugins/maven-toolchains-plugin/README.md) | [3.2.0](../content/org/apache/maven/plugins/maven-toolchains-plugin/maven-toolchains-plugin-3.2.0.buildspec) :white_check_mark: | [3.3.0](../content/org/apache/maven/plugins/maven-toolchains-plugin/maven-toolchains-plugin-3.3.0.buildspec)  | `bin/add-new-release.sh content/org/apache/maven/plugins/maven-toolchains-plugin/maven-toolchains-plugin-3.2.0.buildspec 3.3.0 staging` |
...
| artifactId | from | to | command |
| ---------- | ---- | -- | ------- |
| <!-- 20260723193715 --> [legend-engine](../content/org/finos/legend/engine/README.md) | [4.71.1](../content/org/finos/legend/engine/legend-engine-4.71.1.buildspec) :warning: [:memo:](https://github.com/finos/legend-engine/pull/1337#issuecomment-1508509457) | [4.135.6](../content/org/finos/legend/engine/legend-engine-4.135.6.buildspec) | `bin/add-new-release.sh content/org/finos/legend/engine/legend-engine-4.71.1.buildspec 4.135.6` |
