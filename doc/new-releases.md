...
| ---------- | ---- | -- | ------- |
| <!-- 20260303174920 --> [liftwizard](../content/io/liftwizard/README.md) | [2.1.42](../content/io/liftwizard/liftwizard-2.1.42.buildspec) :white_check_mark: | [2.1.43](../content/io/liftwizard/liftwizard-2.1.43.buildspec) | `bin/add-new-release.sh content/io/liftwizard/liftwizard-2.1.42.buildspec 2.1.43` |
| <!-- 20260303162118 --> [scg-base](../content/io/telicent/smart-caches/graph/scg-base/README.md) | [0.93.1](../content/io/telicent/smart-caches/graph/scg-base/scg-base-0.93.1.buildspec) :white_check_mark: | [0.93.2](../content/io/telicent/smart-caches/graph/scg-base/scg-base-0.93.2.buildspec) | `bin/add-new-release.sh content/io/telicent/smart-caches/graph/scg-base/scg-base-0.93.1.buildspec 0.93.2` |
| <!-- 20260303155927 --> [jena-kafka](../content/io/telicent/jena/jena-kafka/README.md) | [2.3.2](../content/io/telicent/jena/jena-kafka/jena-kafka-2.3.2.buildspec) :white_check_mark: | [3.0.0](../content/io/telicent/jena/jena-kafka/jena-kafka-3.0.0.buildspec) | `bin/add-new-release.sh content/io/telicent/jena/jena-kafka/jena-kafka-2.3.2.buildspec 3.0.0` |
| <!-- 20260303154115 --> [avaje-jex-parent](../content/io/avaje/jex/README.md) | [3.5-RC5](../content/io/avaje/jex/avaje-jex-3.5-RC5.buildspec) :white_check_mark: | [3.5-RC6](../content/io/avaje/jex/avaje-jex-3.5-RC6.buildspec) | `bin/add-new-release.sh content/io/avaje/jex/avaje-jex-3.5-RC5.buildspec 3.5-RC6` |
| <!-- 20260303152253 --> [jline](../content/org/jline/README.md) | [3.30.6](../content/org/jline/jline-3.30.6.buildspec) :white_check_mark: | [4.0.0](../content/org/jline/jline-4.0.0.buildspec) | `bin/add-new-release.sh content/org/jline/jline-3.30.6.buildspec 4.0.0` |
| <!-- 20260303152253 --> [jline](../content/org/jline/README.md) | [3.30.6](../content/org/jline/jline-3.30.6.buildspec) :white_check_mark: | 3.30.7  | `bin/add-new-release.sh content/org/jline/jline-3.30.6.buildspec ...` |
| <!-- 20260303141118 --> [messages-ndjson](../content/io/cucumber/messages-ndjson/README.md) | [0.4.0](../content/io/cucumber/messages-ndjson/messages-ndjson-0.4.0.buildspec) :white_check_mark: | [0.4.1](../content/io/cucumber/messages-ndjson/messages-ndjson-0.4.1.buildspec) | `bin/add-new-release.sh content/io/cucumber/messages-ndjson/messages-ndjson-0.4.0.buildspec 0.4.1` |
| <!-- 20260303141118 --> [messages-ndjson](../content/io/cucumber/messages-ndjson/README.md) | [0.4.0](../content/io/cucumber/messages-ndjson/messages-ndjson-0.4.0.buildspec) :white_check_mark: | 0.3.1  | `bin/add-new-release.sh content/io/cucumber/messages-ndjson/messages-ndjson-0.4.0.buildspec ...` |
