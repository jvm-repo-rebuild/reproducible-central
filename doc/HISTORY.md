...
*Reproducible Central* was developed in two stages:
...
1. in January 2019, before [Reproducible Builds](https://reproducible-builds.org/) is implemented by any JVM build tool or used in real public release context,
   initial rebuild tests to find key factors to having a chance to rebuild an artifact
   and get a result similar to reference build available on Central repository,
2. in March 2020, after Maven can [provide Reproducible Builds](https://maven.apache.org/guides/mini/guide-reproducible-builds.html), it becomes possible to automatically rebuild and really check against reference artifacts,
...
- [Plexus Utils](https://codehaus-plexus.github.io/plexus-utils/) = `org.codehaus.plexus:`[`plexus-utils:*`](https://repo.maven.apache.org/maven2/org/codehaus/plexus/plexus-utils/)\
  ...
  to be improved to remove the impact of Windows platform on the binary (considering any Unix will be easier for rebuilders to set up)\
