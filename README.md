...
2) [**A list of reproducible releases published to Maven Central**](#rebuild-detailed-results)<br>
   ...
   rebuilding **1636 releases** of **387 projects**:
   - **1208** releases are confirmed **fully reproducible** (100% reproducible artifacts :heavy_check_mark:),
...
| org.apache.maven | <a name='org.apache.maven:maven'></a>[maven](content/org/apache/maven/maven/README.md) | 11 | 8 :heavy_check_mark: / 3 :warning: |
...
| **Count:** | **387** | **1636** | **1208** :heavy_check_mark: **428** :warning: |
