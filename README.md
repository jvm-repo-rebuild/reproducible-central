...
2) [**A list of reproducible releases published to Maven Central**](#rebuild-detailed-results)<br>
   ...
   rebuilding **3417 releases** of **627 projects**:
   - **2699** releases are confirmed **fully reproducible** (100% reproducible artifacts :white_check_mark:),
...
| ----------------- | --------------- | --------- | -------- |
| commons-io | [*](content/commons-io/README.md) | 1 | 1 :white_check_mark: |
...
| | [javabean-tester](content/com/github/hazendaz/javabean-tester/README.md) | 10 | 8 :white_check_mark: / 2 :warning: |
...
| eu.maveniverse.maven.toolbox | [toolbox](content/eu/maveniverse/maven/toolbox/README.md) | 4 | 4 :warning: |
...
| net.bytebuddy | [byte-buddy-parent](content/net/bytebuddy/README.md) | 20 | 18 :white_check_mark: / 2 :warning: |
...
| | [flexmonster](content/org/webjars/flexmonster/README.md) | 54 | 50 :white_check_mark: / 4 :warning: |
...
| | [webjars-locator-lite](content/org/webjars/webjars-locator-lite/README.md) | 3 | 3 :white_check_mark: |
...
| **Count:** | **627** | **3417** | **2699** :white_check_mark: **718** :warning: |
