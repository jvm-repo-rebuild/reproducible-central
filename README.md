...
2) [**A list of reproducible releases published to Maven Central**](#rebuild-detailed-results)<br>
   ...
   rebuilding **3540 releases** of **637 projects**:
   - **2809** releases are confirmed **fully reproducible** (100% reproducible artifacts :white_check_mark:),
...
| nl.hsac | [hsac-fitnesse-fixtures](content/nl/hsac/hsac-fitnesse-fixtures/README.md) | 82 | 65 :white_check_mark: / 17 :warning: |
...
| **Count:** | **637** | **3540** | **2809** :white_check_mark: **731** :warning: |
