...
rebuilding **933 releases** of **279 projects**:
- **631** releases were found successfully **fully reproducible** (100% reproducible artifacts :heavy_check_mark:),
...
| **Count:** | **279** | **933** | **631** :heavy_check_mark: **302** :warning: |
