...
2) [**A list of reproducible releases published to Maven Central**](#rebuild-detailed-results)<br>
   ...
   rebuilding **1443 releases** of **370 projects**:
   - **1049** releases are confirmed **fully reproducible** (100% reproducible artifacts :heavy_check_mark:),
...
| net.sourceforge.pmd | <a name='net.sourceforge.pmd:pmd'></a>[pmd](content/net/sourceforge/pmd/README.md) | 30 | 29 :heavy_check_mark: / 1 :warning: |
...
| org.apache.maven | <a name='org.apache.maven:maven'></a>[maven](content/org/apache/maven/maven/README.md) | 8 | 5 :heavy_check_mark: / 3 :warning: |
...
| org.codehaus.modello | <a name='org.codehaus.modello:modello'></a>[modello](content/org/codehaus/modello/README.md) | 2 | 2 :heavy_check_mark: |
...
| org.owasp | <a name='org.owasp:dependency-check-parent'></a>[dependency-check-parent](content/org/owasp/dependency-check/README.md) | 8 | 3 :heavy_check_mark: / 5 :warning: |
...
| | <a name='org.webjars:flexmonster'></a>[flexmonster](content/org/webjars/flexmonster/README.md) | 22 | 21 :heavy_check_mark: / 1 :warning: |
...
| **Count:** | **370** | **1443** | **1049** :heavy_check_mark: **394** :warning: |
