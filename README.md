...
2) [**A list of reproducible releases published to Maven Central**](#rebuild-detailed-results)<br>
   ...
   rebuilding **1323 releases** of **346 projects**:
   - **954** releases are confirmed **fully reproducible** (100% reproducible artifacts :heavy_check_mark:),
   - 369 releases are only partially reproducible (contain some unreproducible artifacts :warning:)
...
| ch.qos.reload4j | <a name='ch.qos.reload4j:reload4j'></a>[reload4j](content/ch/qos/reload4j/README.md) | 6 | 1 :heavy_check_mark: / 5 :warning: |
...
| io.cucumber | <a name='io.cucumber:gherkin-utils'></a>[gherkin-utils](content/io/cucumber/gherkin-utils/README.md) | 1 | 1 :heavy_check_mark: |
...
| io.micronaut.build | <a name='io.micronaut.build:micronaut-maven-plugin'></a>[micronaut-maven-plugin](content/io/micronaut/build/micronaut-maven-plugin/README.md) | 30 | 30 :heavy_check_mark: |
...
| | <a name='org.apache.maven.resolver:maven-resolver'></a>[maven-resolver](content/org/apache/maven/resolver/maven-resolver/README.md) | 13 | 12 :heavy_check_mark: / 1 :warning: |
...
| org.mybatis | <a name='org.mybatis:mybatis-cdi'></a>[mybatis-cdi](content/org/mybatis/cdi/README.md) | 2 | 1 :heavy_check_mark: / 1 :warning: |
...
| org.slf4j | <a name='org.slf4j:slf4j-parent'></a>[slf4j-parent](content/org/slf4j/README.md) | 5 | 2 :heavy_check_mark: / 3 :warning: |
...
| | <a name='org.webjars:flexmonster'></a>[flexmonster](content/org/webjars/flexmonster/README.md) | 19 | 18 :heavy_check_mark: / 1 :warning: |
...
| **Count:** | **346** | **1323** | **954** :heavy_check_mark: **369** :warning: |
