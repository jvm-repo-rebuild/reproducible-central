...
If you would like to play with reproducible builds and contribute to this effort of providing reproducible builds for Java, you are encouraged to look at the following items one after the other : 
