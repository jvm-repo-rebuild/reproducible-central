[net.sourceforge.pmd:pmd](https://search.maven.org/artifact/net.sourceforge.pmd/pmd/) RB check
=======
...
rebuilding **27 releases** of net.sourceforge.pmd:pmd:
...
| -- | --------- | ------ | -- |
| [6.51.0](https://search.maven.org/artifact/net.sourceforge.pmd/pmd/6.51.0/pom) | | | |
