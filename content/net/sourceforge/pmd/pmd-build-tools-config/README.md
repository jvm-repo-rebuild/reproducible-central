...
rebuilding **19 releases** of net.sourceforge.pmd:pmd-build-tools-config:
...
| -- | --------- | ------ | ------ | -- |
| [38](https://central.sonatype.com/artifact/net.sourceforge.pmd/pmd-build-tools-config/38/pom) | | | |
