...
rebuilding **22 releases** of net.sourceforge.pmd:pmd-build-tools-config:
...
| -- | --------- | ------ | ------ | -- |
| [40](https://central.sonatype.com/artifact/net.sourceforge.pmd/pmd-build-tools-config/40/pom) | [mvn jdk21](pmd-build-tools-config-40.buildspec) | [result](pmd-build-tools-config-40.buildinfo): [3 :white_check_mark: ](pmd-build-tools-config-40.buildcompare) | | 72K |
