...
rebuilding **10 releases** of eu.europa.ted.eforms:efx-toolkit-java:
...
| -- | --------- | ------ | ------ | -- |
| [2.0.0-alpha.9](https://central.sonatype.com/artifact/eu.europa.ted.eforms/efx-toolkit-java/2.0.0-alpha.9/pom) | [mvn jdk11](efx-toolkit-java-2.0.0-alpha.9.buildspec) | [result](efx-toolkit-java-2.0.0-alpha.9.buildinfo): [2 :white_check_mark:  1 :warning:](efx-toolkit-java-2.0.0-alpha.9.buildcompare) | 1 :rotating_light: | 2.1M |
