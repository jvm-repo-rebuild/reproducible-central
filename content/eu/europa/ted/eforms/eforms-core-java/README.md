...
rebuilding **13 releases** of eu.europa.ted.eforms:eforms-core-java:
...
| -- | --------- | ------ | ------ | -- |
| [1.9.0](https://central.sonatype.com/artifact/eu.europa.ted.eforms/eforms-core-java/1.9.0/pom) | | | |
