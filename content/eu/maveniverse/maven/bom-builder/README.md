...
rebuilding **13 releases** of eu.maveniverse.maven.bom-builder:bom-builder:
...
| -- | --------- | ------ | ------ | -- |
| [1.3.4](https://central.sonatype.com/artifact/eu.maveniverse.maven.bom-builder/bom-builder/1.3.4/pom) | | | |
