[ch.qos.reload4j:reload4j](https://central.sonatype.com/artifact/ch.qos.reload4j/reload4j/versions) RB check
=======
...
| -- | --------- | ------ | -- |
| [1.2.26](https://central.sonatype.com/artifact/ch.qos.reload4j/reload4j/1.2.26/pom) | [mvn jdk8 w](reload4j-1.2.26.buildspec) | [result](reload4j-1.2.26.buildinfo): [1 :white_check_mark:  3 :warning:](reload4j-1.2.26.buildcompare) | 954K |
