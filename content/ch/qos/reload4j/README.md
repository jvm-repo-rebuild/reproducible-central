...
| -- | --------- | ------ | -- |
| [1.2.22](https://search.maven.org/artifact/ch.qos.reload4j/reload4j/1.2.22/pom) | [mvn jdk8](reload4j-1.2.22.buildspec) | [result](reload4j-1.2.22.buildinfo): [2 :heavy_check_mark:  2 :warning:](reload4j-1.2.22.buildcompare) [:mag:](reload4j-1.2.22.diffoscope) | 933K |
