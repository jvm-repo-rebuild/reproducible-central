[jakarta.activation:jakarta.activation-api](https://central.sonatype.com/artifact/jakarta.activation/jakarta.activation-api/versions) RB check
=======
...
rebuilding **4 releases** of jakarta.activation:jakarta.activation-api:
...
| -- | --------- | ------ | ------ | -- |
| [2.2.0-M2](https://central.sonatype.com/artifact/jakarta.activation/jakarta.activation-api/2.2.0-M2/pom) | [mvn jdk17](jakarta.activation-api-2.2.0-M2.buildspec) | [result](jakarta.activation-api-2.2.0-M2.buildinfo): [3 :white_check_mark:  1 :warning:](jakarta.activation-api-2.2.0-M2.buildcompare) | 1 :no_entry_sign: | 82K |
