[nl.basjes.sunspec:sunspec-device-parent](https://central.sonatype.com/artifact/nl.basjes.sunspec/sunspec-device-parent/versions) RB check
=======
...
rebuilding **13 releases** of nl.basjes.sunspec:sunspec-device-parent:
...
| -- | --------- | ------ | ------ | -- |
| [0.8.0](https://central.sonatype.com/artifact/nl.basjes.sunspec/sunspec-device-parent/0.8.0/pom) | [mvn jdk21](sunspec-device-parent-0.8.0.buildspec) | [result](sunspec-device-parent-0.8.0.buildinfo): [7 :white_check_mark: ](sunspec-device-parent-0.8.0.buildcompare) | | 491K |
