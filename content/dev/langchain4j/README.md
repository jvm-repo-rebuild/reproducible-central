...
rebuilding **22 releases** of dev.langchain4j:langchain4j:
...
| -- | --------- | ------ | -- |
| [1.0.0](https://central.sonatype.com/artifact/dev.langchain4j/langchain4j/1.0.0/pom) | [mvn jdk21](langchain4j-1.0.0.buildspec) | :x: | |
