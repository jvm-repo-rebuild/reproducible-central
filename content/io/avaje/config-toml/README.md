[io.avaje:avaje-config-toml](https://central.sonatype.com/artifact/io.avaje/avaje-config-toml/versions) RB check
=======
...
rebuilding **6 releases** of io.avaje:avaje-config-toml:
...
| -- | --------- | ------ | ------ | -- |
| [5.2](https://central.sonatype.com/artifact/io.avaje/avaje-config-toml/5.2/pom) | [mvn jdk25](avaje-config-toml-5.2.buildspec) | [result](avaje-config-toml-5.2.buildinfo): [3 :white_check_mark: ](avaje-config-toml-5.2.buildcompare) | | 8.1K |
| [5.0](https://central.sonatype.com/artifact/io.avaje/avaje-config-toml/5.0/pom) | [mvn jdk25](avaje-config-toml-5.0.buildspec) | [result](avaje-config-toml-5.0.buildinfo): [3 :white_check_mark: ](avaje-config-toml-5.0.buildcompare) | | 8.1K |
| [4.2](https://central.sonatype.com/artifact/io.avaje/avaje-config-toml/4.2/pom) | [mvn jdk25](avaje-config-toml-4.2.buildspec) | [result](avaje-config-toml-4.2.buildinfo): [1 :white_check_mark:  2 :warning:](avaje-config-toml-4.2.buildcompare) | 2 :no_entry_sign: | 8.1K |
