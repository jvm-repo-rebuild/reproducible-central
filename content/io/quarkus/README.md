...
rebuilding **209 releases** of io.quarkus:quarkus-project:
- **0** releases were found successfully **fully reproducible** (100% reproducible artifacts :white_check_mark:),
- 209 had issues (some unreproducible artifacts :warning:, see eventual :mag: diffoscope and/or :memo: issue tracker links):
  - running [stabilize](doc/stabilize.md) on 120, 0 had all their differences removed :recycle:, 120 still had differences :rotating_light: or files not supported by stabilize :no_entry_sign:
...
| [3.27.5.2](https://central.sonatype.com/artifact/io.quarkus/quarkus-project/3.27.5.2/pom) | | | |
