...
rebuilding **194 releases** of io.quarkus:quarkus-project:
- **0** releases were found successfully **fully reproducible** (100% reproducible artifacts :white_check_mark:),
- 194 had issues (some unreproducible artifacts :warning:, see eventual :mag: diffoscope and/or :memo: issue tracker links):
  - running [stabilize](doc/stabilize.md) on 105, 0 had all their differences removed :recycle:, 105 still had differences :rotating_light: or files not supported by stabilize :no_entry_sign:
...
| [3.37.3](https://central.sonatype.com/artifact/io.quarkus/quarkus-project/3.37.3/pom) | | | |
