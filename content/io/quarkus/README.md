...
rebuilding **190 releases** of io.quarkus:quarkus-project:
...
- 190 had issues (some unreproducible artifacts :warning:, see eventual :mag: diffoscope and/or :memo: issue tracker links):
  - running [stabilize](doc/stabilize.md) on 101, 0 had all their differences removed :recycle:, 101 still had differences :rotating_light: or files not supported by stabilize :no_entry_sign:
...
| [3.27.4.1](https://central.sonatype.com/artifact/io.quarkus/quarkus-project/3.27.4.1/pom) | | | |
