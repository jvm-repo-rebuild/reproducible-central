...
rebuilding **7 releases** of io.yupiik.maven:yupiik-tools-maven-plugin-parent:
...
| -- | --------- | ------ | ------ | -- |
| [1.2.11](https://central.sonatype.com/artifact/io.yupiik.maven/yupiik-tools-maven-plugin-parent/1.2.11/pom) | | | |
