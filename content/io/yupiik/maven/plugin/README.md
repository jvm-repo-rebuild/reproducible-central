...
rebuilding **12 releases** of io.yupiik.maven:yupiik-tools-maven-plugin-parent:
...
| -- | --------- | ------ | ------ | -- |
| [1.2.16](https://central.sonatype.com/artifact/io.yupiik.maven/yupiik-tools-maven-plugin-parent/1.2.16/pom) | | | |
