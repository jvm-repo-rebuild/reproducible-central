...
rebuilding **9 releases** of io.yupiik.maven:yupiik-tools-maven-plugin-parent:
...
| -- | --------- | ------ | ------ | -- |
| [1.2.13](https://central.sonatype.com/artifact/io.yupiik.maven/yupiik-tools-maven-plugin-parent/1.2.13/pom) | | | |
