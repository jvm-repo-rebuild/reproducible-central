...
rebuilding **6 releases** of io.yupiik.maven:yupiik-tools-maven-plugin-parent:
...
| -- | --------- | ------ | ------ | -- |
| [1.2.10](https://central.sonatype.com/artifact/io.yupiik.maven/yupiik-tools-maven-plugin-parent/1.2.10/pom) | | | |
