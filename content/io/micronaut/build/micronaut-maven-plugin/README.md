...
rebuilding **29 releases** of io.micronaut.build:micronaut-maven-plugin:
...
| -- | --------- | ------ | -- |
| [3.5.0](https://search.maven.org/artifact/io.micronaut.build/micronaut-maven-plugin/3.5.0/pom) | | | |
