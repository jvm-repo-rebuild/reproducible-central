...
rebuilding **21 releases** of io.micronaut.build:micronaut-maven-plugin:
...
| -- | --------- | ------ | -- |
| [3.2.3](https://search.maven.org/artifact/io.micronaut.build/micronaut-maven-plugin/3.2.3/pom) | | | |
