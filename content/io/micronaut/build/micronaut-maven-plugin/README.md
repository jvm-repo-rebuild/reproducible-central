[io.micronaut.build:micronaut-maven-plugin](https://search.maven.org/artifact/io.micronaut.build/micronaut-maven-plugin/) RB check
=======
...
rebuilding **28 releases** of io.micronaut.build:micronaut-maven-plugin:
...
| -- | --------- | ------ | -- |
| [3.4.0](https://search.maven.org/artifact/io.micronaut.build/micronaut-maven-plugin/3.4.0/pom) | | | |
