...
rebuilding **21 releases** of tools.jackson.dataformat:jackson-dataformats-binary:
...
| -- | --------- | ------ | ------ | -- |
| [3.2.0](https://central.sonatype.com/artifact/tools.jackson.dataformat/jackson-dataformats-binary/3.2.0/pom) | | | |
