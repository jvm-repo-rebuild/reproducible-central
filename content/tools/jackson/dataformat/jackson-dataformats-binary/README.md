...
rebuilding **13 releases** of tools.jackson.dataformat:jackson-dataformats-binary:
...
| -- | --------- | ------ | ------ | -- |
| [3.0.3](https://central.sonatype.com/artifact/tools.jackson.dataformat/jackson-dataformats-binary/3.0.3/pom) | | | |
