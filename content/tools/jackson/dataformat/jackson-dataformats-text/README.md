...
rebuilding **8 releases** of tools.jackson.dataformat:jackson-dataformats-text:
...
| -- | --------- | ------ | ------ | -- |
| [3.0.0-rc9](https://central.sonatype.com/artifact/tools.jackson.dataformat/jackson-dataformats-text/3.0.0-rc9/pom) | | | |
