...
rebuilding **10 releases** of org.apache.maven.resolver:maven-resolver:
...
| -- | --------- | ------ | -- |
| [1.8.2](https://search.maven.org/artifact/org.apache.maven.resolver/maven-resolver/1.8.2/pom) | | | |
