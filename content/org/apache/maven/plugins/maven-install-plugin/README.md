...
rebuilding **6 releases** of org.apache.maven.plugins:maven-install-plugin:
...
| [3.1.3](https://central.sonatype.com/artifact/org.apache.maven.plugins/maven-install-plugin/3.1.3/pom) | | | |
