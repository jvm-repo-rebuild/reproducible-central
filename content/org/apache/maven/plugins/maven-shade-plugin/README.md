...
rebuilding **13 releases** of org.apache.maven.plugins:maven-shade-plugin:
...
| -- | --------- | ------ | ------ | -- |
| [3.6.2](https://central.sonatype.com/artifact/org.apache.maven.plugins/maven-shade-plugin/3.6.2/pom) | [mvn jdk21](maven-shade-plugin-3.6.2.buildspec) | [result](maven-shade-plugin-3.6.2.buildinfo): [6 :white_check_mark: ](maven-shade-plugin-3.6.2.buildcompare) | | 1.4M |
| [3.6.1](https://central.sonatype.com/artifact/org.apache.maven.plugins/maven-shade-plugin/3.6.1/pom) | [mvn jdk21](maven-shade-plugin-3.6.1.buildspec) | [result](maven-shade-plugin-3.6.1.buildinfo): [6 :white_check_mark: ](maven-shade-plugin-3.6.1.buildcompare) | | 1.4M |
