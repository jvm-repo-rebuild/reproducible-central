...
| -- | --------- | ------ | ------ | -- |
| [1.5.1](https://central.sonatype.com/artifact/commons-daemon/commons-daemon/1.5.1/pom) | [mvn jdk11](commons-daemon-1.5.1.buildspec) | [result](commons-daemon-1.5.1.buildinfo): [9 :white_check_mark:  3 :warning:](commons-daemon-1.5.1.buildcompare) | 2 :rotating_light: 1 :no_entry_sign: | 2.4M |
