...
rebuilding **58 releases** of org.jline:jline:
...
- 17 had issues (some unreproducible artifacts :warning:, see eventual :mag: diffoscope and/or :memo: issue tracker links):
  - running [stabilize](doc/stabilize.md) on 10, 6 had all their differences removed :recycle:, 4 still had differences :rotating_light: or files not supported by stabilize :no_entry_sign:
...
| [4.0.12](https://central.sonatype.com/artifact/org.jline/jline/4.0.12/pom) | [mvn jdk22](jline-4.0.12.buildspec) | :x: | |
...
| [4.0.9](https://central.sonatype.com/artifact/org.jline/jline/4.0.9/pom) | | | |
| [4.0.8](https://central.sonatype.com/artifact/org.jline/jline/4.0.8/pom) | | | |
