...
rebuilding **52 releases** of org.jline:jline:
...
- 14 had issues (some unreproducible artifacts :warning:, see eventual :mag: diffoscope and/or :memo: issue tracker links):
  - running [stabilize](doc/stabilize.md) on 8, 6 had all their differences removed :recycle:, 2 still had differences :rotating_light: or files not supported by stabilize :no_entry_sign:
...
| [4.0.4](https://central.sonatype.com/artifact/org.jline/jline/4.0.4/pom) | | | |
