...
## Project: [org.liquibase.ext:liquibase-percona](https://central.sonatype.com/artifact/org.liquibase.ext/liquibase-percona/versions)

Source code: [https://github.com/liquibase/liquibase-percona.git](https://github.com/liquibase/liquibase-percona.git)

rebuilding **34 releases** of org.liquibase.ext:liquibase-percona:
...
| -- | --------- | ------ | -- |
| [4.24.0](https://central.sonatype.com/artifact/org.liquibase.ext/liquibase-percona/4.24.0/pom) | | | |
| [4.23.2](https://central.sonatype.com/artifact/org.liquibase.ext/liquibase-percona/4.23.2/pom) | [mvn jdk11](liquibase-percona-4.23.2.buildspec) | [result](liquibase-percona-4.23.2.buildinfo): [3 :heavy_check_mark: ](liquibase-percona-4.23.2.buildcompare) | 133K |
