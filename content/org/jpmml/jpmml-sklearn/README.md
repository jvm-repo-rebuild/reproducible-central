...
rebuilding **35 releases** of org.jpmml:jpmml-sklearn:
...
- 24 had issues (some unreproducible artifacts :warning:, see eventual :mag: diffoscope and/or :memo: issue tracker links):
  - running [stabilize](doc/stabilize.md) on 24, 15 had all their differences removed :recycle:, 9 still had differences :rotating_light: or files not supported by stabilize :no_entry_sign:
...
| [1.9.22](https://central.sonatype.com/artifact/org.jpmml/jpmml-sklearn/1.9.22/pom) | | | |
