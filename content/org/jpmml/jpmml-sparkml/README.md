...
rebuilding **59 releases** of org.jpmml:jpmml-sparkml:
...
- 41 had issues (some unreproducible artifacts :warning:, see eventual :mag: diffoscope and/or :memo: issue tracker links):
  - running [stabilize](doc/stabilize.md) on 25, 3 had all their differences removed :recycle:, 22 still had differences :rotating_light: or files not supported by stabilize :no_entry_sign:
...
| [3.1.8](https://central.sonatype.com/artifact/org.jpmml/jpmml-sparkml/3.1.8/pom) | | | |
...
| [3.0.8](https://central.sonatype.com/artifact/org.jpmml/jpmml-sparkml/3.0.8/pom) | | | |
