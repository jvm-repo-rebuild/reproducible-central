...
- 37 had issues (some unreproducible artifacts :warning:, see eventual :mag: diffoscope and/or :memo: issue tracker links):
  - running [stabilize](doc/stabilize.md) on 16, 3 had all their differences removed :recycle:, 13 still had differences :rotating_light: or files not supported by stabilize :no_entry_sign:
...
| [3.0.3](https://central.sonatype.com/artifact/org.jpmml/jpmml-sparkml/3.0.3/pom) | [mvn jdk11](jpmml-sparkml-3.0.3.buildspec) | :x: | |
