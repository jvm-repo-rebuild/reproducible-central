...
rebuilding **66 releases** of org.jpmml:jpmml-sparkml:
...
- 48 had issues (some unreproducible artifacts :warning:, see eventual :mag: diffoscope and/or :memo: issue tracker links):
  - running [stabilize](doc/stabilize.md) on 32, 3 had all their differences removed :recycle:, 29 still had differences :rotating_light: or files not supported by stabilize :no_entry_sign:
