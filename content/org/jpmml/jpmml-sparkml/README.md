...
- 37 had issues (some unreproducible artifacts :warning:, see eventual :mag: diffoscope and/or :memo: issue tracker links):
  - running [stabilize](doc/stabilize.md) on 18, 3 had all their differences removed :recycle:, 15 still had differences :rotating_light: or files not supported by stabilize :no_entry_sign:
...
| [3.0.5](https://central.sonatype.com/artifact/org.jpmml/jpmml-sparkml/3.0.5/pom) | [mvn jdk11](jpmml-sparkml-3.0.5.buildspec) | :x: | |
