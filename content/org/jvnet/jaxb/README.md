...
| -- | --------- | ------ | ------ | -- |
| [4.0.15](https://central.sonatype.com/artifact/org.jvnet.jaxb/jaxb-tools-project/4.0.15/pom) | [mvn jdk21](jaxb-tools-4.0.15.buildspec) | [result](jaxb-tools-project-4.0.15.buildinfo): [71 :white_check_mark:  1 :warning:](jaxb-tools-project-4.0.15.buildcompare) | 1 :rotating_light: | 5.6M |
