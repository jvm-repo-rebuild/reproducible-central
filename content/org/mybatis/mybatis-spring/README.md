...
| -- | --------- | ------ | -- |
| [3.0.1](https://search.maven.org/artifact/org.mybatis/mybatis-spring/3.0.1/pom) | [mvn jdk17 w](mybatis-spring-3.0.1.buildspec) | [result](mybatis-spring-3.0.1.buildinfo): [3 :heavy_check_mark: ](mybatis-spring-3.0.1.buildcompare) | 154K |
