...
rebuilding **12 releases** of org.mybatis.spring.boot:mybatis-spring-boot:
...
| -- | --------- | ------ | ------ | -- |
| [4.1.0](https://central.sonatype.com/artifact/org.mybatis.spring.boot/mybatis-spring-boot/4.1.0/pom) | [mvn jdk25 w](mybatis-spring-boot-4.1.0.buildspec) | [result](mybatis-spring-boot-4.1.0.buildinfo): [24 :white_check_mark:  23 :warning:](mybatis-spring-boot-4.1.0.buildcompare) | 22 :rotating_light: 1 :no_entry_sign: | 196M |
