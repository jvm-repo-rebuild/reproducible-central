...
rebuilding **7 releases** of org.dbunit:dbunit:
...
| -- | --------- | ------ | ------ | -- |
| [3.5.2](https://central.sonatype.com/artifact/org.dbunit/dbunit/3.5.2/pom) | [mvn jdk21](dbunit-3.5.2.buildspec) | [result](dbunit-3.5.2.buildinfo): [3 :white_check_mark: ](dbunit-3.5.2.buildcompare) | | 1.5M |
