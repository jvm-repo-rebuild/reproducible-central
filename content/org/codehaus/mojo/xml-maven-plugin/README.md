...
| -- | --------- | ------ | ------ | -- |
| [1.2.1](https://central.sonatype.com/artifact/org.codehaus.mojo/xml-maven-plugin/1.2.1/pom) | [mvn jdk21](xml-maven-plugin-1.2.1.buildspec) | [result](xml-maven-plugin-1.2.1.buildinfo): [3 :white_check_mark:  1 :warning:](xml-maven-plugin-1.2.1.buildcompare) [:memo:](https://github.com/mojohaus/xml-maven-plugin/issues/155) | 1 :rotating_light: | 347K |
