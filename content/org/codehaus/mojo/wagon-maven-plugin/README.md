[org.codehaus.mojo:wagon-maven-plugin](https://central.sonatype.com/artifact/org.codehaus.mojo/wagon-maven-plugin/versions) RB check
=======
...
rebuilding **4 releases** of org.codehaus.mojo:wagon-maven-plugin:
- **3** releases were found successfully **fully reproducible** (100% reproducible artifacts :white_check_mark:),
- 1 had issues (some unreproducible artifacts :warning:, see eventual :mag: diffoscope and/or :memo: issue tracker links):

| version | [build spec](/BUILDSPEC.md) | [result](https://reproducible-builds.org/docs/jvm/): reproducible? | [stabilize](https://github.com/google/oss-rebuild/blob/main/cmd/stabilize/README.md) | size |
| -- | --------- | ------ | ------ | -- |
| [3.1.0](https://central.sonatype.com/artifact/org.codehaus.mojo/wagon-maven-plugin/3.1.0/pom) | [mvn jdk25](wagon-maven-plugin-3.1.0.buildspec) | [result](wagon-maven-plugin-3.1.0.buildinfo): [4 :white_check_mark: ](wagon-maven-plugin-3.1.0.buildcompare) | | 199K |
| [3.0.0](https://central.sonatype.com/artifact/org.codehaus.mojo/wagon-maven-plugin/3.0.0/pom) | [mvn jdk21](wagon-maven-plugin-3.0.0.buildspec) | [result](wagon-maven-plugin-3.0.0.buildinfo): [4 :white_check_mark: ](wagon-maven-plugin-3.0.0.buildcompare) | | 199K |
