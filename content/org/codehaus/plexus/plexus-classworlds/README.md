...
| -- | --------- | ------ | ------ | -- |
| [2.12.0](https://central.sonatype.com/artifact/org.codehaus.plexus/plexus-classworlds/2.12.0/pom) | [mvn jdk25](plexus-classworlds-2.12.0.buildspec) | [result](plexus-classworlds-2.12.0.buildinfo): [3 :white_check_mark:  1 :warning:](plexus-classworlds-2.12.0.buildcompare) | 1 :rotating_light: | 252K |
