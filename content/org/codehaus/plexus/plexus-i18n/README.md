...
| -- | --------- | ------ | ------ | -- |
| [1.0.0](https://central.sonatype.com/artifact/org.codehaus.plexus/plexus-i18n/1.0.0/pom) | [mvn jdk25](plexus-i18n-1.0.0.buildspec) | [result](plexus-i18n-1.0.0.buildinfo): [3 :white_check_mark:  1 :warning:](plexus-i18n-1.0.0.buildcompare) | 1 :rotating_light: | 43K |
